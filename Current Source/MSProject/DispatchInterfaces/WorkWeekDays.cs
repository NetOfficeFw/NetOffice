...
namespace NetOffice.MSProjectApi
{
	...
	public class WorkWeekDays : COMObject ,IEnumerable<NetOffice.MSProjectApi.WorkWeekDay>
	{
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public WorkWeekDays(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public WorkWeekDays(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		/// <param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public WorkWeekDays(COMObject replacedObject) : base(replacedObject)
		{
		}
...
{			
			...
			NetOffice.MSProjectApi.WorkWeekDay newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.WorkWeekDay.LateBindingApiWrapperType) as NetOffice.MSProjectApi.WorkWeekDay;
			return newObject;
			}
		}
