	...
	public class Year : COMObject
	{
		...
		public NetOffice.MSProjectApi.Months Months
		{
			get
			{
				...
				NetOffice.MSProjectApi.Months newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.Months.LateBindingApiWrapperType) as NetOffice.MSProjectApi.Months;
				return newObject;
			}
		}
