	...
	public class Month : COMObject
	{
		...
		public NetOffice.MSProjectApi.Days Days
		{
			get
			{
				...
				NetOffice.MSProjectApi.Days newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.Days.LateBindingApiWrapperType) as NetOffice.MSProjectApi.Days;
				return newObject;
			}
		}
