	...
	public class WorkWeek : COMObject
	{
		...
		public NetOffice.MSProjectApi.WorkWeekDays WeekDays
		{
			get
			{
				...
				NetOffice.MSProjectApi.WorkWeekDays newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.WorkWeekDays.LateBindingApiWrapperType) as NetOffice.MSProjectApi.WorkWeekDays;
				return newObject;
			}
		}
