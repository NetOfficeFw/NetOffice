	...
	public class Group : COMObject
	{
		...
		public NetOffice.MSProjectApi.GroupCriteria GroupCriteria
		{
			get
			{
				...
				NetOffice.MSProjectApi.GroupCriteria newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.GroupCriteria.LateBindingApiWrapperType) as NetOffice.MSProjectApi.GroupCriteria;
				return newObject;
			}
			set
			{
