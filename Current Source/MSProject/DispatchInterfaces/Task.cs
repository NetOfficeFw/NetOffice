	...
	public class Task : COMObject
	{
		...
		public NetOffice.MSProjectApi.SplitParts SplitParts
		{
			get
			{
				...
				NetOffice.MSProjectApi.SplitParts newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.SplitParts.LateBindingApiWrapperType) as NetOffice.MSProjectApi.SplitParts;
				return newObject;
			}
		}
		...
		public NetOffice.MSProjectApi.TaskDependencies TaskDependencies
		{
			get
			{
				...
				NetOffice.MSProjectApi.TaskDependencies newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.TaskDependencies.LateBindingApiWrapperType) as NetOffice.MSProjectApi.TaskDependencies;
				return newObject;
			}
		}
		...
		public NetOffice.MSProjectApi.StartDriver StartDriver
		{
			get
			{
				...
				NetOffice.MSProjectApi.StartDriver newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.StartDriver.LateBindingApiWrapperType) as NetOffice.MSProjectApi.StartDriver;
				return newObject;
			}
		}
