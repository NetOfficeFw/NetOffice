...
{			
			...
			NetOffice.DAOApi.Parameter newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.DAOApi.Parameter.LateBindingApiWrapperType) as NetOffice.DAOApi.Parameter;
			return newObject;
			}
		}
