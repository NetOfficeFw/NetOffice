...
{			
			...
			NetOffice.AccessApi.WebService newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.WebService.LateBindingApiWrapperType) as NetOffice.AccessApi.WebService;
			return newObject;
			}
		}
