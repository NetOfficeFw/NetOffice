...
{			
			...
			NetOffice.AccessApi.LocalVar newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.LocalVar.LateBindingApiWrapperType) as NetOffice.AccessApi.LocalVar;
			return newObject;
			}
		}
