	...
	public class ShapeNodes : _IMsoDispObj ,IEnumerable<NetOffice.OfficeApi.ShapeNode>
	{
		...
		public NetOffice.OfficeApi.ShapeNode this[object index]
		{
			get
			{
				...
				NetOffice.OfficeApi.ShapeNode newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OfficeApi.ShapeNode.LateBindingApiWrapperType) as NetOffice.OfficeApi.ShapeNode;
				return newObject;
			}
		}
