	...
	public class Variables : COMObject ,IEnumerable<NetOffice.WordApi.Variable>
	{
		...
		public NetOffice.WordApi.Variable this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.Variable newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Variable.LateBindingApiWrapperType) as NetOffice.WordApi.Variable;
				return newObject;
			}
		}
