	...
	public class ShapeNodes : COMObject ,IEnumerable<NetOffice.WordApi.ShapeNode>
	{
		...
		public NetOffice.WordApi.ShapeNode this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.ShapeNode newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.ShapeNode.LateBindingApiWrapperType) as NetOffice.WordApi.ShapeNode;
				return newObject;
			}
		}
