	...
	public class Comments : COMObject ,IEnumerable<NetOffice.WordApi.Comment>
	{
		...
		public NetOffice.WordApi.Comment this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.Comment newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Comment.LateBindingApiWrapperType) as NetOffice.WordApi.Comment;
				return newObject;
			}
		}
