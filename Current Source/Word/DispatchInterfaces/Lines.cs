	...
	public class Lines : COMObject ,IEnumerable<NetOffice.WordApi.Line>
	{
		...
		public NetOffice.WordApi.Line this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.Line newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Line.LateBindingApiWrapperType) as NetOffice.WordApi.Line;
				return newObject;
			}
		}
