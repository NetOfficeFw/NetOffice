	...
	public class Footnotes : COMObject ,IEnumerable<NetOffice.WordApi.Footnote>
	{
		...
		public NetOffice.WordApi.Footnote this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.Footnote newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Footnote.LateBindingApiWrapperType) as NetOffice.WordApi.Footnote;
				return newObject;
			}
		}
