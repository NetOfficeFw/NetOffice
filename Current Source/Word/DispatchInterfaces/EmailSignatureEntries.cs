	...
	public class EmailSignatureEntries : COMObject ,IEnumerable<NetOffice.WordApi.EmailSignatureEntry>
	{
		...
		public NetOffice.WordApi.EmailSignatureEntry this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.EmailSignatureEntry newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.EmailSignatureEntry.LateBindingApiWrapperType) as NetOffice.WordApi.EmailSignatureEntry;
				return newObject;
			}
		}
