	...
	public class Style : COMObject
	{
		...
		public NetOffice.WordApi.TableStyle Table
		{
			get
			{
				...
				NetOffice.WordApi.TableStyle newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.WordApi.TableStyle.LateBindingApiWrapperType) as NetOffice.WordApi.TableStyle;
				return newObject;
			}
		}
