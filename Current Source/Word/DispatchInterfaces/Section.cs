	...
	public class Section : COMObject
	{
		...
		public NetOffice.WordApi.HeadersFooters Headers
		{
			get
			{
				...
				NetOffice.WordApi.HeadersFooters newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.WordApi.HeadersFooters.LateBindingApiWrapperType) as NetOffice.WordApi.HeadersFooters;
				return newObject;
			}
		}
