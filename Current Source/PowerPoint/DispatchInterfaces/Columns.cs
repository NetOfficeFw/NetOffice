	...
	public class Columns : Collection
	{
		...
		public NetOffice.PowerPointApi.Column this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.Column newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.Column.LateBindingApiWrapperType) as NetOffice.PowerPointApi.Column;
				return newObject;
			}
		}
