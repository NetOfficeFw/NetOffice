	...
	public class Rows : Collection
	{
		...
		public NetOffice.PowerPointApi.Row this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.Row newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.Row.LateBindingApiWrapperType) as NetOffice.PowerPointApi.Row;
				return newObject;
			}
		}
