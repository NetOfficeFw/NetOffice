	...
	public class LegendEntry : COMObject
	{
		...
		public NetOffice.PowerPointApi.LegendKey LegendKey
		{
			get
			{
				...
				NetOffice.PowerPointApi.LegendKey newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PowerPointApi.LegendKey.LateBindingApiWrapperType) as NetOffice.PowerPointApi.LegendKey;
				return newObject;
			}
		}
