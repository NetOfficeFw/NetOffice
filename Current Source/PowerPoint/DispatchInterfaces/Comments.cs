	...
	public class Comments : Collection
	{
		...
		public NetOffice.PowerPointApi.Comment this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.Comment newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.Comment.LateBindingApiWrapperType) as NetOffice.PowerPointApi.Comment;
				return newObject;
			}
		}
