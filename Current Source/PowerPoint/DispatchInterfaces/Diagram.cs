	...
	public class Diagram : COMObject
	{
		...
		public NetOffice.PowerPointApi.DiagramNodes Nodes
		{
			get
			{
				...
				NetOffice.PowerPointApi.DiagramNodes newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PowerPointApi.DiagramNodes.LateBindingApiWrapperType) as NetOffice.PowerPointApi.DiagramNodes;
				return newObject;
			}
		}
