	...
	public class FileDialogExtensionList : Collection
	{
		...
		public NetOffice.PowerPointApi.FileDialogExtension this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.FileDialogExtension newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.FileDialogExtension.LateBindingApiWrapperType) as NetOffice.PowerPointApi.FileDialogExtension;
				return newObject;
			}
		}
