	...
	public class Points : COMObject ,IEnumerable<NetOffice.PowerPointApi.Point>
	{
		...
		public NetOffice.PowerPointApi.Point this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.Point newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.Point.LateBindingApiWrapperType) as NetOffice.PowerPointApi.Point;
				return newObject;
			}
		}
