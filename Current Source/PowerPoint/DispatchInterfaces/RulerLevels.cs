	...
	public class RulerLevels : Collection
	{
		...
		public NetOffice.PowerPointApi.RulerLevel this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.RulerLevel newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.RulerLevel.LateBindingApiWrapperType) as NetOffice.PowerPointApi.RulerLevel;
				return newObject;
			}
		}
