	...
	public class IHTMLOptionsHolder : COMObject
	{
		...
		public NetOffice.MSHTMLApi.IHTMLFontNamesCollection fonts
		{
			get
			{
				...
				NetOffice.MSHTMLApi.IHTMLFontNamesCollection newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSHTMLApi.IHTMLFontNamesCollection.LateBindingApiWrapperType) as NetOffice.MSHTMLApi.IHTMLFontNamesCollection;
				return newObject;
			}
		}
		...
		public NetOffice.MSHTMLApi.IHTMLFontSizesCollection sizes(string fontName)
		{
			...
			NetOffice.MSHTMLApi.IHTMLFontSizesCollection newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.MSHTMLApi.IHTMLFontSizesCollection.LateBindingApiWrapperType) as NetOffice.MSHTMLApi.IHTMLFontSizesCollection;
			return newObject;
		}
