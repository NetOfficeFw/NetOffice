...
{
	///<summary>
	/// DispatchInterface DispHTMLBlockElement 
	/// SupportByVersion MSHTML, 4
	///</summary>
	[SupportByVersionAttribute("MSHTML", 4)]
	[EntityTypeAttribute(EntityType.IsDispatchInterface)]
	public class DispHTMLBlockElement : COMObject
	{
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(DispHTMLBlockElement);
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLBlockElement(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLBlockElement(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		/// <param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLBlockElement(COMObject replacedObject) : base(replacedObject)
		{
		}
		
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLBlockElement() : base()
		{
		}
		
		/// <param name="progId">registered ProgID</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLBlockElement(string progId) : base(progId)
		{
		}
