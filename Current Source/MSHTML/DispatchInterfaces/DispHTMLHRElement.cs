...
namespace NetOffice.MSHTMLApi
{
	...
	public class DispHTMLHRElement : COMObject
	{
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLHRElement(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLHRElement(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		/// <param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLHRElement(COMObject replacedObject) : base(replacedObject)
		{
		}
