	...
	public class Conflicts : COMObject ,IEnumerable<NetOffice.OutlookApi.Conflict>
	{
		...
		public NetOffice.OutlookApi.Conflict this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.Conflict newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.Conflict.LateBindingApiWrapperType) as NetOffice.OutlookApi.Conflict;
				return newObject;
			}
		}
