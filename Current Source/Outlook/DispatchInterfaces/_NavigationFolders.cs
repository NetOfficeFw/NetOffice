	...
	public class _NavigationFolders : COMObject ,IEnumerable<NetOffice.OutlookApi._NavigationFolder>
	{
		...
		public NetOffice.OutlookApi._NavigationFolder this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi._NavigationFolder newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.OutlookApi._NavigationFolder;
				return newObject;
			}
		}
		...
		public NetOffice.OutlookApi.NavigationFolder Add(NetOffice.OutlookApi.MAPIFolder folder)
		{
			...
			NetOffice.OutlookApi.NavigationFolder newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.NavigationFolder.LateBindingApiWrapperType) as NetOffice.OutlookApi.NavigationFolder;
			return newObject;
		}
