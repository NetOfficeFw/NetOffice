	...
	public class Links : COMObject ,IEnumerable<NetOffice.OutlookApi.Link>
	{
		...
		public NetOffice.OutlookApi.Link this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.Link newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.Link.LateBindingApiWrapperType) as NetOffice.OutlookApi.Link;
				return newObject;
			}
		}
