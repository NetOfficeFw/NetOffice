	...
	public class _AutoFormatRules : COMObject ,IEnumerable<NetOffice.OutlookApi.AutoFormatRule>
	{
		...
		public NetOffice.OutlookApi.AutoFormatRule this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.AutoFormatRule newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.AutoFormatRule.LateBindingApiWrapperType) as NetOffice.OutlookApi.AutoFormatRule;
				return newObject;
			}
		}
