	...
	public class _AttachmentSelection : COMObject ,IEnumerable<NetOffice.OutlookApi.Attachment>
	{
		...
		public NetOffice.OutlookApi.Attachment this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.Attachment newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.Attachment.LateBindingApiWrapperType) as NetOffice.OutlookApi.Attachment;
				return newObject;
			}
		}
