	...
	public class ChTrendline : COMObject
	{
		...
		public NetOffice.OWC10Api.ChDataLabel DataLabel
		{
			get
			{
				...
				NetOffice.OWC10Api.ChDataLabel newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.ChDataLabel.LateBindingApiWrapperType) as NetOffice.OWC10Api.ChDataLabel;
				return newObject;
			}
		}
