	...
	public class ChAxis : COMObject
	{
		...
		public NetOffice.OWC10Api.ChFont Font
		{
			get
			{
				...
				NetOffice.OWC10Api.ChFont newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.ChFont.LateBindingApiWrapperType) as NetOffice.OWC10Api.ChFont;
				return newObject;
			}
		}
		...
		public NetOffice.OWC10Api.ChGridlines MajorGridlines
		{
			get
			{
				...
				NetOffice.OWC10Api.ChGridlines newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.ChGridlines.LateBindingApiWrapperType) as NetOffice.OWC10Api.ChGridlines;
				return newObject;
			}
		}
		...
		public NetOffice.OWC10Api.ChCategoryLabels CategoryLabels
		{
			get
			{
				...
				NetOffice.OWC10Api.ChCategoryLabels newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.ChCategoryLabels.LateBindingApiWrapperType) as NetOffice.OWC10Api.ChCategoryLabels;
				return newObject;
			}
		}
