...
namespace NetOffice.ExcelApi
{
	...
	public class Pictures : COMObject ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.Picture Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.Picture newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.Picture.LateBindingApiWrapperType) as NetOffice.ExcelApi.Picture;
			return newObject;
		}
