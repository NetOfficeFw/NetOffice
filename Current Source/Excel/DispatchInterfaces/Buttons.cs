...
namespace NetOffice.ExcelApi
{
	...
	public class Buttons : Buttons_ ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.Button Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.Button newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.Button.LateBindingApiWrapperType) as NetOffice.ExcelApi.Button;
			return newObject;
		}
