...
namespace NetOffice.ExcelApi
{
	...
	public class Labels : Labels_ ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.Label Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.Label newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.Label.LateBindingApiWrapperType) as NetOffice.ExcelApi.Label;
			return newObject;
		}
