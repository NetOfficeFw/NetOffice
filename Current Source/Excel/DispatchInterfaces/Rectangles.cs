...
namespace NetOffice.ExcelApi
{
	...
	public class Rectangles : Rectangles_ ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.Rectangle Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.Rectangle newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.Rectangle.LateBindingApiWrapperType) as NetOffice.ExcelApi.Rectangle;
			return newObject;
		}
