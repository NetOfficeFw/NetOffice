	...
	public class CubeField : COMObject
	{
		...
		public NetOffice.ExcelApi.TreeviewControl TreeviewControl
		{
			get
			{
				...
				NetOffice.ExcelApi.TreeviewControl newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.TreeviewControl.LateBindingApiWrapperType) as NetOffice.ExcelApi.TreeviewControl;
				return newObject;
			}
		}
		...
		public NetOffice.ExcelApi.PivotFields PivotFields
		{
			get
			{
				...
				NetOffice.ExcelApi.PivotFields newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.PivotFields.LateBindingApiWrapperType) as NetOffice.ExcelApi.PivotFields;
				return newObject;
			}
		}
