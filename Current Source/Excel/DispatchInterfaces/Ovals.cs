...
namespace NetOffice.ExcelApi
{
	...
	public class Ovals : Ovals_ ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.Oval Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.Oval newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.Oval.LateBindingApiWrapperType) as NetOffice.ExcelApi.Oval;
			return newObject;
		}
