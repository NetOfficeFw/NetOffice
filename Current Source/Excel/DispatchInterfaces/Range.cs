...
namespace NetOffice.ExcelApi
{
	...
	public class Range : COMObject ,IEnumerable<NetOffice.ExcelApi.Range>
	{
...
{			
		...
		/// <param name="operator">optional NetOffice.ExcelApi.Enums.XlAutoFilterOperator Operator = 1</param>
