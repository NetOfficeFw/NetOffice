...
namespace NetOffice.ExcelApi
{
	...
	public class CheckBoxes : CheckBoxes_ ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.CheckBox Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.CheckBox newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.CheckBox.LateBindingApiWrapperType) as NetOffice.ExcelApi.CheckBox;
			return newObject;
		}
