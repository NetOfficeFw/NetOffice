...
namespace NetOffice.ExcelApi
{
	...
	public class IPageSetup_ : COMObject
	{
		...
		public IPageSetup_(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IPageSetup_(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		/// <param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IPageSetup_(COMObject replacedObject) : base(replacedObject)
		{
		}
	...
	public class IPageSetup : COMObject
	{
		...
		public NetOffice.ExcelApi.Pages Pages
		{
			get
			{
				...
				NetOffice.ExcelApi.Pages newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.Pages.LateBindingApiWrapperType) as NetOffice.ExcelApi.Pages;
				return newObject;
			}
		}
