...
<GuidAttribute("61F0B22C-20C6-46f9-A1BA-BE294B7FEA4E"), ProgIdAttribute("PowerPointClassicAddinVB.Addin")> _
Public Class ExampleClassicAddin
    ...
    Private Shared ReadOnly _prodId As String = "PowerPointClassicAddinVB.Addin"
