...
<GuidAttribute("3472BFF5-61A7-40a6-B5E0-1B00F342564E"), ProgIdAttribute("OutlookClassicAddinVB.Addin")> _
Public Class ExampleClassicAddin
    ...
    Private Shared ReadOnly _prodId As String = "OutlookClassicAddinVB.Addin"
