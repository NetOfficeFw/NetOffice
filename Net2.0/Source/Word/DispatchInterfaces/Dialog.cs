...
namespace LateBindingApi.WordApi
{
	...
	public class Dialog : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdWordDialogTab DefaultTab
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "DefaultTab", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdWordDialogTab)returnItem;
			}
			set
			{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdWordDialog Type
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Type", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdWordDialog)returnItem;
			}
		}
