...
{
	///<summary>
	/// DispatchInterface Browser SupportByLibrary WD09 WD10 WD11 WD12 WD14 
	///</summary>
	...
	public class Browser : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdBrowseTarget Target
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Target", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdBrowseTarget)returnItem;
			}
			set
			{
