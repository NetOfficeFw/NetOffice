...
{
	///<summary>
	/// DispatchInterface Zoom SupportByLibrary WD09 WD10 WD11 WD12 WD14 
	///</summary>
	...
	public class Zoom : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdPageFit PageFit
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "PageFit", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdPageFit)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
