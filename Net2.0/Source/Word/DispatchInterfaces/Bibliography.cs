...
namespace LateBindingApi.WordApi
{
	...
	public class Bibliography : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD12","WD14")]
		public LateBindingApi.WordApi.Sources Sources
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Sources", paramsArray);
				LateBindingApi.WordApi.Sources newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.WordApi.Sources;
				return newObject;
			}
		}
