...
namespace LateBindingApi.WordApi
{
	...
	public class Bookmarks : COMObject ,IEnumerable
	{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdBookmarkSortBy DefaultSorting
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "DefaultSorting", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdBookmarkSortBy)returnItem;
			}
			set
			{
		...
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Bookmark Item(ref object index)
		{
		...
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Bookmark Add(string name, ref object range)
		{
		...
		/// <param name="Name">string Name</param>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Bookmark Add(string name)
		{
