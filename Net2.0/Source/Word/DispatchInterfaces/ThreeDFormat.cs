...
{
	///<summary>
	/// DispatchInterface ThreeDFormat SupportByLibrary WD09 WD10 WD11 WD12 WD14 
	///</summary>
	...
	public class ThreeDFormat : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.ColorFormat ExtrusionColor
		{
			get
			{
				object[] paramsArray = null;
		...
		/// </summary>
		[SupportByLibrary("WD12","WD14")]
		public LateBindingApi.WordApi.ColorFormat ContourColor
		{
			get
			{
				object[] paramsArray = null;
