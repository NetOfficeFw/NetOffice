...
{
	///<summary>
	/// DispatchInterface Pages SupportByLibrary WD11 WD12 WD14 
	///</summary>
	...
	public class Pages : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Page Item(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.WordApi.Page newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.WordApi.Page;
			return newObject;
		}
