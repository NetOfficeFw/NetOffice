...
{
	///<summary>
	/// DispatchInterface SmartTagRecognizers SupportByLibrary WD11 WD12 WD14 
	///</summary>
	...
	public class SmartTagRecognizers : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("WD11","WD12","WD14")]
		public LateBindingApi.WordApi.SmartTagRecognizer Item(ref object index)
		{
			ParameterModifier[] modifiers = Invoker.CreateParamModifiers(true);
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray, modifiers);
			LateBindingApi.WordApi.SmartTagRecognizer newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.WordApi.SmartTagRecognizer;
