...
namespace LateBindingApi.AccessApi
{
	...
	public class _DataAccessPage : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("AC09","AC10","AC11","AC12","AC14")]
		public LateBindingApi.AccessApi.WebOptions WebOptions
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "WebOptions", paramsArray);
				LateBindingApi.AccessApi.WebOptions newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.AccessApi.WebOptions;
				return newObject;
			}
		}
		...
		/// </summary>
		[SupportByLibrary("AC10","AC11","AC12","AC14")]
		public LateBindingApi.OWC10Api.IDataSourceControl MSODSC
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MSODSC", paramsArray);
				LateBindingApi.OWC10Api.IDataSourceControl newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.OWC10Api.IDataSourceControl;
				return newObject;
			}
		}
