...
{
	///<summary>
	/// DispatchInterface _WebBrowserControl SupportByLibrary AC14 
	///</summary>
	[SupportByLibrary("AC14")]
	public class _WebBrowserControl : LateBindingApi.OfficeApi.IAccessible
	{
		...
		/// </summary>
		[SupportByLibrary("AC14")]
		public LateBindingApi.AccessApi.Enums.AcWebBrowserState ReadyState
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ReadyState", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcWebBrowserState)returnItem;
			}
		}
		...
		/// </summary>
		[SupportByLibrary("AC14")]
		public LateBindingApi.AccessApi.Enums.AcWebBrowserScrollBars ScrollBars
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ScrollBars", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcWebBrowserScrollBars)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
