...
{
	///<summary>
	/// DispatchInterface _Textbox SupportByLibrary AC09 AC10 AC11 AC12 AC14 
	///</summary>
	[SupportByLibrary("AC09","AC10","AC11","AC12","AC14")]
	public class _Textbox : LateBindingApi.OfficeApi.IAccessible
	{
		...
		/// </summary>
		[SupportByLibrary("AC12","AC14")]
		public LateBindingApi.AccessApi.Enums.AcTextFormat TextFormat
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "TextFormat", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcTextFormat)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
