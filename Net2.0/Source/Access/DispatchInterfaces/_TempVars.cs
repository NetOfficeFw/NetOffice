...
namespace LateBindingApi.AccessApi
{
	...
	public class _TempVars : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("AC12","AC14")]
		public LateBindingApi.AccessApi.TempVar get_Item(object index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.PropertyGet(this, "Item", paramsArray);
			LateBindingApi.AccessApi.TempVar newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.AccessApi.TempVar;
			return newObject;
		}
