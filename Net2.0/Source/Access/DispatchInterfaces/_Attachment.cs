...
namespace LateBindingApi.AccessApi
{
	...
	public class _Attachment : LateBindingApi.OfficeApi.IAccessible
	{
		...
		/// </summary>
		[SupportByLibrary("AC12","AC14")]
		public LateBindingApi.AccessApi.Enums.AcDisplayAs DisplayAs
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "DisplayAs", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcDisplayAs)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
