...
{
	///<summary>
	/// DispatchInterface _LocalVars SupportByLibrary AC14 
	///</summary>
	...
	public class _LocalVars : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("AC14")]
		public LateBindingApi.AccessApi.LocalVar get_Item(object index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.PropertyGet(this, "Item", paramsArray);
			LateBindingApi.AccessApi.LocalVar newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.AccessApi.LocalVar;
			return newObject;
		}
