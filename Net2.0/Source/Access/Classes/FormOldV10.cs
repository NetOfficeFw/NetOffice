...
namespace LateBindingApi.AccessApi
{
	...
	public delegate void FormOldV10_BeforeBeginTransactionEventHandler(ref Int16 Cancel, ref LateBindingApi.ADODBApi.Connection Connection);
	public delegate void FormOldV10_AfterBeginTransactionEventHandler(ref LateBindingApi.ADODBApi.Connection Connection);
	public delegate void FormOldV10_BeforeCommitTransactionEventHandler(ref Int16 Cancel, ref LateBindingApi.ADODBApi.Connection Connection);
	public delegate void FormOldV10_AfterCommitTransactionEventHandler(ref LateBindingApi.ADODBApi.Connection Connection);
	public delegate void FormOldV10_RollbackTransactionEventHandler(ref LateBindingApi.ADODBApi.Connection Connection);
