...
{	
	...
	public class IPivotControlEvents_SinkHelper : SinkHelper, IPivotControlEvents
	{
		...
		public void ViewChange([In] object reason)
		{
			...
			LateBindingApi.OWC10Api.Enums.PivotViewReasonEnum newReason = (LateBindingApi.OWC10Api.Enums.PivotViewReasonEnum)reason;
		...
		public void DataChange([In] object reason)
		{
			...
			LateBindingApi.OWC10Api.Enums.PivotDataReasonEnum newReason = (LateBindingApi.OWC10Api.Enums.PivotDataReasonEnum)reason;
			object[] paramsArray = new object[1];
			paramsArray[0] = newReason;
			foreach(Delegate delItem in recipients)
				delItem.Method.Invoke(delItem.Target, paramsArray);
		...
		public void PivotTableChange([In] object reason)
		{
			...
			LateBindingApi.OWC10Api.Enums.PivotTableReasonEnum newReason = (LateBindingApi.OWC10Api.Enums.PivotTableReasonEnum)reason;
			object[] paramsArray = new object[1];
			paramsArray[0] = newReason;
			foreach(Delegate delItem in recipients)
				delItem.Method.Invoke(delItem.Target, paramsArray);
		...
		public void CommandEnabled([In, MarshalAs(UnmanagedType.IDispatch)] object command, [In, MarshalAs(UnmanagedType.IDispatch)] object enabled)
		{
			...
			LateBindingApi.OWC10Api.ByRef newEnabled = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, enabled) as LateBindingApi.OWC10Api.ByRef;
			object[] paramsArray = new object[2];
		...
		public void CommandChecked([In, MarshalAs(UnmanagedType.IDispatch)] object command, [In, MarshalAs(UnmanagedType.IDispatch)] object _checked)
		{
			...
			object newCommand = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, command) as object;
			LateBindingApi.OWC10Api.ByRef newChecked = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, _checked) as LateBindingApi.OWC10Api.ByRef;
			object[] paramsArray = new object[2];
			paramsArray[0] = newCommand;
		...
		public void CommandTipText([In, MarshalAs(UnmanagedType.IDispatch)] object command, [In, MarshalAs(UnmanagedType.IDispatch)] object caption)
		{
			...
			object newCommand = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, command) as object;
			LateBindingApi.OWC10Api.ByRef newCaption = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, caption) as LateBindingApi.OWC10Api.ByRef;
			object[] paramsArray = new object[2];
			paramsArray[0] = newCommand;
		...
		public void CommandBeforeExecute([In, MarshalAs(UnmanagedType.IDispatch)] object command, [In, MarshalAs(UnmanagedType.IDispatch)] object cancel)
		{
			...
			object newCommand = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, command) as object;
			LateBindingApi.OWC10Api.ByRef newCancel = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, cancel) as LateBindingApi.OWC10Api.ByRef;
			object[] paramsArray = new object[2];
			paramsArray[0] = newCommand;
		...
		public void BeforeContextMenu([In] object x, [In] object y, [In, MarshalAs(UnmanagedType.IDispatch)] object menu, [In, MarshalAs(UnmanagedType.IDispatch)] object cancel)
		{
			...
			Int32 newx = (Int32)x;
			Int32 newy = (Int32)y;
			LateBindingApi.OWC10Api.ByRef newMenu = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, menu) as LateBindingApi.OWC10Api.ByRef;
			LateBindingApi.OWC10Api.ByRef newCancel = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, cancel) as LateBindingApi.OWC10Api.ByRef;
			object[] paramsArray = new object[4];
			paramsArray[0] = newx;
			paramsArray[1] = newy;
		...
		public void StartEdit([In, MarshalAs(UnmanagedType.IDispatch)] object selection, [In, MarshalAs(UnmanagedType.IDispatch)] object activeObject, [In, MarshalAs(UnmanagedType.IDispatch)] object initialValue, [In, MarshalAs(UnmanagedType.IDispatch)] object arrowMode, [In, MarshalAs(UnmanagedType.IDispatch)] object caretPosition, [In, MarshalAs(UnmanagedType.IDispatch)] object cancel, [In, MarshalAs(UnmanagedType.IDispatch)] object errorDescription)
		{
			...
			LateBindingApi.OWC10Api.ByRef newInitialValue = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, initialValue) as LateBindingApi.OWC10Api.ByRef;
			LateBindingApi.OWC10Api.ByRef newArrowMode = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, arrowMode) as LateBindingApi.OWC10Api.ByRef;
			LateBindingApi.OWC10Api.ByRef newCaretPosition = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, caretPosition) as LateBindingApi.OWC10Api.ByRef;
			LateBindingApi.OWC10Api.ByRef newCancel = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, cancel) as LateBindingApi.OWC10Api.ByRef;
			LateBindingApi.OWC10Api.ByRef newErrorDescription = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, errorDescription) as LateBindingApi.OWC10Api.ByRef;
		...
		public void EndEdit([In] object accept, [In, MarshalAs(UnmanagedType.IDispatch)] object finalValue, [In, MarshalAs(UnmanagedType.IDispatch)] object cancel, [In, MarshalAs(UnmanagedType.IDispatch)] object errorDescription)
		{
			...
			LateBindingApi.OWC10Api.ByRef newFinalValue = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, finalValue) as LateBindingApi.OWC10Api.ByRef;
			LateBindingApi.OWC10Api.ByRef newCancel = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, cancel) as LateBindingApi.OWC10Api.ByRef;
			LateBindingApi.OWC10Api.ByRef newErrorDescription = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, errorDescription) as LateBindingApi.OWC10Api.ByRef;
			object[] paramsArray = new object[4];
		...
		public void BeforeScreenTip([In, MarshalAs(UnmanagedType.IDispatch)] object screenTipText, [In, MarshalAs(UnmanagedType.IDispatch)] object sourceObject)
		{
			...
			LateBindingApi.OWC10Api.ByRef newScreenTipText = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, screenTipText) as LateBindingApi.OWC10Api.ByRef;
