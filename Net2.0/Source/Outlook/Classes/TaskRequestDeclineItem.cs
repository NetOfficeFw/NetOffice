...
namespace LateBindingApi.OutlookApi
{
	...
	public delegate void TaskRequestDeclineItem_AttachmentAddEventHandler(LateBindingApi.OutlookApi.Attachment Attachment);
	public delegate void TaskRequestDeclineItem_AttachmentReadEventHandler(LateBindingApi.OutlookApi.Attachment Attachment);
	public delegate void TaskRequestDeclineItem_BeforeAttachmentSaveEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void TaskRequestDeclineItem_BeforeDeleteEventHandler(COMObject Item, ref bool Cancel);
	public delegate void TaskRequestDeclineItem_AttachmentRemoveEventHandler(LateBindingApi.OutlookApi.Attachment Attachment);
	public delegate void TaskRequestDeclineItem_BeforeAttachmentAddEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void TaskRequestDeclineItem_BeforeAttachmentPreviewEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void TaskRequestDeclineItem_BeforeAttachmentReadEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void TaskRequestDeclineItem_BeforeAttachmentWriteToTempFileEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	...
	///<summary>
	/// CoClass TaskRequestDeclineItem SupportByLibrary OL09 OL10 OL11 OL12 OL14 
	///</summary>
	...
	public class TaskRequestDeclineItem : _TaskRequestDeclineItem, IEventBinding 
	{
		...
		public TaskRequestDeclineItem()
		{
			CreateFromProgId("Outlook.TaskRequestDeclineItem");
		}
		
		/// <param name="progId">progId</param>
		public TaskRequestDeclineItem(string progId)
		{
