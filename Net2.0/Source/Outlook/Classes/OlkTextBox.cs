...
namespace LateBindingApi.OutlookApi
{
	...
	public delegate void OlkTextBox_MouseDownEventHandler(LateBindingApi.OutlookApi.Enums.OlMouseButton Button, LateBindingApi.OutlookApi.Enums.OlShiftState Shift, Single X, Single Y);
	public delegate void OlkTextBox_MouseMoveEventHandler(LateBindingApi.OutlookApi.Enums.OlMouseButton Button, LateBindingApi.OutlookApi.Enums.OlShiftState Shift, Single X, Single Y);
	public delegate void OlkTextBox_MouseUpEventHandler(LateBindingApi.OutlookApi.Enums.OlMouseButton Button, LateBindingApi.OutlookApi.Enums.OlShiftState Shift, Single X, Single Y);
	public delegate void OlkTextBox_EnterEventHandler();
	public delegate void OlkTextBox_ExitEventHandler(ref bool Cancel);
	public delegate void OlkTextBox_KeyDownEventHandler(ref Int32 KeyCode, LateBindingApi.OutlookApi.Enums.OlShiftState Shift);
	public delegate void OlkTextBox_KeyPressEventHandler(ref Int32 KeyAscii);
	public delegate void OlkTextBox_KeyUpEventHandler(ref Int32 KeyCode, LateBindingApi.OutlookApi.Enums.OlShiftState Shift);
	...
	///<summary>
	/// CoClass OlkTextBox SupportByLibrary OL12 OL14 
	///</summary>
