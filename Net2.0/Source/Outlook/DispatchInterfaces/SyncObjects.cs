...
namespace LateBindingApi.OutlookApi
{
	...
	public class SyncObjects : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi._SyncObject AppFolders
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "AppFolders", paramsArray);
				LateBindingApi.OutlookApi._SyncObject newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.OutlookApi._SyncObject;
				return newObject;
			}
		}
		...
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.SyncObject Item(object index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.OutlookApi.SyncObject newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.OutlookApi.SyncObject;
			return newObject;
		}
