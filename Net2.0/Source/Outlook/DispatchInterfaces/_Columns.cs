...
{
	///<summary>
	/// DispatchInterface _Columns SupportByLibrary OL12 OL14 
	///</summary>
	[SupportByLibrary("OL12","OL14")]
	public class _Columns : COMObject
	{
		...
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi._Column Item(object index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.OutlookApi._Column newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.OutlookApi._Column;
			return newObject;
		}
		...
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.Column Add(string name)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(name);
			object returnItem = Invoker.MethodReturn(this, "Add", paramsArray);
			LateBindingApi.OutlookApi.Column newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.OutlookApi.Column;
			return newObject;
		}
