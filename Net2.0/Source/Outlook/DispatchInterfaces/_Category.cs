...
{
	///<summary>
	/// DispatchInterface _Category SupportByLibrary OL12 OL14 
	///</summary>
	...
	public class _Category : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.Enums.OlCategoryColor Color
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Color", paramsArray);
				return (LateBindingApi.OutlookApi.Enums.OlCategoryColor)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.Enums.OlCategoryShortcutKey ShortcutKey
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ShortcutKey", paramsArray);
				return (LateBindingApi.OutlookApi.Enums.OlCategoryShortcutKey)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
