...
namespace LateBindingApi.OutlookApi
{
	...
	public class Search : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi._Results Results
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Results", paramsArray);
				LateBindingApi.OutlookApi._Results newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.OutlookApi._Results;
				return newObject;
			}
		}
		...
		[SupportByLibrary("OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.MAPIFolder Save(string name)
		{
