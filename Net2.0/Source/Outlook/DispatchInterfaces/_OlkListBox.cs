...
namespace LateBindingApi.OutlookApi
{
	...
	public class _OlkListBox : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.Enums.OlMatchEntry MatchEntry
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MatchEntry", paramsArray);
				return (LateBindingApi.OutlookApi.Enums.OlMatchEntry)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.Enums.OlMultiSelect MultiSelect
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MultiSelect", paramsArray);
				return (LateBindingApi.OutlookApi.Enums.OlMultiSelect)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
