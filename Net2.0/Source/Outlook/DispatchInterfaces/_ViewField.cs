...
{
	///<summary>
	/// DispatchInterface _ViewField SupportByLibrary OL12 OL14 
	///</summary>
	...
	public class _ViewField : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.ColumnFormat ColumnFormat
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ColumnFormat", paramsArray);
				LateBindingApi.OutlookApi.ColumnFormat newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.OutlookApi.ColumnFormat;
				return newObject;
			}
		}
