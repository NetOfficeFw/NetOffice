...
namespace LateBindingApi.OutlookApi
{
	...
	public class OutlookBarStorage : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi._OutlookBarGroups Groups
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Groups", paramsArray);
				LateBindingApi.OutlookApi._OutlookBarGroups newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.OutlookApi._OutlookBarGroups;
				return newObject;
			}
		}
