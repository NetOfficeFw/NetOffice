...
{
	///<summary>
	/// DispatchInterface _MarkAsTaskRuleAction SupportByLibrary OL12 OL14 
	///</summary>
	...
	public class _MarkAsTaskRuleAction : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.Enums.OlMarkInterval MarkInterval
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MarkInterval", paramsArray);
				return (LateBindingApi.OutlookApi.Enums.OlMarkInterval)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
