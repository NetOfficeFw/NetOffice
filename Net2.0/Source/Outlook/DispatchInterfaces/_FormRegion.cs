...
namespace LateBindingApi.OutlookApi
{
	...
	public class _FormRegion : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi._Inspector Inspector
		{
			get
			{
				object[] paramsArray = null;
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi.Enums.OlFormRegionMode FormRegionMode
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "FormRegionMode", paramsArray);
				return (LateBindingApi.OutlookApi.Enums.OlFormRegionMode)returnItem;
			}
		}
