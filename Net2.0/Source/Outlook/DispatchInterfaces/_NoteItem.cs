...
{
	///<summary>
	/// DispatchInterface _NoteItem SupportByLibrary OL09 OL10 OL11 OL12 OL14 
	///</summary>
	...
	public class _NoteItem : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.Enums.OlNoteColor Color
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Color", paramsArray);
				return (LateBindingApi.OutlookApi.Enums.OlNoteColor)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
