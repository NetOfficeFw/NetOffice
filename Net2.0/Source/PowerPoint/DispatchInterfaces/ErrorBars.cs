...
{
	///<summary>
	/// DispatchInterface ErrorBars SupportByLibrary PP14 
	///</summary>
	...
	public class ErrorBars : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("PP14")]
		public LateBindingApi.PowerPointApi.Enums.XlEndStyleCap EndStyle
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "EndStyle", paramsArray);
				return (LateBindingApi.PowerPointApi.Enums.XlEndStyleCap)returnItem;
			}
			set
			{
