...
namespace Dynamics
{
    class Program
    {
        ...
        {
            Console.WriteLine("C# Dynamics Performance Test - 15000 Cells.");
            ...
            for (int i = 1; i <= 10; i++)
            {
                ...
                for (int y = 1; y <= 15000; y++)
                {
                    ...
                    dynamic font = cellRange.Font;
                    font.Name = "Verdana";
                    cellRange.NumberFormat = "@";
                    cellRange.WrapText = true;
                    dynamic sampleComment = cellRange.AddComment("Sample Comment");
                    comReferencesList.Add(font);
                    comReferencesList.Add(sampleComment);
            ...
            TimeSpan timeAverage = AppendResultToLogFile(timeElapsedList, "Test3-Dynamics.log");
