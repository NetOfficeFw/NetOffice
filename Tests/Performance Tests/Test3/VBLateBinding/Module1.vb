...
Module Module1
    ...
    Sub Main()
        ...
        Console.WriteLine("Visual Basic LateBinding Performance Test - 15000 Cells.")
        ...
        For i = 1 To 10
            ...
            For y = 1 To 15000
                ...
                Dim sampleComment As Object = cellRange.AddComment("Sample Comment")
        ...
        Dim timeAverage As TimeSpan = AppendResultToLogFile(timeElapsedList, "Test3-VBLateBinding.log")
