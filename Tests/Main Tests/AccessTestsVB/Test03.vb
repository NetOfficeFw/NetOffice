...
Public Class Test03
    ...
    Public Function DoTest() As Tests.Core.TestResult Implements Tests.Core.ITestPackage.DoTest
        ...
        Try
            ...
            Dim documentFile As String = String.Format("{0}\\Test03{1}", Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), fileExtension)
            ...
            Dim newDocumentFile As String = String.Format("{0}\\CompactDatabase{1}", Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), fileExtension)
