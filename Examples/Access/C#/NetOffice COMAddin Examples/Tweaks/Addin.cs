...
{
    [COMAddin("NetOfficeCS4 Sample Access Addin", "This Addin shows you the COMAddin tweak option from the NetOffice Tools", 3)]
    [Guid("A8AC490A-A0C1-4D65-BBC1-8E43642F384D"), ProgId("TweakAccessCS4.Addin"), Tweak(true)]  // <== the tweak attribute
    public class Addin : COMAddin
    {
        ...
        protected override void ApplyCustomTweak(string name, string value)
        {
            ...
            {
                Utils.Tray.Text = "TweakAccessCS4.Addin";
