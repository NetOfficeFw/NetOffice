...
#Region "ITaskPane"
    ...
    Public Sub OnConnection(ByVal application As NetOffice.AccessApi.Application, ByVal parentPane As NetOffice.OfficeApi._CustomTaskPane, ByVal customArguments() As Object) Implements NetOffice.AccessApi.Tools.ITaskPane.OnConnection
    ...
    Public Sub OnDisconnection() Implements NetOffice.AccessApi.Tools.ITaskPane.OnDisconnection

    End Sub

    Public Sub OnDockPositionChanged(ByVal position As NetOffice.OfficeApi.Enums.MsoCTPDockPosition) Implements NetOffice.AccessApi.Tools.ITaskPane.OnDockPositionChanged

    End Sub

    Public Sub OnVisibleStateChanged(ByVal visible As Boolean) Implements NetOffice.AccessApi.Tools.ITaskPane.OnVisibleStateChanged
