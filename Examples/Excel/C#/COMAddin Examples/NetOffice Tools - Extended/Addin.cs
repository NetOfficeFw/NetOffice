...
namespace NetOfficeTools.ExtendedExcelCS4
{
    ...
    */
    ...
    [CustomUI("NetOfficeTools.ExtendedExcelCS4.RibbonUI.xml")]     // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    [Guid("BA38FD48-47BD-43de-8177-0D067A01B566"), ProgId("ExtendedExcelCS4.Addin")]
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedExcelCS4.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedExcelCS4.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedExcelCS4.Addin");
                        break;
                }
            }
