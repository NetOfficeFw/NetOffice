...
<Guid("ED20A119-9E0D-4D7B-B50A-71CFFD44A7C7"), ProgId("ExtendedExcelVB4.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedExcelVB4.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedExcelVB4.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedExcelVB4.Addin")
        ...
        Catch throwedException As Exception
            ...
            MessageBox.Show("An error occured in OnAction." + details, "ExtendedExcelVB4.Addin", MessageBoxButtons.OK, MessageBoxIcon.Error)
