...
{
    [COMAddin("NetOfficeCS4 Sample Word Addin", "This Addin shows you the COMAddin tweak option from the NetOffice Tools", 3)]
    [Guid("BA5CBD20-7254-48A4-941A-A35DD383C154"), ProgId("TweakWordCS4.Addin"), Tweak(true)]  // <== the tweak attribute
    public class Addin : COMAddin
    {
        ...
        protected override void ApplyCustomTweak(string name, string value)
        {
            ...
            {
                Utils.Tray.Text = "TweakWordCS4.Addin";
