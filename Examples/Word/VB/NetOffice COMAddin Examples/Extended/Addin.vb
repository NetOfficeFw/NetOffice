...
<CustomUI("NetOfficeTools.ExtendedWordVB4.RibbonUI.xml"), RegistryLocation(RegistrySaveLocation.CurrentUser)> _
...
Public Class Addin
    ...
    Public Sub OnClickAboutButton(ByVal control As Office.IRibbonControl)
        ...
        MessageBox.Show("NetOffice Tools - Extended Sample Addin.", "ExtendedWordVB4.Addin")
    ...
    Protected Overrides Sub OnError(ByVal methodKind As NetOffice.Tools.ErrorMethodKind, ByVal exception As System.Exception)
        ...
        MessageBox.Show("An error occured in " & methodKind.ToString(), "ExtendedWordVB4.Addin")
