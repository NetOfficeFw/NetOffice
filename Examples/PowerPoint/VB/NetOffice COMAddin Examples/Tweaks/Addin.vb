...
<COMAddin("NetOfficeVB4 Sample PPoint Addin", "This Addin shows you the COMAddin tweak option from the NetOffice Tools", 3)> _
<Guid("CF57E3CF-4FCD-4FE1-89F5-F8B411C345D7"), ProgId("TweakPPointVB4.Addin"), Tweak(True)> _
Public Class Addin
    Inherits COMAddin
    ...
    Protected Overrides Sub ApplyCustomTweak(ByVal name As String, ByVal value As String)
        ...
        If (name = "ShowTray" And value = "yes") Then
            Utils.Tray.Text = "TweakPPointVB4.Addin"
    ...
    Public Shared Sub Register(ByVal type As Type, ByVal registerCall As RegisterCall)
        ...
        ' We set a a custom tweak and a Netoffice default tweak.
