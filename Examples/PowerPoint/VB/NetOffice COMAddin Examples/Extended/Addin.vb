...
<CustomUI("NetOfficeTools.ExtendedPPointVB4.RibbonUI.xml"), RegistryLocation(RegistrySaveLocation.CurrentUser)> _
...
Public Class Addin
    ...
    Public Sub New()
        ...
        Factory.Console.Name = "ExtendedPPointVB4.Addin"
        Factory.Console.EnableSharedOutput = True
        Factory.Console.SendPipeConsoleMessage("ExtendedPPointVB4.Addin", "ExtendedPPointVB4.Addin has been loaded.")
