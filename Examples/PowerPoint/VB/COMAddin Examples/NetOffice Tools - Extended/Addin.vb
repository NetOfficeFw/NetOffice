    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedPPointVB4.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedPPointVB4.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedPPointVB4.Addin")
