...
{
    [COMAddin("NetOfficeCS4 Sample PPoint Addin", "This Addin shows you the COMAddin tweak option from the NetOffice Tools", 3)]
    [Guid("EBCC2A87-F46E-446C-886A-10A355A4B399"), ProgId("TweakPPointCS4.Addin"), Tweak(true)]  // <== the tweak attribute
    public class Addin : COMAddin
    {
        ...
        protected override void ApplyCustomTweak(string name, string value)
        {
            ...
            {
                Utils.Tray.Text = "TweakPPointCS4.Addin";
