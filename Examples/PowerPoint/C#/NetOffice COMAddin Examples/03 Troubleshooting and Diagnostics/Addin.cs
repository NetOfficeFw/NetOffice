...
*/
namespace PowerPoint03AddinCS4
{
    ...
    public class Addin : COMAddin
    {
        ...
        private void Addin_OnStartupComplete(ref Array custom)
        {
            ...
            Utils.Tray.Menu.Items.Add<TrayMenuSeparatorItem>();
            Utils.Tray.Menu.Items.Add<TrayMenuItem>("Fetch Presentation");
            ...
            // Check PowerPoint has been started from another program like: new PowerPoint.Application()
