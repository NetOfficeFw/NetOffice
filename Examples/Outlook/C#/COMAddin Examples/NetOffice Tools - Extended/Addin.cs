...
namespace NetOfficeTools.ExtendedOutlookCS4
{
    ...
    */
    ...
    [CustomUI("NetOfficeTools.ExtendedOutlookCS4.RibbonUI.xml")]    // you can specify a path to an embedded xml ressource file with your ribbon schema, otherwise you can override the GetCustomUI method from COMAddin base class
    ...
    public class Addin : COMAddin
    {
        ...
        public void OnAction(NetOffice.OfficeApi.IRibbonControl control)
        {
            try
            {
                ...
                {
                    case "customButton1":
                        MessageBox.Show("This is the first sample button.", "ExtendedOutlookCS4.Addin");
                        break;
                    case "customButton2":
                        MessageBox.Show("This is the second sample button.", "ExtendedOutlookCS4.Addin");
                        break;
                    default:
                        MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedOutlookCS4.Addin");
                        break;
                }
            }
