...
Imports Access = NetOffice.OutlookApi
...
<Guid("DB89E4AD-6B44-4EFF-A9B5-174335D98A16"), ProgId("ExtendedOutlookVB4.Addin")> _
Public Class Addin
    Inherits COMAddin
    ...
    Public Sub OnAction(ByVal control As Office.IRibbonControl)
        Try
            ...
            Select Case control.Id
                Case "customButton1"
                    MessageBox.Show("This is the first sample button.", "ExtendedOutlookVB4.Addin")
                Case "customButton2"
                    MessageBox.Show("This is the second sample button.", "ExtendedOutlookVB4.Addin")
                Case Else
                    MessageBox.Show("Unkown Control Id: " + control.Id, "ExtendedOutlookVB4.Addin")
            End Select
        ...
        Catch throwedException As Exception
            ...
            MessageBox.Show("An error occured in OnAction." + details, "ExtendedOutlookVB4.Addin", MessageBoxButtons.OK, MessageBoxIcon.Error)
