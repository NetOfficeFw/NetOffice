...
<COMAddin("NetOfficeVB4 Sample Outlook Addin", "This Addin shows you the COMAddin tweak option from the NetOffice Tools", 3)> _
<Guid("AF1B2A6E-2318-4C3C-BE8E-CE788264F303"), ProgId("TweakOutlookVB4.Addin"), Tweak(True)> _
Public Class Addin
    Inherits COMAddin
    ...
    Protected Overrides Sub ApplyCustomTweak(ByVal name As String, ByVal value As String)
        ...
        If (name = "ShowTray" And value = "yes") Then
            Utils.Tray.Text = "TweakOutlookVB4.Addin"
