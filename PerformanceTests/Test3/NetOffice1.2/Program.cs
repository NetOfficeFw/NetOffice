...
namespace NetOffice1._2
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("NetOffice Release 1.2 Performance Test - 15000 Cells.");
            ...
            TimeSpan timeAverage = AppendResultToLogFile(timeElapsedList, "Test3-NetOffice1.1.log");
