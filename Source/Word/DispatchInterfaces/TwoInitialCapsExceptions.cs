	...
	public class TwoInitialCapsExceptions : COMObject ,IEnumerable<NetOffice.WordApi.TwoInitialCapsException>
	{
		...
		public NetOffice.WordApi.TwoInitialCapsException this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.TwoInitialCapsException newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.TwoInitialCapsException.LateBindingApiWrapperType) as NetOffice.WordApi.TwoInitialCapsException;
				return newObject;
			}
		}
