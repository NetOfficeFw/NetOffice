...
namespace NetOffice.WordApi
{
	...
	/// </summary>
	/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/previous-versions/office/ff195028(v=office.15)?redirectedfrom=MSDN"/> </remarks>
	[SupportByVersion("Word", 11,12,14,15,16)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Method, "Item")]
	public class XSLTransforms : COMObject, IEnumerableProvider<NetOffice.WordApi.XSLTransform>
	{
		...
		public XSLTransforms(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.xsltransforms.count"/> </remarks>
		[SupportByVersion("Word", 11,12,14,15,16)]
		public Int32 Count
		{
			get
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.xsltransforms.application"/> </remarks>
		[SupportByVersion("Word", 11,12,14,15,16)]
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.xsltransforms.creator"/> </remarks>
		[SupportByVersion("Word", 11,12,14,15,16)]
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.xsltransforms.parent"/> </remarks>
		...
		public NetOffice.WordApi.XSLTransform this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.XSLTransform>(this, "Item", NetOffice.WordApi.XSLTransform.LateBindingApiWrapperType, index);
			}
		}
		...
		/// SupportByVersion Word 11, 12, 14, 15, 16
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.xsltransforms.add"/> </remarks>
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.XSLTransform>(this, "Add", NetOffice.WordApi.XSLTransform.LateBindingApiWrapperType, location, alias, installForAllUsers);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.XSLTransform>(this, "Add", NetOffice.WordApi.XSLTransform.LateBindingApiWrapperType, location);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.XSLTransform>(this, "Add", NetOffice.WordApi.XSLTransform.LateBindingApiWrapperType, location, alias);
		}
