	...
	public class RecentFiles : COMObject ,IEnumerable<NetOffice.WordApi.RecentFile>
	{
		...
		public NetOffice.WordApi.RecentFile this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.RecentFile newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.RecentFile.LateBindingApiWrapperType) as NetOffice.WordApi.RecentFile;
				return newObject;
			}
		}
