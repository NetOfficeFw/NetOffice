	...
	public class CategoryCollection : COMObject ,IEnumerable<NetOffice.WordApi.ChartCategory>
	{
		...
		public NetOffice.WordApi.ChartCategory this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.ChartCategory newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.ChartCategory.LateBindingApiWrapperType) as NetOffice.WordApi.ChartCategory;
				return newObject;
			}
		}
