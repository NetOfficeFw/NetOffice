	...
	public class Point : COMObject
	{
		...
		public NetOffice.WordApi.DataLabel DataLabel
		{
			get
			{
				...
				NetOffice.WordApi.DataLabel newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.WordApi.DataLabel.LateBindingApiWrapperType) as NetOffice.WordApi.DataLabel;
				return newObject;
			}
		}
