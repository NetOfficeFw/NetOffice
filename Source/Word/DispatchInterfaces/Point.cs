...
namespace NetOffice.WordApi
{
	...
	[TypeId("8A342FA0-5831-4B5E-82E1-003D0A0C635D")]
	public interface Point : ICOMObject
	{
		...
		[SupportByVersion("Word", 14,15,16)]
		Double PieSliceLocation(NetOffice.WordApi.Enums.XlPieSliceLocation loc, object index);
		...
		[CustomMethod]
		[SupportByVersion("Word", 14,15,16)]
		Double PieSliceLocation(NetOffice.WordApi.Enums.XlPieSliceLocation loc);
