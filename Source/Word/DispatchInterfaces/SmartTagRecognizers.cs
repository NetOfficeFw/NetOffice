	...
	public class SmartTagRecognizers : COMObject ,IEnumerable<NetOffice.WordApi.SmartTagRecognizer>
	{
		...
		public NetOffice.WordApi.SmartTagRecognizer this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.SmartTagRecognizer newObject = Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.SmartTagRecognizer.LateBindingApiWrapperType) as NetOffice.WordApi.SmartTagRecognizer;
				return newObject;
			}
		}
