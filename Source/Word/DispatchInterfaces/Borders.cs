	...
	public class Borders : COMObject ,IEnumerable<NetOffice.WordApi.Border>
	{
		...
		public NetOffice.WordApi.Border this[NetOffice.WordApi.Enums.WdBorderType index]
		{
			get
			{
				...
				NetOffice.WordApi.Border newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Border.LateBindingApiWrapperType) as NetOffice.WordApi.Border;
				return newObject;
			}
		}
