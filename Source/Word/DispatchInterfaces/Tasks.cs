	...
	public class Tasks : COMObject ,IEnumerable<NetOffice.WordApi.Task>
	{
		...
		public NetOffice.WordApi.Task this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.Task newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Task.LateBindingApiWrapperType) as NetOffice.WordApi.Task;
				return newObject;
			}
		}
