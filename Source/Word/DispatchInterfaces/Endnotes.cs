	...
	public class Endnotes : COMObject ,IEnumerable<NetOffice.WordApi.Endnote>
	{
		...
		public NetOffice.WordApi.Endnote this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.Endnote newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Endnote.LateBindingApiWrapperType) as NetOffice.WordApi.Endnote;
				return newObject;
			}
		}
