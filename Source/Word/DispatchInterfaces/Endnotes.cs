...
namespace NetOffice.WordApi
{
	...
	[TypeId("00020941-0000-0000-C000-000000000046")]
	public interface Endnotes : ICOMObject, IEnumerableProvider<NetOffice.WordApi.Endnote>
	{
		#region Properties
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdEndnoteLocation Location { get; set; }
		...
		NetOffice.WordApi.Endnote this[Int32 index] { get; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Endnote Add(NetOffice.WordApi.Range range, object reference, object text);
		...
		[CustomMethod]
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Endnote Add(NetOffice.WordApi.Range range);
		...
		[CustomMethod]
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Endnote Add(NetOffice.WordApi.Range range, object reference);
