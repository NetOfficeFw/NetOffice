...
namespace NetOffice.WordApi
{
	...
	public interface OMathScrSubSup : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Word", 12,14,15,16)]
		NetOffice.WordApi.OMathFunction RemoveSub();
		...
		[SupportByVersion("Word", 12,14,15,16)]
		NetOffice.WordApi.OMathFunction RemoveSup();
		...
		[SupportByVersion("Word", 12,14,15,16)]
		NetOffice.WordApi.OMathFunction ToScrPre();
