...
namespace NetOffice.WordApi
{
	...
	[TypeId("00020929-0000-0000-C000-000000000046")]
	public interface FormFields : ICOMObject, IEnumerableProvider<NetOffice.WordApi.FormField>
	{
		#region Properties
		...
		NetOffice.WordApi.FormField this[object index] { get; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.FormField Add(NetOffice.WordApi.Range range, NetOffice.WordApi.Enums.WdFieldType type);
