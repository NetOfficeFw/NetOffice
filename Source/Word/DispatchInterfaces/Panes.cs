...
namespace NetOffice.WordApi
{
	...
	/// </summary>
	/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.panes"/> </remarks>
	[SupportByVersion("Word", 9,10,11,12,14,15,16)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Method, "Item")]
	public class Panes : COMObject, IEnumerableProvider<NetOffice.WordApi.Pane>
	{
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.Panes.Count"/> </remarks>
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public Int32 Count
		{
			get
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.Panes.Application"/> </remarks>
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.Panes.Creator"/> </remarks>
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.Panes.Parent"/> </remarks>
		...
		public NetOffice.WordApi.Pane this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.Pane>(this, "Item", NetOffice.WordApi.Pane.LateBindingApiWrapperType, index);
			}
		}
		...
		/// SupportByVersion Word 9, 10, 11, 12, 14, 15, 16
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.Panes.Add"/> </remarks>
		/// <param name="splitVertical">optional object splitVertical</param>
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public NetOffice.WordApi.Pane Add(object splitVertical)
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.Pane>(this, "Add", NetOffice.WordApi.Pane.LateBindingApiWrapperType, splitVertical);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.Pane>(this, "Add", NetOffice.WordApi.Pane.LateBindingApiWrapperType);
		}
        ...
        /// </summary>
        [SupportByVersion("Word", 9, 10, 11, 12, 14, 15, 16)]
        public IEnumerator<NetOffice.WordApi.Pane> GetEnumerator()
        {
