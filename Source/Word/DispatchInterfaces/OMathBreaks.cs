	...
	public class OMathBreaks : COMObject ,IEnumerable<NetOffice.WordApi.OMathBreak>
	{
		...
		public NetOffice.WordApi.OMathBreak this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.OMathBreak newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.OMathBreak.LateBindingApiWrapperType) as NetOffice.WordApi.OMathBreak;
				return newObject;
			}
		}
