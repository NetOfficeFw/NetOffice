...
namespace NetOffice.WordApi
{
	...
	[TypeId("00020915-0000-0000-C000-000000000046")]
	public interface CustomLabel : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		Single HorizontalPitch { get; set; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdCustomLabelPageSize PageSize { get; set; }
