	...
	public class TableOfFigures : COMObject
	{
		...
		public NetOffice.WordApi.HeadingStyles HeadingStyles
		{
			get
			{
				...
				NetOffice.WordApi.HeadingStyles newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.WordApi.HeadingStyles.LateBindingApiWrapperType) as NetOffice.WordApi.HeadingStyles;
				return newObject;
			}
		}
