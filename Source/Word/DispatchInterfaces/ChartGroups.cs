...
namespace NetOffice.WordApi
{
	...
	/// </summary>
	/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.ChartGroups"/> </remarks>
	[SupportByVersion("Word", 14,15,16)]
	...
	public class ChartGroups : COMObject, IEnumerableProvider<NetOffice.WordApi.ChartGroup>
	{
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.ChartGroups.Parent"/> </remarks>
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.ChartGroups.Count"/> </remarks>
		[SupportByVersion("Word", 14,15,16)]
		public Int32 Count
		{
			get
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.ChartGroups.Application"/> </remarks>
		[SupportByVersion("Word", 14,15,16), ProxyResult]
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Word.ChartGroups.Creator"/> </remarks>
		[SupportByVersion("Word", 14,15,16)]
		...
		public NetOffice.WordApi.ChartGroup this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.ChartGroup>(this, "Item", NetOffice.WordApi.ChartGroup.LateBindingApiWrapperType, index);
			}
		}
