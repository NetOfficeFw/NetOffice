...
namespace NetOffice.WordApi
{
	...
	[TypeId("00020948-0000-0000-C000-000000000046")]
	public interface AutoCorrectEntries : ICOMObject, IEnumerableProvider<NetOffice.WordApi.AutoCorrectEntry>
	{
		#region Properties
		...
		NetOffice.WordApi.AutoCorrectEntry this[object index] { get; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.AutoCorrectEntry Add(string name, string value);
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.AutoCorrectEntry AddRichText(string name, NetOffice.WordApi.Range range);
