	...
	public class LegendEntries : COMObject ,IEnumerable<NetOffice.WordApi.LegendEntry>
	{
		...
		public NetOffice.WordApi.LegendEntry this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.LegendEntry newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.LegendEntry.LateBindingApiWrapperType) as NetOffice.WordApi.LegendEntry;
				return newObject;
			}
		}
