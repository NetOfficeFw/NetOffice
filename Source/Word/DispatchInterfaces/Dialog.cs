...
namespace NetOffice.WordApi
{
	...
	public interface Dialog : ICOMObject
	{
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdWordDialogTab DefaultTab { get; set; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdWordDialog Type { get; }
