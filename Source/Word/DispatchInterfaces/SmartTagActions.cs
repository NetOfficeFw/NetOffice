	...
	public class SmartTagActions : COMObject ,IEnumerable<NetOffice.WordApi.SmartTagAction>
	{
		...
		public NetOffice.WordApi.SmartTagAction this[object index]
		{
			get
			{
				...
				NetOffice.WordApi.SmartTagAction newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.SmartTagAction.LateBindingApiWrapperType) as NetOffice.WordApi.SmartTagAction;
				return newObject;
			}
		}
