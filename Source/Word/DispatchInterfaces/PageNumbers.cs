...
namespace NetOffice.WordApi
{
	...
	[TypeId("00020986-0000-0000-C000-000000000046")]
	public interface PageNumbers : ICOMObject, IEnumerableProvider<NetOffice.WordApi.PageNumber>
	{
		#region Properties
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdPageNumberStyle NumberStyle { get; set; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		Int32 HeadingLevelForChapter { get; set; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdSeparatorType ChapterPageSeparator { get; set; }
		...
		NetOffice.WordApi.PageNumber this[Int32 index] { get; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.PageNumber Add(object pageNumberAlignment, object firstPage);
		...
		[CustomMethod]
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.PageNumber Add();
		...
		[CustomMethod]
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.PageNumber Add(object pageNumberAlignment);
