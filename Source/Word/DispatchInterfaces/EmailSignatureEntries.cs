...
namespace NetOffice.WordApi
{
	...
	public class EmailSignatureEntries : COMObject, IEnumerableProvider<NetOffice.WordApi.EmailSignatureEntry>
	{
		...
		public EmailSignatureEntries(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public EmailSignatureEntries(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.WordApi.EmailSignatureEntry this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.EmailSignatureEntry>(this, "Item", NetOffice.WordApi.EmailSignatureEntry.LateBindingApiWrapperType, index);
			}
		}
