...
namespace NetOffice.WordApi
{
	...
	[TypeId("0002098D-0000-0000-C000-000000000046")]
	public interface ListLevel : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdTrailingCharacter TrailingCharacter { get; set; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdListNumberStyle NumberStyle { get; set; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Enums.WdListLevelAlignment Alignment { get; set; }
		...
		[SupportByVersion("Word", 10,11,12,14,15,16)]
		NetOffice.WordApi.InlineShape PictureBullet { get; }
		...
		[SupportByVersion("Word", 10,11,12,14,15,16)]
		NetOffice.WordApi.InlineShape ApplyPictureBullet(string fileName);
