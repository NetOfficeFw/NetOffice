...
namespace NetOffice.WordApi
{
	...
	[TypeId("0002092B-0000-0000-C000-000000000046")]
	public interface Frames : ICOMObject, IEnumerableProvider<NetOffice.WordApi.Frame>
	{
		#region Properties
		...
		NetOffice.WordApi.Frame this[Int32 index] { get; }
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		NetOffice.WordApi.Frame Add(NetOffice.WordApi.Range range);
