	...
	public class Conflicts : COMObject ,IEnumerable<NetOffice.WordApi.Conflict>
	{
		...
		public NetOffice.WordApi.Conflict this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.Conflict newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.Conflict.LateBindingApiWrapperType) as NetOffice.WordApi.Conflict;
				return newObject;
			}
		}
