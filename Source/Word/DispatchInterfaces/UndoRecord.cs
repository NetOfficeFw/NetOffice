...
namespace NetOffice.WordApi
{
 	...
 	public class UndoRecord : COMObject
	{
		...
		public UndoRecord(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public UndoRecord(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public UndoRecord(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public UndoRecord(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public UndoRecord(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public UndoRecord(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public bool IsRecordingCustomRecord
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "IsRecordingCustomRecord");
			}
		}
		...
		public string CustomRecordName
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "CustomRecordName");
			}
		}
		...
		public Int32 CustomRecordLevel
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "CustomRecordLevel");
			}
		}
		...
		{
			 Factory.ExecuteMethod(this, "StartCustomRecord", name);
		}
		...
		{
			 Factory.ExecuteMethod(this, "StartCustomRecord");
		}
		...
		{
			 Factory.ExecuteMethod(this, "EndCustomRecord");
		}
