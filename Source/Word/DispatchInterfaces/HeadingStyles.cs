	...
	public class HeadingStyles : COMObject ,IEnumerable<NetOffice.WordApi.HeadingStyle>
	{
		...
		public NetOffice.WordApi.HeadingStyle this[Int32 index]
		{
			get
			{
				...
				NetOffice.WordApi.HeadingStyle newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.WordApi.HeadingStyle.LateBindingApiWrapperType) as NetOffice.WordApi.HeadingStyle;
				return newObject;
			}
		}
