...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class ListGallery : COMObject, NetOffice.WordApi.ListGallery
	{
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual bool get_Modified(Int32 index)
		{
			return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "Modified", index);
		}
		...
		public virtual bool Modified(Int32 index)
		{
		...
		/// <param name="index">Int32 index</param>
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public virtual void Reset(Int32 index)
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "Reset", index);
		}
