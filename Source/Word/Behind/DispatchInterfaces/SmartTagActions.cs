...
namespace NetOffice.WordApi.Behind
{
	...
	public class SmartTagActions : COMObject, NetOffice.WordApi.SmartTagActions
	{
		...
		public virtual NetOffice.WordApi.SmartTagAction this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.SmartTagAction>(this, "Item", typeof(NetOffice.WordApi.SmartTagAction), index);
			}
		}
		...
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "ReloadActions");
		}
        ...
        /// </summary>
        [SupportByVersion("Word", 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.WordApi.SmartTagAction> GetEnumerator()
        {
