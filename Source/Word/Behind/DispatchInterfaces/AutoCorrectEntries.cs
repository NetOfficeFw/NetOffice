...
namespace NetOffice.WordApi.Behind
{
	...
	public class AutoCorrectEntries : COMObject, NetOffice.WordApi.AutoCorrectEntries
	{
		...
		public virtual NetOffice.WordApi.AutoCorrectEntry this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.AutoCorrectEntry>(this, "Item", typeof(NetOffice.WordApi.AutoCorrectEntry), index);
			}
		}
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.AutoCorrectEntry Add(string name, string value)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.AutoCorrectEntry>(this, "Add", typeof(NetOffice.WordApi.AutoCorrectEntry), name, value);
		}
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.AutoCorrectEntry AddRichText(string name, NetOffice.WordApi.Range range)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.AutoCorrectEntry>(this, "AddRichText", typeof(NetOffice.WordApi.AutoCorrectEntry), name, range);
		}
        ...
        /// </summary>
        [SupportByVersion("Word", 9, 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.WordApi.AutoCorrectEntry> GetEnumerator()
        {
