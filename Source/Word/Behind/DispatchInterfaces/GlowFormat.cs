...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class GlowFormat : COMObject, NetOffice.WordApi.GlowFormat
	{
		...
		[SupportByVersion("Word", 12,14,15,16)]
		public virtual NetOffice.WordApi.ColorFormat Color
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.WordApi.ColorFormat>(this, "Color", typeof(NetOffice.WordApi.ColorFormat));
			}
		}
