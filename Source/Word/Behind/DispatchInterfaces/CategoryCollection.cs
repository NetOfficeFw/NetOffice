...
namespace NetOffice.WordApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/jj231100.aspx </remarks>
	[SupportByVersion("Word", 15, 16)]
	...
	public class CategoryCollection : COMObject, NetOffice.WordApi.CategoryCollection
	{
		...
		public virtual NetOffice.WordApi.ChartCategory this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.ChartCategory>(this, "_Default", typeof(NetOffice.WordApi.ChartCategory), index);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("Word", 15, 16)]
        public virtual IEnumerator<NetOffice.WordApi.ChartCategory> GetEnumerator()
        {
