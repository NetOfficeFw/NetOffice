...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class OMathRad : COMObject, NetOffice.WordApi.OMathRad
	{
		...
		[SupportByVersion("Word", 12,14,15,16)]
		public virtual NetOffice.WordApi.OMath Deg
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.WordApi.OMath>(this, "Deg", typeof(NetOffice.WordApi.OMath));
			}
		}
		...
		[SupportByVersion("Word", 12,14,15,16)]
		public virtual bool HideDeg
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "HideDeg");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "HideDeg", value);
			}
		}
