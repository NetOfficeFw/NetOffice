...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class UndoRecord : COMObject, NetOffice.WordApi.UndoRecord
	{
		...
		[SupportByVersion("Word", 14,15,16)]
		public virtual bool IsRecordingCustomRecord
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "IsRecordingCustomRecord");
			}
		}
		...
		[SupportByVersion("Word", 14,15,16)]
		public virtual string CustomRecordName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "CustomRecordName");
			}
		}
		...
		[SupportByVersion("Word", 14,15,16)]
		public virtual Int32 CustomRecordLevel
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "CustomRecordLevel");
			}
		}
		...
		[SupportByVersion("Word", 14,15,16)]
		public virtual void StartCustomRecord(object name)
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "StartCustomRecord", name);
		}
		...
		[CustomMethod]
		[SupportByVersion("Word", 14,15,16)]
		public virtual void StartCustomRecord()
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "StartCustomRecord");
		}
		...
		[SupportByVersion("Word", 14,15,16)]
		public virtual void EndCustomRecord()
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "EndCustomRecord");
		}
