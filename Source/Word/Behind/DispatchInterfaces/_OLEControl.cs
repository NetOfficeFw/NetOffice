...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _OLEControl : COMObject, NetOffice.WordApi._OLEControl
	{
		...
		public virtual object Automation
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteReferencePropertyGet(this, "Automation");
			}
		}
