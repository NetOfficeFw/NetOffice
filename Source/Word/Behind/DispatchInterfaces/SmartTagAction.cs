...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class SmartTagAction : COMObject, NetOffice.WordApi.SmartTagAction
	{
		...
		/// </summary>
		[SupportByVersion("Word", 11,12,14,15,16)]
		public virtual NetOffice.WordApi.Enums.WdSmartTagControlType Type
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.WordApi.Enums.WdSmartTagControlType>(this, "Type");
			}
		}
		...
		/// </summary>
		[SupportByVersion("Word", 11,12,14,15,16)]
		public virtual bool ExpandDocumentFragment
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "ExpandDocumentFragment");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "ExpandDocumentFragment", value);
			}
		}
