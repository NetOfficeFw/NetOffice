...
namespace NetOffice.WordApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff835720.aspx </remarks>
	[SupportByVersion("Word", 9,10,11,12,14,15,16)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Method, "Item")]
	public class FormFields : COMObject, NetOffice.WordApi.FormFields
	{
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public virtual bool Shaded
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "Shaded");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "Shaded", value);
			}
		}
		...
		public virtual NetOffice.WordApi.FormField this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.FormField>(this, "Item", typeof(NetOffice.WordApi.FormField), index);
			}
		}
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.FormField Add(NetOffice.WordApi.Range range, NetOffice.WordApi.Enums.WdFieldType type)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.FormField>(this, "Add", typeof(NetOffice.WordApi.FormField), range, type);
		}
        ...
        /// </summary>
        [SupportByVersion("Word", 9, 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.WordApi.FormField> GetEnumerator()
        {
