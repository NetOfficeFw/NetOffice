...
namespace NetOffice.WordApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff195160.aspx </remarks>
	[SupportByVersion("Word", 14,15,16)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Method, "Item")]
	public class CoAuthUpdates : COMObject, NetOffice.WordApi.CoAuthUpdates
	{
		...
		public virtual NetOffice.WordApi.CoAuthUpdate this[Int32 index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.CoAuthUpdate>(this, "Item", typeof(NetOffice.WordApi.CoAuthUpdate), index);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("Word", 14, 15, 16)]
        public virtual IEnumerator<NetOffice.WordApi.CoAuthUpdate> GetEnumerator()
        {
