...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class OMathFunc : COMObject, NetOffice.WordApi.OMathFunc
	{
		...
		[SupportByVersion("Word", 12,14,15,16)]
		public virtual NetOffice.WordApi.OMath FName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.WordApi.OMath>(this, "FName", typeof(NetOffice.WordApi.OMath));
			}
		}
