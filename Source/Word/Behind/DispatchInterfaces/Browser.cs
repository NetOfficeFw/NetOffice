...
namespace NetOffice.WordApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Browser : COMObject, NetOffice.WordApi.Browser
	{
		...
		[SupportByVersion("Word", 9,10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.Enums.WdBrowseTarget Target
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.WordApi.Enums.WdBrowseTarget>(this, "Target");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "Target", value);
			}
		}
