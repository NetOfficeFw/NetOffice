...
namespace NetOffice.WordApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff196821.aspx </remarks>
	[SupportByVersion("Word", 12,14,15,16)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Method, "Item")]
	public class OMaths : COMObject, NetOffice.WordApi.OMaths
	{
		...
		[SupportByVersion("Word", 12,14,15,16)]
		public virtual NetOffice.WordApi.Range Add(NetOffice.WordApi.Range range)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.Range>(this, "Add", typeof(NetOffice.WordApi.Range), range);
		}
