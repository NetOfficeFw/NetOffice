...
namespace NetOffice.WordApi.Behind
{
	...
	/// </summary>
	public class DiagramNodeChildren : COMObject, NetOffice.WordApi.DiagramNodeChildren
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.WordApi.DiagramNodeChildren);
		...
		/// </summary>
		[SupportByVersion("Word", 10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.DiagramNode FirstChild
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.WordApi.DiagramNode>(this, "FirstChild", typeof(NetOffice.WordApi.DiagramNode));
			}
		}
		...
		/// </summary>
		[SupportByVersion("Word", 10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.DiagramNode LastChild
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.WordApi.DiagramNode>(this, "LastChild", typeof(NetOffice.WordApi.DiagramNode));
			}
		}
		...
		[SupportByVersion("Word", 10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.DiagramNode AddNode(object index, object nodeType)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.DiagramNode>(this, "AddNode", typeof(NetOffice.WordApi.DiagramNode), index, nodeType);
		}
		...
		[CustomMethod]
		[SupportByVersion("Word", 10,11,12,14,15,16)]
		public virtual NetOffice.WordApi.DiagramNode AddNode(object index)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.WordApi.DiagramNode>(this, "AddNode", typeof(NetOffice.WordApi.DiagramNode), index);
		}
