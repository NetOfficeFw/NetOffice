...
namespace NetOffice.MSFormsApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class IScrollbar : COMObject, NetOffice.MSFormsApi.IScrollbar
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSFormsApi.IScrollbar);
		...
		/// </summary>
		[SupportByVersion("MSForms", 2)]
		public virtual bool ProportionalThumb
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "ProportionalThumb");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "ProportionalThumb", value);
			}
		}
