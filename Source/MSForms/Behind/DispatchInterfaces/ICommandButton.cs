...
namespace NetOffice.MSFormsApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class ICommandButton : COMObject, NetOffice.MSFormsApi.ICommandButton
	{
		...
		/// </summary>
		[SupportByVersion("MSForms", 2)]
		public virtual bool TakeFocusOnClick
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "TakeFocusOnClick");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "TakeFocusOnClick", value);
			}
		}
