...
namespace NetOffice.MSFormsApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class IPage : COMObject, NetOffice.MSFormsApi.IPage
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSFormsApi.IPage);
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(IPage);                return _type;
            }
        }
		...
		/// </summary>
		[SupportByVersion("MSForms", 2)]
		public virtual NetOffice.MSFormsApi.Enums.fmTransitionEffect TransitionEffect
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.MSFormsApi.Enums.fmTransitionEffect>(this, "TransitionEffect");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "TransitionEffect", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSForms", 2)]
		public virtual Int32 TransitionPeriod
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "TransitionPeriod");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "TransitionPeriod", value);
			}
		}
