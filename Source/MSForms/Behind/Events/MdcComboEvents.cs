...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.MdcComboEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class MdcComboEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.MdcComboEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from MdcComboEvents
		/// </summary>
