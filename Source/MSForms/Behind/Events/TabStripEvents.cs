...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.TabStripEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class TabStripEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.TabStripEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from TabStripEvents
		/// </summary>
