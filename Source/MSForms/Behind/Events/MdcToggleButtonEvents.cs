...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.MdcToggleButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class MdcToggleButtonEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.MdcToggleButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from MdcToggleButtonEvents
		/// </summary>
