...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.ScrollbarEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class ScrollbarEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.ScrollbarEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from ScrollbarEvents
		/// </summary>
		...
		public ScrollbarEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
