...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.CommandButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
	[ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class CommandButtonEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.CommandButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from CommandButtonEvents
		/// </summary>
		public static readonly string Id = "7B020EC1-AF6C-11CE-9F46-00AA00574A4F";
		...
		public CommandButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
