...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.LabelControlEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class LabelControlEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.LabelControlEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from LabelControlEvents
		/// </summary>
