...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.MdcCheckBoxEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class MdcCheckBoxEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.MdcCheckBoxEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from MdcCheckBoxEvents
		/// </summary>
