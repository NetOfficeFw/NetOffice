...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.MdcTextEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class MdcTextEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.MdcTextEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from MdcTextEvents
		/// </summary>
		...
		public MdcTextEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
