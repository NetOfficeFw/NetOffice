...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.MdcListEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class MdcListEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.MdcListEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from MdcListEvents
		/// </summary>
