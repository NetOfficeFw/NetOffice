...
namespace NetOffice.MSFormsApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSFormsApi.EventContracts.MdcOptionButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class MdcOptionButtonEvents_SinkHelper : SinkHelper, NetOffice.MSFormsApi.EventContracts.MdcOptionButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from MdcOptionButtonEvents
		/// </summary>
