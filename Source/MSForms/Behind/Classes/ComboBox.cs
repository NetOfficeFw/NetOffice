...
namespace NetOffice.MSFormsApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.MSFormsApi.EventContracts.MdcComboEvents))]
    public class ComboBox : IMdcCombo, NetOffice.MSFormsApi.ComboBox
    {
        ...
        private NetOffice.MSFormsApi.Behind.EventContracts.MdcComboEvents_SinkHelper _mdcComboEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSFormsApi.ComboBox);
		...
		/// SupportByVersion MSForms, 2
		/// </summary>
		private event ComboBox_BeforeDragOverEventHandler _BeforeDragOverEvent;
		...
		/// SupportByVersion MSForms, 2
		/// </summary>
		private event ComboBox_BeforeDropOrPasteEventHandler _BeforeDropOrPasteEvent;
		...
		/// SupportByVersion MSForms, 2
		/// </summary>
		private event ComboBox_DropButtonClickEventHandler _DropButtonClickEvent;
		...
		/// SupportByVersion MSForms, 2
		/// </summary>
		private event ComboBox_ErrorEventHandler _ErrorEvent;
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.MSFormsApi.Behind.EventContracts.MdcComboEvents_SinkHelper.Id);


			if(NetOffice.MSFormsApi.Behind.EventContracts.MdcComboEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_mdcComboEvents_SinkHelper = new NetOffice.MSFormsApi.Behind.EventContracts.MdcComboEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
        ...
        public virtual void DisposeEventBridge()
        {
			...
			{
				_mdcComboEvents_SinkHelper.Dispose();
				_mdcComboEvents_SinkHelper = null;
			}
