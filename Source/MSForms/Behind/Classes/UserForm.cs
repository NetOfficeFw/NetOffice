...
namespace NetOffice.MSFormsApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.MSFormsApi.EventContracts.FormEvents))]
    public class UserForm : _UserForm, NetOffice.MSFormsApi.UserForm
    {
        ...
        private NetOffice.MSFormsApi.Behind.EventContracts.FormEvents_SinkHelper _formEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSFormsApi.UserForm);
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.MSFormsApi.Behind.EventContracts.FormEvents_SinkHelper.Id);


			if(NetOffice.MSFormsApi.Behind.EventContracts.FormEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_formEvents_SinkHelper = new NetOffice.MSFormsApi.Behind.EventContracts.FormEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
