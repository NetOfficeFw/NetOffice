...
namespace NetOffice.MSFormsApi.Behind
{
    ...
    public class CommandButton : ICommandButton, NetOffice.MSFormsApi.CommandButton
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSFormsApi.CommandButton);
		...
		/// </summary>
		[SupportByVersion("MSForms", 2)]
		public virtual event CommandButton_BeforeDragOverEventHandler BeforeDragOverEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSForms", 2)]
		public virtual event CommandButton_BeforeDropOrPasteEventHandler BeforeDropOrPasteEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSForms", 2)]
		public virtual event CommandButton_ErrorEventHandler ErrorEvent
		{
			add
			{
				CreateEventBridge();
