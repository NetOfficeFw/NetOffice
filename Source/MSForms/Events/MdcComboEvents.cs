...
{	
    ...
    [ComImport, Guid("8BD21D32-EC42-11CE-9E0D-00AA006002F3"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface MdcComboEvents
	{
		[SupportByVersion("MSForms", 2)]
	...
	public class MdcComboEvents_SinkHelper : SinkHelper, MdcComboEvents
	{
		#region Static
		
		public static readonly string Id = "8BD21D32-EC42-11CE-9E0D-00AA006002F3";
		...
		public MdcComboEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
