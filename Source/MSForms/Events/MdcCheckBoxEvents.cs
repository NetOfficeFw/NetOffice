...
{	
    ...
    [ComImport, Guid("8BD21D42-EC42-11CE-9E0D-00AA006002F3"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface MdcCheckBoxEvents
	{
		[SupportByVersion("MSForms", 2)]
	...
	public class MdcCheckBoxEvents_SinkHelper : SinkHelper, MdcCheckBoxEvents
	{
		#region Static
		
		public static readonly string Id = "8BD21D42-EC42-11CE-9E0D-00AA006002F3";
		...
		public MdcCheckBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region MdcCheckBoxEvents Members
