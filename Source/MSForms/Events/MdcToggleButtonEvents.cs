...
{	
    ...
    [ComImport, Guid("8BD21D62-EC42-11CE-9E0D-00AA006002F3"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface MdcToggleButtonEvents
	{
		[SupportByVersion("MSForms", 2)]
	...
	public class MdcToggleButtonEvents_SinkHelper : SinkHelper, MdcToggleButtonEvents
	{
		#region Static
		
		public static readonly string Id = "8BD21D62-EC42-11CE-9E0D-00AA006002F3";
		...
		public MdcToggleButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region MdcToggleButtonEvents Members
