...
{	
    ...
    [ComImport, Guid("8BD21D52-EC42-11CE-9E0D-00AA006002F3"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface MdcOptionButtonEvents
	{
		[SupportByVersion("MSForms", 2)]
	...
	public class MdcOptionButtonEvents_SinkHelper : SinkHelper, MdcOptionButtonEvents
	{
		#region Static
		
		public static readonly string Id = "8BD21D52-EC42-11CE-9E0D-00AA006002F3";
		...
		public MdcOptionButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region MdcOptionButtonEvents Members
