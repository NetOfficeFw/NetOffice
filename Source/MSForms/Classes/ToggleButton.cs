...
namespace NetOffice.MSFormsApi
{
	...
	public class ToggleButton : IMdcToggleButton,IEventBinding
	{
		...
		/// <summary>
        /// returns all running MSForms.ToggleButton objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSForms.ToggleButton array</returns>
		public static NetOffice.MSFormsApi.ToggleButton[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSForms","ToggleButton");
		...
		/// <summary>
        /// returns a running MSForms.ToggleButton object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSForms.ToggleButton object or null</returns>
		public static NetOffice.MSFormsApi.ToggleButton GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSForms","ToggleButton", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSForms","ToggleButton", throwOnError);
			if(null != proxy)
				return new NetOffice.MSFormsApi.ToggleButton(null, proxy);
			else
				return null;
