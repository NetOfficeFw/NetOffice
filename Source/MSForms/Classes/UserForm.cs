...
namespace NetOffice.MSFormsApi
{
	...
	public class UserForm : _UserForm,IEventBinding
	{
		...
		public UserForm(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public UserForm(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public UserForm(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public UserForm(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public UserForm(COMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// returns all running MSForms.UserForm objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSForms.UserForm array</returns>
		public static NetOffice.MSFormsApi.UserForm[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSForms","UserForm");
		...
		/// <summary>
        /// returns a running MSForms.UserForm object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSForms.UserForm object or null</returns>
		public static NetOffice.MSFormsApi.UserForm GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSForms","UserForm", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSForms","UserForm", throwOnError);
			if(null != proxy)
				return new NetOffice.MSFormsApi.UserForm(null, proxy);
			else
				return null;
