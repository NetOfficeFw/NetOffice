...
namespace NetOffice.MSFormsApi
{
	...
	public class HTMLTextArea : IWHTMLTextArea,IEventBinding
	{
		...
		public HTMLTextArea(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public HTMLTextArea(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLTextArea(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLTextArea(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLTextArea(COMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// returns all running MSForms.HTMLTextArea objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSForms.HTMLTextArea array</returns>
		public static NetOffice.MSFormsApi.HTMLTextArea[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSForms","HTMLTextArea");
		...
		/// <summary>
        /// returns a running MSForms.HTMLTextArea object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSForms.HTMLTextArea object or null</returns>
		public static NetOffice.MSFormsApi.HTMLTextArea GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSForms","HTMLTextArea", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSForms","HTMLTextArea", throwOnError);
			if(null != proxy)
				return new NetOffice.MSFormsApi.HTMLTextArea(null, proxy);
			else
				return null;
