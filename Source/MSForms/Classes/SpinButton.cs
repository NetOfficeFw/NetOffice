...
namespace NetOffice.MSFormsApi
{
	...
	[EventSink(typeof(Events.SpinbuttonEvents_SinkHelper))]
	public class SpinButton : ISpinbutton, IEventBinding
	{
		...
		private Events.SpinbuttonEvents_SinkHelper _spinbuttonEvents_SinkHelper;
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, Events.SpinbuttonEvents_SinkHelper.Id);


			if(Events.SpinbuttonEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_spinbuttonEvents_SinkHelper = new Events.SpinbuttonEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
