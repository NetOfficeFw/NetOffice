	...
	public class Task : COMObject
	{
		...
		public NetOffice.MSProjectApi.Enums.PjStatusType Status
		{
			get
			{
				...
				return (NetOffice.MSProjectApi.Enums.PjStatusType)returnItem;
			}
		}
		...
		/// <param name="Type">NetOffice.MSProjectApi.Enums.PjTaskTimescaledData Type</param>
		...
		/// <param name="Link">NetOffice.MSProjectApi.Enums.PjTaskLinkType Link</param>
