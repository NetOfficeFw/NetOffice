...
{
	///<summary>
	/// DispatchInterface _Range SupportByLibraryAttribute OWC10, 1
	///</summary>
	[SupportByLibraryAttribute("OWC10", 1)]
	[EntityTypeAttribute(EntityType.IsDispatchInterface)]
	public class _Range : COMObject ,IEnumerable<NetOffice.OWC10Api._Range>
	{
...
{			
		...
		[SupportByLibraryAttribute("OWC10", 1)]
		[NetRuntimeSystem.Runtime.CompilerServices.IndexerName("Item")]
		public NetOffice.OWC10Api._Range this[object rowIndex]
		{
			get
{			
        ...
        #region IEnumerable<NetOffice.OWC10Api._Range> Member
		
		/// <summary>
		/// SupportByLibraryAttribute OWC10, 1
		/// </summary>
		[SupportByLibraryAttribute("OWC10", 1)]
        public IEnumerator<NetOffice.OWC10Api._Range> GetEnumerator()  
        {
            NetRuntimeSystem.Collections.IEnumerable innerEnumerator = (this as NetRuntimeSystem.Collections.IEnumerable);
            foreach (NetOffice.OWC10Api._Range item in innerEnumerator)
                yield return item;
        }
