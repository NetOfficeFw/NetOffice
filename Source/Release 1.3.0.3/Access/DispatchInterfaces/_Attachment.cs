...
{
	///<summary>
	/// DispatchInterface _Attachment SupportByLibraryAttribute Access, 12,14
	///</summary>
	...
	public class _Attachment : NetOffice.OfficeApi.IAccessible
	{
		...
		public NetOffice.AccessApi.Enums.AcDisplayAs DisplayAs
		{
			get
			{
				...
				return (NetOffice.AccessApi.Enums.AcDisplayAs)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// <summary>
		/// SupportByLibrary Access 12, 14, 12, 14
		/// Get
		/// </summary>
		[SupportByLibraryAttribute("Access", 12,14,12,14)]
