...
#pragma warning disable
        ...
        public Databases(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public NetOffice.DAOApi.Database this[object item]
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.DAOApi.Database>(this, "Item", NetOffice.DAOApi.Database.LateBindingApiWrapperType, item);
            }
        }
