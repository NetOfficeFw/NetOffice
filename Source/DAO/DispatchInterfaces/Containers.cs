...
namespace NetOffice.DAOApi
{
	...
	public class Containers : _Collection
	{
		...
		public Containers(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public Containers(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
...
{			
			...
			NetOffice.DAOApi.Container newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.DAOApi.Container.LateBindingApiWrapperType) as NetOffice.DAOApi.Container;
			return newObject;
			}
		}
