...
namespace NetOffice.DAOApi
{
	...
	[TypeId("00000049-0000-0010-8000-00AA006D2EA4")]
    [CoClassSource(typeof(NetOffice.DAOApi.TableDef))]
    public interface _TableDef : _DAO
	{
		...
		/// <param name="name">optional object name</param>
		[SupportByVersion("DAO", 3.6,12.0)]
		NetOffice.DAOApi.Index CreateIndex(object name);
		...
		[CustomMethod]
		[SupportByVersion("DAO", 3.6,12.0)]
		NetOffice.DAOApi.Index CreateIndex();
