	...
	public class _QueryDef : _DAO
	{
		...
		public NetOffice.DAOApi.Parameters Parameters
		{
			get
			{
				...
				NetOffice.DAOApi.Parameters newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.DAOApi.Parameters.LateBindingApiWrapperType) as NetOffice.DAOApi.Parameters;
				return newObject;
			}
		}
