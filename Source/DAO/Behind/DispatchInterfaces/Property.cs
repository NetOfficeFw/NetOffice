...
namespace NetOffice.DAOApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Property : _DAO, NetOffice.DAOApi.Property
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.DAOApi.Property);
		...
		public virtual bool Inherited
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "Inherited");
			}
		}
