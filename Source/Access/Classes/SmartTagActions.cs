...
namespace NetOffice.AccessApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff194973.aspx </remarks>
	...
	public class SmartTagActions : _SmartTagActions
	{
		...
		/// <summary>
        /// returns all running Access.SmartTagActions objects from the running object table(ROT)
        /// </summary>
        /// <returns>an Access.SmartTagActions array</returns>
		public static NetOffice.AccessApi.SmartTagActions[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("Access","SmartTagActions");
		...
		/// <summary>
        /// returns a running Access.SmartTagActions object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Access","SmartTagActions", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Access","SmartTagActions", throwOnError);
			if(null != proxy)
				return new NetOffice.AccessApi.SmartTagActions(null, proxy);
			else
				return null;
