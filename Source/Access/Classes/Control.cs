...
namespace NetOffice.AccessApi
{
	...
	/// MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff834491.aspx
	///</summary>
	[SupportByVersionAttribute("Access", 9,10,11,12,14,15,16)]
	[EntityTypeAttribute(EntityType.IsCoClass)]
	public class Control : _Control
	{
		#pragma warning disable
		#region Fields
        ...
        ///</summary>		
		public Control():base("Access.Control")
		{
		...
		/// <summary>
        /// Returns all running Access.Control objects from the environment/system
        /// </summary>
        /// <returns>an Access.Control array</returns>
		public static NetOffice.AccessApi.Control[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("Access","Control");
		...
		/// <summary>
        /// Returns a running Access.Control object from the environment/system.
        /// </summary>
        /// <returns>an Access.Control object or null</returns>
		public static NetOffice.AccessApi.Control GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Access","Control", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Access","Control", throwOnError);
			if(null != proxy)
				return new NetOffice.AccessApi.Control(null, proxy);
			else
				return null;
