...
namespace NetOffice.AccessApi
{
	...
	/// MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff845694.aspx
	///</summary>
	...
	public class SmartTagProperties : _SmartTagProperties
	{
		...
		public SmartTagProperties(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public SmartTagProperties(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public SmartTagProperties(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public SmartTagProperties(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public SmartTagProperties(COMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// Returns a running Access.SmartTagProperties object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Access","SmartTagProperties", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Access","SmartTagProperties", throwOnError);
			if(null != proxy)
				return new NetOffice.AccessApi.SmartTagProperties(null, proxy);
			else
				return null;
