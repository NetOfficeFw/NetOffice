...
namespace NetOffice.AccessApi
{
	...
	/// MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff821010.aspx
	///</summary>
	[SupportByVersionAttribute("Access", 9,10,11,12,14,15,16)]
	[EntityTypeAttribute(EntityType.IsCoClass)]
	public class FormatCondition : _FormatCondition
	{
		#pragma warning disable
		#region Fields
		...
		///<summary>
        /// Creates a new instance of FormatCondition 
        ///</summary>		
		public FormatCondition():base("Access.FormatCondition")
		{
		...
		/// <summary>
        /// Returns a running Access.FormatCondition object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Access","FormatCondition", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Access","FormatCondition", throwOnError);
			if(null != proxy)
				return new NetOffice.AccessApi.FormatCondition(null, proxy);
			else
				return null;
