...
namespace NetOffice.AccessApi
{
	...
	public class WebOptions : _WebOptions
	{
		...
		/// <summary>
        /// returns all running Access.WebOptions objects from the running object table(ROT)
        /// </summary>
        /// <returns>an Access.WebOptions array</returns>
		public static NetOffice.AccessApi.WebOptions[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("Access","WebOptions");
		...
		/// <summary>
        /// returns a running Access.WebOptions object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an Access.WebOptions object or null</returns>
		public static NetOffice.AccessApi.WebOptions GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Access","WebOptions", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Access","WebOptions", throwOnError);
			if(null != proxy)
				return new NetOffice.AccessApi.WebOptions(null, proxy);
			else
				return null;
