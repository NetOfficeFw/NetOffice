...
namespace NetOffice.AccessApi.Tools
{
    ...
    public abstract class COMAddin : OfficeCOMAddin, IOfficeCOMAddin
    {
        ...
        public new Access.Application Application
        {
            get
            {
                return base.Application as Access.Application;
            }
        }
        ...
        protected override void HandleOnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
        {
            ...
            base.Application = Factory.CreateKnownObjectFromComProxy<Access.Application>(null, application, typeof(Access.Application));
            Utils = OnCreateUtils();
