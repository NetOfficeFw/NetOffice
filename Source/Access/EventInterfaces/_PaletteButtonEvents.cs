...
{	
	...
	[ComImport, Guid("A843CCD0-6E2C-11CF-A219-00A0C90542FF"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface _PaletteButtonEvents
	{
		[SupportByVersionAttribute("Access", 9,10,11,12,14,15,16)]
	...
	public class _PaletteButtonEvents_SinkHelper : SinkHelper, _PaletteButtonEvents
	{
		#region Static
		...
		public _PaletteButtonEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region _PaletteButtonEvents Members
