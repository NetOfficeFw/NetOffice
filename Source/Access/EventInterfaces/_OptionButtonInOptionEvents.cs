...
{	
	...
	public class _OptionButtonInOptionEvents_SinkHelper : SinkHelper, _OptionButtonInOptionEvents
	{
		...
		public _OptionButtonInOptionEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region _OptionButtonInOptionEvents Members
