...
{	
	...
	[ComImport, Guid("3B06E992-E47C-11CD-8701-00AA003F0F07"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface DispNavigationControlEvents
	{
		[SupportByVersionAttribute("Access", 14,15,16)]
	...
	public class DispNavigationControlEvents_SinkHelper : SinkHelper, DispNavigationControlEvents
	{
		#region Static
		
		public static readonly string Id = "3B06E992-E47C-11CD-8701-00AA003F0F07";
		...
		public DispNavigationControlEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region DispNavigationControlEvents Members
