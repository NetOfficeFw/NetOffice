...
{	
	...
	[ComImport, Guid("2E705282-92D1-43CC-A57B-ED48BCCC711D"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface DispPageEvents
	{
		[SupportByVersionAttribute("Access", 12,14,15,16)]
	...
	public class DispPageEvents_SinkHelper : SinkHelper, DispPageEvents
	{
		#region Static
		...
		public DispPageEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
