...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispListBoxEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispListBoxEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispListBoxEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispListBoxEvents
		/// </summary>
		...
		public DispListBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
