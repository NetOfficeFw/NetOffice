...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispCommandButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispCommandButtonEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispCommandButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispCommandButtonEvents
		/// </summary>
