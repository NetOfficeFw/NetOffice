...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispImageEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispImageEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispImageEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispImageEvents
		/// </summary>
