...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._SectionInReportEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _SectionInReportEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._SectionInReportEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _SectionInReportEvents
		/// </summary>
