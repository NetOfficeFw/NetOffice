...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._ToggleButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _ToggleButtonEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._ToggleButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _ToggleButtonEvents
		/// </summary>
		public static readonly string Id = "BC9E434F-F037-11CD-8701-00AA003F0F07";
		...
		public _ToggleButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
