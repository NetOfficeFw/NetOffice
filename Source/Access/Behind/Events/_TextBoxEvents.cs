...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._TextBoxEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _TextBoxEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._TextBoxEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _TextBoxEvents
		/// </summary>
		public static readonly string Id = "BC9E4340-F037-11CD-8701-00AA003F0F07";
		...
		public _TextBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
        ...
        {
            if (!Validate("Invoker.ReleaseParamsArray(cancel);"))
            {
                return;
            }
