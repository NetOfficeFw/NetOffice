...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._SectionEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _SectionEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._SectionEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _SectionEvents
		/// </summary>
