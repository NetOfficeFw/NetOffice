...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispAttachmentEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispAttachmentEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispAttachmentEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispAttachmentEvents
		/// </summary>
