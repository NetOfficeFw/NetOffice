...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._ToggleButtonInOptionEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _ToggleButtonInOptionEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._ToggleButtonInOptionEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _ToggleButtonInOptionEvents
		/// </summary>
