...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._ComboBoxEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _ComboBoxEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._ComboBoxEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _ComboBoxEvents
		/// </summary>
