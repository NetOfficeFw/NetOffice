...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._ListBoxEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _ListBoxEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._ListBoxEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _ListBoxEvents
		/// </summary>
