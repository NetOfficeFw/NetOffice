...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._PageEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _PageEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._PageEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _PageEvents
		/// </summary>
