...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispPaletteButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispPaletteButtonEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispPaletteButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispPaletteButtonEvents
		/// </summary>
		public static readonly string Id = "2E70527F-92D1-43CC-A57B-ED48BCCC711D";
		...
		public DispPaletteButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
        ...
        #region DispPaletteButtonEvents Members
