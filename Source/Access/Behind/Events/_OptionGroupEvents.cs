...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._OptionGroupEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _OptionGroupEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._OptionGroupEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _OptionGroupEvents
		/// </summary>
