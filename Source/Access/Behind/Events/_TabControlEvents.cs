...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._TabControlEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _TabControlEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._TabControlEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _TabControlEvents
		/// </summary>
		...
		public _TabControlEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
