...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispOptionButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispOptionButtonEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispOptionButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispOptionButtonEvents
		/// </summary>
