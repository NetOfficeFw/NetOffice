...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._RectangleEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _RectangleEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._RectangleEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _RectangleEvents
		/// </summary>
		public static readonly string Id = "BC9E4342-F037-11CD-8701-00AA003F0F07";
		...
		public _RectangleEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
