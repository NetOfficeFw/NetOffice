...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._CommandButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _CommandButtonEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._CommandButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _CommandButtonEvents
		/// </summary>
