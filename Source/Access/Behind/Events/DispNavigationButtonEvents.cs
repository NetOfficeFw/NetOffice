...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispNavigationButtonEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispNavigationButtonEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispNavigationButtonEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispNavigationButtonEvents
		/// </summary>
        ...
        #region DispNavigationButtonEvents
