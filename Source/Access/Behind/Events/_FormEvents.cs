...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._FormEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _FormEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._FormEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _FormEvents
		/// </summary>
