...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._BoundObjectFrameEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _BoundObjectFrameEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._BoundObjectFrameEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _BoundObjectFrameEvents
		/// </summary>
		public static readonly string Id = "BC9E4349-F037-11CD-8701-00AA003F0F07";
        ...
        public _BoundObjectFrameEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region _BoundObjectFrameEvents
