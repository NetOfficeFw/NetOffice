...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispCheckBoxEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispCheckBoxEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispCheckBoxEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispCheckBoxEvents
		/// </summary>
