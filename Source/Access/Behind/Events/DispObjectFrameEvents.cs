...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispObjectFrameEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispObjectFrameEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispObjectFrameEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispObjectFrameEvents
		/// </summary>
