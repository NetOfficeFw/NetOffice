...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispOptionGroupEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispOptionGroupEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispOptionGroupEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispOptionGroupEvents
		/// </summary>
