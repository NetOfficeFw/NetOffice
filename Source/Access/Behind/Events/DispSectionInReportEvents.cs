...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispSectionInReportEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispSectionInReportEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispSectionInReportEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispSectionInReportEvents
		/// </summary>
