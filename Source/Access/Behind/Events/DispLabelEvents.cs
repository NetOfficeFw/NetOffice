...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispLabelEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispLabelEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispLabelEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispLabelEvents
		/// </summary>
		...
		public DispLabelEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
