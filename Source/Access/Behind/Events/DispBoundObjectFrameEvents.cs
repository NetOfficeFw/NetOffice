...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispBoundObjectFrameEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispBoundObjectFrameEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispBoundObjectFrameEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispBoundObjectFrameEvents
		/// </summary>
		...
		#region DispBoundObjectFrameEvents
