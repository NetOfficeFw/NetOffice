...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispNavigationControlEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispNavigationControlEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispNavigationControlEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispNavigationControlEvents
		/// </summary>
        ...
        #region DispNavigationControlEvents
