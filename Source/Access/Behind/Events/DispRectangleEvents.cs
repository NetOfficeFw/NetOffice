...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts.DispRectangleEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class DispRectangleEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts.DispRectangleEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from DispRectangleEvents
		/// </summary>
		public static readonly string Id = "2E705271-92D1-43CC-A57B-ED48BCCC711D";
		...
		public DispRectangleEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
