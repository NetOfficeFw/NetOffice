...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._CheckBoxEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _CheckBoxEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._CheckBoxEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _CheckBoxEvents
		/// </summary>
