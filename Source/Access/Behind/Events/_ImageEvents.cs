...
namespace NetOffice.AccessApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.AccessApi.EventContracts._ImageEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class _ImageEvents_SinkHelper : SinkHelper, NetOffice.AccessApi.EventContracts._ImageEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from _ImageEvents
		/// </summary>
