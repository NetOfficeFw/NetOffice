...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._ToggleButtonEvents), typeof(NetOffice.AccessApi.EventContracts.DispToggleButtonEvents))]
    public class ToggleButton : _ToggleButton, NetOffice.AccessApi.ToggleButton
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._ToggleButtonEvents_SinkHelper __ToggleButtonEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.ToggleButton);
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ToggleButton_BeforeUpdateEventHandler BeforeUpdateEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ToggleButton_AfterUpdateEventHandler AfterUpdateEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ToggleButton_EnterEventHandler EnterEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ToggleButton_ExitEventHandler ExitEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ToggleButton_GotFocusEventHandler GotFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ToggleButton_LostFocusEventHandler LostFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._ToggleButtonEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispToggleButtonEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._ToggleButtonEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__ToggleButtonEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._ToggleButtonEvents_SinkHelper(this, _connectPoint);
				return;
			}
