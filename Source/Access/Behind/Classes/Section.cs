...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._SectionEvents), typeof(NetOffice.AccessApi.EventContracts.DispSectionEvents))]
    public class Section : _Section, NetOffice.AccessApi.Section
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._SectionEvents_SinkHelper __SectionEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispSectionEvents_SinkHelper _dispSectionEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.Section);
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Section_ClickEventHandler ClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Section_DblClickEventHandler DblClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Section_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Section_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Section_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 12,14,15,16)]
		public virtual event Section_PaintEventHandler PaintEvent
		{
			add
			{
				CreateEventBridge();
