...
namespace NetOffice.AccessApi.Behind
{
    ...
    public class ReportOldV10 : _Report2, NetOffice.AccessApi.ReportOldV10
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.ReportOldV10);
		...
		/// </summary>
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ReportOldV10_OpenEventHandler OpenEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ReportOldV10_CloseEventHandler CloseEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ReportOldV10_ActivateEventHandler ActivateEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ReportOldV10_DeactivateEventHandler DeactivateEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ReportOldV10_ErrorEventHandler ErrorEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ReportOldV10_NoDataEventHandler NoDataEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event ReportOldV10_PageEventHandler PageEvent
		{
			add
			{
				CreateEventBridge();
