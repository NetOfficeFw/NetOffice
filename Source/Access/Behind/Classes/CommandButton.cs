...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._CommandButtonEvents), typeof(NetOffice.AccessApi.EventContracts.DispCommandButtonEvents))]
    public class CommandButton : _CommandButton, NetOffice.AccessApi.CommandButton
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._CommandButtonEvents_SinkHelper __CommandButtonEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispCommandButtonEvents_SinkHelper _dispCommandButtonEvents_SinkHelper;
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_ClickEventHandler ClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_EnterEventHandler EnterEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_ExitEventHandler ExitEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_GotFocusEventHandler GotFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_LostFocusEventHandler LostFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_DblClickEventHandler DblClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_KeyDownEventHandler KeyDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_KeyPressEventHandler KeyPressEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CommandButton_KeyUpEventHandler KeyUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._CommandButtonEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispCommandButtonEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._CommandButtonEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__CommandButtonEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._CommandButtonEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispCommandButtonEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispCommandButtonEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispCommandButtonEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
