...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._References_Events))]
    public class References : _References, NetOffice.AccessApi.References
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._References_Events_SinkHelper __References_Events_SinkHelper;
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event References_ItemAddedEventHandler ItemAddedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event References_ItemRemovedEventHandler ItemRemovedEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._References_Events_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._References_Events_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__References_Events_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._References_Events_SinkHelper(this, _connectPoint);
				return;
			} 
        }
