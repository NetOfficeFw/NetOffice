...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._TabControlEvents), typeof(NetOffice.AccessApi.EventContracts.DispTabControlEvents))]
    public class TabControl : _TabControl, NetOffice.AccessApi.TabControl
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._TabControlEvents_SinkHelper __TabControlEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispTabControlEvents_SinkHelper _dispTabControlEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.TabControl);
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_ClickEventHandler ClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_DblClickEventHandler DblClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_KeyDownEventHandler KeyDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_KeyPressEventHandler KeyPressEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_KeyUpEventHandler KeyUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TabControl_ChangeEventHandler ChangeEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._TabControlEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispTabControlEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._TabControlEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__TabControlEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._TabControlEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispTabControlEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispTabControlEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispTabControlEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
