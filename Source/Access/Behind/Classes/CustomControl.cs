...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._CustomControlEvents), typeof(NetOffice.AccessApi.EventContracts.DispCustomControlEvents))]
    public class CustomControl : _CustomControl, NetOffice.AccessApi.CustomControl
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._CustomControlEvents_SinkHelper __CustomControlEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispCustomControlEvents_SinkHelper _dispCustomControlEvents_SinkHelper;
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CustomControl_UpdatedEventHandler UpdatedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CustomControl_EnterEventHandler EnterEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CustomControl_ExitEventHandler ExitEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CustomControl_GotFocusEventHandler GotFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event CustomControl_LostFocusEventHandler LostFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._CustomControlEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispCustomControlEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._CustomControlEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__CustomControlEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._CustomControlEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispCustomControlEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispCustomControlEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispCustomControlEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
