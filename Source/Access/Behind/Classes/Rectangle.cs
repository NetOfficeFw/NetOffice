...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._RectangleEvents), typeof(NetOffice.AccessApi.EventContracts.DispRectangleEvents))]
    public class Rectangle : _Rectangle, NetOffice.AccessApi.Rectangle
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._RectangleEvents_SinkHelper __RectangleEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispRectangleEvents_SinkHelper _dispRectangleEvents_SinkHelper;
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Rectangle_ClickEventHandler ClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Rectangle_DblClickEventHandler DblClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Rectangle_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Rectangle_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Rectangle_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._RectangleEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispRectangleEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._RectangleEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__RectangleEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._RectangleEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispRectangleEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispRectangleEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispRectangleEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
