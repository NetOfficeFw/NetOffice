...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._PageEvents), typeof(NetOffice.AccessApi.EventContracts.DispPageEvents))]
    public class Page : _Page, NetOffice.AccessApi.Page
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._PageEvents_SinkHelper __PageEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispPageEvents_SinkHelper _dispPageEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.Page);
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Page_ClickEventHandler ClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Page_DblClickEventHandler DblClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Page_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Page_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Page_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._PageEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispPageEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._PageEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__PageEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._PageEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispPageEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispPageEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispPageEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
