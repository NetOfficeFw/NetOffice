...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._LabelEvents), typeof(NetOffice.AccessApi.EventContracts.DispLabelEvents))]
    public class Label : _Label, NetOffice.AccessApi.Label
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._LabelEvents_SinkHelper __LabelEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispLabelEvents_SinkHelper _dispLabelEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.Label);
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._LabelEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispLabelEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._LabelEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__LabelEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._LabelEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispLabelEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispLabelEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispLabelEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
