...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._TextBoxEvents), typeof(NetOffice.AccessApi.EventContracts.DispTextBoxEvents))]
    public class TextBox : _Textbox, NetOffice.AccessApi.TextBox
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._TextBoxEvents_SinkHelper __TextBoxEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispTextBoxEvents_SinkHelper _dispTextBoxEvents_SinkHelper;
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_BeforeUpdateEventHandler BeforeUpdateEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_AfterUpdateEventHandler AfterUpdateEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_ChangeEventHandler ChangeEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_EnterEventHandler EnterEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_ExitEventHandler ExitEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_GotFocusEventHandler GotFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_LostFocusEventHandler LostFocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_ClickEventHandler ClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_DblClickEventHandler DblClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_KeyDownEventHandler KeyDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_KeyPressEventHandler KeyPressEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event TextBox_KeyUpEventHandler KeyUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 10,11,12,14,15,16)]
		public virtual event TextBox_DirtyEventHandler DirtyEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 10,11,12,14,15,16)]
		public virtual event TextBox_UndoEventHandler UndoEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._TextBoxEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispTextBoxEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._TextBoxEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__TextBoxEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._TextBoxEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispTextBoxEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispTextBoxEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispTextBoxEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
