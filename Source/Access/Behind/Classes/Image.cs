...
namespace NetOffice.AccessApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.AccessApi.EventContracts._ImageEvents), typeof(NetOffice.AccessApi.EventContracts.DispImageEvents))]
    public class Image : _Image, NetOffice.AccessApi.Image
    {
        ...
        private NetOffice.AccessApi.Behind.EventContracts._ImageEvents_SinkHelper __ImageEvents_SinkHelper;
		private NetOffice.AccessApi.Behind.EventContracts.DispImageEvents_SinkHelper _dispImageEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.Image);
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Image_ClickEventHandler ClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Image_DblClickEventHandler DblClickEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Image_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Image_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual event Image_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.AccessApi.Behind.EventContracts._ImageEvents_SinkHelper.Id, NetOffice.AccessApi.Behind.EventContracts.DispImageEvents_SinkHelper.Id);


			if(NetOffice.AccessApi.Behind.EventContracts._ImageEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__ImageEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts._ImageEvents_SinkHelper(this, _connectPoint);
				return;
			}

			if(NetOffice.AccessApi.Behind.EventContracts.DispImageEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_dispImageEvents_SinkHelper = new NetOffice.AccessApi.Behind.EventContracts.DispImageEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
