...
namespace NetOffice.AccessApi.Behind
{
	...
	public class _SmartTags : COMObject, NetOffice.AccessApi._SmartTags
	{
		...
		public virtual NetOffice.AccessApi._SmartTag this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.AccessApi._SmartTag>(this, "Item", index);
			}
		}
		...
		[SupportByVersion("Access", 11,12,14,15,16)]
		[BaseResult]
		public virtual NetOffice.AccessApi._SmartTag Add(string name)
		{
			return InvokerService.InvokeInternal.ExecuteBaseReferenceMethodGet<NetOffice.AccessApi._SmartTag>(this, "Add", name);
		}
        ...
        /// </summary>
        [SupportByVersion("Access", 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.AccessApi._SmartTag> GetEnumerator()
        {
