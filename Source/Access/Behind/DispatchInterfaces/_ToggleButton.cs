...
namespace NetOffice.AccessApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _ToggleButton : NetOffice.OfficeApi.Behind.IAccessible, NetOffice.AccessApi._ToggleButton
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi._ToggleButton);
