...
namespace NetOffice.AccessApi.Behind
{
	...
	public class _ItemsSelected : COMObject, NetOffice.AccessApi._ItemsSelected
	{
		...
		public virtual Int32 this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "Item", index);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("Access", 9, 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<Int32> GetEnumerator()
        {
