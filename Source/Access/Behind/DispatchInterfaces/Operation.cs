...
namespace NetOffice.AccessApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Operation : COMObject, NetOffice.AccessApi.Operation
	{
		...
		[SupportByVersion("Access", 14,15,16)]
		public virtual NetOffice.AccessApi.WSParameters WSParameters
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.AccessApi.WSParameters>(this, "WSParameters", typeof(NetOffice.AccessApi.WSParameters));
			}
		}
		...
		[SupportByVersion("Access", 14,15,16)]
		public virtual object Execute(object bstrParameters)
		{
			return InvokerService.InvokeInternal.ExecuteVariantMethodGet(this, "Execute", bstrParameters);
		}
