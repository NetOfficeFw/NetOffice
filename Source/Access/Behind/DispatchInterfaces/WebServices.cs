...
namespace NetOffice.AccessApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff193176.aspx </remarks>
	[SupportByVersion("Access", 14,15,16)]
	...
	public class WebServices : COMObject, NetOffice.AccessApi.WebServices
	{
		...
		public virtual NetOffice.AccessApi.WebService this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.AccessApi.WebService>(this, "Item", typeof(NetOffice.AccessApi.WebService), index);
			}
		}
        ...
        #region IEnumerableProvider<NetOffice.AccessApi.WebService>

        ICOMObject IEnumerableProvider<NetOffice.AccessApi.WebService>.GetComObjectEnumerator(ICOMObject parent)
        {
            return NetOffice.Utils.GetComObjectEnumeratorAsMethod(parent, this, false);
        }

        IEnumerable IEnumerableProvider<NetOffice.AccessApi.WebService>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
        ...
        /// </summary>
        [SupportByVersion("Access", 14, 15, 16)]
        public virtual IEnumerator<NetOffice.AccessApi.WebService> GetEnumerator()
        {
