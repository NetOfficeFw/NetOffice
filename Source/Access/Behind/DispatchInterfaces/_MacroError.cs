...
namespace NetOffice.AccessApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _MacroError : COMObject, NetOffice.AccessApi._MacroError
	{
		...
		public virtual string Condition
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "Condition");
			}
		}
		...
		public virtual string ActionName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "ActionName");
			}
		}
		...
		public virtual string Arguments
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "Arguments");
			}
		}
		...
		[SupportByVersion("Access", 12,14,15,16)]
		public virtual string MacroName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "MacroName");
			}
		}
