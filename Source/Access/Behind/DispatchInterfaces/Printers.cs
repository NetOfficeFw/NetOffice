...
namespace NetOffice.AccessApi.Behind
{
	...
	public class Printers : COMObject, NetOffice.AccessApi.Printers
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.AccessApi.Printers);
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(Printers);                return _type;
            }
        }
		...
		public virtual NetOffice.AccessApi._Printer this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.AccessApi._Printer>(this, "Item", index);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("Access", 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.AccessApi._Printer> GetEnumerator()
        {
