...
namespace NetOffice.AccessApi.Behind
{
	...
	public class _References : COMObject, NetOffice.AccessApi._References
	{
		...
		public virtual NetOffice.AccessApi.Reference this[object var]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.AccessApi.Reference>(this, "Item", typeof(NetOffice.AccessApi.Reference), var);
			}
		}
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual NetOffice.AccessApi.Reference AddFromGuid(string guid, Int32 major, Int32 minor)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.AccessApi.Reference>(this, "AddFromGuid", typeof(NetOffice.AccessApi.Reference), guid, major, minor);
		}
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual NetOffice.AccessApi.Reference AddFromFile(string fileName)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.AccessApi.Reference>(this, "AddFromFile", typeof(NetOffice.AccessApi.Reference), fileName);
		}
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		public virtual void Remove(NetOffice.AccessApi.Reference reference)
		{
        ...
        /// </summary>
        [SupportByVersion("Access", 9, 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.AccessApi.Reference> GetEnumerator()
        {
