...
{	
    ...
    [ComImport, Guid("2E70526C-92D1-43CC-A57B-ED48BCCC711D"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface DispBoundObjectFrameEvents
	{
		[SupportByVersion("Access", 12,14,15,16)]
	...
	public class DispBoundObjectFrameEvents_SinkHelper : SinkHelper, DispBoundObjectFrameEvents
	{
		#region Static
		
		public static readonly string Id = "2E70526C-92D1-43CC-A57B-ED48BCCC711D";
		...
		public DispBoundObjectFrameEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region DispBoundObjectFrameEvents Members
