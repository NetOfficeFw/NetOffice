...
{	
    ...
    [ComImport, Guid("BC9E4345-F037-11CD-8701-00AA003F0F07"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface _CommandButtonEvents
	{
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
	...
	public class _CommandButtonEvents_SinkHelper : SinkHelper, _CommandButtonEvents
	{
		#region Static
		
		public static readonly string Id = "BC9E4345-F037-11CD-8701-00AA003F0F07";
		...
		public _CommandButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region _CommandButtonEvents Members
