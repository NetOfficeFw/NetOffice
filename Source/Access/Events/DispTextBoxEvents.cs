...
{	
    ...
    [ComImport, Guid("2E705275-92D1-43CC-A57B-ED48BCCC711D"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface DispTextBoxEvents
	{
		[SupportByVersion("Access", 12,14,15,16)]
	...
	public class DispTextBoxEvents_SinkHelper : SinkHelper, DispTextBoxEvents
	{
		#region Static
		
		public static readonly string Id = "2E705275-92D1-43CC-A57B-ED48BCCC711D";
		...
		public DispTextBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region DispTextBoxEvents Members
