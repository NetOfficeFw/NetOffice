...
{	
    ...
    [ComImport, Guid("3B06E975-E47C-11CD-8701-00AA003F0F07"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface _PageEvents
	{
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
	...
	public class _PageEvents_SinkHelper : SinkHelper, _PageEvents
	{
		#region Static
		
		public static readonly string Id = "3B06E975-E47C-11CD-8701-00AA003F0F07";
		...
		public _PageEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
