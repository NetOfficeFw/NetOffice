...
{	
    ...
    [ComImport, Guid("3B06E996-E47C-11CD-8701-00AA003F0F07"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface DispNavigationButtonEvents
	{
		[SupportByVersion("Access", 14,15,16)]
	...
	public class DispNavigationButtonEvents_SinkHelper : SinkHelper, DispNavigationButtonEvents
	{
		#region Static
		
		public static readonly string Id = "3B06E996-E47C-11CD-8701-00AA003F0F07";
		...
		public DispNavigationButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region DispNavigationButtonEvents Members
