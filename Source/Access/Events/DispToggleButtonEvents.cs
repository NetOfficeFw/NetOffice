...
{	
    ...
    [ComImport, Guid("2E705266-92D1-43CC-A57B-ED48BCCC711D"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface DispToggleButtonEvents
	{
		[SupportByVersion("Access", 12,14,15,16)]
	...
	public class DispToggleButtonEvents_SinkHelper : SinkHelper, DispToggleButtonEvents
	{
		#region Static
		
		public static readonly string Id = "2E705266-92D1-43CC-A57B-ED48BCCC711D";
		
		#endregion
		
		#region Ctor

		public DispToggleButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
        ...
        #region DispToggleButtonEvents Members
