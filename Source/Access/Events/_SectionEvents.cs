...
{	
    ...
    [ComImport, Guid("BC9E4353-F037-11CD-8701-00AA003F0F07"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface _SectionEvents
	{
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
	...
	public class _SectionEvents_SinkHelper : SinkHelper, _SectionEvents
	{
		#region Static
		
		public static readonly string Id = "BC9E4353-F037-11CD-8701-00AA003F0F07";
		...
		public _SectionEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
