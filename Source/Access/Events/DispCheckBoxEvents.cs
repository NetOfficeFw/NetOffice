...
{	
    ...
    [ComImport, Guid("2E70526A-92D1-43CC-A57B-ED48BCCC711D"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface DispCheckBoxEvents
	{
		[SupportByVersion("Access", 12,14,15,16)]
	...
	public class DispCheckBoxEvents_SinkHelper : SinkHelper, DispCheckBoxEvents
	{
		#region Static
		
		public static readonly string Id = "2E70526A-92D1-43CC-A57B-ED48BCCC711D";
		...
		public DispCheckBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region DispCheckBoxEvents Members
