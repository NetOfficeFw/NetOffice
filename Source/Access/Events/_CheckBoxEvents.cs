...
{	
    ...
    [ComImport, Guid("BC9E4347-F037-11CD-8701-00AA003F0F07"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface _CheckBoxEvents
	{
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
	...
	public class _CheckBoxEvents_SinkHelper : SinkHelper, _CheckBoxEvents
	{
		#region Static
		
		public static readonly string Id = "BC9E4347-F037-11CD-8701-00AA003F0F07";
		...
		public _CheckBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region _CheckBoxEvents Members
