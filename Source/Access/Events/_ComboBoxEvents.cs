...
{	
    ...
    [ComImport, Guid("BC9E434C-F037-11CD-8701-00AA003F0F07"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface _ComboBoxEvents
	{
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		...
		[SupportByVersion("Access", 9,10,11,12,14,15,16)]
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime), DispId(2078)]
		void NotInList([In] [Out] ref object newData, [In] [Out] ref object response);
	...
	public class _ComboBoxEvents_SinkHelper : SinkHelper, _ComboBoxEvents
	{
		#region Static
		
		public static readonly string Id = "BC9E434C-F037-11CD-8701-00AA003F0F07";
		...
		public _ComboBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region _ComboBoxEvents Members
		...
		{
			Delegate[] recipients = _eventBinding.GetEventRecipients("NotInList");
			if( (true == _eventClass.IsCurrentlyDisposing) || (recipients.Length == 0) )
			{
			...
			_eventBinding.RaiseCustomEvent("NotInList", ref paramsArray);

			newData = (string)paramsArray[0];
