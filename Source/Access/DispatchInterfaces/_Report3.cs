...
namespace NetOffice.AccessApi
{
	...
	public class _Report3 : _Report2 ,IEnumerable<object>
	{
		...
		{		
			...
			NetOffice.AccessApi.GroupLevel newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.GroupLevel.LateBindingApiWrapperType) as NetOffice.AccessApi.GroupLevel;
			return newObject;
		}
		...
		{		
			...
			NetOffice.AccessApi._Section newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.AccessApi._Section;
			return newObject;
		}
