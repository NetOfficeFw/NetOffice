...
namespace NetOffice.AccessApi
{
	...
	public class _LocalVars : COMObject, IEnumerableProvider<NetOffice.AccessApi.LocalVar>
	{
		...
		public _LocalVars(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public NetOffice.AccessApi.LocalVar this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.AccessApi.LocalVar>(this, "Item", NetOffice.AccessApi.LocalVar.LateBindingApiWrapperType, index);
			}
		}
        ...
        #region IEnumerableProvider<NetOffice.AccessApi.LocalVar>

        ICOMObject IEnumerableProvider<NetOffice.AccessApi.LocalVar>.GetComObjectEnumerator(ICOMObject parent)
        {
            return NetOffice.Utils.GetComObjectEnumeratorAsMethod(parent, this, false);
        }

        IEnumerable IEnumerableProvider<NetOffice.AccessApi.LocalVar>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
