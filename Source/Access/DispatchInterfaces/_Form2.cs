...
namespace NetOffice.AccessApi
{
	...
	public class _Form2 : _Form ,IEnumerable<object>
	{
		...
		{		
			...
			NetOffice.AccessApi.Section newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.Section.LateBindingApiWrapperType) as NetOffice.AccessApi.Section;
			return newObject;
		}
		...
		public NetOffice.AccessApi.Module Module
		{
			get
			{
				...
				NetOffice.AccessApi.Module newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.Module.LateBindingApiWrapperType) as NetOffice.AccessApi.Module;
				return newObject;
			}
		}
		...
		public NetOffice.AccessApi.Controls Controls
		{
			get
			{
				...
				NetOffice.AccessApi.Controls newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.Controls.LateBindingApiWrapperType) as NetOffice.AccessApi.Controls;
				return newObject;
			}
		}
		...
		public NetOffice.OWC10Api.PivotTable PivotTable
		{
			get
			{
				...
				NetOffice.OWC10Api.PivotTable newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.PivotTable.LateBindingApiWrapperType) as NetOffice.OWC10Api.PivotTable;
				return newObject;
			}
		}
		...
		public NetOffice.OWC10Api.ChartSpace ChartSpace
		{
			get
			{
				...
				NetOffice.OWC10Api.ChartSpace newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.ChartSpace.LateBindingApiWrapperType) as NetOffice.OWC10Api.ChartSpace;
				return newObject;
			}
		}
