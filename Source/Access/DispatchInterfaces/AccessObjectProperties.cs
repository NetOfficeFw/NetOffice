...
namespace NetOffice.AccessApi
{
	...
	public class AccessObjectProperties : COMObject, IEnumerableProvider<NetOffice.AccessApi.AccessObjectProperty>
	{
		...
		public AccessObjectProperties(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public AccessObjectProperties(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public AccessObjectProperties(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public AccessObjectProperties(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public AccessObjectProperties(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public NetOffice.AccessApi.AccessObjectProperty this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.AccessApi.AccessObjectProperty>(this, "Item", NetOffice.AccessApi.AccessObjectProperty.LateBindingApiWrapperType, index);
			}
		}
		...
		{
			 Factory.ExecuteMethod(this, "Add", propertyName, value);
		}
