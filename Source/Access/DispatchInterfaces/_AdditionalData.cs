...
namespace NetOffice.AccessApi
{
	...
	public class _AdditionalData : COMObject , IEnumerable<NetOffice.AccessApi._AdditionalData>
	{
		...
		public NetOffice.AccessApi._AdditionalData this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.AccessApi._AdditionalData>(this, "Item", NetOffice.AccessApi._AdditionalData.LateBindingApiWrapperType, index);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.AccessApi._AdditionalData>(this, "Add", NetOffice.AccessApi._AdditionalData.LateBindingApiWrapperType, var);
		}
