	...
	public class _NavigationButton : NetOffice.OfficeApi.IAccessible
	{
		...
		public NetOffice.AccessApi.NavigationButton ParentTab
		{
			get
			{
				...
				NetOffice.AccessApi.NavigationButton newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.NavigationButton.LateBindingApiWrapperType) as NetOffice.AccessApi.NavigationButton;
				return newObject;
			}
		}
