...
namespace NetOffice.AccessApi
{
	...
	[TypeId("3B06E994-E47C-11CD-8701-00AA003F0F07")]
    [CoClassSource(typeof(NetOffice.AccessApi.NavigationButton))]
    public interface _NavigationButton : NetOffice.OfficeApi.IAccessible
	{
		#region Properties
		...
		[SupportByVersion("Access", 14,15,16)]
		NetOffice.AccessApi.Enums.AcCursorOnHover CursorOnHover { get; set; }
		...
		[SupportByVersion("Access", 14,15,16)]
		NetOffice.AccessApi.Enums.AcPictureCaptionArrangement PictureCaptionArrangement { get; set; }
		...
		[SupportByVersion("Access", 14,15,16)]
		string NavigationTargetName { get; set; }
		...
		[SupportByVersion("Access", 14,15,16)]
		string NavigationWhereClause { get; set; }
		...
		[SupportByVersion("Access", 14,15,16)]
		NetOffice.AccessApi.NavigationButton ParentTab { get; }
