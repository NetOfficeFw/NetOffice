...
namespace NetOffice.AccessApi
{
	...
	public class _SmartTags : COMObject , IEnumerable<NetOffice.AccessApi._SmartTag>
	{
		...
		public NetOffice.AccessApi._SmartTag this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.AccessApi._SmartTag>(this, "Item", NetOffice.AccessApi._SmartTag.LateBindingApiWrapperType, index);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.AccessApi._SmartTag>(this, "Add", NetOffice.AccessApi._SmartTag.LateBindingApiWrapperType, name);
		}
