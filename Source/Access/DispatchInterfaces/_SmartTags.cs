...
namespace NetOffice.AccessApi
{
	...
	public class _SmartTags : COMObject, IEnumerableProvider<NetOffice.AccessApi._SmartTag>
	{
		...
		public _SmartTags(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Access.SmartTags.Application"/> </remarks>
		[SupportByVersion("Access", 11,12,14,15,16)]
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Access.SmartTags.Parent"/> </remarks>
		...
		public NetOffice.AccessApi._SmartTag this[object index]
		{
			get
			{
				return Factory.ExecuteBaseReferencePropertyGet<NetOffice.AccessApi._SmartTag>(this, "Item", index);
			}
		}
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Access.SmartTags.Count"/> </remarks>
		[SupportByVersion("Access", 11,12,14,15,16)]
		public Int32 Count
		{
			get
		...
		/// SupportByVersion Access 11, 12, 14, 15, 16
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Access.SmartTags.Add"/> </remarks>
		/// <param name="name">string name</param>
		[SupportByVersion("Access", 11,12,14,15,16)]
		[BaseResult]
		public NetOffice.AccessApi._SmartTag Add(string name)
		{
			return Factory.ExecuteBaseReferenceMethodGet<NetOffice.AccessApi._SmartTag>(this, "Add", name);
		}
        ...
        #region IEnumerableProvider<NetOffice.AccessApi._SmartTag>

        ICOMObject IEnumerableProvider<NetOffice.AccessApi._SmartTag>.GetComObjectEnumerator(ICOMObject parent)
        {
            return NetOffice.Utils.GetComObjectEnumeratorAsMethod(parent, this);
        }

        IEnumerable IEnumerableProvider<NetOffice.AccessApi._SmartTag>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
