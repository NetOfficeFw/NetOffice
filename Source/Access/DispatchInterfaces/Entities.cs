...
{			
			...
			NetOffice.AccessApi.Entity newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.AccessApi.Entity.LateBindingApiWrapperType) as NetOffice.AccessApi.Entity;
			return newObject;
			}
		}
