...
namespace NetOffice.VBIDEApi
{
	...
	public class CodeModule : _CodeModule
	{
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("VBIDE","CodeModule", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("VBIDE","CodeModule", throwOnError);
			if(null != proxy)
				return new NetOffice.VBIDEApi.CodeModule(null, proxy);
			else
				return null;
