...
namespace NetOffice.VBIDEApi
{
	...
	public class Component : _Component
	{
		...
		public Component(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public Component(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// Returns a running VBIDE.Component object from the environment/system.
        /// </summary>
        /// <returns>an VBIDE.Component object or null</returns>
		public static NetOffice.VBIDEApi.Component GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("VBIDE","Component", false);
			if(null != proxy)
				return new NetOffice.VBIDEApi.Component(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an VBIDE.Component object or null</returns>
		public static NetOffice.VBIDEApi.Component GetActiveInstance(bool throwOnError)
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("VBIDE","Component", throwOnError);
			if(null != proxy)
				return new NetOffice.VBIDEApi.Component(null, proxy);
			else
				return null;
