...
namespace NetOffice.VBIDEApi
{
	...
	public class _VBComponents_Old : COMObject ,IEnumerable<NetOffice.VBIDEApi.VBComponent>
	{
		...
		public _VBComponents_Old(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public _VBComponents_Old(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
