...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.VBIDEApi.EventContracts._dispCommandBarControlEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
    public class _dispCommandBarControlEvents_SinkHelper : SinkHelper, NetOffice.VBIDEApi.EventContracts._dispCommandBarControlEvents
    {
        #region Static
