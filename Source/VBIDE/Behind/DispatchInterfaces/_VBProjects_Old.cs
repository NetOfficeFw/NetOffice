...
namespace NetOffice.VBIDEApi.Behind
{
    ...
    internal class _VBProjects_Old : COMObject, NetOffice.VBIDEApi._VBProjects_Old
    {
        ...
        public NetOffice.VBIDEApi.VBProject this[object index]
        {
            get
            {
                return Factory.ExecuteKnownReferenceMethodGet<NetOffice.VBIDEApi.VBProject>(this, "Item", typeof(NetOffice.VBIDEApi.VBE), index);
            }
        }
