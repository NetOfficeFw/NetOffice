...
namespace NetOffice.VBIDEApi.Behind
{
    ...
    internal class _VBComponents_Old : COMObject, NetOffice.VBIDEApi._VBComponents_Old
    {
        ...
        public _VBComponents_Old(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public NetOffice.VBIDEApi.VBComponent this[object index]
        {
            get
            {
                return Factory.ExecuteKnownReferenceMethodGet<NetOffice.VBIDEApi.VBComponent>(this, "Item", typeof(NetOffice.VBIDEApi.VBComponent), index);
            }
        }
