...
namespace NetOffice.Tools.Isolation
{
    ...
    public interface IManagedInnerUpdateHandler
    {
        ...
        void SetParent([In, Out, MarshalAs(UnmanagedType.IUnknown)] IShimUpdateHost shim);
        ...
        /// <summary>
        /// Set the host application to the update handler if OnConnections is already passed
        /// </summary>
        /// <param name="application">host application </param>
        void SetApplication([In, Out, MarshalAs(UnmanagedType.IDispatch)] object application);
