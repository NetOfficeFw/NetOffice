...
namespace LateBindingApi.MSProjectApi
{
	...
	public class Month : COMObject
	{
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Days Days
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Days", paramsArray);
				LateBindingApi.MSProjectApi.Days newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,LateBindingApi.MSProjectApi.Days.LateBindingApiWrapperType) as LateBindingApi.MSProjectApi.Days;
				return newObject;
			}
		}
