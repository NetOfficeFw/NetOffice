...
namespace LateBindingApi.MSProjectApi
{
	...
	public class Exception : COMObject
	{
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Enums.PjExceptionType Type
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Type", paramsArray);
				return (LateBindingApi.MSProjectApi.Enums.PjExceptionType)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Enums.PjExceptionPosition MonthPosition
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MonthPosition", paramsArray);
				return (LateBindingApi.MSProjectApi.Enums.PjExceptionPosition)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Enums.PjExceptionItem MonthItem
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MonthItem", paramsArray);
				return (LateBindingApi.MSProjectApi.Enums.PjExceptionItem)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Enums.PjMonth Month
		{
			get
			{
				object[] paramsArray = null;
