...
namespace LateBindingApi.MSProjectApi
{
	...
	public class View : COMObject
	{
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Enums.PjItemType Type
		{
			get
			{
				object[] paramsArray = null;
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Enums.PjViewScreen Screen
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Screen", paramsArray);
				return (LateBindingApi.MSProjectApi.Enums.PjViewScreen)returnItem;
			}
		}
