...
namespace LateBindingApi.MSProjectApi
{
	...
	public class Resources : COMObject ,IEnumerable
	{
		...
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Resource get_UniqueID(Int32 index)
		{
		...
		public LateBindingApi.MSProjectApi.Resource this[object index]
		{
			get
{			
			object[] paramsArray = Invoker.ValidateParamsArray(index);
		...
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Resource Add(object name, object before)
		{
		...
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Resource Add()
		{
			object[] paramsArray = null;
			object returnItem = Invoker.MethodReturn(this, "Add", paramsArray);
			LateBindingApi.MSProjectApi.Resource newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,LateBindingApi.MSProjectApi.Resource.LateBindingApiWrapperType) as LateBindingApi.MSProjectApi.Resource;
		...
		[CustomMethodAttribute]
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.Resource Add(object name)
		{
