...
{
	///<summary>
	/// DispatchInterface Group SupportByLibraryAttribute MSProject, 12,14
	///</summary>
	...
	public class Group : COMObject
	{
		...
		/// </summary>
		[SupportByLibraryAttribute("MSProject", 12,14)]
		public LateBindingApi.MSProjectApi.GroupCriteria GroupCriteria
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "GroupCriteria", paramsArray);
				LateBindingApi.MSProjectApi.GroupCriteria newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,LateBindingApi.MSProjectApi.GroupCriteria.LateBindingApiWrapperType) as LateBindingApi.MSProjectApi.GroupCriteria;
				return newObject;
			}
			set
			{
