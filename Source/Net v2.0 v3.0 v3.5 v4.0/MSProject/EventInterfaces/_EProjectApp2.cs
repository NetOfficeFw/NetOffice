...
{	
	...
	public class _EProjectApp2_SinkHelper : SinkHelper, _EProjectApp2
	{
		...
		public void ProjectBeforeTaskDelete([In, MarshalAs(UnmanagedType.IDispatch)] object tsk, [In] [Out] ref object cancel)
		{
			...
			LateBindingApi.MSProjectApi.Task newtsk = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, tsk) as LateBindingApi.MSProjectApi.Task;
		...
		public void ProjectBeforeResourceDelete([In, MarshalAs(UnmanagedType.IDispatch)] object res, [In] [Out] ref object cancel)
		{
			...
			LateBindingApi.MSProjectApi.Resource newres = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, res) as LateBindingApi.MSProjectApi.Resource;
			object[] paramsArray = new object[2];
		...
		public void ProjectBeforeAssignmentDelete([In, MarshalAs(UnmanagedType.IDispatch)] object asg, [In] [Out] ref object cancel)
		{
			...
			LateBindingApi.MSProjectApi.Assignment newasg = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, asg) as LateBindingApi.MSProjectApi.Assignment;
			object[] paramsArray = new object[2];
		...
		public void ProjectBeforeTaskChange([In, MarshalAs(UnmanagedType.IDispatch)] object tsk, [In] object field, [In, MarshalAs(UnmanagedType.IDispatch)] object newVal, [In] [Out] ref object cancel)
		{
			...
			LateBindingApi.MSProjectApi.Task newtsk = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, tsk) as LateBindingApi.MSProjectApi.Task;
			LateBindingApi.MSProjectApi.Enums.PjField newField = (LateBindingApi.MSProjectApi.Enums.PjField)field;
		...
		public void ProjectBeforeAssignmentChange([In, MarshalAs(UnmanagedType.IDispatch)] object asg, [In] object field, [In, MarshalAs(UnmanagedType.IDispatch)] object newVal, [In] [Out] ref object cancel)
		{
			...
			LateBindingApi.MSProjectApi.Assignment newasg = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, asg) as LateBindingApi.MSProjectApi.Assignment;
			LateBindingApi.MSProjectApi.Enums.PjAssignmentField newField = (LateBindingApi.MSProjectApi.Enums.PjAssignmentField)field;
			object newNewVal = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, newVal) as object;
			object[] paramsArray = new object[4];
			paramsArray[0] = newasg;
			paramsArray[1] = newField;
		...
		public void WindowGoalAreaChange([In, MarshalAs(UnmanagedType.IDispatch)] object window, [In] object goalArea)
		{
			...
			LateBindingApi.MSProjectApi.Window newWindow = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, window) as LateBindingApi.MSProjectApi.Window;
		...
		public void WindowSelectionChange([In, MarshalAs(UnmanagedType.IDispatch)] object window, [In, MarshalAs(UnmanagedType.IDispatch)] object sel, [In, MarshalAs(UnmanagedType.IDispatch)] object selType)
		{
			...
			LateBindingApi.MSProjectApi.Window newWindow = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, window) as LateBindingApi.MSProjectApi.Window;
			LateBindingApi.MSProjectApi.Selection newsel = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, sel) as LateBindingApi.MSProjectApi.Selection;
		...
		public void WindowBeforeViewChange([In, MarshalAs(UnmanagedType.IDispatch)] object window, [In, MarshalAs(UnmanagedType.IDispatch)] object prevView, [In, MarshalAs(UnmanagedType.IDispatch)] object newView, [In] object projectHasViewWindow, [In, MarshalAs(UnmanagedType.IDispatch)] object info)
		{
			...
			LateBindingApi.MSProjectApi.Window newWindow = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, window) as LateBindingApi.MSProjectApi.Window;
			LateBindingApi.MSProjectApi.View newprevView = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, prevView) as LateBindingApi.MSProjectApi.View;
			LateBindingApi.MSProjectApi.View newnewView = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, newView) as LateBindingApi.MSProjectApi.View;
			bool newprojectHasViewWindow = (bool)projectHasViewWindow;
			LateBindingApi.MSProjectApi.EventInfo newInfo = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, info) as LateBindingApi.MSProjectApi.EventInfo;
		...
		public void WindowActivate([In, MarshalAs(UnmanagedType.IDispatch)] object activatedWindow)
		{
			...
			LateBindingApi.MSProjectApi.Window newactivatedWindow = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, activatedWindow) as LateBindingApi.MSProjectApi.Window;
			object[] paramsArray = new object[1];
		...
		public void WindowDeactivate([In, MarshalAs(UnmanagedType.IDispatch)] object deactivatedWindow)
		{
			...
			LateBindingApi.MSProjectApi.Window newdeactivatedWindow = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, deactivatedWindow) as LateBindingApi.MSProjectApi.Window;
			object[] paramsArray = new object[1];
		...
		public void ProjectBeforeSaveBaseline([In, MarshalAs(UnmanagedType.IDispatch)] object pj, [In] object interim, [In] object bl, [In] object interimCopy, [In] object interimInto, [In] object allTasks, [In] object rollupToSummaryTasks, [In] object rollupFromSubtasks, [In, MarshalAs(UnmanagedType.IDispatch)] object info)
		{
			...
			LateBindingApi.MSProjectApi.Enums.PjBaselines newbl = (LateBindingApi.MSProjectApi.Enums.PjBaselines)bl;
			LateBindingApi.MSProjectApi.Enums.PjSaveBaselineFrom newInterimCopy = (LateBindingApi.MSProjectApi.Enums.PjSaveBaselineFrom)interimCopy;
			LateBindingApi.MSProjectApi.Enums.PjSaveBaselineTo newInterimInto = (LateBindingApi.MSProjectApi.Enums.PjSaveBaselineTo)interimInto;
		...
		public void ProjectBeforeClearBaseline([In, MarshalAs(UnmanagedType.IDispatch)] object pj, [In] object interim, [In] object bl, [In] object interimFrom, [In] object allTasks, [In, MarshalAs(UnmanagedType.IDispatch)] object info)
		{
			...
			bool newInterim = (bool)interim;
			LateBindingApi.MSProjectApi.Enums.PjBaselines newbl = (LateBindingApi.MSProjectApi.Enums.PjBaselines)bl;
			LateBindingApi.MSProjectApi.Enums.PjSaveBaselineTo newInterimFrom = (LateBindingApi.MSProjectApi.Enums.PjSaveBaselineTo)interimFrom;
			bool newAllTasks = (bool)allTasks;
			LateBindingApi.MSProjectApi.EventInfo newInfo = LateBindingApi.Core.Factory.CreateObjectFromComProxy(_eventClass, info) as LateBindingApi.MSProjectApi.EventInfo;
