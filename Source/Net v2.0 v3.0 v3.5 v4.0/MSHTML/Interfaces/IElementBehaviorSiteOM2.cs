...
{
	///<summary>
	/// Interface IElementBehaviorSiteOM2 SupportByLibraryAttribute MSHTML, 4
	///</summary>
	...
	public class IElementBehaviorSiteOM2 : IElementBehaviorSiteOM
	{
		...
		/// </summary>
		[SupportByLibraryAttribute("MSHTML", 4)]
		public LateBindingApi.MSHTMLApi.IHTMLElementDefaults GetDefaults()
		{
			object[] paramsArray = null;
			object returnItem = Invoker.MethodReturn(this, "GetDefaults", paramsArray);
			LateBindingApi.MSHTMLApi.IHTMLElementDefaults newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.MSHTMLApi.IHTMLElementDefaults;
			return newObject;
		}
