...
{
	///<summary>
	/// DispatchInterface DispHTMLMapElement SupportByLibraryAttribute MSHTML, 4
	///</summary>
	...
	public class DispHTMLMapElement : COMObject
	{
		...
		/// </summary>
		[SupportByLibraryAttribute("MSHTML", 4)]
		public LateBindingApi.MSHTMLApi.IHTMLAreasCollection areas
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "areas", paramsArray);
				LateBindingApi.MSHTMLApi.IHTMLAreasCollection newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.MSHTMLApi.IHTMLAreasCollection;
				return newObject;
			}
		}
