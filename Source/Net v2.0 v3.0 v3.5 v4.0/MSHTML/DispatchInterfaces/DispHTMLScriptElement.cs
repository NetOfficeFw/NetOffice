...
{
	///<summary>
	/// DispatchInterface DispHTMLScriptElement SupportByLibraryAttribute MSHTML, 4
	///</summary>
	...
	public class DispHTMLScriptElement : COMObject
	{
		...
		/// </summary>
		[SupportByLibraryAttribute("MSHTML", 4)]
		public string usedCharset
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "usedCharset", paramsArray);
				return (string)returnItem;
			}
		}
