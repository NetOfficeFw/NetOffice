...
{
	///<summary>
	/// DispatchInterface DispDOMCustomEvent SupportByLibraryAttribute MSHTML, 4
	///</summary>
	[SupportByLibraryAttribute("MSHTML", 4)]
	[EntityTypeAttribute(EntityType.IsDispatchInterface)]
	public class DispDOMCustomEvent : COMObject
	{
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(DispDOMCustomEvent);
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispDOMCustomEvent(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispDOMCustomEvent(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		/// <param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispDOMCustomEvent(COMObject replacedObject) : base(replacedObject)
		{
		}
		
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispDOMCustomEvent() : base()
		{
		}
		
		/// <param name="progId">registered ProgID</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispDOMCustomEvent(string progId) : base(progId)
		{
		}
		...
		/// <param name="canBubble">bool canBubble</param>
		/// <param name="cancelable">bool cancelable</param>
		/// <param name="detail">object detail</param>
		[SupportByLibraryAttribute("MSHTML", 4)]
		public void initCustomEvent(string eventType, bool canBubble, bool cancelable, object detail)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(eventType, canBubble, cancelable, detail);
			Invoker.Method(this, "initCustomEvent", paramsArray);
		}
