...
{
	///<summary>
	/// DispatchInterface DispHTMLTableRow SupportByLibraryAttribute MSHTML, 4
	///</summary>
	...
	public class DispHTMLTableRow : COMObject
	{
		...
		/// <param name="index">Int32 index</param>
		[SupportByLibraryAttribute("MSHTML", 4)]
		public COMObject ie9_insertCell(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "ie9_insertCell", paramsArray);
			COMObject newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem);
			return newObject;
		}
		...
		/// <param name="index">Int32 index</param>
		[SupportByLibraryAttribute("MSHTML", 4)]
		public void ie9_deleteCell(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			Invoker.Method(this, "ie9_deleteCell", paramsArray);
		}
