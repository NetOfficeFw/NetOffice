...
{
	///<summary>
	/// DispatchInterface _NavigationButton SupportByLibraryAttribute Access, 14
	///</summary>
	...
	public class _NavigationButton : NetOffice.OfficeApi.IAccessible
	{
		...
		public NetOffice.AccessApi.Enums.AcCursorOnHover CursorOnHover
		{
			get
			{
				...
				return (NetOffice.AccessApi.Enums.AcCursorOnHover)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		public NetOffice.AccessApi.Enums.AcPictureCaptionArrangement PictureCaptionArrangement
		{
			get
			{
				...
				return (NetOffice.AccessApi.Enums.AcPictureCaptionArrangement)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
