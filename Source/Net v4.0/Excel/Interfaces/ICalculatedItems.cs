...
{
	///<summary>
	/// Interface ICalculatedItems SupportByLibrary Excel, 9,10,11,12,14
	///</summary>
	...
	public class ICalculatedItems : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("Excel", 10,11,12,14)]
		public NetOffice.ExcelApi.PivotItem Add(string name, string formula, object useStandardFormula=null)
		{
