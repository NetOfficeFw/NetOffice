...
{
	///<summary>
	/// Interface IDropDowns SupportByLibrary Excel, 9,10,11,12,14
	///</summary>
	...
	public class IDropDowns : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("Excel", 9,10,11,12,14)]
		public NetOffice.ExcelApi.DropDown Add(Double left, Double top, Double width, Double height, object editable=null)
		{
