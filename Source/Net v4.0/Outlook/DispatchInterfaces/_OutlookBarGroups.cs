...
{
	///<summary>
	/// DispatchInterface _OutlookBarGroups SupportByLibrary Outlook, 9,10,11,12,14
	///</summary>
	...
	public class _OutlookBarGroups : COMObject
	{
		...
		[SupportByLibrary("Outlook", 9,10,11,12,14)]
		public NetOffice.OutlookApi.OutlookBarGroup Add(string name, object index=null)
		{
