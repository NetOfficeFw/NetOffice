...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkLabelEvents))]
    public class OlkLabel : _OlkLabel, NetOffice.OutlookApi.OlkLabel
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkLabelEvents_SinkHelper _olkLabelEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.OlkLabel);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkLabelEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkLabelEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkLabelEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkLabelEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
