...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.StoresEvents_12))]
    public class Stores : _Stores, NetOffice.OutlookApi.Stores
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.StoresEvents_12_SinkHelper _storesEvents_12_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.Stores);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.StoresEvents_12_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.StoresEvents_12_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_storesEvents_12_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.StoresEvents_12_SinkHelper(this, _connectPoint);
				return;
			} 
        }
