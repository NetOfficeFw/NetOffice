...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkTimeControlEvents))]
    public class OlkTimeControl : _OlkTimeControl, NetOffice.OutlookApi.OlkTimeControl
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkTimeControlEvents_SinkHelper _olkTimeControlEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.OlkTimeControl);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkTimeControlEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkTimeControlEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkTimeControlEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkTimeControlEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
