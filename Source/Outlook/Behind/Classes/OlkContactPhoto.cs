...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkContactPhotoEvents))]
    public class OlkContactPhoto : _OlkContactPhoto, NetOffice.OutlookApi.OlkContactPhoto
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkContactPhotoEvents_SinkHelper _olkContactPhotoEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.OlkContactPhoto);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkContactPhotoEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkContactPhotoEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkContactPhotoEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkContactPhotoEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
