...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.FoldersEvents))]
    public class Folders : _Folders, NetOffice.OutlookApi.Folders
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.FoldersEvents_SinkHelper _foldersEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.Folders);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.FoldersEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.FoldersEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_foldersEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.FoldersEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
