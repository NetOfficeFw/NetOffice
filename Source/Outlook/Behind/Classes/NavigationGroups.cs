...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.NavigationGroupsEvents_12))]
    public class NavigationGroups : _NavigationGroups, NetOffice.OutlookApi.NavigationGroups
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.NavigationGroupsEvents_12_SinkHelper _navigationGroupsEvents_12_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.NavigationGroups);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.NavigationGroupsEvents_12_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.NavigationGroupsEvents_12_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_navigationGroupsEvents_12_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.NavigationGroupsEvents_12_SinkHelper(this, _connectPoint);
				return;
			} 
        }
