...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OutlookBarGroupsEvents))]
    public class OutlookBarGroups : _OutlookBarGroups, NetOffice.OutlookApi.OutlookBarGroups
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OutlookBarGroupsEvents_SinkHelper _outlookBarGroupsEvents_SinkHelper;
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OutlookBarGroupsEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OutlookBarGroupsEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_outlookBarGroupsEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OutlookBarGroupsEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
