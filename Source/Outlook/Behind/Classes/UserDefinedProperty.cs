...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsCoClass)]
 	public class UserDefinedProperty : _UserDefinedProperty, NetOffice.OutlookApi.UserDefinedProperty
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.UserDefinedProperty);
