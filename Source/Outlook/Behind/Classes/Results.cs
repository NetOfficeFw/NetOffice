...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.ResultsEvents))]
    public class Results : _Results, NetOffice.OutlookApi.Results
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.ResultsEvents_SinkHelper _resultsEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.Results);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.ResultsEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.ResultsEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_resultsEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.ResultsEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
