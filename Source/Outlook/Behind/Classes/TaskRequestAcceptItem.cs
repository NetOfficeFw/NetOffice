...
namespace NetOffice.OutlookApi.Behind
{
    ...
    public class TaskRequestAcceptItem : _TaskRequestAcceptItem, NetOffice.OutlookApi.TaskRequestAcceptItem
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.TaskRequestAcceptItem);
		...
		/// </summary>
		public TaskRequestAcceptItem() : base()
		{
