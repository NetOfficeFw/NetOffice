...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.SyncObjectEvents))]
    public class SyncObject : _SyncObject, NetOffice.OutlookApi.SyncObject
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.SyncObjectEvents_SinkHelper _syncObjectEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.SyncObject);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.SyncObjectEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.SyncObjectEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_syncObjectEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.SyncObjectEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
