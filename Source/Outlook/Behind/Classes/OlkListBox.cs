...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkListBoxEvents))]
    public class OlkListBox : _OlkListBox, NetOffice.OutlookApi.OlkListBox
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkListBoxEvents_SinkHelper _olkListBoxEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.OlkListBox);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkListBoxEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkListBoxEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkListBoxEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkListBoxEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
