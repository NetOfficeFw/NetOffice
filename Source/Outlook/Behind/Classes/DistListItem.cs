...
namespace NetOffice.OutlookApi.Behind
{
    ...
    public class DistListItem : _DistListItem, NetOffice.OutlookApi.DistListItem
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.DistListItem);
