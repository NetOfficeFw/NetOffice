...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkTimeZoneControlEvents))]
    public class OlkTimeZoneControl : _OlkTimeZoneControl, NetOffice.OutlookApi.OlkTimeZoneControl
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkTimeZoneControlEvents_SinkHelper _olkTimeZoneControlEvents_SinkHelper;
		...
		/// </summary>
		public OlkTimeZoneControl() : base()
		{
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkTimeZoneControlEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkTimeZoneControlEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkTimeZoneControlEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkTimeZoneControlEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
