...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkInfoBarEvents))]
    public class OlkInfoBar : _OlkInfoBar, NetOffice.OutlookApi.OlkInfoBar
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkInfoBarEvents_SinkHelper _olkInfoBarEvents_SinkHelper;
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkInfoBarEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkInfoBarEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkInfoBarEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkInfoBarEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
