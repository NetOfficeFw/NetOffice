...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkSenderPhotoEvents))]
    public class OlkSenderPhoto : _OlkSenderPhoto, NetOffice.OutlookApi.OlkSenderPhoto
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkSenderPhotoEvents_SinkHelper _olkSenderPhotoEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.OlkSenderPhoto);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkSenderPhotoEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkSenderPhotoEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkSenderPhotoEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkSenderPhotoEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
