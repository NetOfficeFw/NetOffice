...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkCheckBoxEvents))]
    public class OlkCheckBox : _OlkCheckBox, NetOffice.OutlookApi.OlkCheckBox
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkCheckBoxEvents_SinkHelper _olkCheckBoxEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.OlkCheckBox);
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkCheckBoxEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkCheckBoxEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkCheckBoxEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkCheckBoxEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
