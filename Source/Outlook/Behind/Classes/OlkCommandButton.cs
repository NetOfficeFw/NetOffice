...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts.OlkCommandButtonEvents))]
    public class OlkCommandButton : _OlkCommandButton, NetOffice.OutlookApi.OlkCommandButton
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts.OlkCommandButtonEvents_SinkHelper _olkCommandButtonEvents_SinkHelper;
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts.OlkCommandButtonEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts.OlkCommandButtonEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_olkCommandButtonEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts.OlkCommandButtonEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
