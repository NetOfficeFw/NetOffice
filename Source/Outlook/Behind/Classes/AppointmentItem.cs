...
namespace NetOffice.OutlookApi.Behind
{
	...
	public class AppointmentItem : _AppointmentItem, NetOffice.OutlookApi.AppointmentItem
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.AppointmentItem);
