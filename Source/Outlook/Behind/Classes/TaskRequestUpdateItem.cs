...
namespace NetOffice.OutlookApi.Behind
{
    ...
    public class TaskRequestUpdateItem : _TaskRequestUpdateItem, NetOffice.OutlookApi.TaskRequestUpdateItem
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi.TaskRequestUpdateItem);
		...
		/// </summary>
		public TaskRequestUpdateItem() : base()
		{
