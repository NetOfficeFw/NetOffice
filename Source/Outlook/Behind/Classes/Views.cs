...
namespace NetOffice.OutlookApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.OutlookApi.EventContracts._ViewsEvents))]
    public class Views : _Views, NetOffice.OutlookApi.Views
    {
        ...
        private NetOffice.OutlookApi.Behind.EventContracts._ViewsEvents_SinkHelper __ViewsEvents_SinkHelper;
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OutlookApi.Behind.EventContracts._ViewsEvents_SinkHelper.Id);


			if(NetOffice.OutlookApi.Behind.EventContracts._ViewsEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				__ViewsEvents_SinkHelper = new NetOffice.OutlookApi.Behind.EventContracts._ViewsEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
