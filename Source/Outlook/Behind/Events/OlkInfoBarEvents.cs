...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkInfoBarEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkInfoBarEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkInfoBarEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkInfoBarEvents
        /// </summary>
        ...
        public OlkInfoBarEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
