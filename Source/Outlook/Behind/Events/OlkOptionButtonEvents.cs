...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkOptionButtonEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkOptionButtonEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkOptionButtonEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkOptionButtonEvents
        /// </summary>
        ...
        public OlkOptionButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
