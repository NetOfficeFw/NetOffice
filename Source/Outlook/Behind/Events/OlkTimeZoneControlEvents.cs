...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkTimeZoneControlEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkTimeZoneControlEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkTimeZoneControlEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkTimeZoneControlEvents
        /// </summary>
