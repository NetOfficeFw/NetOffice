...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkListBoxEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkListBoxEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkListBoxEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkListBoxEvents
        /// </summary>
