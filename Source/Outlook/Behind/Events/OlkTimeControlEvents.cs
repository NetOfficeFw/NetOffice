...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkTimeControlEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkTimeControlEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkTimeControlEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkTimeControlEvents
        /// </summary>
        public static readonly string Id = "000672F0-0000-0000-C000-000000000046";
        ...
        public OlkTimeControlEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
