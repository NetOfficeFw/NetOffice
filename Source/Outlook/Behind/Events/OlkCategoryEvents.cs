...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkCategoryEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkCategoryEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkCategoryEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkCategoryEvents
        /// </summary>
