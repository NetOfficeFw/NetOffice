...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkBusinessCardControlEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkBusinessCardControlEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkBusinessCardControlEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkBusinessCardControlEvents
        /// </summary>
		...
		#region OlkBusinessCardControlEvents
