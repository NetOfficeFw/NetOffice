...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkDateControlEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkDateControlEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkDateControlEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkDateControlEvents
        /// </summary>
        public static readonly string Id = "000672FB-0000-0000-C000-000000000046";
        ...
        public OlkDateControlEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
