...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkContactPhotoEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkContactPhotoEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkContactPhotoEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkContactPhotoEvents
        /// </summary>
