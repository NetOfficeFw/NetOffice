...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkTextBoxEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkTextBoxEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkTextBoxEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkTextBoxEvents
        /// </summary>
