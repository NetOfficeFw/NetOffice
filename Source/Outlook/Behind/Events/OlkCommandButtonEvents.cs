...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkCommandButtonEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkCommandButtonEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkCommandButtonEvents
	{
        #region Static
       
        /// <summary>
        /// Interface Id from OlkComboBoxEvents
        /// </summary>
