...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.ResultsEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class ResultsEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.ResultsEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from ResultsEvents
        /// </summary>
