...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.OutlookApi.EventContracts.OlkSenderPhotoEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class OlkSenderPhotoEvents_SinkHelper : SinkHelper, NetOffice.OutlookApi.EventContracts.OlkSenderPhotoEvents
	{
        #region Static

        /// <summary>
        /// Interface Id from OlkSenderPhotoEvents
        /// </summary>
