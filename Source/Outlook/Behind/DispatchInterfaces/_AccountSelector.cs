...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _AccountSelector : COMObject, NetOffice.OutlookApi._AccountSelector
	{
		...
		[SupportByVersion("Outlook", 14,15,16)]
		[BaseResult]
		public virtual NetOffice.OutlookApi._Account SelectedAccount
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.OutlookApi._Account>(this, "SelectedAccount");
			}
		}
