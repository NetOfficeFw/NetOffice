...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _MoveOrCopyRuleAction : COMObject, NetOffice.OutlookApi._MoveOrCopyRuleAction
	{
		...
		public virtual NetOffice.OutlookApi.MAPIFolder Folder
		{
			...
			set
			{
				InvokerService.InvokeInternal.ExecuteReferencePropertySet(this, "Folder", value);
			}
		}
