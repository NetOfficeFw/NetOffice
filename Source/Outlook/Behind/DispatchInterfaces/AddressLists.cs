...
namespace NetOffice.OutlookApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff868743.aspx </remarks>
	[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
	...
	public class AddressLists : COMObject, NetOffice.OutlookApi.AddressLists
	{
		...
		public virtual NetOffice.OutlookApi.AddressList this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi.AddressList>(this, "Item", typeof(NetOffice.OutlookApi.AddressList), index);
			}
		}
        ...
        [SupportByVersion("Outlook", 9, 10, 11, 12, 14, 15, 16)]
        [CustomEnumerator]
        public virtual IEnumerator<NetOffice.OutlookApi.AddressList> GetEnumerator()
        {
            NetRuntimeSystem.Collections.IEnumerable innerEnumerator = (this as NetRuntimeSystem.Collections.IEnumerable);
            foreach (NetOffice.OutlookApi.AddressList item in innerEnumerator)
                yield return item;
