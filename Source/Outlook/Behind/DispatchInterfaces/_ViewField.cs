...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _ViewField : COMObject, NetOffice.OutlookApi._ViewField
	{
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		public virtual NetOffice.OutlookApi.ColumnFormat ColumnFormat
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi.ColumnFormat>(this, "ColumnFormat", typeof(NetOffice.OutlookApi.ColumnFormat));
			}
		}
