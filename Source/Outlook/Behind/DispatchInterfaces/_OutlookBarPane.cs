...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _OutlookBarPane : COMObject, NetOffice.OutlookApi._OutlookBarPane
	{
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.OutlookBarStorage Contents
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi.OutlookBarStorage>(this, "Contents", typeof(NetOffice.OutlookApi.OutlookBarStorage));
			}
		}
		...
		/// </summary>
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.OutlookBarGroup CurrentGroup
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi.OutlookBarGroup>(this, "CurrentGroup", typeof(NetOffice.OutlookApi.OutlookBarGroup));
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteReferencePropertySet(this, "CurrentGroup", value);
			}
		}
