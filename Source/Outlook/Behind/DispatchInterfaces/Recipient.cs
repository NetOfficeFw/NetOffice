...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Recipient : COMObject, NetOffice.OutlookApi.Recipient
	{
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.AddressEntry AddressEntry
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi.AddressEntry>(this, "AddressEntry", typeof(NetOffice.OutlookApi.AddressEntry));
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteReferencePropertySet(this, "AddressEntry", value);
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual string AutoResponse
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "AutoResponse");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "AutoResponse", value);
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlResponseStatus MeetingResponseStatus
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlResponseStatus>(this, "MeetingResponseStatus");
			}
		}
		...
		public virtual bool Resolved
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "Resolved");
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlTrackingStatus TrackingStatus
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlTrackingStatus>(this, "TrackingStatus");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "TrackingStatus", value);
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual DateTime TrackingStatusTime
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteDateTimePropertyGet(this, "TrackingStatusTime");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "TrackingStatusTime", value);
			}
		}
		...
		public virtual bool Sendable
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "Sendable");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "Sendable", value);
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual string FreeBusy(DateTime start, Int32 minPerChar, object completeFormat)
		{
			return InvokerService.InvokeInternal.ExecuteStringMethodGet(this, "FreeBusy", start, minPerChar, completeFormat);
		}
		...
		[CustomMethod]
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual string FreeBusy(DateTime start, Int32 minPerChar)
		{
			return InvokerService.InvokeInternal.ExecuteStringMethodGet(this, "FreeBusy", start, minPerChar);
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteBoolMethodGet(this, "Resolve");
		}
