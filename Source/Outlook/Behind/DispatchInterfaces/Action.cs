...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Action : COMObject, NetOffice.OutlookApi.Action
	{
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlActionCopyLike CopyLike
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlActionCopyLike>(this, "CopyLike");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "CopyLike", value);
			}
		}
		...
		public virtual string Prefix
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "Prefix");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "Prefix", value);
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlActionReplyStyle ReplyStyle
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlActionReplyStyle>(this, "ReplyStyle");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "ReplyStyle", value);
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlActionResponseStyle ResponseStyle
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlActionResponseStyle>(this, "ResponseStyle");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "ResponseStyle", value);
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlActionShowOn ShowOn
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlActionShowOn>(this, "ShowOn");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "ShowOn", value);
			}
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteVariantMethodGet(this, "Execute");
		}
