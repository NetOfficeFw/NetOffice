...
namespace NetOffice.OutlookApi.Behind
{
	...
	public class _Reminders : COMObject, NetOffice.OutlookApi._Reminders
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi._Reminders);
		...
		public virtual NetOffice.OutlookApi._Reminder this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferenceMethodGet<NetOffice.OutlookApi._Reminder>(this, "Item", index);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("Outlook", 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.OutlookApi._Reminder> GetEnumerator()
        {
            NetRuntimeSystem.Collections.IEnumerable innerEnumerator = (this as NetRuntimeSystem.Collections.IEnumerable);
            foreach (NetOffice.OutlookApi._Reminder item in innerEnumerator)
                yield return item;
