...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _ColumnFormat : COMObject, NetOffice.OutlookApi._ColumnFormat
	{
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		public virtual Int32 FieldFormat
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "FieldFormat");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "FieldFormat", value);
			}
		}
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlAlign Align
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlAlign>(this, "Align");
			}
			set
			{
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlUserPropertyType FieldType
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlUserPropertyType>(this, "FieldType");
			}
		}
