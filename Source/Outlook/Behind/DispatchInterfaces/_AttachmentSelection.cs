...
namespace NetOffice.OutlookApi.Behind
{
	...
	public class _AttachmentSelection : COMObject, NetOffice.OutlookApi._AttachmentSelection
	{
		...
		[SupportByVersion("Outlook", 14,15,16)]
		public virtual NetOffice.OutlookApi.Enums.OlSelectionLocation Location
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlSelectionLocation>(this, "Location");
			}
		}
