...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Exception : COMObject, NetOffice.OutlookApi.Exception
	{
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual NetOffice.OutlookApi.AppointmentItem AppointmentItem
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi.AppointmentItem>(this, "AppointmentItem", typeof(NetOffice.OutlookApi.AppointmentItem));
			}
		}
		...
		public virtual bool Deleted
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "Deleted");
			}
		}
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		public virtual DateTime OriginalDate
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteDateTimePropertyGet(this, "OriginalDate");
			}
		}
