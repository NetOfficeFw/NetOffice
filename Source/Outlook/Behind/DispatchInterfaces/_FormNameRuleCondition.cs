...
namespace NetOffice.OutlookApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _FormNameRuleCondition : COMObject, NetOffice.OutlookApi._FormNameRuleCondition
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OutlookApi._FormNameRuleCondition);
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		public virtual object FormName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteVariantPropertyGet(this, "FormName");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteVariantPropertySet(this, "FormName", value);
			}
		}
