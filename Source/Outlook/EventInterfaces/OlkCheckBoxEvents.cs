...
{	
	...
	[ComImport, Guid("000672E2-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface OlkCheckBoxEvents
	{
		[SupportByVersionAttribute("Outlook", 12,14,15,16)]
	...
	public class OlkCheckBoxEvents_SinkHelper : SinkHelper, OlkCheckBoxEvents
	{
		#region Static
		...
		public OlkCheckBoxEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region OlkCheckBoxEvents Members
