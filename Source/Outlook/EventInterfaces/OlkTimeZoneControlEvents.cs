...
{	
	...
	[ComImport, Guid("00067368-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface OlkTimeZoneControlEvents
	{
		[SupportByVersionAttribute("Outlook", 12,14,15)]
	...
	public class OlkTimeZoneControlEvents_SinkHelper : SinkHelper, OlkTimeZoneControlEvents
	{
		#region Static
		...
		public OlkTimeZoneControlEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
