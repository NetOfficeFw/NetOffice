...
namespace NetOffice.OutlookApi
{
	...
	public class ExchangeUser : _ExchangeUser
	{
		...
		public ExchangeUser(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public ExchangeUser(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ExchangeUser(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ExchangeUser(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ExchangeUser(ICOMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// Returns all running Outlook.ExchangeUser objects from the environment/system
        /// </summary>
        /// <returns>an Outlook.ExchangeUser array</returns>
		public static NetOffice.OutlookApi.ExchangeUser[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("Outlook","ExchangeUser");
		...
		/// <summary>
        /// Returns a running Outlook.ExchangeUser object from the environment/system.
        /// </summary>
        /// <returns>an Outlook.ExchangeUser object or null</returns>
		public static NetOffice.OutlookApi.ExchangeUser GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Outlook","ExchangeUser", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Outlook","ExchangeUser", throwOnError);
			if(null != proxy)
				return new NetOffice.OutlookApi.ExchangeUser(null, proxy);
			else
				return null;
