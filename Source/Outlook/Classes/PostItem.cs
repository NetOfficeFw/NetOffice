...
namespace NetOffice.OutlookApi
{
	...
	public delegate void PostItem_CustomActionEventHandler(COMObject Action, COMObject Response, ref bool Cancel);
	public delegate void PostItem_CustomPropertyChangeEventHandler(string Name);
	public delegate void PostItem_ForwardEventHandler(COMObject Forward, ref bool Cancel);
	...
	public delegate void PostItem_ReplyEventHandler(COMObject Response, ref bool Cancel);
	public delegate void PostItem_ReplyAllEventHandler(COMObject Response, ref bool Cancel);
	...
	public delegate void PostItem_BeforeDeleteEventHandler(COMObject Item, ref bool Cancel);
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff869495.aspx </remarks>
	...
	public class PostItem : _PostItem,IEventBinding
	{
		...
		public PostItem(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public PostItem(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public PostItem(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public PostItem(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public PostItem(COMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// returns all running Outlook.PostItem objects from the running object table(ROT)
        /// </summary>
        /// <returns>an Outlook.PostItem array</returns>
		public static NetOffice.OutlookApi.PostItem[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("Outlook","PostItem");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.OutlookApi.PostItem> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.OutlookApi.PostItem>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.OutlookApi.PostItem(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running Outlook.PostItem object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an Outlook.PostItem object or null</returns>
		public static NetOffice.OutlookApi.PostItem GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Outlook","PostItem", false);
			if(null != proxy)
				return new NetOffice.OutlookApi.PostItem(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an Outlook.PostItem object or null</returns>
		public static NetOffice.OutlookApi.PostItem GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Outlook","PostItem", throwOnError);
			if(null != proxy)
				return new NetOffice.OutlookApi.PostItem(null, proxy);
			else
				return null;
