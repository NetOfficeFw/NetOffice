...
namespace NetOffice.OutlookApi
{
	...
	public class OlkCategory : _OlkCategory,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running Outlook.OlkCategory objects from the environment/system
        /// </summary>
        /// <returns>an Outlook.OlkCategory array</returns>
		public static NetOffice.OutlookApi.OlkCategory[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("Outlook","OlkCategory");
		...
		/// <summary>
        /// Returns a running Outlook.OlkCategory object from the environment/system.
        /// </summary>
        /// <returns>an Outlook.OlkCategory object or null</returns>
		public static NetOffice.OutlookApi.OlkCategory GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Outlook","OlkCategory", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Outlook","OlkCategory", throwOnError);
			if(null != proxy)
				return new NetOffice.OutlookApi.OlkCategory(null, proxy);
			else
				return null;
