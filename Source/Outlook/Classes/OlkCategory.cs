...
namespace NetOffice.OutlookApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff869980.aspx </remarks>
	...
	public class OlkCategory : _OlkCategory,IEventBinding
	{
		...
		public OlkCategory(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public OlkCategory(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running Outlook.OlkCategory objects from the running object table(ROT)
        /// </summary>
        /// <returns>an Outlook.OlkCategory array</returns>
		public static NetOffice.OutlookApi.OlkCategory[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("Outlook","OlkCategory");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.OutlookApi.OlkCategory> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.OutlookApi.OlkCategory>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.OutlookApi.OlkCategory(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running Outlook.OlkCategory object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an Outlook.OlkCategory object or null</returns>
		public static NetOffice.OutlookApi.OlkCategory GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Outlook","OlkCategory", false);
			if(null != proxy)
				return new NetOffice.OutlookApi.OlkCategory(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an Outlook.OlkCategory object or null</returns>
		public static NetOffice.OutlookApi.OlkCategory GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Outlook","OlkCategory", throwOnError);
			if(null != proxy)
				return new NetOffice.OutlookApi.OlkCategory(null, proxy);
			else
				return null;
