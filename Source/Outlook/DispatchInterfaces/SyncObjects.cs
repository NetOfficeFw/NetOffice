	...
	public class SyncObjects : COMObject ,IEnumerable<NetOffice.OutlookApi.SyncObject>
	{
		...
		public NetOffice.OutlookApi._SyncObject AppFolders
		{
			get
			{
				...
				NetOffice.OutlookApi._SyncObject newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.OutlookApi._SyncObject;
				return newObject;
			}
		}
		...
		public NetOffice.OutlookApi.SyncObject this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.SyncObject newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.SyncObject.LateBindingApiWrapperType) as NetOffice.OutlookApi.SyncObject;
				return newObject;
			}
		}
