...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("00063025-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.NoteItem))]
    public interface _NoteItem : ICOMObject
	{
		#region Properties
		...
		/// </summary>
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.Enums.OlNoteColor Color { get; set; }
