...
namespace NetOffice.OutlookApi
{
	...
	public class _RuleActions : COMObject , IEnumerable<NetOffice.OutlookApi._RuleAction>
	{
		...
		public NetOffice.OutlookApi._RuleAction this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi._RuleAction>(this, "Item", NetOffice.OutlookApi._RuleAction.LateBindingApiWrapperType, index);
			}
		}
