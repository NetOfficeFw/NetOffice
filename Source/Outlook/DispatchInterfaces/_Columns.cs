	...
	public class _Columns : COMObject ,IEnumerable<NetOffice.OutlookApi._Column>
	{
		...
		public NetOffice.OutlookApi._Column this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi._Column newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.OutlookApi._Column;
				return newObject;
			}
		}
		...
		public NetOffice.OutlookApi.Column Add(string name)
		{
			...
			NetOffice.OutlookApi.Column newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.Column.LateBindingApiWrapperType) as NetOffice.OutlookApi.Column;
			return newObject;
		}
