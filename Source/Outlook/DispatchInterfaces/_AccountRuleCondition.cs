...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("000630DB-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.AccountRuleCondition))]
    public interface _AccountRuleCondition : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.Account Account { get; set; }
