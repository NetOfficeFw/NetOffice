	...
	public class RecurrencePattern : COMObject
	{
		...
		public NetOffice.OutlookApi.Exceptions Exceptions
		{
			get
			{
				...
				NetOffice.OutlookApi.Exceptions newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OutlookApi.Exceptions.LateBindingApiWrapperType) as NetOffice.OutlookApi.Exceptions;
				return newObject;
			}
		}
