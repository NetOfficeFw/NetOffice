	...
	public class _Inspectors : COMObject ,IEnumerable<NetOffice.OutlookApi.Inspector>
	{
		...
		public NetOffice.OutlookApi.Inspector this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.Inspector newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.Inspector.LateBindingApiWrapperType) as NetOffice.OutlookApi.Inspector;
				return newObject;
			}
		}
