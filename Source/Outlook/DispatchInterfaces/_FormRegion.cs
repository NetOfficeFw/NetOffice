...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("0006305A-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.FormRegion))]
    public interface _FormRegion : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		[BaseResult]
		NetOffice.OutlookApi._Inspector Inspector { get; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.Enums.OlFormRegionMode FormRegionMode { get; }
