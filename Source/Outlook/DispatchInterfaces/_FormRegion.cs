...
namespace NetOffice.OutlookApi
{
 	...
 	public class _FormRegion : COMObject
	{
		...
		public NetOffice.OutlookApi._Inspector Inspector
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi._Inspector>(this, "Inspector", NetOffice.OutlookApi._Inspector.LateBindingApiWrapperType);
			}
		}
