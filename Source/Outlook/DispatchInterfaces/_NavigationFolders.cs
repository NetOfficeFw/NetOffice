...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("000630F1-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.NavigationFolders))]
    public interface _NavigationFolders : ICOMObject, IEnumerableProvider<NetOffice.OutlookApi._NavigationFolder>
	{
		#region Properties
		...
		NetOffice.OutlookApi._NavigationFolder this[object index] { get; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.NavigationFolder Add(NetOffice.OutlookApi.MAPIFolder folder);
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		void Remove(NetOffice.OutlookApi.NavigationFolder removableFolder);
