...
namespace NetOffice.OutlookApi
{
	...
	public class _NavigationFolders : COMObject , IEnumerable<NetOffice.OutlookApi._NavigationFolder>
	{
		...
		public NetOffice.OutlookApi._NavigationFolder this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi._NavigationFolder>(this, "Item", NetOffice.OutlookApi._NavigationFolder.LateBindingApiWrapperType, index);
			}
		}
