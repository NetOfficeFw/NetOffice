...
namespace NetOffice.OutlookApi
{
	...
	public class _ViewFields : COMObject , IEnumerable<NetOffice.OutlookApi._ViewField>
	{
		...
		public NetOffice.OutlookApi._ViewField this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi._ViewField>(this, "Item", NetOffice.OutlookApi._ViewField.LateBindingApiWrapperType, index);
			}
		}
