	...
	public class _ViewFields : COMObject ,IEnumerable<NetOffice.OutlookApi._ViewField>
	{
		...
		public NetOffice.OutlookApi._ViewField this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi._ViewField newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.OutlookApi._ViewField;
				return newObject;
			}
		}
		...
		public NetOffice.OutlookApi.ViewField Add(string propertyName)
		{
			...
			NetOffice.OutlookApi.ViewField newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.ViewField.LateBindingApiWrapperType) as NetOffice.OutlookApi.ViewField;
			return newObject;
		}
