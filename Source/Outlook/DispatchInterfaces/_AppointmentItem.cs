...
namespace NetOffice.OutlookApi
{
 	...
 	public class _AppointmentItem : COMObject
	{
		...
		public NetOffice.OutlookApi._TimeZone StartTimeZone
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi._TimeZone>(this, "StartTimeZone", NetOffice.OutlookApi._TimeZone.LateBindingApiWrapperType);
			}
			set
			{
		...
		public NetOffice.OutlookApi._TimeZone EndTimeZone
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi._TimeZone>(this, "EndTimeZone", NetOffice.OutlookApi._TimeZone.LateBindingApiWrapperType);
			}
			set
			{
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi._AppointmentItem>(this, "CopyTo", NetOffice.OutlookApi._AppointmentItem.LateBindingApiWrapperType, destinationFolder, copyOptions);
		}
