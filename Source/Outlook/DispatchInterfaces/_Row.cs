...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("000630D3-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.Row))]
    public interface _Row : ICOMObject
	{
		#region Properties
		...
		/// <param name="index">object index</param>
		[SupportByVersion("Outlook", 12,14,15,16)]
		DateTime LocalTimeToUTC(object index);
		...
		/// <param name="index">object index</param>
		[SupportByVersion("Outlook", 12,14,15,16)]
		DateTime UTCToLocalTime(object index);
