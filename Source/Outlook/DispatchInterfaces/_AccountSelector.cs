...
namespace NetOffice.OutlookApi
{
 	...
 	public class _AccountSelector : COMObject
	{
		...
		public NetOffice.OutlookApi._Account SelectedAccount
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi._Account>(this, "SelectedAccount", NetOffice.OutlookApi._Account.LateBindingApiWrapperType);
			}
		}
