...
namespace NetOffice.OutlookApi
{
	...
	public class _OutlookBarGroups : COMObject, IEnumerableProvider<NetOffice.OutlookApi.OutlookBarGroup>
	{
		...
		public _OutlookBarGroups(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public _OutlookBarGroups(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.OutlookApi.OutlookBarGroup this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi.OutlookBarGroup>(this, "Item", NetOffice.OutlookApi.OutlookBarGroup.LateBindingApiWrapperType, index);
			}
		}
