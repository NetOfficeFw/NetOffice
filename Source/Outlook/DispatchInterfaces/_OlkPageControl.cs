...
namespace NetOffice.OutlookApi
{
 	...
 	public class _OlkPageControl : COMObject
	{
		...
		public _OlkPageControl(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		/// Get/Set
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Outlook.OlkPageControl.Page"/> </remarks>
		[SupportByVersion("Outlook", 12,14,15,16)]
		public NetOffice.OutlookApi.Enums.OlPageType Page
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.OutlookApi.Enums.OlPageType>(this, "Page");
			}
			set
			{
				Factory.ExecuteEnumPropertySet(this, "Page", value);
			}
		}
