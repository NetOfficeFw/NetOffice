...
namespace NetOffice.OutlookApi
{
	...
	public class _RuleConditions : COMObject , IEnumerable<NetOffice.OutlookApi._RuleCondition>
	{
		...
		public NetOffice.OutlookApi._RuleCondition this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi._RuleCondition>(this, "Item", NetOffice.OutlookApi._RuleCondition.LateBindingApiWrapperType, index);
			}
		}
