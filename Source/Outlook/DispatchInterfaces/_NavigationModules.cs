...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("000630E7-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.NavigationModules))]
    public interface _NavigationModules : ICOMObject, IEnumerableProvider<NetOffice.OutlookApi._NavigationModule>
	{
		#region Properties
		...
		NetOffice.OutlookApi._NavigationModule this[object index] { get; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.NavigationModule GetNavigationModule(NetOffice.OutlookApi.Enums.OlNavigationModuleType moduleType);
