...
namespace NetOffice.OutlookApi
{
 	...
 	public class Search : COMObject
	{
		...
		public NetOffice.OutlookApi._Results Results
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi._Results>(this, "Results", NetOffice.OutlookApi._Results.LateBindingApiWrapperType);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi.MAPIFolder>(this, "Save", NetOffice.OutlookApi.MAPIFolder.LateBindingApiWrapperType, name);
		}
