...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("00063046-0000-0000-C000-000000000046")]
	public interface FormDescription : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		void PublishForm(NetOffice.OutlookApi.Enums.OlFormRegistry registry, object folder);
		...
		[CustomMethod]
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		void PublishForm(NetOffice.OutlookApi.Enums.OlFormRegistry registry);
