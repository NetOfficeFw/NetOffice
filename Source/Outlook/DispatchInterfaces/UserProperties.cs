	...
	public class UserProperties : COMObject ,IEnumerable<NetOffice.OutlookApi.UserProperty>
	{
		...
		public NetOffice.OutlookApi.UserProperty this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.UserProperty newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.UserProperty.LateBindingApiWrapperType) as NetOffice.OutlookApi.UserProperty;
				return newObject;
			}
		}
