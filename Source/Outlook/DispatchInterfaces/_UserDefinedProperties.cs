...
namespace NetOffice.OutlookApi
{
	...
	public class _UserDefinedProperties : COMObject , IEnumerable<NetOffice.OutlookApi._UserDefinedProperty>
	{
		...
		public NetOffice.OutlookApi._UserDefinedProperty this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi._UserDefinedProperty>(this, "Item", NetOffice.OutlookApi._UserDefinedProperty.LateBindingApiWrapperType, index);
			}
		}
