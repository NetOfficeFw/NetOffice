	...
	public class _UserDefinedProperties : COMObject ,IEnumerable<NetOffice.OutlookApi._UserDefinedProperty>
	{
		...
		public NetOffice.OutlookApi._UserDefinedProperty this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi._UserDefinedProperty newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.OutlookApi._UserDefinedProperty;
				return newObject;
			}
		}
		...
		public NetOffice.OutlookApi.UserDefinedProperty Add(string name, NetOffice.OutlookApi.Enums.OlUserPropertyType type, object displayFormat, object formula)
		{
			...
			NetOffice.OutlookApi.UserDefinedProperty newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.UserDefinedProperty.LateBindingApiWrapperType) as NetOffice.OutlookApi.UserDefinedProperty;
			return newObject;
		}
