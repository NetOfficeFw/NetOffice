...
namespace NetOffice.OutlookApi
{
	...
	public class _OrderFields : COMObject , IEnumerable<NetOffice.OutlookApi._OrderField>
	{
		...
		public NetOffice.OutlookApi._OrderField this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi._OrderField>(this, "Item", NetOffice.OutlookApi._OrderField.LateBindingApiWrapperType, index);
			}
		}
