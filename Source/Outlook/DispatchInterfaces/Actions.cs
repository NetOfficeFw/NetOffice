	...
	public class Actions : COMObject ,IEnumerable<NetOffice.OutlookApi.Action>
	{
		...
		public NetOffice.OutlookApi.Action this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi.Action newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi.Action.LateBindingApiWrapperType) as NetOffice.OutlookApi.Action;
				return newObject;
			}
		}
