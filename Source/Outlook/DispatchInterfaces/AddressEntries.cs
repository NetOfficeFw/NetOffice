...
namespace NetOffice.OutlookApi
{
	...
	public interface AddressEntries : ICOMObject, IEnumerableProvider<NetOffice.OutlookApi.AddressEntry>
	{
		...
		NetOffice.OutlookApi.AddressEntry this[object index] { get; }
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.AddressEntry Add(string type, object name, object address);
		...
		[CustomMethod]
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.AddressEntry Add(string type);
		...
		[CustomMethod]
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.AddressEntry Add(string type, object name);
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.AddressEntry GetFirst();
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.AddressEntry GetLast();
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.AddressEntry GetNext();
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		NetOffice.OutlookApi.AddressEntry GetPrevious();
		...
		[SupportByVersion("Outlook", 9,10,11,12,14,15,16)]
		void Sort(object property, object order);
