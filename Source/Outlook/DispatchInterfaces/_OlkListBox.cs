...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("000672DF-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.OlkListBox))]
    public interface _OlkListBox : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.Enums.OlMatchEntry MatchEntry { get; set; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.Enums.OlMultiSelect MultiSelect { get; set; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		void SetSelected(Int32 index, bool selected);
