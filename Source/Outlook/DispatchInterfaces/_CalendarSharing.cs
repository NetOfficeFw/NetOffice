...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("000630E2-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.CalendarSharing))]
    public interface _CalendarSharing : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.Enums.OlCalendarDetail CalendarDetail { get; set; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		bool RestrictToWorkingHours { get; set; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.MailItem ForwardAsICal(NetOffice.OutlookApi.Enums.OlCalendarMailFormat mailFormat);
