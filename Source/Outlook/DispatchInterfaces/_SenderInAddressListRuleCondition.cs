...
namespace NetOffice.OutlookApi
{
	...
	public class _SenderInAddressListRuleCondition : COMObject
	{
		...
		public _SenderInAddressListRuleCondition(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public _SenderInAddressListRuleCondition(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
