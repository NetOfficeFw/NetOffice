...
namespace NetOffice.OutlookApi
{
	...
	[TypeId("000630C8-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.OutlookApi.SelectNamesDialog))]
    public interface _SelectNamesDialog : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.Recipients Recipients { get; set; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.Enums.OlRecipientSelectors NumberOfRecipientSelectors { get; set; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		NetOffice.OutlookApi.AddressList InitialAddressList { get; set; }
		...
		[SupportByVersion("Outlook", 12,14,15,16)]
		void SetDefaultDisplayMode(NetOffice.OutlookApi.Enums.OlDefaultSelectNamesDisplayMode defaultMode);
