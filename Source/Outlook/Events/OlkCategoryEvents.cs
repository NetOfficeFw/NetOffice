...
{	
    ...
    [ComImport, Guid("000672F5-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface OlkCategoryEvents
	{
		[SupportByVersion("Outlook", 12,14,15,16)]
	...
	public class OlkCategoryEvents_SinkHelper : SinkHelper, OlkCategoryEvents
	{
		#region Static
		
		public static readonly string Id = "000672F5-0000-0000-C000-000000000046";
		...
		public OlkCategoryEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region OlkCategoryEvents Members
