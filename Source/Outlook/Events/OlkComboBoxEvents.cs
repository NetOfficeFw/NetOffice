...
{	
    ...
    [ComImport, Guid("000672E3-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface OlkComboBoxEvents
	{
		[SupportByVersion("Outlook", 12,14,15,16)]
	...
	public class OlkComboBoxEvents_SinkHelper : SinkHelper, OlkComboBoxEvents
	{
		#region Static
		
		public static readonly string Id = "000672E3-0000-0000-C000-000000000046";
		...
		public OlkComboBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region OlkComboBoxEvents Members
