...
{	
    ...
    [ComImport, Guid("000672EC-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface OlkContactPhotoEvents
	{
		[SupportByVersion("Outlook", 12,14,15,16)]
	...
	public class OlkContactPhotoEvents_SinkHelper : SinkHelper, OlkContactPhotoEvents
	{
		#region Static
		
		public static readonly string Id = "000672EC-0000-0000-C000-000000000046";
		...
		public OlkContactPhotoEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region OlkContactPhotoEvents Members
