...
{	
    ...
    [ComImport, Guid("000672E6-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface OlkTextBoxEvents
	{
		[SupportByVersion("Outlook", 12,14,15,16)]
	...
	public class OlkTextBoxEvents_SinkHelper : SinkHelper, OlkTextBoxEvents
	{
		#region Static
		
		public static readonly string Id = "000672E6-0000-0000-C000-000000000046";
		
		#endregion
		
		#region Ctor

		public OlkTextBoxEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region OlkTextBoxEvents Members
