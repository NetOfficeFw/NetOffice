...
{	
    ...
    [ComImport, Guid("000672FB-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class OlkDateControlEvents_SinkHelper : SinkHelper, OlkDateControlEvents
	{
		#region Static
		...
		#region OlkDateControlEvents Members
