...
{	
    ...
    [ComImport, Guid("000672E0-0000-0000-C000-000000000046"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	public interface OlkCommandButtonEvents
	{
		[SupportByVersion("Outlook", 12,14,15,16)]
	...
	public class OlkCommandButtonEvents_SinkHelper : SinkHelper, OlkCommandButtonEvents
	{
		#region Static
		
		public static readonly string Id = "000672E0-0000-0000-C000-000000000046";
		...
		public OlkCommandButtonEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region OlkCommandButtonEvents Members
