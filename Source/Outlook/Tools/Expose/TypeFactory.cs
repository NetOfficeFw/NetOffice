...
namespace NetOffice.OutlookApi.Tools.Expose
{
    /// <summary>
    /// OutlookApi Default Type Factory
    /// </summary>
    public class TypeFactory : NetOffice.Tools.Expose.Factory
    {
        private string _factoryNamespace = "NetOffice.OutlookApi";
        private Guid _componentId = new Guid("00062FFF-0000-0000-C000-000000000046");
