...
namespace NetOffice.OutlookApi.ModulesLegacy
{
    ///<summary>
    /// Module GlobalModule
	...
	public static class ApplicationModule
	{
        ...
        public static NetOffice.OutlookApi.TimeZones TimeZones
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OutlookApi.TimeZones>(_instance, "TimeZones", typeof(NetOffice.OutlookApi.TimeZones));
            }
        }
        ...
        {
            return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi.Search>(_instance, "AdvancedSearch", typeof(NetOffice.OutlookApi.Search), scope, filter, searchSubFolders, tag);
        }
        ...
        {
            return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi.Search>(_instance, "AdvancedSearch", typeof(NetOffice.OutlookApi.Search), scope);
        }
        ...
        {
            return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi.Search>(_instance, "AdvancedSearch", typeof(NetOffice.OutlookApi.Search), scope, filter);
        }
        ...
        {
            return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OutlookApi.Search>(_instance, "AdvancedSearch", typeof(NetOffice.OutlookApi.Search), scope, filter, searchSubFolders);
        }
