...
namespace NetOffice.VisioApi
{
	...
	public class IVValidationRuleSets : COMObject ,IEnumerable<NetOffice.VisioApi.IVValidationRuleSet>
	{
		...
		public IVValidationRuleSets(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVValidationRuleSets(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
