...
namespace NetOffice.VisioApi
{
	...
	[TypeId("000D0713-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.VisioApi.Layers))]
    public interface IVLayers : ICOMObject, IEnumerableProvider<NetOffice.VisioApi.IVLayer>
	{
		#region Properties
		...
		NetOffice.VisioApi.IVLayer this[object nameOrIndex] { get; }
		...
		NetOffice.VisioApi.IVLayer get_ItemU(object nameOrIndex);
		...
		NetOffice.VisioApi.IVLayer ItemU(object nameOrIndex);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[BaseResult]
		NetOffice.VisioApi.IVLayer Add(string layerName);
