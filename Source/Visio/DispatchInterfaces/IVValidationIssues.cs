...
namespace NetOffice.VisioApi
{
	...
	public class IVValidationIssues : COMObject ,IEnumerable<NetOffice.VisioApi.IVValidationIssue>
	{
		...
		public IVValidationIssues(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVValidationIssues(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
