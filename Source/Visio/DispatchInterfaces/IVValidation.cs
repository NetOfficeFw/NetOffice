...
namespace NetOffice.VisioApi
{
 	...
 	public class IVValidation : COMObject
	{
		...
		public IVValidation(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVValidation(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVValidation(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVValidation(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVValidation(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public NetOffice.VisioApi.IVValidationRuleSets RuleSets
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVValidationRuleSets>(this, "RuleSets", NetOffice.VisioApi.IVValidationRuleSets.LateBindingApiWrapperType);
			}
		}
		...
		public NetOffice.VisioApi.IVValidationIssues Issues
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVValidationIssues>(this, "Issues", NetOffice.VisioApi.IVValidationIssues.LateBindingApiWrapperType);
			}
		}
