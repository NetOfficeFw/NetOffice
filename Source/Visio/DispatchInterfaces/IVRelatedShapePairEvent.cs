...
namespace NetOffice.VisioApi
{
 	...
 	public class IVRelatedShapePairEvent : COMObject
	{
		...
		public IVRelatedShapePairEvent(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVRelatedShapePairEvent(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVRelatedShapePairEvent(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVRelatedShapePairEvent(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVRelatedShapePairEvent(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public Int32 FromShapeID
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "FromShapeID");
			}
		}
		...
		public Int32 ToShapeID
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "ToShapeID");
			}
		}
