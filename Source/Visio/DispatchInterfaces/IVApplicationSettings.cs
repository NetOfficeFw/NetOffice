...
namespace NetOffice.VisioApi
{
	...
	public class IVApplicationSettings : COMObject
	{
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVApplicationSettings(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVApplicationSettings(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		/// <param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IVApplicationSettings(COMObject replacedObject) : base(replacedObject)
		{
		}
