...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class IVDataRecordsetChangedEvent : COMObject, NetOffice.VisioApi.IVDataRecordsetChangedEvent
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.IVDataRecordsetChangedEvent);
