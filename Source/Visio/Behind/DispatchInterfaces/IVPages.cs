...
namespace NetOffice.VisioApi.Behind
{
	...
	/// </summary>
	public class IVPages : COMObject, NetOffice.VisioApi.IVPages
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.IVPages);
		...
		public virtual NetOffice.VisioApi.IVPage this[object nameOrIndex]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVPage>(this, "Item", nameOrIndex);
			}
		}
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVPage get_ItemU(object nameOrIndex)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVPage>(this, "ItemU", typeof(NetOffice.VisioApi.IVPage), nameOrIndex);
		}
		...
		public virtual NetOffice.VisioApi.IVPage ItemU(object nameOrIndex)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVPage get_ItemFromID(Int32 nID)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVPage>(this, "ItemFromID", typeof(NetOffice.VisioApi.IVPage), nID);
		}
		...
		public virtual NetOffice.VisioApi.IVPage ItemFromID(Int32 nID)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[BaseResult]
		public virtual NetOffice.VisioApi.IVPage Add()
		{
			return InvokerService.InvokeInternal.ExecuteBaseReferenceMethodGet<NetOffice.VisioApi.IVPage>(this, "Add");
		}
        ...
        #region IEnumerableProvider<NetOffice.VisioApi.IVPage>

        ICOMObject IEnumerableProvider<NetOffice.VisioApi.IVPage>.GetComObjectEnumerator(ICOMObject parent)
        {
            return NetOffice.Utils.GetComObjectEnumeratorAsProperty(parent, this, false);
        }

        IEnumerable IEnumerableProvider<NetOffice.VisioApi.IVPage>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
        ...
        /// </summary>
        [SupportByVersion("Visio", 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.VisioApi.IVPage> GetEnumerator()
        {
