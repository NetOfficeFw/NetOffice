...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class IVSection : COMObject, NetOffice.VisioApi.IVSection
	{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVRow get_Row(Int16 index)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVRow>(this, "Row", typeof(NetOffice.VisioApi.IVRow), index);
		}
		...
		public virtual NetOffice.VisioApi.IVRow Row(Int16 index)
		{
