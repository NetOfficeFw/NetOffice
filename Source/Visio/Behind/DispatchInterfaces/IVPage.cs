...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class IVPage : COMObject, NetOffice.VisioApi.IVPage
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.IVPage);
		...
		{
			return InvokerService.InvokeInternal.ExecuteInt32MethodGet(this, "AutoConnectMany", fromShapeIDs, toShapeIDs, placementDirs);
		}
