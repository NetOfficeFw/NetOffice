...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class IVMenuSet : COMObject, NetOffice.VisioApi.IVMenuSet
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.IVMenuSet);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[BaseResult]
		public virtual NetOffice.VisioApi.IVMenus Menus
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVMenus>(this, "Menus");
			}
		}
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[BaseResult]
		public virtual NetOffice.VisioApi.IVMenuSets Parent
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVMenuSets>(this, "Parent");
			}
		}
