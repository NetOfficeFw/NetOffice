...
namespace NetOffice.VisioApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class IVWindow_ : COMObject, NetOffice.VisioApi.IVWindow_
    {
        #region Ctor
    ...
    public class IVWindow : IVWindow_, NetOffice.VisioApi.IVWindow
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.IVWindow);
