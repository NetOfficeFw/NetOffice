...
namespace NetOffice.VisioApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.VisioApi.EventContracts.EDocuments"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class EDocuments_SinkHelper : SinkHelper, NetOffice.VisioApi.EventContracts.EDocuments
	{
		#region Static
		
		/// <summary>
		/// Interface Id from EDocuments
		/// </summary>
