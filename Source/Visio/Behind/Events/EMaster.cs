...
namespace NetOffice.VisioApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.VisioApi.EventContracts.EMaster"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class EMaster_SinkHelper : SinkHelper, NetOffice.VisioApi.EventContracts.EMaster
	{
		#region Static
		
		/// <summary>
		/// Interface Id from EMaster
		/// </summary>
