...
namespace NetOffice.VisioApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.VisioApi.EventContracts.EWindow"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class EWindow_SinkHelper : SinkHelper, NetOffice.VisioApi.EventContracts.EWindow
	{
		#region Static
		
		/// <summary>
		/// Interface Id from EWindow
		/// </summary>
