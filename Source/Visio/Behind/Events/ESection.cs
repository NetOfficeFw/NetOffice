...
namespace NetOffice.VisioApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.VisioApi.EventContracts.ESection"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class ESection_SinkHelper : SinkHelper, NetOffice.VisioApi.EventContracts.ESection
	{
		#region Static
		
		/// <summary>
		/// Interface Id from ESection
		/// </summary>
