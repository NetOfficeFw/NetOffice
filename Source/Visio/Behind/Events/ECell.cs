...
namespace NetOffice.VisioApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.VisioApi.EventContracts.ECell"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class ECell_SinkHelper : SinkHelper, NetOffice.VisioApi.EventContracts.ECell
	{
		#region Static
		
		/// <summary>
		/// Interface Id from ECell
		/// </summary>
