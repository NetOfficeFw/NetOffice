...
namespace NetOffice.VisioApi.Behind
{
    ...
    public class Window : IVWindow, NetOffice.VisioApi.Window
    {
        ...
        private NetOffice.VisioApi.Behind.EventContracts.EWindow_SinkHelper _eWindow_SinkHelper;
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_SelectionChangedEventHandler SelectionChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_BeforeWindowClosedEventHandler BeforeWindowClosedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_WindowActivatedEventHandler WindowActivatedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_BeforeWindowSelDeleteEventHandler BeforeWindowSelDeleteEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_BeforeWindowPageTurnEventHandler BeforeWindowPageTurnEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_WindowTurnedToPageEventHandler WindowTurnedToPageEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_WindowChangedEventHandler WindowChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_ViewChangedEventHandler ViewChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_QueryCancelWindowCloseEventHandler QueryCancelWindowCloseEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_WindowCloseCanceledEventHandler WindowCloseCanceledEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_OnKeystrokeMessageForAddonEventHandler OnKeystrokeMessageForAddonEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_MouseDownEventHandler MouseDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_MouseMoveEventHandler MouseMoveEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_MouseUpEventHandler MouseUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_KeyDownEventHandler KeyDownEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_KeyPressEventHandler KeyPressEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Window_KeyUpEventHandler KeyUpEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.VisioApi.Behind.EventContracts.EWindow_SinkHelper.Id);


			if(NetOffice.VisioApi.Behind.EventContracts.EWindow_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_eWindow_SinkHelper = new NetOffice.VisioApi.Behind.EventContracts.EWindow_SinkHelper(this, _connectPoint);
				return;
			} 
        }
