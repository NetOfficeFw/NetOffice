...
namespace NetOffice.VisioApi.Behind
{
    ...
    public class Section : IVSection, NetOffice.VisioApi.Section
    {
        ...
        private NetOffice.VisioApi.Behind.EventContracts.ESection_SinkHelper _eSection_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.Section);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Section_CellChangedEventHandler CellChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Section_FormulaChangedEventHandler FormulaChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.VisioApi.Behind.EventContracts.ESection_SinkHelper.Id);


			if(NetOffice.VisioApi.Behind.EventContracts.ESection_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_eSection_SinkHelper = new NetOffice.VisioApi.Behind.EventContracts.ESection_SinkHelper(this, _connectPoint);
				return;
			} 
        }
