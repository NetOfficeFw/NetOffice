...
namespace NetOffice.VisioApi.Behind
{
    ...
    public class Cell : IVCell, NetOffice.VisioApi.Cell
    {
        ...
        private NetOffice.VisioApi.Behind.EventContracts.ECell_SinkHelper _eCell_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.Cell);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Cell_CellChangedEventHandler CellChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Cell_FormulaChangedEventHandler FormulaChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.VisioApi.Behind.EventContracts.ECell_SinkHelper.Id);


			if (NetOffice.VisioApi.Behind.EventContracts.ECell_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_eCell_SinkHelper = new NetOffice.VisioApi.Behind.EventContracts.ECell_SinkHelper(this, _connectPoint);
				return;
			} 
        }
