...
namespace NetOffice.VisioApi.Behind
{
    ...
    public class DataRecordsets : IVDataRecordsets, NetOffice.VisioApi.DataRecordsets
    {
        ...
        private NetOffice.VisioApi.Behind.EventContracts.EDataRecordsets_SinkHelper _eDataRecordsets_SinkHelper;
		...
		[SupportByVersion("Visio", 12,14,15,16)]
		public virtual event DataRecordsets_DataRecordsetAddedEventHandler DataRecordsetAddedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 12,14,15,16)]
		public virtual event DataRecordsets_BeforeDataRecordsetDeleteEventHandler BeforeDataRecordsetDeleteEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 12,14,15,16)]
		public virtual event DataRecordsets_DataRecordsetChangedEventHandler DataRecordsetChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.VisioApi.Behind.EventContracts.EDataRecordsets_SinkHelper.Id);


			if (NetOffice.VisioApi.Behind.EventContracts.EDataRecordsets_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_eDataRecordsets_SinkHelper = new NetOffice.VisioApi.Behind.EventContracts.EDataRecordsets_SinkHelper(this, _connectPoint);
				return;
			} 
        }
