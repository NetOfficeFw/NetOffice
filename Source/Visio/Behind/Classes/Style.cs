...
namespace NetOffice.VisioApi.Behind
{
    ...
    public class Style : IVStyle, NetOffice.VisioApi.Style
    {
        ...
        private NetOffice.VisioApi.Behind.EventContracts.EStyle_SinkHelper _eStyle_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.Style);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Style_StyleChangedEventHandler StyleChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Style_BeforeStyleDeleteEventHandler BeforeStyleDeleteEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Style_QueryCancelStyleDeleteEventHandler QueryCancelStyleDeleteEvent
		{
			add
			{
				CreateEventBridge();
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Style_StyleDeleteCanceledEventHandler StyleDeleteCanceledEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.VisioApi.Behind.EventContracts.EStyle_SinkHelper.Id);


			if(NetOffice.VisioApi.Behind.EventContracts.EStyle_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_eStyle_SinkHelper = new NetOffice.VisioApi.Behind.EventContracts.EStyle_SinkHelper(this, _connectPoint);
				return;
			} 
        }
