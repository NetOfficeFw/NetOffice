...
namespace NetOffice.VisioApi.Behind
{
    ...
    public class Characters : IVCharacters, NetOffice.VisioApi.Characters
    {
        ...
        private NetOffice.VisioApi.Behind.EventContracts.ECharacters_SinkHelper _eCharacters_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.Characters);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual event Characters_TextChangedEventHandler TextChangedEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.VisioApi.Behind.EventContracts.ECharacters_SinkHelper.Id);


			if (NetOffice.VisioApi.Behind.EventContracts.ECharacters_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_eCharacters_SinkHelper = new NetOffice.VisioApi.Behind.EventContracts.ECharacters_SinkHelper(this, _connectPoint);
				return;
			} 
        }
