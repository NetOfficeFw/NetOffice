...
namespace NetOffice.VisioApi.Behind
{
	...
	/// </summary>
	public class LPVISIODATACOLUMNS : COMObject, NetOffice.VisioApi.LPVISIODATACOLUMNS
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIODATACOLUMNS);
		...
		public virtual NetOffice.VisioApi.IVDataColumn this[object indexOrName]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVDataColumn>(this, "Item", indexOrName);
			}
		}
		...
		[SupportByVersion("Visio", 12,14,15,16)]
		public virtual void SetColumnProperties(String[] columnNames, Int32[] properties, object[] values)
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "SetColumnProperties", columnNames, properties, values);
		}
        ...
        /// </summary>
        [SupportByVersion("Visio", 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.VisioApi.IVDataColumn> GetEnumerator()
        {
