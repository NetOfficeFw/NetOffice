...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPVISIOVALIDATIONRULESET : COMObject, NetOffice.VisioApi.LPVISIOVALIDATIONRULESET
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOVALIDATIONRULESET);
		...
		/// </summary>
		[SupportByVersion("Visio", 14,15,16)]
		public virtual NetOffice.VisioApi.Enums.VisRuleSetFlags RuleSetFlags
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.VisioApi.Enums.VisRuleSetFlags>(this, "RuleSetFlags");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "RuleSetFlags", value);
			}
		}
		...
		[SupportByVersion("Visio", 14,15,16)]
		[BaseResult]
		public virtual NetOffice.VisioApi.IVValidationRules Rules
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVValidationRules>(this, "Rules");
			}
		}
