...
namespace NetOffice.VisioApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class LPVISIODOCUMENT_ : COMObject, NetOffice.VisioApi.LPVISIODOCUMENT_
    {
        #region Ctor
    ...
    public class LPVISIODOCUMENT : LPVISIODOCUMENT_, NetOffice.VisioApi.LPVISIODOCUMENT
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIODOCUMENT);
