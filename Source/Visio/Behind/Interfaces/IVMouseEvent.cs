...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class IVMouseEvent : COMObject, NetOffice.VisioApi.IVMouseEvent
	{
		...
		public virtual Double x
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteDoublePropertyGet(this, "x");
			}
		}
		...
		public virtual Double y
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteDoublePropertyGet(this, "y");
			}
		}
		...
		/// </summary>
		[SupportByVersion("Visio", 12,14,15,16)]
		public virtual NetOffice.VisioApi.Enums.VisMouseMoveDragStates DragState
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.VisioApi.Enums.VisMouseMoveDragStates>(this, "DragState");
			}
		}
