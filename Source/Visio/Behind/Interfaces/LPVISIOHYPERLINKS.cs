...
namespace NetOffice.VisioApi.Behind
{
	...
	/// </summary>
	public class LPVISIOHYPERLINKS : COMObject, NetOffice.VisioApi.LPVISIOHYPERLINKS
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOHYPERLINKS);
		...
		public virtual NetOffice.VisioApi.IVHyperlink this[object nameOrIndex]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVHyperlink>(this, "Item", nameOrIndex);
			}
		}
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVHyperlink get_ItemU(object nameOrIndex)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVHyperlink>(this, "ItemU", typeof(NetOffice.VisioApi.IVHyperlink), nameOrIndex);
		}
		...
		public virtual NetOffice.VisioApi.IVHyperlink ItemU(object nameOrIndex)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[BaseResult]
		public virtual NetOffice.VisioApi.IVHyperlink Add()
		{
			return InvokerService.InvokeInternal.ExecuteBaseReferenceMethodGet<NetOffice.VisioApi.IVHyperlink>(this, "Add");
		}
        ...
        /// </summary>
        [SupportByVersion("Visio", 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.VisioApi.IVHyperlink> GetEnumerator()
        {
