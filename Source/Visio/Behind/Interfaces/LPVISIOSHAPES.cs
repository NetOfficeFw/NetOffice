...
namespace NetOffice.VisioApi.Behind
{
	...
	/// </summary>
	public class LPVISIOSHAPES : COMObject, NetOffice.VisioApi.LPVISIOSHAPES
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOSHAPES);
		...
		public virtual NetOffice.VisioApi.IVShape this[object nameUIDOrIndex]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "Item", nameUIDOrIndex);
			}
		}
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVShape get_ItemFromID16(Int16 objectID)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemFromID16", typeof(NetOffice.VisioApi.IVShape), objectID);
		}
		...
		public virtual NetOffice.VisioApi.IVShape ItemFromID16(Int16 objectID)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVShape get_ItemFromID(Int32 objectID)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemFromID", typeof(NetOffice.VisioApi.IVShape), objectID);
		}
		...
		public virtual NetOffice.VisioApi.IVShape ItemFromID(Int32 objectID)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVShape get_ItemU(object nameUIDOrIndex)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemU", typeof(NetOffice.VisioApi.IVShape), nameUIDOrIndex);
		}
		...
		public virtual NetOffice.VisioApi.IVShape ItemU(object nameUIDOrIndex)
		{
		...
		[SupportByVersion("Visio", 14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVShape get_ItemFromUniqueID(string uniqueID)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemFromUniqueID", typeof(NetOffice.VisioApi.IVShape), uniqueID);
		}
		...
		public virtual NetOffice.VisioApi.IVShape ItemFromUniqueID(string uniqueID)
		{
