...
namespace NetOffice.VisioApi.Behind
{
	...
	/// </summary>
	public class LPVISIOCOLORS : COMObject, NetOffice.VisioApi.LPVISIOCOLORS
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOCOLORS);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual NetOffice.VisioApi.IVColor get_Item16(Int16 index)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVColor>(this, "Item16", typeof(NetOffice.VisioApi.IVColor), index);
		}
		...
		public virtual NetOffice.VisioApi.IVColor Item16(Int16 index)
		{
		...
		public virtual NetOffice.VisioApi.IVColor this[Int32 index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVColor>(this, "Item", index);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("Visio", 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.VisioApi.IVColor> GetEnumerator()
        {
