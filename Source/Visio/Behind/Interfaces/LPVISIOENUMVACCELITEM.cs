...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPVISIOENUMVACCELITEM : COMObject, NetOffice.VisioApi.LPVISIOENUMVACCELITEM
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOENUMVACCELITEM);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual Int32 Next(Int32 celt, out NetOffice.VisioApi.IVAccelItem rgelt, out Int32 pceltFetched)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual Int32 Clone(out NetOffice.VisioApi.IEnumVAccelItem ppenm)
		{
