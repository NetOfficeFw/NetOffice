...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPVISIOENUMVSTATUSBAR : COMObject, NetOffice.VisioApi.LPVISIOENUMVSTATUSBAR
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOENUMVSTATUSBAR);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual Int32 Next(Int32 celt, out NetOffice.VisioApi.IVStatusBar rgelt, out Int32 pceltFetched)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual Int32 Clone(out NetOffice.VisioApi.IEnumVStatusBar ppenm)
		{
