...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPVISIOENUMVSTATUSBARITEM : COMObject, NetOffice.VisioApi.LPVISIOENUMVSTATUSBARITEM
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOENUMVSTATUSBARITEM);
