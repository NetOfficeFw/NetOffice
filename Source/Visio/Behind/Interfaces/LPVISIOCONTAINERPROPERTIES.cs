...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPVISIOCONTAINERPROPERTIES : COMObject, NetOffice.VisioApi.LPVISIOCONTAINERPROPERTIES
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOCONTAINERPROPERTIES);
