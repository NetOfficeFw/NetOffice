...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPSERVERPUBLISHOPTIONS : COMObject, NetOffice.VisioApi.LPSERVERPUBLISHOPTIONS
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPSERVERPUBLISHOPTIONS);
		...
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "SetPagesToPublish", publishPages, namesArray, flags);
		}
		...
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "SetRecordsetsToPublish", publishDataRecordsets, dataRecordsetIDs);
		}
