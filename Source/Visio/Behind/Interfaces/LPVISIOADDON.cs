...
namespace NetOffice.VisioApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPVISIOADDON : COMObject, NetOffice.VisioApi.LPVISIOADDON
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.VisioApi.LPVISIOADDON);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		public virtual void Run(string argString)
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "Run", argString);
		}
