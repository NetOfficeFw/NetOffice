...
{	
	...
	public class EWindows_SinkHelper : SinkHelper, EWindows
	{
		#region Static
		...
		public EWindows_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
