...
{	
	...
	public class EApplication_SinkHelper : SinkHelper, EApplication
	{
		...
		public void AppActivated([In, MarshalAs(UnmanagedType.IDispatch)] object app)
		{
			...
			NetOffice.VisioApi.IVApplication newapp = Factory.CreateKnownObjectFromComProxy<NetOffice.VisioApi.IVApplication>(EventClass, app, NetOffice.VisioApi.IVApplication.LateBindingApiWrapperType);
