...
namespace NetOffice.VisioApi
{
 	...
 	public class LPVISIOTOOLBARITEM : COMObject
	{
		...
		public NetOffice.VisioApi.IVToolbarItems Parent
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVToolbarItems>(this, "Parent", NetOffice.VisioApi.IVToolbarItems.LateBindingApiWrapperType);
			}
		}
