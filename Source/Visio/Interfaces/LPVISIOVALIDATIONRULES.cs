...
namespace NetOffice.VisioApi
{
	...
	public class LPVISIOVALIDATIONRULES : COMObject ,IEnumerable<NetOffice.VisioApi.IVValidationRule>
	{
		...
		public LPVISIOVALIDATIONRULES(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOVALIDATIONRULES(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
