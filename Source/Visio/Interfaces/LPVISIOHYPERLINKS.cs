...
namespace NetOffice.VisioApi
{
	...
	public class LPVISIOHYPERLINKS : COMObject ,IEnumerable<NetOffice.VisioApi.IVHyperlink>
	{
		...
		public LPVISIOHYPERLINKS(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOHYPERLINKS(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
