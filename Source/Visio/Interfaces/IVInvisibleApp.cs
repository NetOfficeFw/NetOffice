...
namespace NetOffice.VisioApi
{
	...
	[TypeId("000D072C-0000-0000-C000-000000000046")]
    [CoClassSource(typeof(NetOffice.VisioApi.InvisibleApp))]
    public interface IVInvisibleApp : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		Int32 SetCustomMenus(NetOffice.VisioApi.IVUIObject menusObject);

		/// <summary>
		/// SupportByVersion Visio 11, 12, 14, 15, 16
		/// </summary>
		[SupportByVersion("Visio", 11,12,14,15,16)]
		Int32 ClearCustomMenus();
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		[SupportByVersion("Visio", 11,12,14,15,16)]
		Int32 SaveWorkspaceAs(string fileName);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		Int32 AddUndoUnit(object pUndoUnit);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		Int32 RenameCurrentScope(string bstrScopeName);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		Int32 InvokeHelp(string bstrHelpFileName, Int32 command, Int32 data);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		Int32 OnComponentEnterState(NetOffice.VisioApi.Enums.VisOnComponentEnterCodes uStateID, bool bEnter);
		...
		[SupportByVersion("Visio", 14,15,16)]
		Int32 RegisterRibbonX(object sourceAddOn, NetOffice.VisioApi.IVDocument targetDocument, NetOffice.VisioApi.Enums.VisRibbonXModes targetModes, string friendlyName);
		...
		/// <param name="targetDocument">NetOffice.VisioApi.IVDocument targetDocument</param>
		[SupportByVersion("Visio", 14,15,16)]
		Int32 UnregisterRibbonX(object sourceAddOn, NetOffice.VisioApi.IVDocument targetDocument);
		...
		[SupportByVersion("Visio", 14,15,16)]
		Int32 SetPreviewEnabled(string galleryName, bool onOrOff);
