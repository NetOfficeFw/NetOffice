...
namespace NetOffice.VisioApi
{
	...
	public class LPVISIODATACOLUMNS : COMObject ,IEnumerable<NetOffice.VisioApi.IVDataColumn>
	{
		...
		public LPVISIODATACOLUMNS(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIODATACOLUMNS(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
