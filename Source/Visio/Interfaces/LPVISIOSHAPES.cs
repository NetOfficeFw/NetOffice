...
namespace NetOffice.VisioApi
{
	...
	public class LPVISIOSHAPES : COMObject , IEnumerable<NetOffice.VisioApi.IVShape>
	{
		...
		public LPVISIOSHAPES(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public LPVISIOSHAPES(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOSHAPES(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOSHAPES(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOSHAPES(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOSHAPES(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOSHAPES(string progId) : base(progId)
		{
		}
		...
		public NetOffice.VisioApi.IVShape this[object nameUIDOrIndex]
		{
			get
			{
				return Factory.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "Item", nameUIDOrIndex);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemFromID16", NetOffice.VisioApi.IVShape.LateBindingApiWrapperType, objectID);
		}
		...
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemFromID", NetOffice.VisioApi.IVShape.LateBindingApiWrapperType, objectID);
		}
		...
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemU", NetOffice.VisioApi.IVShape.LateBindingApiWrapperType, nameUIDOrIndex);
		}
		...
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVShape>(this, "ItemFromUniqueID", NetOffice.VisioApi.IVShape.LateBindingApiWrapperType, uniqueID);
		}
