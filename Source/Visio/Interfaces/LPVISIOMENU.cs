...
namespace NetOffice.VisioApi
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class LPVISIOMENU : COMObject
	{
		...
		public LPVISIOMENU(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMENU(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMENU(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMENU(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMENU(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMENU() : base()
		{
		}
		
		/// <param name="progId">registered progID</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMENU(string progId) : base(progId)
		{
		}
		...
		public Int16 MDIWindowMenu
		{
			get
			{
				return Factory.ExecuteInt16PropertyGet(this, "MDIWindowMenu");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "MDIWindowMenu", value);
			}
		}
		...
		public NetOffice.VisioApi.IVMenuItems MenuItems
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVMenuItems>(this, "MenuItems", NetOffice.VisioApi.IVMenuItems.LateBindingApiWrapperType);
			}
		}
		...
		public NetOffice.VisioApi.IVMenus Parent
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVMenus>(this, "Parent", NetOffice.VisioApi.IVMenus.LateBindingApiWrapperType);
			}
		}
