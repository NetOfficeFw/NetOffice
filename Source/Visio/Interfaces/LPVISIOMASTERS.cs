...
namespace NetOffice.VisioApi
{
	...
	public class LPVISIOMASTERS : COMObject, IEnumerableProvider<NetOffice.VisioApi.IVMaster>
	{
		...
		public LPVISIOMASTERS(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public LPVISIOMASTERS(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMASTERS(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMASTERS(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMASTERS(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMASTERS(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMASTERS() : base()
		{
		}
		
		/// <param name="progId">registered progID</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOMASTERS(string progId) : base(progId)
		{
		}
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public NetOffice.VisioApi.IVMaster get_ItemU(object nameUIDOrIndex)
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVMaster>(this, "ItemU", NetOffice.VisioApi.IVMaster.LateBindingApiWrapperType, nameUIDOrIndex);
		}
		...
		public NetOffice.VisioApi.IVMaster ItemU(object nameUIDOrIndex)
		{
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public NetOffice.VisioApi.IVMaster get_ItemFromID(Int32 nID)
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVMaster>(this, "ItemFromID", NetOffice.VisioApi.IVMaster.LateBindingApiWrapperType, nID);
		}
		...
		public NetOffice.VisioApi.IVMaster ItemFromID(Int32 nID)
		{
        ...
        #region IEnumerableProvider<NetOffice.VisioApi.IVMaster>

        ICOMObject IEnumerableProvider<NetOffice.VisioApi.IVMaster>.GetComObjectEnumerator(ICOMObject parent)
        {
            return NetOffice.Utils.GetComObjectEnumeratorAsProperty(parent, this, false);
        }

        IEnumerable IEnumerableProvider<NetOffice.VisioApi.IVMaster>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
