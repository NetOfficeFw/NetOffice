...
namespace NetOffice.VisioApi
{
	...
	public interface LPVISIOHYPERLINK : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		void AddToFavorites(object favoritesTitle);
		...
		[SupportByVersion("Visio", 11,12,14,15,16)]
		string CreateURL(Int16 canonicalForm);
