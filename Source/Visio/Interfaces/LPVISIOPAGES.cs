...
namespace NetOffice.VisioApi
{
	...
	public class LPVISIOPAGES : COMObject , IEnumerable<NetOffice.VisioApi.IVPage>
	{
		...
		public LPVISIOPAGES(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public LPVISIOPAGES(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOPAGES(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOPAGES(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOPAGES(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LPVISIOPAGES(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public NetOffice.VisioApi.IVPage this[object nameOrIndex]
		{
			get
			{
				return Factory.ExecuteBaseReferencePropertyGet<NetOffice.VisioApi.IVPage>(this, "Item", nameOrIndex);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVPage>(this, "ItemU", NetOffice.VisioApi.IVPage.LateBindingApiWrapperType, nameOrIndex);
		}
		...
		{
			return Factory.ExecuteKnownReferencePropertyGet<NetOffice.VisioApi.IVPage>(this, "ItemFromID", NetOffice.VisioApi.IVPage.LateBindingApiWrapperType, nID);
		}
		...
		{
			return Factory.ExecuteBaseReferenceMethodGet<NetOffice.VisioApi.IVPage>(this, "Add");
		}
