...
namespace NetOffice.VisioApi
{
	...
	public class LPVISIOTOOLBARS : COMObject, IEnumerableProvider<NetOffice.VisioApi.IVToolbar>
	{
		...
		public LPVISIOTOOLBARS(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
