...
namespace NetOffice.VisioApi
{
 	...
 	public class LPVISIOWINDOW_ : COMObject
	{
		...
		public LPVISIOWINDOW_(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
 	...
 	public class LPVISIOWINDOW : COMObject
	{
		...
		/// <param name="parentObject">object there has created the proxy</param>
		/// <param name="proxyShare">proxy share instead if com proxy</param>
		public LPVISIOWINDOW(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
