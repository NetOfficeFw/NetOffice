...
namespace NetOffice.VisioApi
{
	...
	public class AccelTable : IVAccelTable
	{
		...
		public AccelTable(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public AccelTable(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public AccelTable(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public AccelTable(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public AccelTable(ICOMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// Returns a running Visio.AccelTable object from the environment/system.
        /// </summary>
        /// <returns>an Visio.AccelTable object or null</returns>
		public static NetOffice.VisioApi.AccelTable GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","AccelTable", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","AccelTable", throwOnError);
			if(null != proxy)
				return new NetOffice.VisioApi.AccelTable(null, proxy);
			else
				return null;
