...
namespace NetOffice.VisioApi
{
	...
	/// MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/ff769385(v=office.14).aspx
	///</summary>
	...
	public class Selection : IVSelection
	{
		...
		/// <summary>
        /// Returns all running Visio.Selection objects from the environment/system
        /// </summary>
        /// <returns>an Visio.Selection array</returns>
		public static NetOffice.VisioApi.Selection[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("Visio","Selection");
		...
		/// <summary>
        /// Returns a running Visio.Selection object from the environment/system.
        /// </summary>
        /// <returns>an Visio.Selection object or null</returns>
		public static NetOffice.VisioApi.Selection GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","Selection", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","Selection", throwOnError);
			if(null != proxy)
				return new NetOffice.VisioApi.Selection(null, proxy);
			else
				return null;
