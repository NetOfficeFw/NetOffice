...
namespace NetOffice.VisioApi
{
	...
	/// MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/ff769395(v=office.14).aspx
	///</summary>
	...
	public class Shapes : IVShapes
	{
        ...
        ///</summary>		
		public Shapes():base("Visio.Shapes")
		{
		...
		/// <summary>
        /// Returns all running Visio.Shapes objects from the environment/system
        /// </summary>
        /// <returns>an Visio.Shapes array</returns>
		public static NetOffice.VisioApi.Shapes[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("Visio","Shapes");
		...
		/// <summary>
        /// Returns a running Visio.Shapes object from the environment/system.
        /// </summary>
        /// <returns>an Visio.Shapes object or null</returns>
		public static NetOffice.VisioApi.Shapes GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","Shapes", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","Shapes", throwOnError);
			if(null != proxy)
				return new NetOffice.VisioApi.Shapes(null, proxy);
			else
				return null;
