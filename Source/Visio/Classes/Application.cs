...
namespace NetOffice.VisioApi
{
    ...
    public class Application : IVApplication, ICloneable<Application>, IEventBinding, IAutomaticQuit
	{
		#pragma warning disable
        ...
        {
            return Running.ProxyService.GetActiveInstances<Application>("Visio", "Application");
        }
        ...
        {
            return Running.ProxyService.GetActiveInstances<Application>("Visio", "Application", predicate);
        }
        ...
        {
            var sequence = Running.ProxyService.GetActiveInstances<Application>("Visio", "Application");
        ...
        {
            var sequence = Running.ProxyService.GetActiveInstances<Application>("Visio", "Application", predicate);
            int result = sequence.Count;
            sequence.Dispose();
            return result;
        }
        ...
        {
            return Running.ProxyService.GetActiveInstance<Application>("Visio", "Application", throwExceptionIfNotFound);
        }
        ...
        {
            return Running.ProxyService.GetActiveInstance<Application>("Visio", "Application", predicate, throwExceptionIfNotFound);
        }
