...
namespace NetOffice.VisioApi
{
	...
	/// MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/ff769341(v=office.14).aspx
	///</summary>
	...
	public class MenuItems : IVMenuItems
	{
		...
		public MenuItems(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public MenuItems(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		///<summary>
        /// Creates a new instance of MenuItems 
        ///</summary>		
		public MenuItems():base("Visio.MenuItems")
		{
		...
		/// <summary>
        /// Returns all running Visio.MenuItems objects from the environment/system
        /// </summary>
        /// <returns>an Visio.MenuItems array</returns>
		public static NetOffice.VisioApi.MenuItems[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("Visio","MenuItems");
		...
		/// <summary>
        /// Returns a running Visio.MenuItems object from the environment/system.
        /// </summary>
        /// <returns>an Visio.MenuItems object or null</returns>
		public static NetOffice.VisioApi.MenuItems GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","MenuItems", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Visio","MenuItems", throwOnError);
			if(null != proxy)
				return new NetOffice.VisioApi.MenuItems(null, proxy);
			else
				return null;
