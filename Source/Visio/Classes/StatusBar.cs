...
namespace NetOffice.VisioApi
{
	...
	public class StatusBar : IVStatusBar
	{
		...
		/// <summary>
        /// returns all running Visio.StatusBar objects from the running object table(ROT)
        /// </summary>
        /// <returns>an Visio.StatusBar array</returns>
		public static NetOffice.VisioApi.StatusBar[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("Visio","StatusBar");
		...
		/// <summary>
        /// returns a running Visio.StatusBar object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an Visio.StatusBar object or null</returns>
		public static NetOffice.VisioApi.StatusBar GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Visio","StatusBar", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("Visio","StatusBar", throwOnError);
			if(null != proxy)
				return new NetOffice.VisioApi.StatusBar(null, proxy);
			else
				return null;
