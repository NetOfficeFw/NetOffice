...
namespace NetOffice.MSComctlLibApi
{
	...
	[TypeId("8E3867A1-8586-11D1-B16A-00C0F0283628")]
    [CoClassSource(typeof(NetOffice.MSComctlLibApi.StatusBar))]
    public interface IStatusBar : ICOMObject
	{
		#region Properties
		...
		/// </summary>
		[SupportByVersion("MSComctlLib", 6)]
		NetOffice.MSComctlLibApi.Enums.SbarStyleConstants Style { get; set; }
		...
		[SupportByVersion("MSComctlLib", 6)]
		[BaseResult]
		NetOffice.MSComctlLibApi.IPanels Panels { get; set; }
		...
		string PanelProperties { get; set; }
