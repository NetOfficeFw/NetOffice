	...
	public class IToolbar : COMObject
	{
		...
		public NetOffice.MSComctlLibApi.IButtons Buttons
		{
			get
			{
				...
				NetOffice.MSComctlLibApi.IButtons newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.MSComctlLibApi.IButtons;
				return newObject;
			}
			set
			{
		...
		public NetOffice.MSComctlLibApi.IControls Controls
		{
			get
			{
				...
				NetOffice.MSComctlLibApi.IControls newObject = NetOffice.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.MSComctlLibApi.IControls;
				return newObject;
			}
		}
