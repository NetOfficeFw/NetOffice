...
namespace NetOffice.MSComctlLibApi
{
	...
	public class Nodes : INodes
	{
		...
		public Nodes(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public Nodes(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public Nodes(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public Nodes(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public Nodes(ICOMObject replacedObject) : base(replacedObject)
		{
        ...
        ///</summary>		
		public Nodes():base("MSComctlLib.Nodes")
		{
		...
		public Nodes(string progId):base(progId)
		{
		...
		/// <summary>
        /// Returns a running MSComctlLib.Nodes object from the environment/system.
        /// </summary>
        /// <returns>an MSComctlLib.Nodes object or null</returns>
		public static NetOffice.MSComctlLibApi.Nodes GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSComctlLib","Nodes", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSComctlLib","Nodes", throwOnError);
			if(null != proxy)
				return new NetOffice.MSComctlLibApi.Nodes(null, proxy);
			else
				return null;
