...
namespace NetOffice.MSComctlLibApi
{
	...
	public class ComboItem : IComboItem
	{
		...
		public ComboItem(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ComboItem(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// Returns all running MSComctlLib.ComboItem objects from the environment/system
        /// </summary>
        /// <returns>an MSComctlLib.ComboItem array</returns>
		public static NetOffice.MSComctlLibApi.ComboItem[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSComctlLib","ComboItem");
		...
		/// <summary>
        /// Returns a running MSComctlLib.ComboItem object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSComctlLib","ComboItem", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSComctlLib","ComboItem", throwOnError);
			if(null != proxy)
				return new NetOffice.MSComctlLibApi.ComboItem(null, proxy);
			else
				return null;
