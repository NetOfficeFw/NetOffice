...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.MSComctlLibApi.EventContracts.ITreeViewEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
    public class ITreeViewEvents_SinkHelper : SinkHelper, NetOffice.MSComctlLibApi.EventContracts.ITreeViewEvents
    {
        #region Static

        /// <summary>
        /// Interface Id from ITreeViewEvents
        /// </summary>
        ...
        public void Collapse([In, MarshalAs(UnmanagedType.IDispatch)] object node)
        {
            ...
            NetOffice.MSComctlLibApi.Node newNode = Factory.CreateKnownObjectFromComProxy<NetOffice.MSComctlLibApi.Node>(EventClass, node, typeof(NetOffice.MSComctlLibApi.Node));
            object[] paramsArray = new object[1];
