...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.MSComctlLibApi.EventContracts.ISliderEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
    public class ISliderEvents_SinkHelper : SinkHelper, NetOffice.MSComctlLibApi.EventContracts.ISliderEvents
    {
        #region Static

        /// <summary>
        /// Interface Id from ISliderEvents
        /// </summary>
