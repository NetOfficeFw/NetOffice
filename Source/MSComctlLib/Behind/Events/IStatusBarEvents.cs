...
{
    /// <summary>
    /// Default implementation of <see cref="NetOffice.MSComctlLibApi.EventContracts.IStatusBarEvents"/>
    /// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
    public class IStatusBarEvents_SinkHelper : SinkHelper, NetOffice.MSComctlLibApi.EventContracts.IStatusBarEvents
    {
        #region Static

        /// <summary>
        /// Interface Id from IStatusBarEvents
        /// </summary>
