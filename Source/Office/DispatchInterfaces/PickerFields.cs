...
{			
			...
			NetOffice.OfficeApi.PickerField newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OfficeApi.PickerField.LateBindingApiWrapperType) as NetOffice.OfficeApi.PickerField;
			return newObject;
			}
		}
