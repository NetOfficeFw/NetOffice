...
namespace NetOffice.OfficeApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff862500.aspx </remarks>
	...
	public class PickerFields : _IMsoDispObj ,IEnumerable<NetOffice.OfficeApi.PickerField>
	{
		...
		public PickerFields(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public PickerFields(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
...
{			
		...
		/// Get
		/// </summary>
		///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff862793.aspx </remarks>
		[SupportByVersionAttribute("Office", 14,15)]
		public Int32 Count
		{
			get
