...
namespace NetOffice.OfficeApi
{
	...
	[TypeId("000C0313-0000-0000-C000-000000000046")]
    public interface ConnectorFormat : _IMsoDispObj
    {
        ...
        /// </summary>
        [SupportByVersion("Office", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.OfficeApi.Shape BeginConnectedShape { get; }
        ...
        /// </summary>
        [SupportByVersion("Office", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.OfficeApi.Shape EndConnectedShape { get; }
        ...
        [SupportByVersion("Office", 9, 10, 11, 12, 14, 15, 16)]
        void BeginConnect(NetOffice.OfficeApi.Shape connectedShape, Int32 connectionSite);
        ...
        /// <param name="connectionSite">Int32 connectionSite</param>
        [SupportByVersion("Office", 9, 10, 11, 12, 14, 15, 16)]
        void EndConnect(NetOffice.OfficeApi.Shape connectedShape, Int32 connectionSite);
