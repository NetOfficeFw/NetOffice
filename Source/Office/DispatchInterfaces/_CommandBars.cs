...
namespace NetOffice.OfficeApi
{
	...
	public class _CommandBars : _IMsoDispObj , IEnumerable<NetOffice.OfficeApi.CommandBar>
	{
		...
		public NetOffice.OfficeApi.CommandBarControl ActionControl
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OfficeApi.CommandBarControl>(this, "ActionControl", NetOffice.OfficeApi.CommandBarControl.LateBindingApiWrapperType);
			}
		}
