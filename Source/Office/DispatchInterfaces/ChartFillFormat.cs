	...
	public class ChartFillFormat : COMObject
	{
		...
		public NetOffice.OfficeApi.ChartColorFormat BackColor
		{
			get
			{
				...
				NetOffice.OfficeApi.ChartColorFormat newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OfficeApi.ChartColorFormat.LateBindingApiWrapperType) as NetOffice.OfficeApi.ChartColorFormat;
				return newObject;
			}
		}
