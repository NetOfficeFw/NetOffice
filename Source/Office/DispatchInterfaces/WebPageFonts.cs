...
namespace NetOffice.OfficeApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff864178.aspx </remarks>
	...
	public class WebPageFonts : _IMsoDispObj ,IEnumerable<NetOffice.OfficeApi.WebPageFont>
	{
		...
		public WebPageFonts(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public WebPageFonts(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// Get
		/// </summary>
		///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff862200.aspx </remarks>
		[SupportByVersionAttribute("Office", 9,10,11,12,14,15)]
		public Int32 Count
		{
			get
