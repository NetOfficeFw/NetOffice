...
namespace NetOffice.OfficeApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff862726.aspx </remarks>
	...
	public class CustomXMLNodes : _IMsoDispObj ,IEnumerable<NetOffice.OfficeApi.CustomXMLNode>
	{
		...
		public CustomXMLNodes(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public CustomXMLNodes(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// Unknown COM Proxy
		/// </summary>
		///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff865501.aspx </remarks>
		[SupportByVersionAttribute("Office", 12,14,15)]
		...
		/// Get
		/// </summary>
		///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff861782.aspx </remarks>
		[SupportByVersionAttribute("Office", 12,14,15)]
		public Int32 Count
		{
			get
