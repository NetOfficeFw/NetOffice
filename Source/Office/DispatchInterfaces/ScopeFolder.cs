...
namespace NetOffice.OfficeApi
{
 	...
 	public class ScopeFolder : _IMsoDispObj
	{
		...
		public ScopeFolder(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ScopeFolder(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.OfficeApi.ScopeFolders ScopeFolders
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OfficeApi.ScopeFolders>(this, "ScopeFolders", NetOffice.OfficeApi.ScopeFolders.LateBindingApiWrapperType);
			}
		}
