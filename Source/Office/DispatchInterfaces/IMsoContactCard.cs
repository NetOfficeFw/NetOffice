...
namespace NetOffice.OfficeApi
{
 	...
 	public class IMsoContactCard : _IMsoDispObj
	{
		...
		public IMsoContactCard(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public NetOffice.OfficeApi.Enums.MsoContactCardAddressType AddressType
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoContactCardAddressType>(this, "AddressType");
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoContactCardType CardType
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoContactCardType>(this, "CardType");
			}
		}
