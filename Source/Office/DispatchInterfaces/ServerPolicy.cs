...
{			
			...
			NetOffice.OfficeApi.PolicyItem newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OfficeApi.PolicyItem.LateBindingApiWrapperType) as NetOffice.OfficeApi.PolicyItem;
			return newObject;
			}
		}
