...
namespace NetOffice.OfficeApi
{
	...
	public class IMsoTickLabels : COMObject
	{
		...
		public IMsoTickLabels(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IMsoTickLabels(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.OfficeApi.Enums.XlTickLabelOrientation Orientation
		{
			get
			{
				...
				return (NetOffice.OfficeApi.Enums.XlTickLabelOrientation)intReturnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
