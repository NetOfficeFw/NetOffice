...
namespace NetOffice.OfficeApi.Tools
{
    ...
    public interface ITaskPane
    {
        ...
        void OnConnection(ICOMObject application, NetOffice.OfficeApi._CustomTaskPane parentPane, object[] customArguments);
        ...
        /// <summary>
        /// Called after any visibility changes because the UserControl.VisibleChanged event doesnt works as expected in a task pane scenario
        /// </summary>
