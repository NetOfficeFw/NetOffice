...
{
    /// <summary>
    /// Represents a tray menu label item
    /// </summary>
    [ItemType(TrayMenuItemType.Label)]
    public class TrayMenuLabelItem : TrayMenuItem
    {
        #region Ctor
        ...
        internal TrayMenuLabelItem(TrayMenu owner, string text) : base(owner, text)
        {
            ItemType = TrayMenuItemType.Label;
        }
        ...
        internal TrayMenuLabelItem(TrayMenu owner, string text, bool visible) : base(owner, text, visible)
        {
            ItemType = TrayMenuItemType.Label;
        }
