...
namespace NetOffice.OfficeApi
{
	...
	public class IMsoErrorBars : COMObject
	{
		...
		public IMsoErrorBars(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IMsoErrorBars(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.OfficeApi.Enums.XlEndStyleCap EndStyle
		{
			get
			{
				...
				return (NetOffice.OfficeApi.Enums.XlEndStyleCap)intReturnItem;
			}
			set
			{
