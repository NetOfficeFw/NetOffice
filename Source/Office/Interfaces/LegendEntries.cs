...
namespace NetOffice.OfficeApi
{
	...
	public class LegendEntries : COMObject, IEnumerableProvider<NetOffice.OfficeApi.LegendEntry>
	{
		...
		public NetOffice.OfficeApi.LegendEntry this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OfficeApi.LegendEntry>(this, "_Default", NetOffice.OfficeApi.LegendEntry.LateBindingApiWrapperType, index);
			}
		}
        ...
        #region IEnumerableProvider<NetOffice.OfficeApi.LegendEntry>

        ICOMObject IEnumerableProvider<NetOffice.OfficeApi.LegendEntry>.GetComObjectEnumerator(ICOMObject parent)
        {
            return NetOffice.Utils.GetComObjectEnumeratorAsMethod(parent, this);
        }

        IEnumerable IEnumerableProvider<NetOffice.OfficeApi.LegendEntry>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
