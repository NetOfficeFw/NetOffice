...
{			
			...
			NetOffice.OfficeApi.ChartPoint newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OfficeApi.ChartPoint.LateBindingApiWrapperType) as NetOffice.OfficeApi.ChartPoint;
			return newObject;
			}
		}
