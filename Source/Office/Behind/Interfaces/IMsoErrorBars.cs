...
namespace NetOffice.OfficeApi.Behind
{
    ...
    public class IMsoErrorBars : COMObject, NetOffice.OfficeApi.IMsoErrorBars
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OfficeApi.IMsoErrorBars);
        ...
        /// </summary>
        [SupportByVersion("Office", 12, 14, 15, 16)]
        public virtual NetOffice.OfficeApi.Enums.XlEndStyleCap EndStyle
        {
            get
            {
                return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.XlEndStyleCap>(this, "EndStyle");
            }
            set
            {
