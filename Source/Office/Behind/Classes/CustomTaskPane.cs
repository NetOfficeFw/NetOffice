...
namespace NetOffice.OfficeApi.Behind
{
    ...
    public class CustomTaskPane : NetOffice.OfficeApi.Behind._CustomTaskPane, NetOffice.OfficeApi.CustomTaskPane
    {
        ...
        private NetOffice.OfficeApi.Behind.EventContracts._CustomTaskPaneEvents_SinkHelper __CustomTaskPaneEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OfficeApi.CustomTaskPane);
        ...
        public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
                _activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OfficeApi.Behind.EventContracts._CustomTaskPaneEvents_SinkHelper.Id);


            if (NetOffice.OfficeApi.Behind.EventContracts._CustomTaskPaneEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
            {
                __CustomTaskPaneEvents_SinkHelper = new NetOffice.OfficeApi.Behind.EventContracts._CustomTaskPaneEvents_SinkHelper(this, _connectPoint);
                return;
            }
        }
