...
namespace NetOffice.OfficeApi.Behind
{
    ...
    [ComEventInterface(typeof(NetOffice.OfficeApi.EventInterfaces._CustomTaskPaneEvents))]
    internal class CustomTaskPane : NetOffice.OfficeApi.Behind._CustomTaskPane, NetOffice.OfficeApi.CustomTaskPane
    {
        ...
        private NetOffice.OfficeApi.Behind.EventInterfaces._CustomTaskPaneEvents_SinkHelper __CustomTaskPaneEvents_SinkHelper;
        ...
        public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
                _activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OfficeApi.Behind.EventInterfaces._CustomTaskPaneEvents_SinkHelper.Id);


            if (NetOffice.OfficeApi.Behind.EventInterfaces._CustomTaskPaneEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
            {
                __CustomTaskPaneEvents_SinkHelper = new NetOffice.OfficeApi.Behind.EventInterfaces._CustomTaskPaneEvents_SinkHelper(this, _connectPoint);
                return;
            }
        }
