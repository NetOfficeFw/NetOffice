...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class CommandBars : NetOffice.OfficeApi.Behind._CommandBars, NetOffice.OfficeApi.CommandBars
    {
        ...
        private NetOffice.OfficeApi.Behind.EventInterfaces._CommandBarsEvents_SinkHelper __CommandBarsEvents_SinkHelper;
        ...
        public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
                _activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.OfficeApi.Behind.EventInterfaces._CommandBarsEvents_SinkHelper.Id);


            if (NetOffice.OfficeApi.Behind.EventInterfaces._CommandBarsEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
            {
                __CommandBarsEvents_SinkHelper = new NetOffice.OfficeApi.Behind.EventInterfaces._CommandBarsEvents_SinkHelper(this, _connectPoint);
                return;
            }
        }
