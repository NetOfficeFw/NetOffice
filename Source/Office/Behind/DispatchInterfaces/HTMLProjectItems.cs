...
namespace NetOffice.OfficeApi.Behind
{
    ...
    public class HTMLProjectItems : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.HTMLProjectItems
    {
        ...
        public virtual NetOffice.OfficeApi.HTMLProjectItem this[object index]
        {
            get
            {
                return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.OfficeApi.HTMLProjectItem>(this, "Item", typeof(NetOffice.OfficeApi.HTMLProjectItem), index);
            }
        }
        ...
        /// </summary>
        [SupportByVersion("Office", 9, 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.OfficeApi.HTMLProjectItem> GetEnumerator()
        {
