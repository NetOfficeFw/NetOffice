...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class SmartArtColors : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.SmartArtColors
    {
        ...
        public NetOffice.OfficeApi.SmartArtColor this[object index]
        {
            get
            {
                return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OfficeApi.SmartArtColor>(this, "Item", typeof(NetOffice.OfficeApi.SmartArtColor), index);
            }
        }
