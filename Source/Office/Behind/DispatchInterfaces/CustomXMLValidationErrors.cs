...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class CustomXMLValidationErrors : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.CustomXMLValidationErrors
    {
        ...
        public NetOffice.OfficeApi.CustomXMLValidationError this[Int32 index]
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OfficeApi.CustomXMLValidationError>(this, "Item", typeof(NetOffice.OfficeApi.CustomXMLValidationError), index);
            }
        }
