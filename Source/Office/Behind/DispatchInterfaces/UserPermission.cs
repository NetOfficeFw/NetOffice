...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class UserPermission : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.UserPermission
    {
        ...
        public UserPermission(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
