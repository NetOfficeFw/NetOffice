...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class IMsoWalls : COMObject, NetOffice.OfficeApi.IMsoWalls
    {
        ...
        public IMsoWalls(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
