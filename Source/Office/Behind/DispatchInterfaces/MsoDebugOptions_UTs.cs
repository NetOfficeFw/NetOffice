...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class MsoDebugOptions_UTs : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.MsoDebugOptions_UTs
    {
        ...
        public NetOffice.OfficeApi.MsoDebugOptions_UT this[Int32 index]
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OfficeApi.MsoDebugOptions_UT>(this, "Item", typeof(NetOffice.OfficeApi.MsoDebugOptions_UT), index);
            }
        }
