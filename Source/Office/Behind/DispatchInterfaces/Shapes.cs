...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class Shapes : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.Shapes
    {
        ...
        public NetOffice.OfficeApi.Shape Default
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OfficeApi.Shape>(this, "Default", typeof(NetOffice.OfficeApi.Shape));
            }
        }
