...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class ODSOColumns : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.ODSOColumns
    {
        ...
        public ODSOColumns(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public object this[object varIndex]
        {
            get
            {
                return Factory.ExecuteVariantMethodGet(this, "Item", varIndex);
            }
        }
