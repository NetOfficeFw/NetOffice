...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class DocumentLibraryVersions : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.DocumentLibraryVersions
    {
        ...
        public NetOffice.OfficeApi.DocumentLibraryVersion this[Int32 lIndex]
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OfficeApi.DocumentLibraryVersion>(this, "Item", typeof(NetOffice.OfficeApi.DocumentLibraryVersion), lIndex);
            }
        }
