...
namespace NetOffice.OfficeApi.Behind
{
    ...
    public class CustomXMLPrefixMapping : NetOffice.OfficeApi.Behind. _IMsoDispObj, NetOffice.OfficeApi.CustomXMLPrefixMapping
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.OfficeApi.CustomXMLPrefixMapping);
