...
namespace NetOffice.OfficeApi.Behind
{
    ...
    internal class ThemeFonts : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.OfficeApi.ThemeFonts
    {
        ...
        public NetOffice.OfficeApi.ThemeFont this[NetOffice.OfficeApi.Enums.MsoFontLanguageIndex index]
        {
            get
            {
                return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OfficeApi.ThemeFont>(this, "Item",typeof(NetOffice.OfficeApi.ThemeFont), index);
            }
        }
