...
namespace NetOffice.OfficeApi
{
	...
	public class CustomXMLSchemaCollection : _CustomXMLSchemaCollection
	{
		...
		public CustomXMLSchemaCollection(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public CustomXMLSchemaCollection(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public CustomXMLSchemaCollection(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// Returns a running Office.CustomXMLSchemaCollection object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Office","CustomXMLSchemaCollection", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("Office","CustomXMLSchemaCollection", throwOnError);
			if(null != proxy)
				return new NetOffice.OfficeApi.CustomXMLSchemaCollection(null, proxy);
			else
				return null;
