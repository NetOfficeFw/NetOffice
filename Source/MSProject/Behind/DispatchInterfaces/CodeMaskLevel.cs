...
namespace NetOffice.MSProjectApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class CodeMaskLevel : COMObject, NetOffice.MSProjectApi.CodeMaskLevel
	{
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSProjectApi.Enums.PjCustomOutlineCodeSequence Sequence
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.MSProjectApi.Enums.PjCustomOutlineCodeSequence>(this, "Sequence");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "Sequence", value);
			}
		}
		...
		public virtual object Length
		{
			...
			set
			{
				InvokerService.InvokeInternal.ExecuteVariantPropertySet(this, "Length", value);
			}
		}
