...
namespace NetOffice.MSProjectApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Window : COMObject, NetOffice.MSProjectApi.Window
	{
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSProjectApi.Pane ActivePane
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.Pane>(this, "ActivePane", typeof(NetOffice.MSProjectApi.Pane));
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSProjectApi.Pane TopPane
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.Pane>(this, "TopPane", typeof(NetOffice.MSProjectApi.Pane));
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSProjectApi.Pane BottomPane
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.Pane>(this, "BottomPane", typeof(NetOffice.MSProjectApi.Pane));
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSHTMLApi.IHTMLDocument2 WebBrowserControlWindow()
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.MSHTMLApi.IHTMLDocument2>(this, "WebBrowserControlWindow", typeof(NetOffice.MSHTMLApi.IHTMLDocument2));
		}
		...
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSHTMLApi.IHTMLDocument2 WebBrowserControlFrame(object frameName)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.MSHTMLApi.IHTMLDocument2>(this, "WebBrowserControlFrame", typeof(NetOffice.MSHTMLApi.IHTMLDocument2), frameName);
		}
