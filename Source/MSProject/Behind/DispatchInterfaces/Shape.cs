...
namespace NetOffice.MSProjectApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Shape : COMObject, NetOffice.MSProjectApi.Shape
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSProjectApi.Shape);
		...
		/// </summary>
		[SupportByVersion("MSProject", 11)]
		public virtual NetOffice.MSProjectApi.Shape Duplicate()
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.MSProjectApi.Shape>(this, "Duplicate", typeof(NetOffice.MSProjectApi.Shape));
		}
