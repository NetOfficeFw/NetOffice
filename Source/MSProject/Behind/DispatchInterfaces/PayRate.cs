...
namespace NetOffice.MSProjectApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class PayRate : COMObject, NetOffice.MSProjectApi.PayRate
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSProjectApi.PayRate);
		...
		public virtual object EffectiveDate
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteVariantPropertyGet(this, "EffectiveDate");
			}
		}
