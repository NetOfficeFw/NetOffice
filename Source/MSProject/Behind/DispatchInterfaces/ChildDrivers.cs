...
namespace NetOffice.MSProjectApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff920568(v=office.14).aspx </remarks>
	[SupportByVersion("MSProject", 11,12,14)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Property, "Item")]
	public class ChildDrivers : COMObject, NetOffice.MSProjectApi.ChildDrivers
	{
		...
		public virtual NetOffice.MSProjectApi.Task this[Int32 index]
		{
			get
			{
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual Int32 TotalDetectedCount
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "TotalDetectedCount");
			}
		}
