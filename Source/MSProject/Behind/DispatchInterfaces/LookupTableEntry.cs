...
namespace NetOffice.MSProjectApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class LookupTableEntry : COMObject, NetOffice.MSProjectApi.LookupTableEntry
	{
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSProjectApi.LookupTableEntry ParentEntry
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.LookupTableEntry>(this, "ParentEntry", typeof(NetOffice.MSProjectApi.LookupTableEntry));
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual string LocalizedCookie
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "LocalizedCookie");
			}
		}
