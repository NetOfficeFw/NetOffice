...
namespace NetOffice.MSProjectApi.Behind
{
	...
	public class OutlineCodes : COMObject, NetOffice.MSProjectApi.OutlineCodes
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSProjectApi.OutlineCodes);
		...
		public virtual NetOffice.MSProjectApi.OutlineCode this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.OutlineCode>(this, "Item", typeof(NetOffice.MSProjectApi.OutlineCode), index);
			}
		}
		...
		[SupportByVersion("MSProject", 11,12,14)]
		public virtual NetOffice.MSProjectApi.OutlineCode Add(NetOffice.MSProjectApi.Enums.PjCustomField fieldID, string name)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.MSProjectApi.OutlineCode>(this, "Add", typeof(NetOffice.MSProjectApi.OutlineCode), fieldID, name);
		}
        ...
        /// </summary>
        [SupportByVersion("MSProject", 11, 12, 14)]
        public virtual IEnumerator<NetOffice.MSProjectApi.OutlineCode> GetEnumerator()
        {
