...
namespace NetOffice.MSProjectApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff920769(v=office.14).aspx </remarks>
	[SupportByVersion("MSProject", 11,12,14)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Property, "Item")]
	public class Windows2 : COMObject, NetOffice.MSProjectApi.Windows2
	{
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(Windows2);                return _type;
            }
        }
