...
namespace NetOffice.MSProjectApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff920747(v=office.14).aspx </remarks>
	[SupportByVersion("MSProject", 11,12,14)]
	...
	public class Views : COMObject, NetOffice.MSProjectApi.Views
	{
		...
		public virtual NetOffice.MSProjectApi.View this[object index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.MSProjectApi.View>(this, "Item", index);
			}
		}
		...
		[SupportByVersion("MSProject", 11,12,14)]
		[BaseResult]
		public virtual NetOffice.MSProjectApi.View Copy(object source, string newName)
		{
			return InvokerService.InvokeInternal.ExecuteBaseReferenceMethodGet<NetOffice.MSProjectApi.View>(this, "Copy", source, newName);
		}
        ...
        /// </summary>
        [SupportByVersion("MSProject", 11, 12, 14)]
        public virtual IEnumerator<NetOffice.MSProjectApi.View> GetEnumerator()
        {
