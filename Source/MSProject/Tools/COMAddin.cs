...
namespace NetOffice.MSProjectApi.Tools
{
    ...
    public abstract class COMAddin : OfficeCOMAddin, IOfficeCOMAddin
    {
        ...
        /// </summary>
        public new MSProject.Application Application
        {
            get
            {
                return base.Application as MSProject.Application;
            }
        }
        ...
        protected override void HandleOnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
        {
            ...
            base.Application = Factory.CreateKnownObjectFromComProxy<MSProject.Application>(null, application, typeof(MSProjectApi.Application));
            Utils = OnCreateUtils();
