...
namespace NetOffice.MSProjectApi
{
 	...
 	public class View : COMObject
	{
		...
		public NetOffice.MSProjectApi.Enums.PjItemType Type
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.MSProjectApi.Enums.PjItemType>(this, "Type");
			}
		}
		...
		public bool Single
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "Single");
			}
		}
		...
		public NetOffice.MSProjectApi.Enums.PjViewScreen Screen
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.MSProjectApi.Enums.PjViewScreen>(this, "Screen");
			}
		}
