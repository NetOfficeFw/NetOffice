...
namespace NetOffice.MSProjectApi
{
	...
	[TypeId("9DD14145-F0A9-4692-8288-A6835F93DC8A")]
	public interface CalendarDrivers : ICOMObject, IEnumerableProvider<NetOffice.MSProjectApi.Resource>
	{
		#region Properties
		...
		NetOffice.MSProjectApi.Resource this[Int32 index] { get; }
        ...
        /// </summary>
        [SupportByVersion("MSProject", 11, 12, 14)]
        new IEnumerator<NetOffice.MSProjectApi.Resource> GetEnumerator();
