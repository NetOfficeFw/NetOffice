...
namespace NetOffice.MSProjectApi
{
	...
	public class CalendarDrivers : COMObject ,IEnumerable<NetOffice.MSProjectApi.Resource>
	{
		...
		public CalendarDrivers(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public CalendarDrivers(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
