...
namespace NetOffice.MSProjectApi
{
	...
	[TypeId("ED989E98-F561-4D58-8F67-5D2E2B920E77")]
	public interface Filters : ICOMObject, IEnumerableProvider<NetOffice.MSProjectApi.Filter>
	{
		#region Properties
		...
		NetOffice.MSProjectApi.Filter this[object index] { get; }
		...
		[SupportByVersion("MSProject", 11,12,14)]
		NetOffice.MSProjectApi.Filter Copy(object source, string newName);
