...
namespace NetOffice.MSProjectApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff920578(v=office.14).aspx </remarks>
	...
	public class CostRateTables : COMObject ,IEnumerable<NetOffice.MSProjectApi.CostRateTable>
	{
		...
		public CostRateTables(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public CostRateTables(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
...
{			
			...
			NetOffice.MSProjectApi.CostRateTable newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.CostRateTable.LateBindingApiWrapperType) as NetOffice.MSProjectApi.CostRateTable;
			return newObject;
			}
		}
