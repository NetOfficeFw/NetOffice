...
namespace NetOffice.MSProjectApi
{
 	...
 	public class ReportTemplate : COMObject
	{
		...
		public string TemplatePath
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "TemplatePath");
			}
		}
		...
		public NetOffice.MSProjectApi.Enums.PjVisualReportsCubeType CubeType
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.MSProjectApi.Enums.PjVisualReportsCubeType>(this, "CubeType");
			}
		}
		...
		public NetOffice.MSProjectApi.Enums.PjVisualReportsTemplateType TemplateType
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.MSProjectApi.Enums.PjVisualReportsTemplateType>(this, "TemplateType");
			}
		}
