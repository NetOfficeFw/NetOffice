	...
	public class Resource : COMObject
	{
		...
		public NetOffice.MSProjectApi.CostRateTables CostRateTables
		{
			get
			{
				...
				NetOffice.MSProjectApi.CostRateTables newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.CostRateTables.LateBindingApiWrapperType) as NetOffice.MSProjectApi.CostRateTables;
				return newObject;
			}
		}
		...
		public NetOffice.MSProjectApi.PayRates PayRates
		{
			get
			{
				...
				NetOffice.MSProjectApi.PayRates newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.PayRates.LateBindingApiWrapperType) as NetOffice.MSProjectApi.PayRates;
				return newObject;
			}
		}
		...
		public NetOffice.MSProjectApi.Availabilities Availabilities
		{
			get
			{
				...
				NetOffice.MSProjectApi.Availabilities newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.Availabilities.LateBindingApiWrapperType) as NetOffice.MSProjectApi.Availabilities;
				return newObject;
			}
		}
