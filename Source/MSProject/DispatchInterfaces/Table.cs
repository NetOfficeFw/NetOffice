...
namespace NetOffice.MSProjectApi
{
 	...
 	public class Table : COMObject
	{
		...
		public NetOffice.MSProjectApi.Enums.PjItemType TableType
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.MSProjectApi.Enums.PjItemType>(this, "TableType");
			}
		}
		...
		public NetOffice.MSProjectApi.Enums.PjDateFormat DateFormat
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.MSProjectApi.Enums.PjDateFormat>(this, "DateFormat");
			}
			set
			{
				Factory.ExecuteEnumPropertySet(this, "DateFormat", value);
			}
		}
		...
		public Int32 RowHeight
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "RowHeight");
			}
			set
			{
		...
		public bool LockFirstColumn
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "LockFirstColumn");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "LockFirstColumn", value);
			}
		}
		...
		public bool AdjustHeaderRowHeight
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "AdjustHeaderRowHeight");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "AdjustHeaderRowHeight", value);
			}
		}
		...
		public NetOffice.MSProjectApi.TableFields TableFields
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.TableFields>(this, "TableFields", NetOffice.MSProjectApi.TableFields.LateBindingApiWrapperType);
			}
		}
