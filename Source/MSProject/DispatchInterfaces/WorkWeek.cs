...
namespace NetOffice.MSProjectApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff920771(v=office.14).aspx </remarks>
	...
	public class WorkWeek : COMObject
	{
		...
		public WorkWeek(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public WorkWeek(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.MSProjectApi.WorkWeekDays WeekDays
		{
			get
			{
				...
				NetOffice.MSProjectApi.WorkWeekDays newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.WorkWeekDays.LateBindingApiWrapperType) as NetOffice.MSProjectApi.WorkWeekDays;
				return newObject;
			}
		}
