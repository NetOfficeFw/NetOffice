...
namespace NetOffice.MSProjectApi
{
	...
	public class PredecessorDrivers : COMObject ,IEnumerable<NetOffice.MSProjectApi.TaskDependency>
	{
		...
		public PredecessorDrivers(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public PredecessorDrivers(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
