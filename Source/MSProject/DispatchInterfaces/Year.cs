...
namespace NetOffice.MSProjectApi
{
 	...
 	public class Year : COMObject
	{
		...
		public Year(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public NetOffice.MSProjectApi.Months Months
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.Months>(this, "Months", NetOffice.MSProjectApi.Months.LateBindingApiWrapperType);
			}
		}
