...
namespace NetOffice.MSProjectApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff920625(v=office.14).aspx </remarks>
	...
	public class LookupTable : COMObject ,IEnumerable<NetOffice.MSProjectApi.LookupTableEntry>
	{
		...
		public LookupTable(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public LookupTable(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
...
{			
			...
			NetOffice.MSProjectApi.LookupTableEntry newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.MSProjectApi.LookupTableEntry.LateBindingApiWrapperType) as NetOffice.MSProjectApi.LookupTableEntry;
			return newObject;
			}
		}
