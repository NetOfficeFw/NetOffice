...
namespace NetOffice.MSProjectApi
{
	...
	public class WorkWeekDays : COMObject , IEnumerable<NetOffice.MSProjectApi.WorkWeekDay>
	{
		...
		public WorkWeekDays(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public NetOffice.MSProjectApi.WorkWeek Parent
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.WorkWeek>(this, "Parent", NetOffice.MSProjectApi.WorkWeek.LateBindingApiWrapperType);
			}
		}
		...
		public NetOffice.MSProjectApi.WorkWeekDay this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.WorkWeekDay>(this, "Item", NetOffice.MSProjectApi.WorkWeekDay.LateBindingApiWrapperType, index);
			}
		}
