...
namespace NetOffice.MSProjectApi
{
	...
	public class Tables : COMObject , IEnumerable<NetOffice.MSProjectApi.Table>
	{
		...
		public NetOffice.MSProjectApi.Table this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.MSProjectApi.Table>(this, "Item", NetOffice.MSProjectApi.Table.LateBindingApiWrapperType, index);
			}
		}
		...
		[SupportByVersion("MSProject", 11,12,14)]
		public NetOffice.MSProjectApi.Table Copy(object source, string newName)
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.MSProjectApi.Table>(this, "Copy", NetOffice.MSProjectApi.Table.LateBindingApiWrapperType, source, newName);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.MSProjectApi.Table>(this, "Add", NetOffice.MSProjectApi.Table.LateBindingApiWrapperType, name, field, task);
		}
		...
		[CustomMethod]
		[SupportByVersion("MSProject", 11,12,14)]
		public NetOffice.MSProjectApi.Table Add(string name, NetOffice.MSProjectApi.Enums.PjField field)
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.MSProjectApi.Table>(this, "Add", NetOffice.MSProjectApi.Table.LateBindingApiWrapperType, name, field);
		}

		#endregion

       #region IEnumerable<NetOffice.MSProjectApi.Table> Member
        
        /// <summary>
		/// SupportByVersion MSProject, 11,12,14
		/// </summary>
		[SupportByVersion("MSProject", 11,12,14)]
       public IEnumerator<NetOffice.MSProjectApi.Table> GetEnumerator()  
       {
