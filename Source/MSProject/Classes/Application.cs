...
namespace NetOffice.MSProjectApi
{
    ...
    public class Application : _MSProject, ICloneable<Application>, IEventBinding, IAutomaticQuit
	{
        ...
        public Application(Core factory = null, bool enableProxyService = false) : base()
        {
            ...
            {
                object proxy = Running.ProxyService.GetActiveInstance("MSProject", "Application", false);
                if (null != proxy)
                {
        ...
        {
            return Running.ProxyService.GetActiveInstances<Application>("MSProject", "Application", predicate);
        }
        ...
        {
            var sequence = Running.ProxyService.GetActiveInstances<Application>("MSProject", "Application");
        ...
        {
            var sequence = Running.ProxyService.GetActiveInstances<Application>("MSProject", "Application", predicate);
            int result = sequence.Count;
            sequence.Dispose();
            return result;
        }
        ...
        {
            return Running.ProxyService.GetActiveInstance<Application>("MSProject", "Application", predicate, throwExceptionIfNotFound);
        }
