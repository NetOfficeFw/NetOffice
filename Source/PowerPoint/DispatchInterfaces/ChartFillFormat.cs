	...
	public class ChartFillFormat : COMObject
	{
		...
		public NetOffice.PowerPointApi.ChartColorFormat BackColor
		{
			get
			{
				...
				NetOffice.PowerPointApi.ChartColorFormat newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PowerPointApi.ChartColorFormat.LateBindingApiWrapperType) as NetOffice.PowerPointApi.ChartColorFormat;
				return newObject;
			}
		}
