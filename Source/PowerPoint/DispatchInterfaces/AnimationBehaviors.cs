	...
	public class AnimationBehaviors : Collection
	{
		...
		public NetOffice.PowerPointApi.AnimationBehavior this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.AnimationBehavior newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.AnimationBehavior.LateBindingApiWrapperType) as NetOffice.PowerPointApi.AnimationBehavior;
				return newObject;
			}
		}
