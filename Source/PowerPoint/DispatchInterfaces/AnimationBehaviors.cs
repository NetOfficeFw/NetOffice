...
namespace NetOffice.PowerPointApi
{
	...
	/// </summary>
	/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/PowerPoint.AnimationBehaviors"/> </remarks>
	[SupportByVersion("PowerPoint", 10,11,12,14,15,16)]
 	...
 	public class AnimationBehaviors : Collection
	{
		...
		public AnimationBehaviors(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/PowerPoint.AnimationBehaviors.Application"/> </remarks>
		[SupportByVersion("PowerPoint", 10,11,12,14,15,16)]
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/PowerPoint.AnimationBehaviors.Parent"/> </remarks>
		...
		public NetOffice.PowerPointApi.AnimationBehavior this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.AnimationBehavior>(this, "Item", NetOffice.PowerPointApi.AnimationBehavior.LateBindingApiWrapperType, index);
			}
		}
		...
		/// SupportByVersion PowerPoint 10, 11, 12, 14, 15, 16
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/PowerPoint.AnimationBehaviors.Add"/> </remarks>
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.AnimationBehavior>(this, "Add", NetOffice.PowerPointApi.AnimationBehavior.LateBindingApiWrapperType, type, index);
		}
