	...
	public class PublishObjects : Collection
	{
		...
		public NetOffice.PowerPointApi.PublishObject this[Int32 index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.PublishObject newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.PublishObject.LateBindingApiWrapperType) as NetOffice.PowerPointApi.PublishObject;
				return newObject;
			}
		}
