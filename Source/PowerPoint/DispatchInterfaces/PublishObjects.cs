...
namespace NetOffice.PowerPointApi
{
	...
	/// </summary>
	/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/PowerPoint.PublishObjects"/> </remarks>
	[SupportByVersion("PowerPoint", 9,10,11,12,14,15,16)]
 	...
 	public class PublishObjects : Collection
	{
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/PowerPoint.PublishObjects.Application"/> </remarks>
		[SupportByVersion("PowerPoint", 9,10,11,12,14,15,16)]
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/PowerPoint.PublishObjects.Parent"/> </remarks>
		...
		public NetOffice.PowerPointApi.PublishObject this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.PublishObject>(this, "Item", NetOffice.PowerPointApi.PublishObject.LateBindingApiWrapperType, index);
			}
		}
