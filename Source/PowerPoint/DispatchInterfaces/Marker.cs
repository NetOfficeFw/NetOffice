...
namespace NetOffice.PowerPointApi
{
	...
	public class Marker : COMObject
	{
		...
		public Marker(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public Marker(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.PowerPointApi.Enums.PpMarkerType MarkerType
		{
			get
			{
				...
				return (NetOffice.PowerPointApi.Enums.PpMarkerType)intReturnItem;
			}
			set
			{
