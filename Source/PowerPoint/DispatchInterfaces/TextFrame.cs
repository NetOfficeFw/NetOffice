...
namespace NetOffice.PowerPointApi
{
 	...
 	public class TextFrame : COMObject
	{
		...
		public NetOffice.PowerPointApi.Ruler Ruler
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PowerPointApi.Ruler>(this, "Ruler", NetOffice.PowerPointApi.Ruler.LateBindingApiWrapperType);
			}
		}
		...
		public NetOffice.PowerPointApi.Enums.PpAutoSize AutoSize
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.PowerPointApi.Enums.PpAutoSize>(this, "AutoSize");
			}
			set
			{
