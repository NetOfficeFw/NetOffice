...
namespace NetOffice.PowerPointApi
{
 	...
 	public class TextStyle : COMObject
	{
		...
		public NetOffice.PowerPointApi.TextStyleLevels Levels
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PowerPointApi.TextStyleLevels>(this, "Levels", NetOffice.PowerPointApi.TextStyleLevels.LateBindingApiWrapperType);
			}
		}
