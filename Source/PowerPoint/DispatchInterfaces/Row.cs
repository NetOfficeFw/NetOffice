	...
	public class Row : COMObject
	{
		...
		public NetOffice.PowerPointApi.CellRange Cells
		{
			get
			{
				...
				NetOffice.PowerPointApi.CellRange newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PowerPointApi.CellRange.LateBindingApiWrapperType) as NetOffice.PowerPointApi.CellRange;
				return newObject;
			}
		}
