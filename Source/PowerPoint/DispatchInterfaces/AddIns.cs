	...
	public class AddIns : Collection
	{
		...
		public NetOffice.PowerPointApi.AddIn this[object index]
		{
			get
			{
				...
				NetOffice.PowerPointApi.AddIn newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.PowerPointApi.AddIn.LateBindingApiWrapperType) as NetOffice.PowerPointApi.AddIn;
				return newObject;
			}
		}
