	...
	public class ActionSetting : COMObject
	{
		...
		public NetOffice.PowerPointApi.Hyperlink Hyperlink
		{
			get
			{
				...
				NetOffice.PowerPointApi.Hyperlink newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PowerPointApi.Hyperlink.LateBindingApiWrapperType) as NetOffice.PowerPointApi.Hyperlink;
				return newObject;
			}
		}
