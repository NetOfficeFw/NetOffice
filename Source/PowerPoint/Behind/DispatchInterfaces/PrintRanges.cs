...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), HasIndexProperty(IndexInvoke.Method, "Item")]
 	public class PrintRanges : Collection, NetOffice.PowerPointApi.PrintRanges
	{
		...
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.PrintRange>(this, "Add", typeof(NetOffice.PowerPointApi.PrintRange), start, end);
		}
		...
		public NetOffice.PowerPointApi.PrintRange this[Int32 index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.PrintRange>(this, "Item", typeof(NetOffice.PowerPointApi.PrintRange), index);
			}
		}
