...
namespace NetOffice.PowerPointApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class DisplayUnitLabel_ : COMObject, NetOffice.PowerPointApi.DisplayUnitLabel_
    {
        #region Ctor
    ...
    public class DisplayUnitLabel : DisplayUnitLabel_, NetOffice.PowerPointApi.DisplayUnitLabel
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.PowerPointApi.DisplayUnitLabel);
