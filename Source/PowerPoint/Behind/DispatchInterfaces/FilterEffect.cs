...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class FilterEffect : COMObject, NetOffice.PowerPointApi.FilterEffect
	{
		...
		public NetOffice.PowerPointApi.Enums.MsoAnimFilterEffectType Type
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.PowerPointApi.Enums.MsoAnimFilterEffectType>(this, "Type");
			}
			set
			{
		...
		public NetOffice.PowerPointApi.Enums.MsoAnimFilterEffectSubtype Subtype
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.PowerPointApi.Enums.MsoAnimFilterEffectSubtype>(this, "Subtype");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "Subtype", value);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState Reveal
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "Reveal");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "Reveal", value);
			}
		}
