...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class FileDialogExtension : COMObject, NetOffice.PowerPointApi.FileDialogExtension
	{
		...
		public string Extensions
		{
			...
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "Extensions", value);
			}
		}
