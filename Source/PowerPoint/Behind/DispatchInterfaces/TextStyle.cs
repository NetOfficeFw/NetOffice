...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class TextStyle : COMObject, NetOffice.PowerPointApi.TextStyle
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.PowerPointApi.TextStyle);
		...
		public NetOffice.PowerPointApi.Ruler Ruler
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.PowerPointApi.Ruler>(this, "Ruler", typeof(NetOffice.PowerPointApi.Ruler));
			}
		}
		...
		public NetOffice.PowerPointApi.TextStyleLevels Levels
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.PowerPointApi.TextStyleLevels>(this, "Levels", typeof(NetOffice.PowerPointApi.TextStyleLevels));
			}
		}
