...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), HasIndexProperty(IndexInvoke.Method, "Item")]
 	public class Tags : Collection, NetOffice.PowerPointApi.Tags
	{
		...
		public string this[string name]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringMethodGet(this, "Item", name);
			}
		}
		...
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "AddBinary", name, filePath);
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteInt32MethodGet(this, "BinaryValue", name);
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteStringMethodGet(this, "Value", index);
		}
