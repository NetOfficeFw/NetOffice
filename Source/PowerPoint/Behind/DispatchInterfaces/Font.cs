...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Font : COMObject, NetOffice.PowerPointApi.Font
	{
		...
		public NetOffice.OfficeApi.Enums.MsoTriState Underline
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "Underline");
			}
			set
			{
