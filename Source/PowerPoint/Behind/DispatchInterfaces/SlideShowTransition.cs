...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class SlideShowTransition : COMObject, NetOffice.PowerPointApi.SlideShowTransition
	{
		...
		public NetOffice.OfficeApi.Enums.MsoTriState AdvanceOnClick
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "AdvanceOnClick");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "AdvanceOnClick", value);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState AdvanceOnTime
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "AdvanceOnTime");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "AdvanceOnTime", value);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState Hidden
		{
			...
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "Hidden", value);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState LoopSoundUntilNext
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "LoopSoundUntilNext");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "LoopSoundUntilNext", value);
			}
		}
		...
		public NetOffice.PowerPointApi.Enums.PpTransitionSpeed Speed
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.PowerPointApi.Enums.PpTransitionSpeed>(this, "Speed");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "Speed", value);
			}
		}
