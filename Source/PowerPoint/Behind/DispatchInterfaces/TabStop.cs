...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class TabStop : COMObject, NetOffice.PowerPointApi.TabStop
	{
		...
		public NetOffice.PowerPointApi.Enums.PpTabStopType Type
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.PowerPointApi.Enums.PpTabStopType>(this, "Type");
			}
			set
			{
