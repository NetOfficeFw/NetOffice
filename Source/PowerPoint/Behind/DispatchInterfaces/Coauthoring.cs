...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Coauthoring : COMObject, NetOffice.PowerPointApi.Coauthoring
	{
		...
		public bool MergeMode
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "MergeMode");
			}
		}
		...
		public bool FavorServerEditsDuringMerge
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "FavorServerEditsDuringMerge");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "FavorServerEditsDuringMerge", value);
			}
		}
		...
		public Int32 CoauthorCount
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "CoauthorCount");
			}
		}
