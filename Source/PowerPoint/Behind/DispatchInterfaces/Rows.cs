...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), HasIndexProperty(IndexInvoke.Method, "Item")]
 	public class Rows : Collection, NetOffice.PowerPointApi.Rows
	{
		...
		public NetOffice.PowerPointApi.Row this[Int32 index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.Row>(this, "Item", typeof(NetOffice.PowerPointApi.Row), index);
			}
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.Row>(this, "Add", typeof(NetOffice.PowerPointApi.Row), beforeRow);
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.Row>(this, "Add", typeof(NetOffice.PowerPointApi.Row));
		}
