...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), HasIndexProperty(IndexInvoke.Method, "Item")]
 	public class Sequences : Collection, NetOffice.PowerPointApi.Sequences
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.PowerPointApi.Sequences);
		...
		public NetOffice.PowerPointApi.Sequence this[Int32 index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.Sequence>(this, "Item", typeof(NetOffice.PowerPointApi.Sequence), index);
			}
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.Sequence>(this, "Add", typeof(NetOffice.PowerPointApi.Sequence), index);
		}
		...
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.Sequence>(this, "Add", typeof(NetOffice.PowerPointApi.Sequence));
		}
