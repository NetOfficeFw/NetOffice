...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class SoundEffect : COMObject, NetOffice.PowerPointApi.SoundEffect
	{
		...
		public NetOffice.PowerPointApi.Enums.PpSoundEffectType Type
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.PowerPointApi.Enums.PpSoundEffectType>(this, "Type");
			}
			set
			{
		...
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "ImportFromFile", fileName);
		}
