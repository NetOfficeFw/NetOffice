...
namespace NetOffice.PowerPointApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff746714.aspx </remarks>
	[SupportByVersion("PowerPoint", 14,15,16)]
	...
	public class Points : COMObject, NetOffice.PowerPointApi.Points
	{
		...
		public NetOffice.PowerPointApi.Point this[Int32 index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PowerPointApi.Point>(this, "_Default", typeof(NetOffice.PowerPointApi.Point), index);
			}
		}
