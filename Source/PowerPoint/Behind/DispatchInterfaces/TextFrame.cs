...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class TextFrame : COMObject, NetOffice.PowerPointApi.TextFrame
	{
		...
		public NetOffice.PowerPointApi.Enums.PpAutoSize AutoSize
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.PowerPointApi.Enums.PpAutoSize>(this, "AutoSize");
			}
			set
			{
