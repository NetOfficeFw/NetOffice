...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class PlaySettings : COMObject, NetOffice.PowerPointApi.PlaySettings
	{
		...
		public NetOffice.OfficeApi.Enums.MsoTriState HideWhileNotPlaying
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "HideWhileNotPlaying");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "HideWhileNotPlaying", value);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState PlayOnEntry
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "PlayOnEntry");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "PlayOnEntry", value);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState RewindMovie
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "RewindMovie");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "RewindMovie", value);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState PauseAnimation
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "PauseAnimation");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "PauseAnimation", value);
			}
		}
		...
		public Int32 StopAfterSlides
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "StopAfterSlides");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "StopAfterSlides", value);
			}
		}
