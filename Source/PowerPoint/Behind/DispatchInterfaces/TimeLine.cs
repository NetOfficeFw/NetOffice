...
namespace NetOffice.PowerPointApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class TimeLine : COMObject, NetOffice.PowerPointApi.TimeLine
	{
		...
		public NetOffice.PowerPointApi.Sequence MainSequence
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.PowerPointApi.Sequence>(this, "MainSequence", typeof(NetOffice.PowerPointApi.Sequence));
			}
		}
		...
		public NetOffice.PowerPointApi.Sequences InteractiveSequences
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.PowerPointApi.Sequences>(this, "InteractiveSequences", typeof(NetOffice.PowerPointApi.Sequences));
			}
		}
