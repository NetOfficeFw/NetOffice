...
namespace NetOffice.PowerPointApi.Tools
{
    ...
    public abstract class COMAddin : IDTExtensibility2, Office.IRibbonExtensibility, Office.ICustomTaskPaneConsumer
    {
        ...
        /// </summary>
        /// <param name="RibbonID">target ribbon id, only used from PowerPoint and ignored in this standard impklementation. overwrite this method if you need a custom behavior</param>
