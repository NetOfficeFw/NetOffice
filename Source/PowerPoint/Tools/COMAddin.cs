...
namespace NetOffice.PowerPointApi.Tools
{
    ...
    public abstract class COMAddin : OfficeCOMAddin, IOfficeCOMAddin
    {
        ...
        /// </summary>
        public new PowerPoint.Application Application
        {
            get
            {
                return base.Application as PowerPoint.Application;
            }
        }
        ...
        #region IDTExtensibility Overrides
        ...
        protected override void HandleOnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
        {
            ...
            base.Application = Factory.CreateKnownObjectFromComProxy<PowerPoint.Application>(null, application, typeof(PowerPoint.Application));
            Utils = OnCreateUtils();
