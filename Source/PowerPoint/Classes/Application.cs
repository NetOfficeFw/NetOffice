...
namespace NetOffice.PowerPointApi
{
    ...
    public class Application : _Application, ICloneable<Application>, IEventBinding, IAutomaticQuit
    {
        ...
        {
            var sequence = Running.ProxyService.GetActiveInstances<Application>("PowerPoint", "Application");
        ...
        {
            var sequence = Running.ProxyService.GetActiveInstances<Application>("PowerPoint", "Application", predicate);
            int result = sequence.Count;
            sequence.Dispose();
            return result;
        }
