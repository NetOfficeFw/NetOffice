...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLLinkElement : DispHTMLLinkElement,IEventBinding
	{
		...
		public HTMLLinkElement(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLLinkElement(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLLinkElement objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLLinkElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLLinkElement[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLLinkElement");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLLinkElement> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLLinkElement>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.MSHTMLApi.HTMLLinkElement(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running MSHTML.HTMLLinkElement object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLLinkElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLLinkElement GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLLinkElement", false);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLLinkElement(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an MSHTML.HTMLLinkElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLLinkElement GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLLinkElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLLinkElement(null, proxy);
			else
				return null;
