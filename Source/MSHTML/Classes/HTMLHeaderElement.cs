...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLHeaderElement : DispHTMLHeaderElement,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLHeaderElement objects from the environment/system
        /// </summary>
        /// <returns>an MSHTML.HTMLHeaderElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLHeaderElement[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLHeaderElement");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLHeaderElement object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLHeaderElement", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLHeaderElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLHeaderElement(null, proxy);
			else
				return null;
