...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLHeaderElement : DispHTMLHeaderElement,IEventBinding
	{
		...
		public HTMLHeaderElement(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLHeaderElement(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLHeaderElement objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLHeaderElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLHeaderElement[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLHeaderElement");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLHeaderElement> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLHeaderElement>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.MSHTMLApi.HTMLHeaderElement(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running MSHTML.HTMLHeaderElement object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLHeaderElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLHeaderElement GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLHeaderElement", false);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLHeaderElement(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an MSHTML.HTMLHeaderElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLHeaderElement GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLHeaderElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLHeaderElement(null, proxy);
			else
				return null;
