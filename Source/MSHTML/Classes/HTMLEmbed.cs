...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLEmbed : DispHTMLEmbed,IEventBinding
	{
		...
		public HTMLEmbed(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public HTMLEmbed(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLEmbed(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLEmbed(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLEmbed(COMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLEmbed objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLEmbed array</returns>
		public static NetOffice.MSHTMLApi.HTMLEmbed[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLEmbed");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLEmbed> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLEmbed>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.MSHTMLApi.HTMLEmbed(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running MSHTML.HTMLEmbed object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLEmbed object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLEmbed GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLEmbed", false);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLEmbed(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an MSHTML.HTMLEmbed object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLEmbed GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLEmbed", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLEmbed(null, proxy);
			else
				return null;
