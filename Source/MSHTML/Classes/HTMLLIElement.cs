...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLLIElement : DispHTMLLIElement,IEventBinding
	{
		...
		public HTMLLIElement(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLLIElement(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLLIElement objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLLIElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLLIElement[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLLIElement");
		...
		/// <summary>
        /// returns a running MSHTML.HTMLLIElement object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLLIElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLLIElement GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLLIElement", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLLIElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLLIElement(null, proxy);
			else
				return null;
