...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLObjectElement : DispHTMLObjectElement,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLObjectElement objects from the environment/system
        /// </summary>
        /// <returns>an MSHTML.HTMLObjectElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLObjectElement[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLObjectElement");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLObjectElement object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLObjectElement", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLObjectElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLObjectElement(null, proxy);
			else
				return null;
