...
namespace NetOffice.MSHTMLApi
{
	...
	[EventSink(typeof(Events.HTMLObjectElementEvents_SinkHelper))]
	public class HTMLObjectElement : DispHTMLObjectElement, IEventBinding
	{
		...
		private Events.HTMLObjectElementEvents_SinkHelper _hTMLObjectElementEvents_SinkHelper;
		...
		public HTMLObjectElement(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public HTMLObjectElement(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLObjectElement(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLObjectElement(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLObjectElement(ICOMObject replacedObject) : base(replacedObject)
		{
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, Events.HTMLObjectElementEvents_SinkHelper.Id);


			if(Events.HTMLObjectElementEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_hTMLObjectElementEvents_SinkHelper = new Events.HTMLObjectElementEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
