...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLFontElement : DispHTMLFontElement,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLFontElement objects from the environment/system
        /// </summary>
        /// <returns>an MSHTML.HTMLFontElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLFontElement[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLFontElement");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLFontElement object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLFontElement", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLFontElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLFontElement(null, proxy);
			else
				return null;
