...
namespace NetOffice.MSHTMLApi
{
	...
	[EventSink(typeof(Events.HTMLMapEvents_SinkHelper))]
	public class HTMLMapElement : DispHTMLMapElement, IEventBinding
	{
		...
		private Events.HTMLMapEvents_SinkHelper _hTMLMapEvents_SinkHelper;
		...
		public void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, Events.HTMLMapEvents_SinkHelper.Id);


			if(Events.HTMLMapEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_hTMLMapEvents_SinkHelper = new Events.HTMLMapEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
