...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLMapElement : DispHTMLMapElement,IEventBinding
	{
		...
		public HTMLMapElement(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLMapElement(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLMapElement objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLMapElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLMapElement[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLMapElement");
		...
		/// <summary>
        /// returns a running MSHTML.HTMLMapElement object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLMapElement", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLMapElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLMapElement(null, proxy);
			else
				return null;
