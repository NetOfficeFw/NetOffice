...
namespace NetOffice.MSHTMLApi
{
	...
	public delegate void HTMLSpanFlow_onhelpEventHandler();
	public delegate void HTMLSpanFlow_onclickEventHandler();
	public delegate void HTMLSpanFlow_ondblclickEventHandler();
	public delegate void HTMLSpanFlow_onkeypressEventHandler();
	public delegate void HTMLSpanFlow_onkeydownEventHandler();
	public delegate void HTMLSpanFlow_onkeyupEventHandler();
	public delegate void HTMLSpanFlow_onmouseoutEventHandler();
	public delegate void HTMLSpanFlow_onmouseoverEventHandler();
	public delegate void HTMLSpanFlow_onmousemoveEventHandler();
	public delegate void HTMLSpanFlow_onmousedownEventHandler();
	public delegate void HTMLSpanFlow_onmouseupEventHandler();
	public delegate void HTMLSpanFlow_onselectstartEventHandler();
	public delegate void HTMLSpanFlow_onfilterchangeEventHandler();
	public delegate void HTMLSpanFlow_ondragstartEventHandler();
	public delegate void HTMLSpanFlow_onbeforeupdateEventHandler();
	public delegate void HTMLSpanFlow_onafterupdateEventHandler();
	public delegate void HTMLSpanFlow_onerrorupdateEventHandler();
	public delegate void HTMLSpanFlow_onrowexitEventHandler();
	public delegate void HTMLSpanFlow_onrowenterEventHandler();
	public delegate void HTMLSpanFlow_ondatasetchangedEventHandler();
	public delegate void HTMLSpanFlow_ondataavailableEventHandler();
	public delegate void HTMLSpanFlow_ondatasetcompleteEventHandler();
	public delegate void HTMLSpanFlow_onlosecaptureEventHandler();
	public delegate void HTMLSpanFlow_onpropertychangeEventHandler();
	public delegate void HTMLSpanFlow_onscrollEventHandler();
	public delegate void HTMLSpanFlow_onfocusEventHandler();
	public delegate void HTMLSpanFlow_onblurEventHandler();
	public delegate void HTMLSpanFlow_onresizeEventHandler();
	public delegate void HTMLSpanFlow_ondragEventHandler();
	public delegate void HTMLSpanFlow_ondragendEventHandler();
	public delegate void HTMLSpanFlow_ondragenterEventHandler();
	public delegate void HTMLSpanFlow_ondragoverEventHandler();
	public delegate void HTMLSpanFlow_ondragleaveEventHandler();
	public delegate void HTMLSpanFlow_ondropEventHandler();
	public delegate void HTMLSpanFlow_onbeforecutEventHandler();
	public delegate void HTMLSpanFlow_oncutEventHandler();
	public delegate void HTMLSpanFlow_onbeforecopyEventHandler();
	public delegate void HTMLSpanFlow_oncopyEventHandler();
	public delegate void HTMLSpanFlow_onbeforepasteEventHandler();
	public delegate void HTMLSpanFlow_onpasteEventHandler();
	public delegate void HTMLSpanFlow_oncontextmenuEventHandler();
	public delegate void HTMLSpanFlow_onrowsdeleteEventHandler();
	public delegate void HTMLSpanFlow_onrowsinsertedEventHandler();
	public delegate void HTMLSpanFlow_oncellchangeEventHandler();
	public delegate void HTMLSpanFlow_onreadystatechangeEventHandler();
	public delegate void HTMLSpanFlow_onbeforeeditfocusEventHandler();
	public delegate void HTMLSpanFlow_onlayoutcompleteEventHandler();
	public delegate void HTMLSpanFlow_onpageEventHandler();
	public delegate void HTMLSpanFlow_onbeforedeactivateEventHandler();
	public delegate void HTMLSpanFlow_onbeforeactivateEventHandler();
	public delegate void HTMLSpanFlow_onmoveEventHandler();
	public delegate void HTMLSpanFlow_oncontrolselectEventHandler();
	public delegate void HTMLSpanFlow_onmovestartEventHandler();
	public delegate void HTMLSpanFlow_onmoveendEventHandler();
	public delegate void HTMLSpanFlow_onresizestartEventHandler();
	public delegate void HTMLSpanFlow_onresizeendEventHandler();
	public delegate void HTMLSpanFlow_onmouseenterEventHandler();
	public delegate void HTMLSpanFlow_onmouseleaveEventHandler();
	public delegate void HTMLSpanFlow_onmousewheelEventHandler();
	public delegate void HTMLSpanFlow_onactivateEventHandler();
	public delegate void HTMLSpanFlow_ondeactivateEventHandler();
	public delegate void HTMLSpanFlow_onfocusinEventHandler();
	public delegate void HTMLSpanFlow_onfocusoutEventHandler();
	public delegate void HTMLSpanFlow_onchangeEventHandler();
	public delegate void HTMLSpanFlow_onselectEventHandler();
	...
	public class HTMLSpanFlow : DispHTMLSpanFlow,IEventBinding
	{
		...
		public HTMLSpanFlow(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public HTMLSpanFlow(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLSpanFlow(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLSpanFlow(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLSpanFlow(COMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLSpanFlow objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLSpanFlow array</returns>
		public static NetOffice.MSHTMLApi.HTMLSpanFlow[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLSpanFlow");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLSpanFlow> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLSpanFlow>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.MSHTMLApi.HTMLSpanFlow(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running MSHTML.HTMLSpanFlow object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLSpanFlow object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLSpanFlow GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLSpanFlow", false);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLSpanFlow(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an MSHTML.HTMLSpanFlow object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLSpanFlow GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLSpanFlow", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLSpanFlow(null, proxy);
			else
				return null;
