...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLSpanFlow : DispHTMLSpanFlow,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLSpanFlow objects from the environment/system
        /// </summary>
        /// <returns>an MSHTML.HTMLSpanFlow array</returns>
		public static NetOffice.MSHTMLApi.HTMLSpanFlow[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLSpanFlow");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLSpanFlow object from the environment/system.
        /// </summary>
        /// <returns>an MSHTML.HTMLSpanFlow object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLSpanFlow GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLSpanFlow", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLSpanFlow", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLSpanFlow(null, proxy);
			else
				return null;
