...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLDocumentCompatibleInfo : DispHTMLDocumentCompatibleInfo
	{
		...
		public HTMLDocumentCompatibleInfo(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
		public HTMLDocumentCompatibleInfo(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLDocumentCompatibleInfo(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLDocumentCompatibleInfo(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLDocumentCompatibleInfo(ICOMObject replacedObject) : base(replacedObject)
		{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLDocumentCompatibleInfo objects from the environment/system
        /// </summary>
		...
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLDocumentCompatibleInfo");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLDocumentCompatibleInfo object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLDocumentCompatibleInfo", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLDocumentCompatibleInfo", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLDocumentCompatibleInfo(null, proxy);
			else
				return null;
