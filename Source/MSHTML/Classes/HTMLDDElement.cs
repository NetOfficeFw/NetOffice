...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLDDElement : DispHTMLDDElement,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLDDElement objects from the environment/system
        /// </summary>
        /// <returns>an MSHTML.HTMLDDElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLDDElement[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLDDElement");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLDDElement object from the environment/system.
        /// </summary>
        /// <returns>an MSHTML.HTMLDDElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLDDElement GetActiveInstance()
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLDDElement", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLDDElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLDDElement(null, proxy);
			else
				return null;
