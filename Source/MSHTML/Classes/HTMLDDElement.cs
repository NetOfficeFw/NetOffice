...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLDDElement : DispHTMLDDElement,IEventBinding
	{
		...
		public HTMLDDElement(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLDDElement(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLDDElement objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLDDElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLDDElement[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLDDElement");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLDDElement> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLDDElement>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.MSHTMLApi.HTMLDDElement(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running MSHTML.HTMLDDElement object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLDDElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLDDElement GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLDDElement", false);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLDDElement(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an MSHTML.HTMLDDElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLDDElement GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLDDElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLDDElement(null, proxy);
			else
				return null;
