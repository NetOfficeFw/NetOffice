...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLTableSection : DispHTMLTableSection,IEventBinding
	{
		...
		public HTMLTableSection(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLTableSection(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLTableSection objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLTableSection array</returns>
		public static NetOffice.MSHTMLApi.HTMLTableSection[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLTableSection");
		...
		/// <summary>
        /// returns a running MSHTML.HTMLTableSection object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLTableSection", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLTableSection", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLTableSection(null, proxy);
			else
				return null;
