...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLScreen : DispHTMLScreen
	{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLScreen objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLScreen array</returns>
		public static NetOffice.MSHTMLApi.HTMLScreen[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLScreen");
		...
		/// <summary>
        /// returns a running MSHTML.HTMLScreen object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLScreen object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLScreen GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLScreen", false);
			if(null != proxy)
		...
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLScreen", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLScreen(null, proxy);
			else
				return null;
