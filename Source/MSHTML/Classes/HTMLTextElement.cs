...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLTextElement : DispHTMLTextElement,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLTextElement objects from the environment/system
        /// </summary>
        /// <returns>an MSHTML.HTMLTextElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLTextElement[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLTextElement");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLTextElement object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLTextElement", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLTextElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLTextElement(null, proxy);
			else
				return null;
