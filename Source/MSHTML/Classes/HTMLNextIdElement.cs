...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLNextIdElement : DispHTMLNextIdElement,IEventBinding
	{
		...
		public HTMLNextIdElement(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public HTMLNextIdElement(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// <summary>
        /// returns all running MSHTML.HTMLNextIdElement objects from the running object table(ROT)
        /// </summary>
        /// <returns>an MSHTML.HTMLNextIdElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLNextIdElement[] GetActiveInstances()
		{		
			NetRuntimeSystem.Collections.Generic.List<object> proxyList = NetOffice.RunningObjectTable.GetActiveProxiesFromROT("MSHTML","HTMLNextIdElement");
			NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLNextIdElement> resultList = new NetRuntimeSystem.Collections.Generic.List<NetOffice.MSHTMLApi.HTMLNextIdElement>();
			foreach(object proxy in proxyList)
				resultList.Add( new NetOffice.MSHTMLApi.HTMLNextIdElement(null, proxy) );
			return resultList.ToArray();
		}

		/// <summary>
        /// returns a running MSHTML.HTMLNextIdElement object from the running object table(ROT). the method takes the first element from the table
        /// </summary>
        /// <returns>an MSHTML.HTMLNextIdElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLNextIdElement GetActiveInstance()
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLNextIdElement", false);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLNextIdElement(null, proxy);
			else
				return null;
		}
        ...
        /// <returns>an MSHTML.HTMLNextIdElement object or null</returns>
		public static NetOffice.MSHTMLApi.HTMLNextIdElement GetActiveInstance(bool throwOnError)
		{
			object proxy = NetOffice.RunningObjectTable.GetActiveProxyFromROT("MSHTML","HTMLNextIdElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLNextIdElement(null, proxy);
			else
				return null;
