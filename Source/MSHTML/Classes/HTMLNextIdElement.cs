...
namespace NetOffice.MSHTMLApi
{
	...
	public class HTMLNextIdElement : DispHTMLNextIdElement,IEventBinding
	{
		...
		/// <summary>
        /// Returns all running MSHTML.HTMLNextIdElement objects from the environment/system
        /// </summary>
        /// <returns>an MSHTML.HTMLNextIdElement array</returns>
		public static NetOffice.MSHTMLApi.HTMLNextIdElement[] GetActiveInstances()
		{		
			IDisposableEnumeration proxyList = NetOffice.ProxyService.GetActiveInstances("MSHTML","HTMLNextIdElement");
		...
		/// <summary>
        /// Returns a running MSHTML.HTMLNextIdElement object from the environment/system.
        /// </summary>
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLNextIdElement", false);
			if(null != proxy)
		...
		{
			object proxy  = NetOffice.ProxyService.GetActiveInstance("MSHTML","HTMLNextIdElement", throwOnError);
			if(null != proxy)
				return new NetOffice.MSHTMLApi.HTMLNextIdElement(null, proxy);
			else
				return null;
