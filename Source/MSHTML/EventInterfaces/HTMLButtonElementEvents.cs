...
{	
	...
	[ComImport, Guid("3050F2B3-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLButtonElementEvents_SinkHelper : SinkHelper, HTMLButtonElementEvents
	{
		#region Static
		
		public static readonly string Id = "3050F2B3-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLButtonElementEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region HTMLButtonElementEvents Members
