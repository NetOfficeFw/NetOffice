...
{	
	...
	[ComImport, Guid("3050F3BA-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLMapEvents_SinkHelper : SinkHelper, HTMLMapEvents
	{
		#region Static
		...
		public HTMLMapEvents_SinkHelper(COMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
