...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLMarqueeElementEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLMarqueeElementEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLMarqueeElementEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLMarqueeElementEvents
		/// </summary>
        ...
        public void onstart()
        {
            ...
            EventBinding.RaiseCustomEvent("onfinish", ref paramsArray);
        }
        ...
        {
            if (!Validate("onbounce"))
            {
                return;
            }

            object[] paramsArray = new object[0];
            EventBinding.RaiseCustomEvent("onbounce", ref paramsArray);
        }
        ...
        {
            if (!Validate("onselect"))
            {
                return;
            }

            object[] paramsArray = new object[0];
            EventBinding.RaiseCustomEvent("onselect", ref paramsArray);
        }
        ...
        public void onchange()
        {
            ...
            object[] paramsArray = new object[0];
            EventBinding.RaiseCustomEvent("onchange", ref paramsArray);
        }
