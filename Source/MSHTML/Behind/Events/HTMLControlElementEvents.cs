...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLControlElementEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLControlElementEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLControlElementEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLControlElementEvents
		/// </summary>
		public static readonly string Id = "3050F4EA-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLControlElementEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
		...
		#region HTMLControlElementEvents
