...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLSelectElementEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLSelectElementEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLSelectElementEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLSelectElementEvents
		/// </summary>
		public static readonly string Id = "3050F302-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLSelectElementEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
        ...
        #region HTMLSelectElementEvents
		...
		{
			Delegate[] recipients = EventBinding.GetEventRecipients("onchange");
