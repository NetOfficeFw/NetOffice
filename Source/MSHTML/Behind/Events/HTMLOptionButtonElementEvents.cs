...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLOptionButtonElementEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLOptionButtonElementEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLOptionButtonElementEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLOptionButtonElementEvents
		/// </summary>
		...
		public HTMLOptionButtonElementEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
        ...
        #region HTMLOptionButtonElementEvents
