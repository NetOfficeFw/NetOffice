...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLLabelEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLLabelEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLLabelEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLLabelEvents
		/// </summary>
		public static readonly string Id = "3050F329-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLLabelEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
