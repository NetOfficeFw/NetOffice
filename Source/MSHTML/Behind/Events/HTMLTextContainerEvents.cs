...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLTextContainerEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLTextContainerEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLTextContainerEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLTextContainerEvents
		/// </summary>
		public static readonly string Id = "1FF6AA72-5842-11CF-A707-00AA00C0098D";
        ...
        #region HTMLTextContainerEvents
