...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLStyleElementEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLStyleElementEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLStyleElementEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLStyleElementEvents
		/// </summary>
		public static readonly string Id = "3050F3CB-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLStyleElementEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
