...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLImgEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLImgEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLImgEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLImgEvents
		/// </summary>
		public static readonly string Id = "3050F25B-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLImgEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
