...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLInputTextElementEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLInputTextElementEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLInputTextElementEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLInputTextElementEvents
		/// </summary>
		public static readonly string Id = "3050F2A7-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLInputTextElementEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
        ...
        public void onabort()
        {
            ...
            object[] paramsArray = new object[0];
            EventBinding.RaiseCustomEvent("onabort", ref paramsArray);
        }
