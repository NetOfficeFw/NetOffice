...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLAreaEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLAreaEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLAreaEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLAreaEvents
		/// </summary>
