...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLScriptEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLScriptEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLScriptEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLScriptEvents
		/// </summary>
		public static readonly string Id = "3050F3E2-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLScriptEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
