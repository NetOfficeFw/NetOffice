...
{
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLAnchorEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLAnchorEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLAnchorEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLAnchorEvents
		/// </summary>
		public static readonly string Id = "3050F29D-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLAnchorEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
