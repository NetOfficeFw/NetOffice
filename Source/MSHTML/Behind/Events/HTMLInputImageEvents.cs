...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLInputImageEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLInputImageEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLInputImageEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLInputImageEvents
		/// </summary>
