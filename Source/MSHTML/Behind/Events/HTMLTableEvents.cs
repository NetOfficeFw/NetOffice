...
namespace NetOffice.MSHTMLApi.Behind.EventContracts
{
	...
	/// <summary>
	/// Default implementation of <see cref="NetOffice.MSHTMLApi.EventContracts.HTMLTableEvents"/>
	/// </summary>
    [InternalEntity(InternalEntityKind.SinkHelper)]
    [ComVisible(true), ClassInterface(ClassInterfaceType.None), TypeLibType(TypeLibTypeFlags.FHidden)]
	public class HTMLTableEvents_SinkHelper : SinkHelper, NetOffice.MSHTMLApi.EventContracts.HTMLTableEvents
	{
		#region Static
		
		/// <summary>
		/// Interface Id from HTMLTableEvents
		/// </summary>
		public static readonly string Id = "3050F407-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLTableEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
        ...
        #region HTMLTableEvents Members
		/// <summary>
		/// 
		/// </summary>
        public void onhelp()
