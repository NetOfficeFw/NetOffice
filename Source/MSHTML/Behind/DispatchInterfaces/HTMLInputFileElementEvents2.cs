...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class HTMLInputFileElementEvents2 : COMObject, NetOffice.MSHTMLApi.HTMLInputFileElementEvents2
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.HTMLInputFileElementEvents2);
