...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLDListElement : COMObject, NetOffice.MSHTMLApi.DispHTMLDListElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLDListElement);
		...
		public virtual bool compact
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "compact");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "compact", value);
			}
		}
