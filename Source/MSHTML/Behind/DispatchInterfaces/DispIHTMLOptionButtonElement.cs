...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispIHTMLOptionButtonElement : COMObject, NetOffice.MSHTMLApi.DispIHTMLOptionButtonElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispIHTMLOptionButtonElement);
