...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispIHTMLInputButtonElement : COMObject, NetOffice.MSHTMLApi.DispIHTMLInputButtonElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispIHTMLInputButtonElement);
