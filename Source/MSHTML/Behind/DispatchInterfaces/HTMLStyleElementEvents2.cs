...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class HTMLStyleElementEvents2 : DispHTMLStyleElement, NetOffice.MSHTMLApi.HTMLStyleElementEvents2
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.HTMLStyleElementEvents2);
