...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLCommentElement : COMObject, NetOffice.MSHTMLApi.DispHTMLCommentElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLCommentElement);
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual Int32 atomic
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "atomic");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "atomic", value);
			}
		}
