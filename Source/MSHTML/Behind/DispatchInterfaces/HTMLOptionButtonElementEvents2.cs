...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class HTMLOptionButtonElementEvents2 : COMObject, NetOffice.MSHTMLApi.HTMLOptionButtonElementEvents2
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.HTMLOptionButtonElementEvents2);
