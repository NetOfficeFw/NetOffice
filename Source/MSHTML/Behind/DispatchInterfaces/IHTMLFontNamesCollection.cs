...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class IHTMLFontNamesCollection : COMObject, NetOffice.MSHTMLApi.IHTMLFontNamesCollection
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.IHTMLFontNamesCollection);
		...
		[SupportByVersion("MSHTML", 4)]
		public virtual string item(Int32 index)
		{
