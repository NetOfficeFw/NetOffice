...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLEmbed : COMObject, NetOffice.MSHTMLApi.DispHTMLEmbed
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLEmbed);
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual string ie8_pluginspage
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "ie8_pluginspage");
			}
		}
