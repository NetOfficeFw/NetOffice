...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class HTMLFrameSiteEvents2 : HTMLFrameSiteEvents, NetOffice.MSHTMLApi.HTMLFrameSiteEvents2
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.HTMLFrameSiteEvents2);
