...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class IHTMLTxtRangeCollection : COMObject, NetOffice.MSHTMLApi.IHTMLTxtRangeCollection
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.IHTMLTxtRangeCollection);
