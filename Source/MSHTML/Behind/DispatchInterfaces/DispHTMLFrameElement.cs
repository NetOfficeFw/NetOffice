...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLFrameElement : COMObject, NetOffice.MSHTMLApi.DispHTMLFrameElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLFrameElement);
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual string ie8_frameBorder
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "ie8_frameBorder");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "ie8_frameBorder", value);
			}
		}
