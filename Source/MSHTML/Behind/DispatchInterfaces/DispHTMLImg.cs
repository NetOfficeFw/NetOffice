...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLImg : COMObject, NetOffice.MSHTMLApi.DispHTMLImg
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLImg);
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual string ie8_longDesc
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "ie8_longDesc");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "ie8_longDesc", value);
			}
		}
