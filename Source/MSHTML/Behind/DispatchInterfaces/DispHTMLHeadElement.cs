...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLHeadElement : COMObject, NetOffice.MSHTMLApi.DispHTMLHeadElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLHeadElement);
		...
		public virtual string profile
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "profile");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "profile", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual string ie8_profile
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "ie8_profile");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "ie8_profile", value);
			}
		}
