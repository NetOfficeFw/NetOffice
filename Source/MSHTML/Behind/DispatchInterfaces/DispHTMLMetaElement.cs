...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLMetaElement : COMObject, NetOffice.MSHTMLApi.DispHTMLMetaElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLMetaElement);
		...
		public virtual string scheme
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "scheme");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "scheme", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual string ie8_url
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "ie8_url");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "ie8_url", value);
			}
		}
