...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispCPlugins : COMObject, NetOffice.MSHTMLApi.DispCPlugins
	{
		...
		[SupportByVersion("MSHTML", 4)]
		public virtual void refresh(object reload)
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "refresh", reload);
		}
