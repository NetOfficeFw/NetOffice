...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTCDefaultDispatch : COMObject, NetOffice.MSHTMLApi.DispHTCDefaultDispatch
	{
		...
		[SupportByVersion("MSHTML", 4)]
		[BaseResult]
		public virtual NetOffice.MSHTMLApi.IHTMLElement element
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBaseReferencePropertyGet<NetOffice.MSHTMLApi.IHTMLElement>(this, "element");
			}
		}
		...
		public virtual object defaults
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteReferencePropertyGet(this, "defaults");
			}
		}
