...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLBlockElement : COMObject, NetOffice.MSHTMLApi.DispHTMLBlockElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLBlockElement);
		...
		public virtual string width
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "width");
			}
			set
			{
