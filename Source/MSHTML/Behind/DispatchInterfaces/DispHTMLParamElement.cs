...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLParamElement : COMObject, NetOffice.MSHTMLApi.DispHTMLParamElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLParamElement);
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual string ie8_valueType
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "ie8_valueType");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "ie8_valueType", value);
			}
		}
