...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class IHTMLIFrameElement2 : IHTMLIFrameElement, NetOffice.MSHTMLApi.IHTMLIFrameElement2
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.IHTMLIFrameElement2);
