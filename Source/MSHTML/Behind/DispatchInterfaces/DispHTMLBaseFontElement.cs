...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLBaseFontElement : COMObject, NetOffice.MSHTMLApi.DispHTMLBaseFontElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLBaseFontElement);
		...
		public virtual string face
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "face");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "face", value);
			}
		}
