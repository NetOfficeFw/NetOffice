...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLSelectElement : COMObject, NetOffice.MSHTMLApi.DispHTMLSelectElement
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.DispHTMLSelectElement);
		...
		[SupportByVersion("MSHTML", 4)]
		public virtual void ie8_add(NetOffice.MSHTMLApi.IHTMLOptionElement pElem, object pvarBefore)
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "ie8_add", pElem, pvarBefore);
		}
