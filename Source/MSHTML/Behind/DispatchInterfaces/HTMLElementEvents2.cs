...
namespace NetOffice.MSHTMLApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class HTMLElementEvents2 : DispHTMLGenericElement, NetOffice.MSHTMLApi.HTMLElementEvents2
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.HTMLElementEvents2);
