...
namespace NetOffice.MSHTMLApi.Behind
{
    ...
    public class HTMLWindowProxy : DispHTMLWindowProxy, NetOffice.MSHTMLApi.HTMLWindowProxy
    {
        ...
        private NetOffice.MSHTMLApi.Behind.EventContracts.HTMLWindowEvents_SinkHelper _hTMLWindowEvents_SinkHelper;
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.MSHTMLApi.HTMLWindowProxy);
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onloadEventHandler onloadEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onunloadEventHandler onunloadEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onhelpEventHandler onhelpEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onfocusEventHandler onfocusEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onblurEventHandler onblurEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onerrorEventHandler onerrorEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onresizeEventHandler onresizeEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onscrollEventHandler onscrollEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onbeforeunloadEventHandler onbeforeunloadEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onbeforeprintEventHandler onbeforeprintEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLWindowProxy_onafterprintEventHandler onafterprintEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.MSHTMLApi.Behind.EventContracts.HTMLWindowEvents_SinkHelper.Id);


			if(NetOffice.MSHTMLApi.Behind.EventContracts.HTMLWindowEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_hTMLWindowEvents_SinkHelper = new NetOffice.MSHTMLApi.Behind.EventContracts.HTMLWindowEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
