...
namespace NetOffice.MSHTMLApi.Behind
{
    ...
    public class HTMLNamespace : DispHTMLNamespace, NetOffice.MSHTMLApi.HTMLNamespace
    {
        ...
        private NetOffice.MSHTMLApi.Behind.EventContracts.HTMLNamespaceEvents_SinkHelper _hTMLNamespaceEvents_SinkHelper;
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLNamespace_onreadystatechangeEventHandler onreadystatechangeEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.MSHTMLApi.Behind.EventContracts.HTMLNamespaceEvents_SinkHelper.Id);


			if(NetOffice.MSHTMLApi.Behind.EventContracts.HTMLNamespaceEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_hTMLNamespaceEvents_SinkHelper = new NetOffice.MSHTMLApi.Behind.EventContracts.HTMLNamespaceEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
