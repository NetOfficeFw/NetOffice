...
namespace NetOffice.MSHTMLApi.Behind
{
    ...
    public class HTMLXMLHttpRequest : DispHTMLXMLHttpRequest, NetOffice.MSHTMLApi.HTMLXMLHttpRequest
    {
        ...
        private NetOffice.MSHTMLApi.Behind.EventContracts.HTMLXMLHttpRequestEvents_SinkHelper _hTMLXMLHttpRequestEvents_SinkHelper;
		...
		/// </summary>
		public HTMLXMLHttpRequest() : base()
		{
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLXMLHttpRequest_ontimeoutEventHandler ontimeoutEvent
		{
			add
			{
				CreateEventBridge();
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public virtual event HTMLXMLHttpRequest_onreadystatechangeEventHandler onreadystatechangeEvent
		{
			add
			{
				CreateEventBridge();
		...
		public virtual void CreateEventBridge()
        {
            ...
            if (null == _activeSinkId)
				_activeSinkId = SinkHelper.GetConnectionPoint(this, ref _connectPoint, NetOffice.MSHTMLApi.Behind.EventContracts.HTMLXMLHttpRequestEvents_SinkHelper.Id);


			if(NetOffice.MSHTMLApi.Behind.EventContracts.HTMLXMLHttpRequestEvents_SinkHelper.Id.Equals(_activeSinkId, StringComparison.InvariantCultureIgnoreCase))
			{
				_hTMLXMLHttpRequestEvents_SinkHelper = new NetOffice.MSHTMLApi.Behind.EventContracts.HTMLXMLHttpRequestEvents_SinkHelper(this, _connectPoint);
				return;
			} 
        }
