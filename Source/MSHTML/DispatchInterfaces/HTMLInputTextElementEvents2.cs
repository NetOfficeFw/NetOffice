...
{
	/// <summary>
	/// DispatchInterface HTMLInputTextElementEvents2 
	/// SupportByVersion MSHTML, 4
	/// </summary>
	[SupportByVersion("MSHTML", 4)]
	[EntityType(EntityType.IsDispatchInterface)]
	[TypeId("3050F618-98B5-11CF-BB82-00AA00BDCE0B")]
	public interface HTMLInputTextElementEvents2 : DispHTMLInputElement
	{
		#region Methods
		...
		/// <param name="pEvtObj">NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj</param>
		[SupportByVersion("MSHTML", 4)]
        new bool onchange(NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj);
		...
		/// <param name="pEvtObj">NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj</param>
		[SupportByVersion("MSHTML", 4)]
        new void onselect(NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj);
		...
		/// <param name="pEvtObj">NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj</param>
		[SupportByVersion("MSHTML", 4)]
        new void onerror(NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj);
		...
		/// <param name="pEvtObj">NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj</param>
		[SupportByVersion("MSHTML", 4)]
        new void onabort(NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj);
