...
{
	/// <summary>
	/// DispatchInterface DispHTMLFrameElement 
	/// SupportByVersion MSHTML, 4
	/// </summary>
	[SupportByVersion("MSHTML", 4)]
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLFrameElement : COMObject
	{
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(DispHTMLFrameElement);
                return _type;
            }
        }
		...
		public DispHTMLFrameElement(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public DispHTMLFrameElement(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLFrameElement(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLFrameElement(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLFrameElement(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLFrameElement(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLFrameElement() : base()
		{
		}
		
		/// <param name="progId">registered progID</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLFrameElement(string progId) : base(progId)
		{
		}
		...
		public string frameBorder
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "frameBorder");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "frameBorder", value);
			}
		}
		...
		public object frameSpacing
		{
			get
			{
				return Factory.ExecuteVariantPropertyGet(this, "frameSpacing");
			}
			set
			{
				Factory.ExecuteVariantPropertySet(this, "frameSpacing", value);
			}
		}
		...
		public object marginWidth
		{
			get
			{
				return Factory.ExecuteVariantPropertyGet(this, "marginWidth");
			}
			set
			{
				Factory.ExecuteVariantPropertySet(this, "marginWidth", value);
			}
		}
		...
		public object marginHeight
		{
			get
			{
				return Factory.ExecuteVariantPropertyGet(this, "marginHeight");
			}
			set
			{
				Factory.ExecuteVariantPropertySet(this, "marginHeight", value);
			}
		}
		...
		public bool noResize
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "noResize");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "noResize", value);
			}
		}
		...
		public string scrolling
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "scrolling");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "scrolling", value);
			}
		}
		...
		public NetOffice.MSHTMLApi.IHTMLWindow2 contentWindow
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.MSHTMLApi.IHTMLWindow2>(this, "contentWindow", NetOffice.MSHTMLApi.IHTMLWindow2.LateBindingApiWrapperType);
			}
		}
		...
		public bool allowTransparency
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "allowTransparency");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "allowTransparency", value);
			}
		}
		...
		public string longDesc
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "longDesc");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "longDesc", value);
			}
		}
		...
		public object contentDocument
		{
			get
			{
				return Factory.ExecuteReferencePropertyGet(this, "contentDocument");
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public string ie8_src
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "ie8_src");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ie8_src", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public string ie8_longDesc
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "ie8_longDesc");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ie8_longDesc", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public string ie8_frameBorder
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "ie8_frameBorder");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ie8_frameBorder", value);
			}
		}
