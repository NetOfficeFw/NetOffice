...
namespace NetOffice.MSHTMLApi
{
	...
	[TypeId("3050F513-98B5-11CF-BB82-00AA00BDCE0B")]
    [CoClassSource(typeof(NetOffice.MSHTMLApi.HTMLFrameElement))]
    public interface DispHTMLFrameElement : ICOMObject
	{
		#region Properties
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		NetOffice.MSHTMLApi.IHTMLWindow2 contentWindow { get; }
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		string ie8_frameBorder { get; set; }
