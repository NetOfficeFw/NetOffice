...
namespace NetOffice.MSHTMLApi
{
 	...
 	public class DispHTMLMetaElement : COMObject
	{
		...
		public DispHTMLMetaElement(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public DispHTMLMetaElement(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLMetaElement(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLMetaElement(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLMetaElement(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLMetaElement(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public string httpEquiv
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "httpEquiv");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "httpEquiv", value);
			}
		}
		...
		public string scheme
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "scheme");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "scheme", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("MSHTML", 4)]
		public string ie8_url
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "ie8_url");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ie8_url", value);
			}
		}
