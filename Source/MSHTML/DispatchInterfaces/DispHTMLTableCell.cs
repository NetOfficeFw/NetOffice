...
{
	/// <summary>
	/// DispatchInterface DispHTMLTableCell 
	/// SupportByVersion MSHTML, 4
	/// </summary>
	[SupportByVersion("MSHTML", 4)]
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class DispHTMLTableCell : COMObject
	{
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(DispHTMLTableCell);
                return _type;
            }
        }
		...
		public DispHTMLTableCell(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public DispHTMLTableCell(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLTableCell(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLTableCell(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLTableCell(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLTableCell(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLTableCell() : base()
		{
		}
		
		/// <param name="progId">registered progID</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public DispHTMLTableCell(string progId) : base(progId)
		{
		}
		...
		public Int32 rowSpan
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "rowSpan");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "rowSpan", value);
			}
		}
		...
		public Int32 colSpan
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "colSpan");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "colSpan", value);
			}
		}
		...
		public Int32 cellIndex
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "cellIndex");
			}
		}
		...
		public string abbr
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "abbr");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "abbr", value);
			}
		}
		...
		public string axis
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "axis");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "axis", value);
			}
		}
		...
		public string headers
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "headers");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "headers", value);
			}
		}
		...
		public string scope
		{
			...
			set
			{
				Factory.ExecuteValuePropertySet(this, "scope", value);
			}
		}
