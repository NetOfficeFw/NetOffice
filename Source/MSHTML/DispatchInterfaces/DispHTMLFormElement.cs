...
namespace NetOffice.MSHTMLApi
{
 	...
 	public class DispHTMLFormElement : COMObject
	{
		...
		public DispHTMLFormElement(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public string ie8_action
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "ie8_action");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ie8_action", value);
			}
		}
