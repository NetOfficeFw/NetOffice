...
namespace NetOffice.MSHTMLApi
{
	...
	[TypeId("3050F510-98B5-11CF-BB82-00AA00BDCE0B")]
    [CoClassSource(typeof(NetOffice.MSHTMLApi.HTMLFormElement), typeof(NetOffice.MSHTMLApi.OldHTMLFormElement))]
    public interface DispHTMLFormElement : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("MSHTML", 4)]
		void appendNameValuePair(object name, object value);
		...
		[CustomMethod]
		[SupportByVersion("MSHTML", 4)]
		void appendNameValuePair(object name);
		...
		[SupportByVersion("MSHTML", 4)]
		void appendNameFilePair(object name, object filename);
		...
		[CustomMethod]
		[SupportByVersion("MSHTML", 4)]
		void appendNameFilePair(object name);
