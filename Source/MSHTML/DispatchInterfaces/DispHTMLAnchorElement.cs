...
namespace NetOffice.MSHTMLApi
{
	...
	public class DispHTMLAnchorElement : COMObject
	{
		...
		public string ie8_shape
		{
			...
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ie8_shape", paramsArray);
				return NetRuntimeSystem.Convert.ToString(returnItem);
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
				Invoker.PropertySet(this, "ie8_shape", paramsArray);
			}
		}
		...
		public string ie8_coords
		{
			...
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ie8_coords", paramsArray);
				return NetRuntimeSystem.Convert.ToString(returnItem);
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
				Invoker.PropertySet(this, "ie8_coords", paramsArray);
			}
		}
