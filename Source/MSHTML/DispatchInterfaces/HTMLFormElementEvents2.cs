...
{
	/// <summary>
	/// DispatchInterface HTMLFormElementEvents2 
	/// SupportByVersion MSHTML, 4
	/// </summary>
	[SupportByVersion("MSHTML", 4)]
	[EntityType(EntityType.IsDispatchInterface)]
	[TypeId("3050F614-98B5-11CF-BB82-00AA00BDCE0B")]
	public interface HTMLFormElementEvents2 : DispHTMLFormElement
	{
		#region Methods
		...
		/// <param name="pEvtObj">NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj</param>
		[SupportByVersion("MSHTML", 4)]
        new bool onsubmit(NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj);
		...
		/// <param name="pEvtObj">NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj</param>
		[SupportByVersion("MSHTML", 4)]
        new bool onreset(NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj);
