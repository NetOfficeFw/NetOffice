...
namespace NetOffice.MSHTMLApi
{
	...
	[TypeId("3050F622-98B5-11CF-BB82-00AA00BDCE0B")]
	public interface HTMLSelectElementEvents2 : DispHTMLSelectElement
	{
		#region Methods
		...
		/// <param name="pEvtObj">NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj</param>
		[SupportByVersion("MSHTML", 4)]
        new void onchange(NetOffice.MSHTMLApi.IHTMLEventObj pEvtObj);
