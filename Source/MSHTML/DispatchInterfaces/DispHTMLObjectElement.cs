...
namespace NetOffice.MSHTMLApi
{
 	...
 	public class DispHTMLObjectElement : COMObject
	{
		...
		public string ie8_codeBase
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "ie8_codeBase");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ie8_codeBase", value);
			}
		}
		...
		public string ie8_data
		{
			get
			{
				return Factory.ExecuteStringPropertyGet(this, "ie8_data");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ie8_data", value);
			}
		}
		...
		{
			return Factory.ExecuteVariantMethodGet(this, "namedRecordset", dataMember, hierarchy);
		}
		...
		{
			return Factory.ExecuteVariantMethodGet(this, "namedRecordset", dataMember);
		}
