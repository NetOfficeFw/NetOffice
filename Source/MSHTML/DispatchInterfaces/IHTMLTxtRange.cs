...
namespace NetOffice.MSHTMLApi
{
 	...
 	public class IHTMLTxtRange : COMObject
	{
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.MSHTMLApi.IHTMLElement>(this, "parentElement", NetOffice.MSHTMLApi.IHTMLElement.LateBindingApiWrapperType);
		}
