...
{	
    ...
    [ComImport, Guid("3050F4EA-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLControlElementEvents_SinkHelper : SinkHelper, HTMLControlElementEvents
	{
		#region Static
		...
		#region HTMLControlElementEvents Members
