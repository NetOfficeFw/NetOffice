...
{	
    ...
    [ComImport, Guid("3050F3E2-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLScriptEvents_SinkHelper : SinkHelper, HTMLScriptEvents
	{
		#region Static
		...
		#region HTMLScriptEvents Members
