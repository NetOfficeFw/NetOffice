...
{	
    ...
    [ComImport, Guid("3050F2C3-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLInputImageEvents_SinkHelper : SinkHelper, HTMLInputImageEvents
	{
		#region Static
		
		public static readonly string Id = "3050F2C3-98B5-11CF-BB82-00AA00BDCE0B";
		...
		public HTMLInputImageEvents_SinkHelper(ICOMObject eventClass, IConnectionPoint connectPoint): base(eventClass)
		{
