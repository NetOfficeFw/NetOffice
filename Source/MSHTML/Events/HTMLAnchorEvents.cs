...
{	
    ...
    [ComImport, Guid("3050F29D-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLAnchorEvents_SinkHelper : SinkHelper, HTMLAnchorEvents
	{
		#region Static
		...
		#region HTMLAnchorEvents Members
