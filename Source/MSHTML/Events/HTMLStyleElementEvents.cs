...
{	
    ...
    [ComImport, Guid("3050F3CB-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLStyleElementEvents_SinkHelper : SinkHelper, HTMLStyleElementEvents
	{
		#region Static
		...
		#region HTMLStyleElementEvents Members
