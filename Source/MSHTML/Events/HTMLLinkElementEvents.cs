...
{	
    ...
    [ComImport, Guid("3050F3CC-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLLinkElementEvents_SinkHelper : SinkHelper, HTMLLinkElementEvents
	{
		#region Static
		...
		#region HTMLLinkElementEvents Members
