...
{	
    ...
    [ComImport, Guid("3050F407-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType((short)0x1010)]
	...
	public class HTMLTableEvents_SinkHelper : SinkHelper, HTMLTableEvents
	{
		#region Static
