...
namespace NetOffice.OWC10Api
{
	...
	public class SchemaRelatedFields : COMObject ,IEnumerable<NetOffice.OWC10Api.SchemaRelatedField>
	{
		...
		public SchemaRelatedFields(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public SchemaRelatedFields(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
