...
namespace NetOffice.OWC10Api
{
	...
	public class Workbooks : COMObject, IEnumerableProvider<NetOffice.OWC10Api.Workbook>
	{
		...
		public NetOffice.OWC10Api.Workbook this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.Workbook>(this, "Item", NetOffice.OWC10Api.Workbook.LateBindingApiWrapperType, index);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("OWC10", 1)]
        public IEnumerator<NetOffice.OWC10Api.Workbook> GetEnumerator()
        {
