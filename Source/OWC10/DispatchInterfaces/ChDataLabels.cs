...
namespace NetOffice.OWC10Api
{
    ...
    public class ChDataLabels : COMObject, IEnumerableProvider<NetOffice.OWC10Api.ChDataLabel>
    {
        ...
        public ChDataLabels(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public ChDataLabels(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
        {
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChDataLabels(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
        {
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChDataLabels(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
        {
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChDataLabels(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
        {
        }
        
        ///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChDataLabels(ICOMObject replacedObject) : base(replacedObject)
        {
        }
        ...
        public bool HasBubbleSize
        {
            get
            {
                return Factory.ExecuteBoolPropertyGet(this, "HasBubbleSize");
            }
            set
            {
                Factory.ExecuteValuePropertySet(this, "HasBubbleSize", value);
            }
        }
        ...
        public bool HasCategoryName
        {
            get
            {
                return Factory.ExecuteBoolPropertyGet(this, "HasCategoryName");
            }
            set
            {
                Factory.ExecuteValuePropertySet(this, "HasCategoryName", value);
            }
        }
        ...
        public bool HasPercentage
        {
            get
            {
                return Factory.ExecuteBoolPropertyGet(this, "HasPercentage");
            }
            set
            {
                Factory.ExecuteValuePropertySet(this, "HasPercentage", value);
            }
        }
        ...
        public bool HasSeriesName
        {
            get
            {
                return Factory.ExecuteBoolPropertyGet(this, "HasSeriesName");
            }
            set
            {
                Factory.ExecuteValuePropertySet(this, "HasSeriesName", value);
            }
        }
        ...
        public bool HasValue
        {
            get
            {
                return Factory.ExecuteBoolPropertyGet(this, "HasValue");
            }
            set
            {
                Factory.ExecuteValuePropertySet(this, "HasValue", value);
            }
        }
        ...
        public NetOffice.OWC10Api.Enums.ChartDataLabelPositionEnum Position
        {
            get
            {
                return Factory.ExecuteEnumPropertyGet<NetOffice.OWC10Api.Enums.ChartDataLabelPositionEnum>(this, "Position");
            }
            set
            {
        ...
        public NetOffice.OWC10Api.ChDataLabel this[Int32 index]
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.ChDataLabel>(this, "Item", NetOffice.OWC10Api.ChDataLabel.LateBindingApiWrapperType, index);
            }
        }
        ...
        #region IEnumerableProvider<NetOffice.OWC10Api.ChDataLabel>

        ICOMObject IEnumerableProvider<NetOffice.OWC10Api.ChDataLabel>.GetComObjectEnumerator(ICOMObject parent)
        {
            return this;
        }

        IEnumerable IEnumerableProvider<NetOffice.OWC10Api.ChDataLabel>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
