...
namespace NetOffice.OWC10Api
{
	...
	[TypeId("F5B39AAC-1480-11D3-8549-00C04FAC67D7")]
	public interface ElementExtension : ICOMObject
	{
		#region Properties
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		bool ConsumesRecordset { get; set; }
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		string AlternateDataSource { get; set; }
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		string ListDisplayField { get; set; }
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		[SupportByVersion("OWC10", 1)]
		void FixupNames(string bstrOldSource, string bstrNewSource, string bstrOldDefaultCaption);
