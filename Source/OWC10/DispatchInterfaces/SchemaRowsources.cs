...
namespace NetOffice.OWC10Api
{
	...
	public class SchemaRowsources : COMObject ,IEnumerable<NetOffice.OWC10Api.SchemaRowsource>
	{
		...
		public SchemaRowsources(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public SchemaRowsources(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
