	...
	public class IPivotControl : COMObject
	{
		...
		public NetOffice.OWC10Api.PivotClassFactory ClassFactory
		{
			get
			{
				...
				NetOffice.OWC10Api.PivotClassFactory newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.PivotClassFactory.LateBindingApiWrapperType) as NetOffice.OWC10Api.PivotClassFactory;
				return newObject;
			}
			set
			{
