...
namespace NetOffice.OWC10Api
{
	...
	public class ChLegend : COMObject
	{
		...
		public ChLegend(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ChLegend(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.OWC10Api.ChLegendEntries LegendEntries
		{
			get
			{
				...
				NetOffice.OWC10Api.ChLegendEntries newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.ChLegendEntries.LateBindingApiWrapperType) as NetOffice.OWC10Api.ChLegendEntries;
				return newObject;
			}
		}
		...
		public NetOffice.OWC10Api.Enums.ChartLegendPositionEnum Position
		{
			get
			{
				...
				return (NetOffice.OWC10Api.Enums.ChartLegendPositionEnum)intReturnItem;
			}
			set
			{
