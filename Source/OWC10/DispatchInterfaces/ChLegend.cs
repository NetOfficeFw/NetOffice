...
#pragma warning disable
        ...
        public ChLegend(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public ChLegend(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
        {
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChLegend(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
        {
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChLegend(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
        {
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChLegend(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
        {
        }

        ///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public ChLegend(ICOMObject replacedObject) : base(replacedObject)
        {
        }
        ...
        public NetOffice.OWC10Api.ChLegendEntries LegendEntries
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.ChLegendEntries>(this, "LegendEntries", NetOffice.OWC10Api.ChLegendEntries.LateBindingApiWrapperType);
            }
        }
        ...
        public NetOffice.OWC10Api.Enums.ChartLegendPositionEnum Position
        {
            get
            {
                return Factory.ExecuteEnumPropertyGet<NetOffice.OWC10Api.Enums.ChartLegendPositionEnum>(this, "Position");
            }
            set
            {
