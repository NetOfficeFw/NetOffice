...
namespace NetOffice.OWC10Api
{
	...
	public class Headings : COMObject ,IEnumerable<NetOffice.OWC10Api.Heading>
	{
		...
		public Headings(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public Headings(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
...
{			
			...
			NetOffice.OWC10Api.Heading newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.Heading.LateBindingApiWrapperType) as NetOffice.OWC10Api.Heading;
			return newObject;
			}
		}
