...
{			
			...
			NetOffice.OWC10Api.Border newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.Border.LateBindingApiWrapperType) as NetOffice.OWC10Api.Border;
			return newObject;
			}
		}
