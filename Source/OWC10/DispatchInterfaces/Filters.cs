...
namespace NetOffice.OWC10Api
{
	...
	public class Filters : COMObject, IEnumerableProvider<NetOffice.OWC10Api.Filter>
	{
		...
		public NetOffice.OWC10Api.Filter this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.Filter>(this, "Item", NetOffice.OWC10Api.Filter.LateBindingApiWrapperType, index);
			}
		}
        ...
        #region IEnumerableProvider<NetOffice.OWC10Api.Filter>

        ICOMObject IEnumerableProvider<NetOffice.OWC10Api.Filter>.GetComObjectEnumerator(ICOMObject parent)
        {
            return NetOffice.Utils.GetComObjectEnumeratorAsProperty(parent, this, false);
        }

        IEnumerable IEnumerableProvider<NetOffice.OWC10Api.Filter>.FetchVariantComObjectEnumerator(ICOMObject parent, ICOMObject enumerator)
        {
