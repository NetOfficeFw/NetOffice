...
namespace NetOffice.OWC10Api
{
	...
	public class IDARef : COMObject
	{
		...
		public IDARef(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IDARef(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.OWC10Api.Enums.FieldListRelationshipTypeEnum Reltype
		{
			get
			{
				...
				return (NetOffice.OWC10Api.Enums.FieldListRelationshipTypeEnum)intReturnItem;
			}
		}
