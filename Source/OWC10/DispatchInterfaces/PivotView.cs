...
namespace NetOffice.OWC10Api
{
 	...
 	public class PivotView : COMObject
	{
		...
		public NetOffice.OWC10Api.IPivotControl Control
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.IPivotControl>(this, "Control", NetOffice.OWC10Api.IPivotControl.LateBindingApiWrapperType);
			}
		}
