...
namespace NetOffice.OWC10Api
{
	...
	public class ChTrendlines : COMObject, IEnumerableProvider<NetOffice.OWC10Api.ChTrendline>
	{
		...
		public ChTrendlines(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public NetOffice.OWC10Api.ChTrendline this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.ChTrendline>(this, "Item", NetOffice.OWC10Api.ChTrendline.LateBindingApiWrapperType, index);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OWC10Api.ChTrendline>(this, "Add", NetOffice.OWC10Api.ChTrendline.LateBindingApiWrapperType);
		}
