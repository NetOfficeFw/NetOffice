...
namespace NetOffice.OWC10Api
{
	...
	public class PivotResultField : COMObject
	{
		...
		public PivotResultField(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public PivotResultField(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		public NetOffice.OWC10Api.PivotResultAxis Axis
		{
			get
			{
				...
				NetOffice.OWC10Api.PivotResultAxis newObject = Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.OWC10Api.PivotResultAxis;
				return newObject;
			}
		}
