...
namespace NetOffice.OWC10Api
{
	...
	public class ElementExtensions : COMObject ,IEnumerable<NetOffice.OWC10Api.ElementExtension>
	{
		...
		public ElementExtensions(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ElementExtensions(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
