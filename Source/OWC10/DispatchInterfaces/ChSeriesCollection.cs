...
namespace NetOffice.OWC10Api
{
	...
	public class ChSeriesCollection : COMObject, IEnumerableProvider<NetOffice.OWC10Api.ChSeries>
	{
		...
		public ChSeriesCollection(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public NetOffice.OWC10Api.ChSeries this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.ChSeries>(this, "Item", NetOffice.OWC10Api.ChSeries.LateBindingApiWrapperType, index);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OWC10Api.ChSeries>(this, "Add", NetOffice.OWC10Api.ChSeries.LateBindingApiWrapperType, index);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.OWC10Api.ChSeries>(this, "Add", NetOffice.OWC10Api.ChSeries.LateBindingApiWrapperType);
		}
