...
namespace NetOffice.OWC10Api
{
	...
	public class SchemaRelationships : COMObject ,IEnumerable<NetOffice.OWC10Api.SchemaRelationship>
	{
		...
		public SchemaRelationships(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public SchemaRelationships(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
