...
namespace NetOffice.OWC10Api
{
	...
	public class ChDataLabel : COMObject
	{
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ChDataLabel(COMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ChDataLabel(COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		/// <param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ChDataLabel(COMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public NetOffice.OWC10Api.ChDataLabels Parent
		{
			get
			{
				...
				NetOffice.OWC10Api.ChDataLabels newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.OWC10Api.ChDataLabels.LateBindingApiWrapperType) as NetOffice.OWC10Api.ChDataLabels;
				return newObject;
			}
		}
