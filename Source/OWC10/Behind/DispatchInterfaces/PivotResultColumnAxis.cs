...
namespace NetOffice.OWC10Api.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class PivotResultColumnAxis : PivotResultGroupAxis, NetOffice.OWC10Api.PivotResultColumnAxis
	{
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.PivotGroupAxis SourceColumnAxis		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.PivotGroupAxis>(this, "SourceColumnAxis", typeof(NetOffice.OWC10Api.PivotGroupAxis));
			}
		}
