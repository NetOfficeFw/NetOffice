...
namespace NetOffice.OWC10Api.Behind
{
	...
	public class ChDataLabels : COMObject, NetOffice.OWC10Api.ChDataLabels
	{
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual bool HasBubbleSize
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "HasBubbleSize");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "HasBubbleSize", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual bool HasCategoryName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "HasCategoryName");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "HasCategoryName", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual bool HasPercentage
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "HasPercentage");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "HasPercentage", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual bool HasSeriesName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "HasSeriesName");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "HasSeriesName", value);
			}
		}
		...
		public virtual bool HasValue
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "HasValue");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "HasValue", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.Enums.ChartDataLabelPositionEnum Position
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OWC10Api.Enums.ChartDataLabelPositionEnum>(this, "Position");
			}
			set
			{
		...
		public virtual NetOffice.OWC10Api.ChDataLabel this[Int32 index]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.ChDataLabel>(this, "Item", typeof(NetOffice.OWC10Api.ChDataLabel), index);
			}
		}
        ...
        [SupportByVersion("OWC10", 1)]
        [CustomEnumerator]
        public virtual IEnumerator<NetOffice.OWC10Api.ChDataLabel> GetEnumerator()
        {
            NetRuntimeSystem.Collections.IEnumerable innerEnumerator = (this as NetRuntimeSystem.Collections.IEnumerable);
            foreach (NetOffice.OWC10Api.ChDataLabel item in innerEnumerator)
                yield return item;
