...
namespace NetOffice.OWC10Api.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class ChSurface : COMObject, NetOffice.OWC10Api.ChSurface
	{
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.ChPlotArea Parent
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.ChPlotArea>(this, "Parent", typeof(NetOffice.OWC10Api.ChPlotArea));
			}
		}
