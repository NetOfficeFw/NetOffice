...
namespace NetOffice.OWC10Api.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class PageRowsource : COMObject, NetOffice.OWC10Api.PageRowsource
	{
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.LookupRelationships LookupRelationships
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.LookupRelationships>(this, "LookupRelationships", typeof(NetOffice.OWC10Api.LookupRelationships));
			}
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.RecordsetDef Promote()
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.OWC10Api.RecordsetDef>(this, "Promote", typeof(NetOffice.OWC10Api.RecordsetDef));
		}
