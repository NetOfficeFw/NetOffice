...
namespace NetOffice.OWC10Api.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class TextFormat : COMObject, NetOffice.OWC10Api.TextFormat
	{
		...
		public virtual object ForeColor
		{
			...
			set
			{
				InvokerService.InvokeInternal.ExecuteVariantPropertySet(this, "ForeColor", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.Enums.PivotHAlignmentEnum HorizontalAlignment
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OWC10Api.Enums.PivotHAlignmentEnum>(this, "HorizontalAlignment");
			}
			set
			{
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.PivotFont Font
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.OWC10Api.PivotFont>(this, "Font", typeof(NetOffice.OWC10Api.PivotFont));
			}
		}
