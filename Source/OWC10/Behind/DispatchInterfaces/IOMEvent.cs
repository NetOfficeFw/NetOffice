...
namespace NetOffice.OWC10Api.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class IOMEvent : COMObject, NetOffice.OWC10Api.IOMEvent
	{
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual string KeyChar
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "KeyChar");
			}
		}
