...
namespace NetOffice.OWC10Api.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class SchemaField : COMObject, NetOffice.OWC10Api.SchemaField
	{
		...
		public virtual bool IsKey
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "IsKey");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "IsKey", value);
			}
		}
		...
		public virtual bool IsRenamed
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "IsRenamed");
			}
		}
		...
		public virtual string BaseTableName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "BaseTableName");
			}
		}
		...
		[SupportByVersion("OWC10", 1)]
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public virtual string BaseColumnName
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "BaseColumnName");
			}
		}
