...
namespace NetOffice.OWC10Api.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class PivotMemberProperty : COMObject, NetOffice.OWC10Api.PivotMemberProperty
	{
		...
		/// </summary>
		[SupportByVersion("OWC10", 1)]
		public virtual NetOffice.OWC10Api.Enums.PivotMemberPropertyDisplayEnum DisplayIn
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.OWC10Api.Enums.PivotMemberPropertyDisplayEnum>(this, "DisplayIn");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteEnumPropertySet(this, "DisplayIn", value);
			}
		}
