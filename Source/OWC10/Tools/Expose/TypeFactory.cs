...
namespace NetOffice.OWC10Api.Tools.Expose
{
    /// <summary>
    /// OWC10 Default Type Factory
    /// </summary>
    public class TypeFactory : NetOffice.Tools.Expose.Factory
    {
        private string _factoryNamespace = "NetOffice.OWC10Api";
        private Guid _componentId = new Guid("0002E550-0000-0000-C000-000000000046");
        private string[] _dependencies = new string[] { "MSDATASRCApi.dll", "MSComctlLibApi.dll", "ADODBApi.dll" };
