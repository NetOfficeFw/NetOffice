	...
	public class OptionButtons : OptionButtons_ ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.GroupBox GroupBox
		{
			get
			{
				...
				NetOffice.ExcelApi.GroupBox newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.GroupBox.LateBindingApiWrapperType) as NetOffice.ExcelApi.GroupBox;
				return newObject;
			}
		}
		...
		public NetOffice.ExcelApi.OptionButton Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.OptionButton newObject = Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.OptionButton.LateBindingApiWrapperType) as NetOffice.ExcelApi.OptionButton;
			return newObject;
		}
