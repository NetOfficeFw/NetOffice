...
namespace NetOffice.ExcelApi
{
    ...
    /// </summary>
    [SyntaxBypass]
    public interface OptionButtons_ : ICOMObject
    {
        #region Properties
	...
	[TypeId("00020882-0000-0000-C000-000000000046")]
    public interface OptionButtons : OptionButtons_, IEnumerableProvider<object>
    {
        #region Properties
        ...
        /// </summary>
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.GroupBox GroupBox { get; }
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.OptionButton Add(Double left, Double top, Double width, Double height);
