...
namespace NetOffice.ExcelApi
{
    ...
    /// </summary>
    [SyntaxBypass]
    public interface GroupBoxes_ : ICOMObject
    {
        #region Properties
	...
	[TypeId("0002088A-0000-0000-C000-000000000046")]
    public interface GroupBoxes : GroupBoxes_, IEnumerableProvider<object>
    {
        #region Properties
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.GroupBox Add(Double left, Double top, Double width, Double height);
