...
namespace NetOffice.ExcelApi
{
	...
	/// </summary>
	[SyntaxBypass]
 	public interface Rectangles_ : ICOMObject
	{
		#region Properties
	...
	[TypeId("0002089D-0000-0000-C000-000000000046")]
    public interface Rectangles : Rectangles_, IEnumerableProvider<object>
    {
        #region Properties
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.Rectangle Add(Double left, Double top, Double width, Double height);
