...
namespace NetOffice.ExcelApi
{
	...
	public interface PivotLine : ICOMObject
	{
		#region Properties
		...
		[SupportByVersion("Excel", 12,14,15,16)]
		NetOffice.ExcelApi.Enums.XlPivotLineType LineType { get; }
		...
		[SupportByVersion("Excel", 12,14,15,16)]
		NetOffice.ExcelApi.PivotLineCells PivotLineCells { get; }
		...
		[SupportByVersion("Excel", 15, 16)]
		NetOffice.ExcelApi.PivotLineCells PivotLineCellsFull { get; }
