	...
	public class _Worksheet : COMObject
	{
		...
		public NetOffice.ExcelApi.Outline Outline
		{
			get
			{
				...
				NetOffice.ExcelApi.Outline newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.Outline.LateBindingApiWrapperType) as NetOffice.ExcelApi.Outline;
				return newObject;
			}
		}
		...
		public NetOffice.ExcelApi.ListObjects ListObjects
		{
			get
			{
				...
				NetOffice.ExcelApi.ListObjects newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.ListObjects.LateBindingApiWrapperType) as NetOffice.ExcelApi.ListObjects;
				return newObject;
			}
		}
