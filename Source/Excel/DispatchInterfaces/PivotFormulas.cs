...
{			
			...
			NetOffice.ExcelApi.PivotFormula newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.PivotFormula.LateBindingApiWrapperType) as NetOffice.ExcelApi.PivotFormula;
			return newObject;
			}
		}
