...
namespace NetOffice.ExcelApi
{
	...
	///</summary>
	///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff836774.aspx </remarks>
	...
	public class ColorScaleCriteria : COMObject ,IEnumerable<NetOffice.ExcelApi.ColorScaleCriterion>
	{
		...
		public ColorScaleCriteria(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ColorScaleCriteria(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
		...
		/// Get
		/// </summary>
		///<remarks> MSDN Online Documentation: http://msdn.microsoft.com/en-us/en-us/library/office/ff196013.aspx </remarks>
		[SupportByVersionAttribute("Excel", 12,14,15)]
		public Int32 Count
		{
			get
