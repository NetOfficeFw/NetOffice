...
namespace NetOffice.ExcelApi
{
	...
	/// </summary>
	/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Excel.PivotTableChangeList"/> </remarks>
	[SupportByVersion("Excel", 14,15,16)]
	[EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Property), HasIndexProperty(IndexInvoke.Property, "_Default")]
	public class PivotTableChangeList : COMObject, IEnumerableProvider<NetOffice.ExcelApi.ValueChange>
	{
		...
		public PivotTableChangeList(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Excel.PivotTableChangeList.Application"/> </remarks>
		[SupportByVersion("Excel", 14,15,16)]
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Excel.PivotTableChangeList.Creator"/> </remarks>
		[SupportByVersion("Excel", 14,15,16)]
		...
		/// Unknown COM Proxy
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Excel.PivotTableChangeList.Parent"/> </remarks>
		...
		public NetOffice.ExcelApi.ValueChange this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.ValueChange>(this, "_Default", NetOffice.ExcelApi.ValueChange.LateBindingApiWrapperType, index);
			}
		}
		...
		/// Get
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Excel.PivotTableChangeList.Count"/> </remarks>
		[SupportByVersion("Excel", 14,15,16)]
		public Int32 Count
		{
			get
		...
		/// SupportByVersion Excel 14, 15, 16
		/// </summary>
		/// <remarks> Docs: <see href="https://docs.microsoft.com/en-us/office/vba/api/Excel.PivotTableChangeList.Add"/> </remarks>
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ValueChange>(this, "Add", NetOffice.ExcelApi.ValueChange.LateBindingApiWrapperType, new object[]{ tuple, value, allocationValue, allocationMethod, allocationWeightExpression });
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ValueChange>(this, "Add", NetOffice.ExcelApi.ValueChange.LateBindingApiWrapperType, tuple, value);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ValueChange>(this, "Add", NetOffice.ExcelApi.ValueChange.LateBindingApiWrapperType, tuple, value, allocationValue);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ValueChange>(this, "Add", NetOffice.ExcelApi.ValueChange.LateBindingApiWrapperType, tuple, value, allocationValue, allocationMethod);
		}
