...
namespace NetOffice.ExcelApi
{
	...
	/// </summary>
	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff839966.aspx </remarks>
	[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
	...
	[TypeId("00024430-0000-0000-C000-000000000046")]
	public interface Hyperlinks : ICOMObject, IEnumerableProvider<NetOffice.ExcelApi.Hyperlink>
	{
		#region Properties
		...
		NetOffice.ExcelApi.Hyperlink this[object index] { get; }
		...
		/// SupportByVersion Excel 9, 10, 11, 12, 14, 15, 16
		/// </summary>
		/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff822490.aspx </remarks>
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		object Add(object anchor, string address, object subAddress, object screenTip, object textToDisplay);
		...
		[CustomMethod]
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		object Add(object anchor, string address);
		...
		[CustomMethod]
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		object Add(object anchor, string address, object subAddress);
		...
		[CustomMethod]
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		object Add(object anchor, string address, object subAddress, object screenTip);
        ...
        /// </summary>
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        new IEnumerator<NetOffice.ExcelApi.Hyperlink> GetEnumerator();
