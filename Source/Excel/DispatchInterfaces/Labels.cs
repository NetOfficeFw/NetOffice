...
namespace NetOffice.ExcelApi
{
	...
	/// </summary>
	[SyntaxBypass]
 	public class Labels_ : COMObject
	{
		#region Ctor
	...
	public class Labels : Labels_, IEnumerableProvider<object>
	{
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Label>(this, "Add", NetOffice.ExcelApi.Label.LateBindingApiWrapperType, left, top, width, height);
		}
