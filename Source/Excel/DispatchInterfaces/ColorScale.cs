	...
	public class ColorScale : COMObject
	{
		...
		public NetOffice.ExcelApi.ColorScaleCriteria ColorScaleCriteria
		{
			get
			{
				...
				NetOffice.ExcelApi.ColorScaleCriteria newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.ColorScaleCriteria.LateBindingApiWrapperType) as NetOffice.ExcelApi.ColorScaleCriteria;
				return newObject;
			}
		}
