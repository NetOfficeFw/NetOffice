...
namespace NetOffice.ExcelApi
{
	...
	public class TextBoxes : TextBoxes_ ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.TextBox Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.TextBox newObject = Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.TextBox.LateBindingApiWrapperType) as NetOffice.ExcelApi.TextBox;
			return newObject;
		}
