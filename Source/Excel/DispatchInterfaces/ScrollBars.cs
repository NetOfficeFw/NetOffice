...
namespace NetOffice.ExcelApi
{
	...
	public class ScrollBars : COMObject ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.ScrollBar Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.ScrollBar newObject = Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.ScrollBar.LateBindingApiWrapperType) as NetOffice.ExcelApi.ScrollBar;
			return newObject;
		}
