...
namespace NetOffice.ExcelApi
{
	...
	public class Spinners : COMObject ,IEnumerable<object>
	{
		...
		public NetOffice.ExcelApi.Spinner Add(Double left, Double top, Double width, Double height)
		{
			...
			NetOffice.ExcelApi.Spinner newObject = Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.Spinner.LateBindingApiWrapperType) as NetOffice.ExcelApi.Spinner;
			return newObject;
		}
