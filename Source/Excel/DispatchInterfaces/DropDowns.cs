...
namespace NetOffice.ExcelApi
{
    ...
    /// </summary>
    [SyntaxBypass]
    public interface DropDowns_ : ICOMObject
    {
        #region Properties
    ...
    /// </summary>
    [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
    [EntityType(EntityType.IsDispatchInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Method, "Excel", 9, 10, 11, 12, 14, 15, 16)]
	[TypeId("0002088C-0000-0000-C000-000000000046")]
    public interface DropDowns : DropDowns_, IEnumerableProvider<object>
    {
        #region Properties
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.DropDown Add(Double left, Double top, Double width, Double height, object editable);
        ...
        [CustomMethod]
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.DropDown Add(Double left, Double top, Double width, Double height);
