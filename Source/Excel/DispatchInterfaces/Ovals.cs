...
namespace NetOffice.ExcelApi
{
    ...
    /// </summary>
    [SyntaxBypass]
    public interface Ovals_ : ICOMObject
    {
        #region Properties
	...
	[TypeId("0002089F-0000-0000-C000-000000000046")]
    public interface Ovals : Ovals_, IEnumerableProvider<object>
    {
        #region Properties
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.Oval Add(Double left, Double top, Double width, Double height);
