...
{			
			...
			NetOffice.ExcelApi.ListColumn newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.ListColumn.LateBindingApiWrapperType) as NetOffice.ExcelApi.ListColumn;
			return newObject;
			}
		}
