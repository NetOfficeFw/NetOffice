	...
	public class IDiagram : COMObject
	{
		...
		public NetOffice.ExcelApi.DiagramNodes Nodes
		{
			get
			{
				...
				NetOffice.ExcelApi.DiagramNodes newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.DiagramNodes.LateBindingApiWrapperType) as NetOffice.ExcelApi.DiagramNodes;
				return newObject;
			}
		}
