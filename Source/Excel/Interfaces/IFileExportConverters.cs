...
namespace NetOffice.ExcelApi
{
	...
	public class IFileExportConverters : COMObject ,IEnumerable<NetOffice.ExcelApi.FileExportConverter>
	{
		...
		public IFileExportConverters(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IFileExportConverters(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
