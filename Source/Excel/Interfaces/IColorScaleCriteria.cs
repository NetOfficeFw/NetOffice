...
namespace NetOffice.ExcelApi
{
	...
	public class IColorScaleCriteria : COMObject ,IEnumerable<NetOffice.ExcelApi.ColorScaleCriterion>
	{
		...
		public IColorScaleCriteria(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public IColorScaleCriteria(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
