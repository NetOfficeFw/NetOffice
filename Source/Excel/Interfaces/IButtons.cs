...
namespace NetOffice.ExcelApi
{
    ...
    /// </summary>
    [SyntaxBypass]
    public interface IButtons_ : ICOMObject
    {
        #region Properties
	...
	[TypeId("0002087E-0001-0000-C000-000000000046")]
    public interface IButtons : IButtons_, IEnumerableProvider<object>
    {
        #region Properties
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.Button Add(Double left, Double top, Double width, Double height);
