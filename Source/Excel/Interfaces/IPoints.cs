	...
	public class IPoints : COMObject ,IEnumerable<NetOffice.ExcelApi.Point>
	{
		...
		public NetOffice.ExcelApi.Point this[Int32 index]
		{
			get
			{
				...
				NetOffice.ExcelApi.Point newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.ExcelApi.Point.LateBindingApiWrapperType) as NetOffice.ExcelApi.Point;
				return newObject;
			}
		}
