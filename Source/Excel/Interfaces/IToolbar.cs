	...
	public class IToolbar : COMObject
	{
		...
		public NetOffice.ExcelApi.ToolbarButtons ToolbarButtons
		{
			get
			{
				...
				NetOffice.ExcelApi.ToolbarButtons newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.ToolbarButtons.LateBindingApiWrapperType) as NetOffice.ExcelApi.ToolbarButtons;
				return newObject;
			}
		}
