...
namespace NetOffice.ExcelApi
{
	...
	[TypeId("0002089B-0001-0000-C000-000000000046")]
    public interface ILines : ICOMObject, IEnumerableProvider<object>
    {
        #region Properties
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        NetOffice.ExcelApi.Line Add(Double x1, Double y1, Double x2, Double y2);
