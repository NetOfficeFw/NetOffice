...
namespace NetOffice.ExcelApi
{
	...
	public class ITableStyleElements : COMObject ,IEnumerable<NetOffice.ExcelApi.TableStyleElement>
	{
		...
		public ITableStyleElements(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ITableStyleElements(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
