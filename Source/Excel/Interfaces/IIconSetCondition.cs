	...
	public class IIconSetCondition : COMObject
	{
		...
		public NetOffice.ExcelApi.IconCriteria IconCriteria
		{
			get
			{
				...
				NetOffice.ExcelApi.IconCriteria newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.IconCriteria.LateBindingApiWrapperType) as NetOffice.ExcelApi.IconCriteria;
				return newObject;
			}
		}
