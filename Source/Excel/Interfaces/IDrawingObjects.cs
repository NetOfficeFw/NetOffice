...
namespace NetOffice.ExcelApi
{
    ...
    /// </summary>
    [SyntaxBypass]
    public interface IDrawingObjects_ : ICOMObject
    {
        #region Properties
    ...
    /// </summary>
    [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
    [EntityType(EntityType.IsInterface), Enumerator(Enumerator.Reference, EnumeratorInvoke.Method, "Excel", 9, 10, 11, 12, 14, 15, 16)]
	[TypeId("0002086F-0001-0000-C000-000000000046")]
    public interface IDrawingObjects : IDrawingObjects_, IEnumerableProvider<object>
    {
        #region Properties
        ...
        /// </summary>
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        object ArrowHeadLength { get; set; }
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        object Reshape(Int32 vertex, object insert, object left, object top);
        ...
        [CustomMethod]
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        object Reshape(Int32 vertex, object insert);
        ...
        [CustomMethod]
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        object Reshape(Int32 vertex, object insert, object left);
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        object Vertices(object index1, object index2);
