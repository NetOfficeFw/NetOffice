...
{			
			...
			NetOffice.ExcelApi.Style newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.Style.LateBindingApiWrapperType) as NetOffice.ExcelApi.Style;
			return newObject;
			}
		}
