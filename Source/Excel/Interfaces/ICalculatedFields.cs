...
namespace NetOffice.ExcelApi
{
	...
	public class ICalculatedFields : COMObject ,IEnumerable<NetOffice.ExcelApi.PivotField>
	{
		...
		public ICalculatedFields(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ICalculatedFields(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
