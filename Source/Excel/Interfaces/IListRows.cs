...
namespace NetOffice.ExcelApi
{
	...
	public class IListRows : COMObject, IEnumerableProvider<NetOffice.ExcelApi.ListRow>
	{
		...
		public IListRows(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
