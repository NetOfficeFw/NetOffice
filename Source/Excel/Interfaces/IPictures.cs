...
namespace NetOffice.ExcelApi
{
	...
	[TypeId("000208A7-0001-0000-C000-000000000046")]
	public interface IPictures : ICOMObject, IEnumerableProvider<object>
	{
		#region Properties
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		NetOffice.ExcelApi.Picture Add(Double left, Double top, Double width, Double height);
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		NetOffice.ExcelApi.Picture Insert(string filename, object converter);
		...
		[CustomMethod]
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		NetOffice.ExcelApi.Picture Insert(string filename);
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		NetOffice.ExcelApi.Picture Paste(object link);
		...
		[CustomMethod]
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		NetOffice.ExcelApi.Picture Paste();
