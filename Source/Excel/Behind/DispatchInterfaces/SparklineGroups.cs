...
namespace NetOffice.ExcelApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff836765.aspx </remarks>
	[SupportByVersion("Excel", 14,15,16)]
	...
	public class SparklineGroups : COMObject, NetOffice.ExcelApi.SparklineGroups
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public SparklineGroups(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		public NetOffice.ExcelApi.SparklineGroup this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.SparklineGroup>(this, "_Default", typeof(NetOffice.ExcelApi.SparklineGroup), index);
			}
		}
