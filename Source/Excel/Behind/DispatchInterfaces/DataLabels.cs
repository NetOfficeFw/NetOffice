...
namespace NetOffice.ExcelApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff196984.aspx </remarks>
	[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
	...
	public class DataLabels : COMObject, NetOffice.ExcelApi.DataLabels
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public DataLabels(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
