...
namespace NetOffice.ExcelApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff838649.aspx </remarks>
	[SupportByVersion("Excel", 11,12,14,15,16)]
	...
	public class ListColumns : COMObject, NetOffice.ExcelApi.ListColumns
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public ListColumns(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
