...
namespace NetOffice.ExcelApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff840099.aspx </remarks>
	[SupportByVersion("Excel", 12,14,15,16)]
	...
	public class ColorStops : COMObject, NetOffice.ExcelApi.ColorStops
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public ColorStops(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		public NetOffice.ExcelApi.ColorStop this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.ColorStop>(this, "_Default", typeof(NetOffice.ExcelApi.ColorStop), index);
			}
		}
