...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class CheckBoxes : NetOffice.ExcelApi.Behind.CheckBoxes_, NetOffice.ExcelApi.CheckBoxes
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.CheckBoxes);
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.CheckBox Add(Double left, Double top, Double width, Double height)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.CheckBox>(this, "Add", typeof(NetOffice.ExcelApi.CheckBox), left, top, width, height);
        }
