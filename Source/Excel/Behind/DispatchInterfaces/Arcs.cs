...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class Arcs : NetOffice.ExcelApi.Behind.Arcs_, NetOffice.ExcelApi.Arcs
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.Arcs);
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.Arc Add(Double x1, Double y1, Double x2, Double y2)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Arc>(this, "Add", typeof(NetOffice.ExcelApi.Arc), x1, y1, x2, y2);
        }
