...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class ProtectedViewWindows : COMObject, NetOffice.ExcelApi.ProtectedViewWindows
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public ProtectedViewWindows(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
