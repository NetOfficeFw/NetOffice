...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class ChartTitle_ : COMObject, NetOffice.ExcelApi.ChartTitle_
    {
        #region Ctor
    ...
    public class ChartTitle : NetOffice.ExcelApi.Behind.ChartTitle_, NetOffice.ExcelApi.ChartTitle
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.ChartTitle);
