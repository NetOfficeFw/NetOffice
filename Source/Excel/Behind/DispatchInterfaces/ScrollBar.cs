...
namespace NetOffice.ExcelApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class ScrollBar : COMObject, NetOffice.ExcelApi.ScrollBar
	{
		...
		public ScrollBar(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
