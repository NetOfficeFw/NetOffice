...
namespace NetOffice.ExcelApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Legend : COMObject, NetOffice.ExcelApi.Legend
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.Legend);
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		public virtual NetOffice.ExcelApi.Enums.XlLegendPosition Position
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.ExcelApi.Enums.XlLegendPosition>(this, "Position");
			}
			set
			{
