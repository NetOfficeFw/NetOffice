...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class ModelRelationships : COMObject, NetOffice.ExcelApi.ModelRelationships
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public ModelRelationships(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
