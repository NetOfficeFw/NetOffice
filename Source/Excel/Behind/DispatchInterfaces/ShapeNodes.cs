...
namespace NetOffice.ExcelApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff822109.aspx </remarks>
	[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
    ...
    public class ShapeNodes : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.ExcelApi.ShapeNodes
	{
		...
		public virtual NetOffice.ExcelApi.ShapeNode this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ShapeNode>(this, "Item", typeof(NetOffice.ExcelApi.ShapeNode), index);
			}
		}
