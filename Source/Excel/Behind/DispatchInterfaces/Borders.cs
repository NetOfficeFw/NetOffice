...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class Borders : COMObject, NetOffice.ExcelApi.Borders
	{
		...
		public virtual NetOffice.ExcelApi.Border this[NetOffice.ExcelApi.Enums.XlBordersIndex index]
		{
			get
			{
        ...
        /// </summary>
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual IEnumerator<NetOffice.ExcelApi.Border> GetEnumerator()
        {
