...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class OptionButtons : NetOffice.ExcelApi.Behind.OptionButtons_, NetOffice.ExcelApi.OptionButtons
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.OptionButtons);
        ...
        public virtual NetOffice.ExcelApi.GroupBox GroupBox
        {
            get
            {
                return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.GroupBox>(this, "GroupBox", typeof(NetOffice.ExcelApi.GroupBox));
            }
        }
        ...
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.OptionButton>(this, "Add", typeof(NetOffice.ExcelApi.OptionButton), left, top, width, height);
        }
