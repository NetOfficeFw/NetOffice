...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class AllowEditRanges : COMObject, NetOffice.ExcelApi.AllowEditRanges
	{
		...
		public AllowEditRanges(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public AllowEditRanges(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
