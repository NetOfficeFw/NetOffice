...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class AxisTitle_ : COMObject, NetOffice.ExcelApi.AxisTitle_
    {
        #region Ctor
    ...
    public class AxisTitle : NetOffice.ExcelApi.Behind.AxisTitle_, NetOffice.ExcelApi.AxisTitle
    {
