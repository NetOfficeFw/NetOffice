...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class DiagramNodeChildren : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.ExcelApi.DiagramNodeChildren
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public DiagramNodeChildren(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		public NetOffice.ExcelApi.DiagramNode FirstChild
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.DiagramNode>(this, "FirstChild", typeof(NetOffice.ExcelApi.DiagramNode));
			}
		}
		...
		public NetOffice.ExcelApi.DiagramNode LastChild
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.DiagramNode>(this, "LastChild", typeof(NetOffice.ExcelApi.DiagramNode));
			}
		}
