...
{
	/// <summary>
	/// DispatchInterface ToolbarButton 
	/// SupportByVersion Excel, 9,10,11,12,14,15,16
	/// </summary>
	[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
	[EntityType(EntityType.IsDispatchInterface)]
 	public class ToolbarButton : COMObject, NetOffice.ExcelApi.ToolbarButton
	{
		...
		public ToolbarButton(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public ToolbarButton(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ToolbarButton(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ToolbarButton(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ToolbarButton(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
		{
		}
		
		///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ToolbarButton(ICOMObject replacedObject) : base(replacedObject)
		{
		}
		...
		public bool IsGap
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "IsGap");
			}
		}
		...
		public bool Pushed
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "Pushed");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "Pushed", value);
			}
		}
		...
		{
			 Factory.ExecuteMethod(this, "Copy", toolbar, before);
		}
		...
		{
			 Factory.ExecuteMethod(this, "Move", toolbar, before);
		}
