...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class Ovals : NetOffice.ExcelApi.Behind.Ovals_, NetOffice.ExcelApi.Ovals
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.Ovals);
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.Oval Add(Double left, Double top, Double width, Double height)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Oval>(this, "Add", typeof(NetOffice.ExcelApi.Oval), left, top, width, height);
        }
