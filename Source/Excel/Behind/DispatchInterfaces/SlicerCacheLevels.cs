...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class SlicerCacheLevels : COMObject, NetOffice.ExcelApi.SlicerCacheLevels
    {
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]        public SlicerCacheLevels(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
        {
        }
