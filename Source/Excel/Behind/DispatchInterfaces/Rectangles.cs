...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class Rectangles_ : COMObject, NetOffice.ExcelApi.Rectangles_
    {
        #region Ctor
        ...
        public Rectangles_(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public Rectangles_(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
        {
        ...
        public Rectangles_(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
        {
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public Rectangles_(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
        {
        }
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public Rectangles_(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public Rectangles_(ICOMObject replacedObject) : base(replacedObject)
        {
        }
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public Rectangles_() : base()
        {
        }

        /// <param name="progId">registered progID</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public Rectangles_(string progId) : base(progId)
        {
        }
    ...
    public class Rectangles : NetOffice.ExcelApi.Behind.Rectangles_, NetOffice.ExcelApi.Rectangles
    {
        ...
        {
            return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Rectangle>(this, "Add", typeof(NetOffice.ExcelApi.Rectangle), left, top, width, height);
        }
