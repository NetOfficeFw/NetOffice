...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class Rectangles : NetOffice.ExcelApi.Behind.Rectangles_, NetOffice.ExcelApi.Rectangles
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.Rectangles);
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.Rectangle Add(Double left, Double top, Double width, Double height)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Rectangle>(this, "Add", typeof(NetOffice.ExcelApi.Rectangle), left, top, width, height);
        }
