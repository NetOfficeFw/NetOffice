...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class Panes : COMObject, NetOffice.ExcelApi.Panes
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public Panes(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		public NetOffice.ExcelApi.Pane this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.Pane>(this, "_Default", typeof(NetOffice.ExcelApi.Pane), index);
			}
		}
