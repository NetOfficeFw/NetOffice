...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class ListBoxes_ : COMObject, NetOffice.ExcelApi.ListBoxes_
    {
        #region Ctor
    ...
    public class ListBoxes : NetOffice.ExcelApi.Behind.ListBoxes_, NetOffice.ExcelApi.ListBoxes
    {
        ...
        {
            return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ListBox>(this, "Add", typeof(NetOffice.ExcelApi.ListBox), left, top, width, height);
        }
