...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class Drawings_ : COMObject, NetOffice.ExcelApi.Drawings_
    {
        #region Ctor
    ...
    public class Drawings : NetOffice.ExcelApi.Behind.Drawings_, NetOffice.ExcelApi.Drawings
    {
        ...
        {
            return Factory.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Drawing>(this, "Add", typeof(NetOffice.ExcelApi.Drawing), new object[] { x1, y1, x2, y2, closed });
        }
