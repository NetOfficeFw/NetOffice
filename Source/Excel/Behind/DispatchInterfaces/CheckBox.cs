...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class CheckBox_ : COMObject, NetOffice.ExcelApi.CheckBox_
    {
        #region Ctor
        ...
        public CheckBox_(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public CheckBox_(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
        {
        ...
        public CheckBox_(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
        {
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public CheckBox_(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
        {
        }
        ...
        ///<param name="comProxyType">Type of inner wrapped COM proxy"</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public CheckBox_(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public CheckBox_(ICOMObject replacedObject) : base(replacedObject)
        {
        }
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public CheckBox_() : base()
        {
        }

        /// <param name="progId">registered progID</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public CheckBox_(string progId) : base(progId)
        {
        }
    ...
    public class CheckBox : NetOffice.ExcelApi.Behind.CheckBox_, NetOffice.ExcelApi.CheckBox
    {
