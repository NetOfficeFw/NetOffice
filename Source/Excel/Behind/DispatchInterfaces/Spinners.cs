...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class Spinners : COMObject, NetOffice.ExcelApi.Spinners
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.Spinners);
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		public virtual NetOffice.ExcelApi.Spinner Add(Double left, Double top, Double width, Double height)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Spinner>(this, "Add", typeof(NetOffice.ExcelApi.Spinner), left, top, width, height);
		}
