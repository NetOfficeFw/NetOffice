...
namespace NetOffice.ExcelApi.Behind
{
	...
	/// </summary>	/// <remarks> MSDN Online: http://msdn.microsoft.com/en-us/en-us/library/office/ff194125.aspx </remarks>
	[SupportByVersion("Excel", 14,15,16)]
	...
	public class Slicers : COMObject, NetOffice.ExcelApi.Slicers
	{
        ...
        ///<param name="parentObject">object there has created the proxy</param>
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]		public Slicers(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
		{
		}
		...
		public NetOffice.ExcelApi.Slicer this[object index]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.Slicer>(this, "_Default", typeof(NetOffice.ExcelApi.Slicer), index);
			}
		}
