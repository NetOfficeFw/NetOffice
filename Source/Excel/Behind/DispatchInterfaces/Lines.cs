...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class Lines : COMObject, NetOffice.ExcelApi.Lines
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.Lines);
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		public virtual NetOffice.ExcelApi.Line Add(Double x1, Double y1, Double x2, Double y2)
		{
			return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.Line>(this, "Add", typeof(NetOffice.ExcelApi.Line), x1, y1, x2, y2);
		}
