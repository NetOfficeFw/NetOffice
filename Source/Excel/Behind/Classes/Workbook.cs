...
namespace NetOffice.ExcelApi.Behind
{
    ...
    [ComEventInterface(typeof(NetOffice.ExcelApi.EventContracts.WorkbookEvents))]
    internal class Workbook : NetOffice.ExcelApi.Behind._Workbook, NetOffice.ExcelApi.Workbook
    {
