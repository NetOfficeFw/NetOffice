...
namespace NetOffice.ExcelApi.Behind
{
    ...
    [ComEventContract(typeof(NetOffice.ExcelApi.EventContracts.OLEObjectEvents))]
    public class OLEObject : NetOffice.ExcelApi.Behind._OLEObject, NetOffice.ExcelApi.OLEObject
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.OLEObject);
