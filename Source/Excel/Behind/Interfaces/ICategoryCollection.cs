...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class ICategoryCollection : COMObject, NetOffice.ExcelApi.ICategoryCollection
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.ICategoryCollection);
        ...
        public virtual NetOffice.ExcelApi.ChartCategory this[object index]
        {
            get
            {
                return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ChartCategory>(this, "_Default", typeof(NetOffice.ExcelApi.ChartCategory), index);
            }
        }
