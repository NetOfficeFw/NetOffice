...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IModelTable : COMObject, NetOffice.ExcelApi.IModelTable
    {
        ...
        public IModelTable(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public NetOffice.ExcelApi.ModelTableColumns ModelTableColumns
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.ModelTableColumns>(this, "ModelTableColumns", typeof(NetOffice.ExcelApi.ModelTableColumns));
            }
        }
        ...
        public NetOffice.ExcelApi.WorkbookConnection SourceWorkbookConnection
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.WorkbookConnection>(this, "SourceWorkbookConnection", typeof(NetOffice.ExcelApi.WorkbookConnection));
            }
        }
