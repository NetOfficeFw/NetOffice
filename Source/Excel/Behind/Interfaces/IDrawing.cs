...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IDrawing_ : COMObject, NetOffice.ExcelApi.IDrawing_
    {
        ...
        {
            return InvokerService.InvokeInternal.ExecuteVariantPropertyGet(this, "Vertices", index1, index2);
        }
        ...
        {
            return InvokerService.InvokeInternal.ExecuteVariantPropertyGet(this, "Vertices", index1);
        }
    ...
    public class IDrawing : NetOffice.ExcelApi.Behind.IDrawing_, NetOffice.ExcelApi.IDrawing
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.IDrawing);
        ...
        {
            return InvokerService.InvokeInternal.ExecuteVariantMethodGet(this, "AddVertex", left, top);
        }
