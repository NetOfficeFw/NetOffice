...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IMenuItems : COMObject, NetOffice.ExcelApi.IMenuItems
    {
        ...
        public IMenuItems(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
