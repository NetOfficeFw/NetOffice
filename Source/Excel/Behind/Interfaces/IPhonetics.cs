...
namespace NetOffice.ExcelApi.Behind
{
	...
	public class IPhonetics : COMObject, NetOffice.ExcelApi.IPhonetics
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.IPhonetics);
		...
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		public virtual Int32 Add(Int32 start, Int32 length, string text)
		{
			return InvokerService.InvokeInternal.ExecuteInt32MethodGet(this, "Add", start, length, text);
		}
