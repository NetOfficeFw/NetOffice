...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IEditBoxes : NetOffice.ExcelApi.Behind.IEditBoxes_, NetOffice.ExcelApi.IEditBoxes
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.IEditBoxes);
        ...
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.EditBox>(this, "Add", typeof(NetOffice.ExcelApi.EditBox), left, top, width, height);
        }
