...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class IRectangle_ : COMObject, NetOffice.ExcelApi.IRectangle_
    {
        #region Ctor
    ...
    public class IRectangle : NetOffice.ExcelApi.Behind.IRectangle_, NetOffice.ExcelApi.IRectangle
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.IRectangle);
