...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IPageSetup_ : COMObject, NetOffice.ExcelApi.IPageSetup_
    {
        ...
        public IPageSetup_(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]        public IPageSetup_(string progId) : base(progId)
        {
        }
    ...
    public class IPageSetup : NetOffice.ExcelApi.Behind.IPageSetup_, NetOffice.ExcelApi.IPageSetup
    {
        ...
        /// <param name="parentObject">object there has created the proxy</param>
        /// <param name="proxyShare">proxy share instead if com proxy</param>
        public IPageSetup(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
