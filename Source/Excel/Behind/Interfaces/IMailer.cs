...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IMailer : COMObject, NetOffice.ExcelApi.IMailer
    {
        ...
        public IMailer(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
