...
namespace NetOffice.ExcelApi.Behind
{
    ...
    /// </summary>
    [SyntaxBypass]
    public class IButton_ : COMObject, NetOffice.ExcelApi.IButton_
    {
        #region Ctor
        ...
        public IButton_(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
    ...
    public class IButton : NetOffice.ExcelApi.Behind.IButton_, NetOffice.ExcelApi.IButton
    {
