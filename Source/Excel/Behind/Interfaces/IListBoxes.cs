...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IListBoxes : NetOffice.ExcelApi.Behind.IListBoxes_, NetOffice.ExcelApi.IListBoxes
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.IListBoxes);
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.ListBox Add(Double left, Double top, Double width, Double height)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.ListBox>(this, "Add", typeof(NetOffice.ExcelApi.ListBox), left, top, width, height);
        }
