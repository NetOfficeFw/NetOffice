...
namespace NetOffice.ExcelApi.Behind
{
	...
	/// </summary>
	public class IShapes : COMObject, NetOffice.ExcelApi.IShapes
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.IShapes);
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(IShapes);                return _type;
            }
        }
		...
		/// </summary>
		[SupportByVersion("Excel", 9,10,11,12,14,15,16)]
		public virtual Int32 SelectAll()
		{
			return InvokerService.InvokeInternal.ExecuteInt32MethodGet(this, "SelectAll");
		}
