...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IModelRelationships : COMObject, NetOffice.ExcelApi.IModelRelationships
    {
        ...
        public static Type LateBindingApiWrapperType
        {
            ...
            {
                if (null == _type)
                    _type = typeof(IModelRelationships);
                return _type;
            }
        }
        ...
        public IModelRelationships(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
        {
        }
        ...
        public IModelRelationships(Core factory, ICOMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
        {
        ...
        ///<param name="comProxy">inner wrapped COM proxy</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public IModelRelationships(ICOMObject parentObject, object comProxy) : base(parentObject, comProxy)
        {
        }
        ...
        public IModelRelationships(Core factory, ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
        {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public IModelRelationships(ICOMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(parentObject, comProxy, comProxyType)
        {
        }

        ///<param name="replacedObject">object to replaced. replacedObject are not usable after this action</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public IModelRelationships(ICOMObject replacedObject) : base(replacedObject)
        {
        }

        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public IModelRelationships() : base()
        {
        }

        /// <param name="progId">registered progID</param>
        [EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
        public IModelRelationships(string progId) : base(progId)
        {
        }
        ...
        public NetOffice.ExcelApi.ModelRelationship this[object index]
        {
            get
            {
                return Factory.ExecuteKnownReferencePropertyGet<NetOffice.ExcelApi.ModelRelationship>(this, "_Default", typeof(NetOffice.ExcelApi.ModelRelationship), index);
            }
        }
