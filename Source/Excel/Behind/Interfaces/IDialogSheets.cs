...
namespace NetOffice.ExcelApi.Behind
{
    ...
    public class IDialogSheets : COMObject, NetOffice.ExcelApi.IDialogSheets
    {
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ExcelApi.IDialogSheets);
        ...
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.DialogSheet Add(object before, object after, object count)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.DialogSheet>(this, "Add", typeof(NetOffice.ExcelApi.DialogSheet), before, after, count);
        }
        ...
        [CustomMethod]
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.DialogSheet Add()
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.DialogSheet>(this, "Add", typeof(NetOffice.ExcelApi.DialogSheet));
        }
        ...
        [CustomMethod]
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.DialogSheet Add(object before)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.DialogSheet>(this, "Add", typeof(NetOffice.ExcelApi.DialogSheet), before);
        }
        ...
        [CustomMethod]
        [SupportByVersion("Excel", 9, 10, 11, 12, 14, 15, 16)]
        public virtual NetOffice.ExcelApi.DialogSheet Add(object before, object after)
        {
            return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.ExcelApi.DialogSheet>(this, "Add", typeof(NetOffice.ExcelApi.DialogSheet), before, after);
        }
