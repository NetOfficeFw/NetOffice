...
{
	///<summary>
	/// DispatchInterface Parameters SupportByLibrary DAO3.6 DAO12 
	///</summary>
	...
	public class Parameters : _Collection
	{
		...
		[SupportByLibrary("DAO3.6","DAO12")]
		public LateBindingApi.DAOApi.Parameter get_Item(object item)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(item);
			object returnItem = Invoker.PropertyGet(this, "Item", paramsArray);
			LateBindingApi.DAOApi.Parameter newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.DAOApi.Parameter;
			return newObject;
		}
