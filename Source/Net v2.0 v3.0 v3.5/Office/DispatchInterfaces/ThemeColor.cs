...
{
	///<summary>
	/// DispatchInterface ThemeColor SupportByLibrary OF12 OF14 
	///</summary>
	...
	public class ThemeColor : _IMsoDispObj
	{
		...
		/// </summary>
		[SupportByLibrary("OF12","OF14")]
		public LateBindingApi.OfficeApi.Enums.MsoThemeColorSchemeIndex ThemeColorSchemeIndex
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ThemeColorSchemeIndex", paramsArray);
				return (LateBindingApi.OfficeApi.Enums.MsoThemeColorSchemeIndex)returnItem;
			}
		}
