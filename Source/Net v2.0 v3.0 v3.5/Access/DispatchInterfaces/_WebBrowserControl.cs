...
{
	///<summary>
	/// DispatchInterface _WebBrowserControl SupportByLibrary Access, 14
	///</summary>
	...
	public class _WebBrowserControl : NetOffice.OfficeApi.IAccessible
	{
		...
		public NetOffice.AccessApi.Enums.AcWebBrowserState ReadyState
		{
			get
			{
				...
				return (NetOffice.AccessApi.Enums.AcWebBrowserState)returnItem;
			}
		}
		...
		public NetOffice.AccessApi.Enums.AcWebBrowserScrollBars ScrollBars
		{
			get
			{
				...
				return (NetOffice.AccessApi.Enums.AcWebBrowserScrollBars)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
