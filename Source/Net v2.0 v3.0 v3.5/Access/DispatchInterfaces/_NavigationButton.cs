...
{
	///<summary>
	/// DispatchInterface _NavigationButton SupportByLibrary AC14 
	///</summary>
	[SupportByLibrary("AC14")]
	public class _NavigationButton : LateBindingApi.OfficeApi.IAccessible
	{
		...
		/// </summary>
		[SupportByLibrary("AC14")]
		public LateBindingApi.AccessApi.Enums.AcCursorOnHover CursorOnHover
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "CursorOnHover", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcCursorOnHover)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibrary("AC14")]
		public LateBindingApi.AccessApi.Enums.AcPictureCaptionArrangement PictureCaptionArrangement
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "PictureCaptionArrangement", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcPictureCaptionArrangement)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibrary("AC14")]
		public LateBindingApi.AccessApi.NavigationButton ParentTab
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "ParentTab", paramsArray);
				LateBindingApi.AccessApi.NavigationButton newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.AccessApi.NavigationButton;
				return newObject;
			}
		}
