...
{
	///<summary>
	/// DispatchInterface _Combobox SupportByLibrary AC09 AC10 AC11 AC12 AC14 
	///</summary>
	[SupportByLibrary("AC09","AC10","AC11","AC12","AC14")]
	public class _Combobox : LateBindingApi.OfficeApi.IAccessible
	{
		...
		/// </summary>
		[SupportByLibrary("AC09","AC10","AC11","AC12","AC14")]
		public LateBindingApi.AccessApi.FormatConditions FormatConditions
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "FormatConditions", paramsArray);
				LateBindingApi.AccessApi.FormatConditions newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.AccessApi.FormatConditions;
				return newObject;
			}
		}
		...
		/// </summary>
		[SupportByLibrary("AC12","AC14")]
		public LateBindingApi.AccessApi.Enums.AcSeparatorCharacters SeparatorCharacters
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "SeparatorCharacters", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcSeparatorCharacters)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibrary("AC12","AC14")]
		public LateBindingApi.AccessApi.Enums.AcDisplayAsHyperlink DisplayAsHyperlink
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "DisplayAsHyperlink", paramsArray);
				return (LateBindingApi.AccessApi.Enums.AcDisplayAsHyperlink)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
