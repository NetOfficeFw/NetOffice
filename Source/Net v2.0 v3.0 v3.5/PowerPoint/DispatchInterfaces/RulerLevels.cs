...
{
	///<summary>
	/// DispatchInterface RulerLevels SupportByLibrary PP09 PP10 PP11 PP12 PP14 
	///</summary>
	...
	public class RulerLevels : Collection
	{
		...
		[SupportByLibrary("PP09","PP10","PP11","PP12","PP14")]
		public LateBindingApi.PowerPointApi.RulerLevel Item(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.PowerPointApi.RulerLevel newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.PowerPointApi.RulerLevel;
			return newObject;
		}
