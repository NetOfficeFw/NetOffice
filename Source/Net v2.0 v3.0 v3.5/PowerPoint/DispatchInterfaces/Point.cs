...
namespace LateBindingApi.PowerPointApi
{
	...
	public class Point : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("PP14")]
		public LateBindingApi.PowerPointApi.DataLabel DataLabel
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "DataLabel", paramsArray);
				LateBindingApi.PowerPointApi.DataLabel newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.PowerPointApi.DataLabel;
				return newObject;
			}
		}
		...
		/// SupportByLibrary PP14 
		/// </summary>
		/// <param name="loc">LateBindingApi.PowerPointApi.Enums.XlPieSliceLocation loc</param>
		/// <param name="Index">LateBindingApi.PowerPointApi.Enums.XlPieSliceIndex Index</param>
		[SupportByLibrary("PP14")]
		public Double PieSliceLocation(LateBindingApi.PowerPointApi.Enums.XlPieSliceLocation loc, LateBindingApi.PowerPointApi.Enums.XlPieSliceIndex index)
		{
