...
namespace LateBindingApi.PowerPointApi
{
	...
	public class FilterEffect : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("PP10","PP11","PP12","PP14")]
		public LateBindingApi.PowerPointApi.Enums.MsoAnimFilterEffectType Type
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Type", paramsArray);
				return (LateBindingApi.PowerPointApi.Enums.MsoAnimFilterEffectType)returnItem;
			}
			set
			{
		...
		/// </summary>
		[SupportByLibrary("PP10","PP11","PP12","PP14")]
		public LateBindingApi.PowerPointApi.Enums.MsoAnimFilterEffectSubtype Subtype
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Subtype", paramsArray);
				return (LateBindingApi.PowerPointApi.Enums.MsoAnimFilterEffectSubtype)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibrary("PP10","PP11","PP12","PP14")]
		public LateBindingApi.OfficeApi.Enums.MsoTriState Reveal
		{
			get
			{
				object[] paramsArray = null;
