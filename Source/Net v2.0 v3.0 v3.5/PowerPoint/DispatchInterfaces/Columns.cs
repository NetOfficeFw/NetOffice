...
{
	///<summary>
	/// DispatchInterface Columns SupportByLibrary PP09 PP10 PP11 PP12 PP14 
	///</summary>
	...
	public class Columns : Collection
	{
		...
		[SupportByLibrary("PP09","PP10","PP11","PP12","PP14")]
		public LateBindingApi.PowerPointApi.Column Item(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.PowerPointApi.Column newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.PowerPointApi.Column;
			return newObject;
		}
		...
		/// SupportByLibrary PP09 PP10 PP11 PP12 PP14 
		/// </summary>
		/// <param name="BeforeColumn">Int32 BeforeColumn</param>
		[SupportByLibrary("PP09","PP10","PP11","PP12","PP14")]
		public LateBindingApi.PowerPointApi.Column Add(Int32 beforeColumn)
		{
