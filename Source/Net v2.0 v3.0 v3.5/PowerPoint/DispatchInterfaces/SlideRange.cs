...
{
	///<summary>
	/// DispatchInterface SlideRange SupportByLibrary PowerPoint, 9,10,11,12,14
	///</summary>
	...
	public class SlideRange : COMObject ,IEnumerable
	{
		...
		public NetOffice.PowerPointApi._Master Master
		{
			get
			{
				...
				NetOffice.PowerPointApi._Master newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PowerPointApi._Master.LateBindingApiWrapperType) as NetOffice.PowerPointApi._Master;
				return newObject;
			}
		}
