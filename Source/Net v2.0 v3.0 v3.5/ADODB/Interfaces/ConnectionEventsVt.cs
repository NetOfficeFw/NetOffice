...
namespace LateBindingApi.ADODBApi
{
	...
	public class ConnectionEventsVt : COMObject
	{
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 InfoMessage(LateBindingApi.ADODBApi.Error pError, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Connection pConnection)
		{
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 BeginTransComplete(Int32 transactionLevel, LateBindingApi.ADODBApi.Error pError, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Connection pConnection)
		{
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 CommitTransComplete(LateBindingApi.ADODBApi.Error pError, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Connection pConnection)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(pError, adStatus, pConnection);
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 RollbackTransComplete(LateBindingApi.ADODBApi.Error pError, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Connection pConnection)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(pError, adStatus, pConnection);
		...
		/// <param name="adStatus">LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus</param>
		/// <param name="pCommand">LateBindingApi.ADODBApi._Command pCommand</param>
		/// <param name="pRecordset">LateBindingApi.ADODBApi._Recordset pRecordset</param>
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 WillExecute(ref string source, LateBindingApi.ADODBApi.Enums.CursorTypeEnum cursorType, LateBindingApi.ADODBApi.Enums.LockTypeEnum lockType, ref Int32 options, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Command pCommand, LateBindingApi.ADODBApi._Recordset pRecordset, LateBindingApi.ADODBApi._Connection pConnection)
		{
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 ExecuteComplete(Int32 recordsAffected, LateBindingApi.ADODBApi.Error pError, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Command pCommand, LateBindingApi.ADODBApi._Recordset pRecordset, LateBindingApi.ADODBApi._Connection pConnection)
		{
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 WillConnect(ref string connectionString, ref string userID, ref string password, ref Int32 options, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Connection pConnection)
		{
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 ConnectComplete(LateBindingApi.ADODBApi.Error pError, LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Connection pConnection)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(pError, adStatus, pConnection);
		...
		/// <param name="pConnection">LateBindingApi.ADODBApi._Connection pConnection</param>
		[SupportByLibrary("ADO2.1","ADO2.5")]
		public Int32 Disconnect(LateBindingApi.ADODBApi.Enums.EventStatusEnum adStatus, LateBindingApi.ADODBApi._Connection pConnection)
		{
