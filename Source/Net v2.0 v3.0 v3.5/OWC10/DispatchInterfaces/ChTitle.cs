...
{
	///<summary>
	/// DispatchInterface ChTitle SupportByLibrary XWC1.0 
	///</summary>
	...
	public class ChTitle : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.Enums.ChartTitlePositionEnum Position
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Position", paramsArray);
				return (LateBindingApi.OWC10Api.Enums.ChartTitlePositionEnum)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
