...
namespace LateBindingApi.OWC10Api
{
	...
	public class FieldListHierarchy : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.FieldListNode Root
		{
			get
			{
		...
		/// </summary>
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.FieldListNode Selection
		{
			get
			{
				object[] paramsArray = null;
		...
		/// SupportByLibrary XWC1.0 
		/// </summary>
		/// <param name="pflhs">LateBindingApi.OWC10Api.FieldListHierarchySite pflhs</param>
		[SupportByLibrary("XWC1.0")]
		public void SetHierarchySite(LateBindingApi.OWC10Api.FieldListHierarchySite pflhs)
		{
		...
		/// SupportByLibrary XWC1.0 
		/// </summary>
		/// <param name="pflnParent">LateBindingApi.OWC10Api.FieldListNode pflnParent</param>
		...
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.FieldListNode AddNode(LateBindingApi.OWC10Api.FieldListNode pflnParent, bool fInsertFirst, Int32 nID, string bstrName, string bstrData, Int32 nType)
		{
		...
		/// <param name="nID">Int32 nID</param>
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.FieldListNode GetNode(Int32 nID)
		{
		...
		[SupportByLibrary("XWC1.0")]
		public void RemoveNode(LateBindingApi.OWC10Api.FieldListNode pfln)
		{
		...
		/// <param name="nType">Int32 nType</param>
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.FieldListType AddType(Int32 nType)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(nType);
			object returnItem = Invoker.MethodReturn(this, "AddType", paramsArray);
			LateBindingApi.OWC10Api.FieldListType newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.OWC10Api.FieldListType;
			return newObject;
		}
		...
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.FieldListType GetType(Int32 nTypeId)
		{
