...
namespace NetOffice.OWC10Api
{
	...
	public class PivotResultMemberProperties : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("XWC1.0")]
		public NetOffice.OWC10Api.PivotResultMemberProperty get_Item(object varIndex)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(varIndex);
			object returnItem = Invoker.PropertyGet(this, "Item", paramsArray);
			NetOffice.OWC10Api.PivotResultMemberProperty newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.OWC10Api.PivotResultMemberProperty;
			return newObject;
		}
