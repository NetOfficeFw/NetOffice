...
namespace LateBindingApi.OWC10Api
{
	...
	public class ChSegment : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.ChSegmentBoundary Begin
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Begin", paramsArray);
				LateBindingApi.OWC10Api.ChSegmentBoundary newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.OWC10Api.ChSegmentBoundary;
				return newObject;
			}
		}
		...
		/// </summary>
		[SupportByLibrary("XWC1.0")]
		public LateBindingApi.OWC10Api.ChSegmentBoundary End
		{
			get
			{
				object[] paramsArray = null;
