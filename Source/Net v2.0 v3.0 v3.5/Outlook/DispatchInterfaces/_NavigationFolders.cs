	...
	public class _NavigationFolders : COMObject
	{
		...
		public NetOffice.OutlookApi._NavigationFolder this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi._NavigationFolder newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi._NavigationFolder.LateBindingApiWrapperType) as NetOffice.OutlookApi._NavigationFolder;
				return newObject;
			}
		}
