...
namespace LateBindingApi.OutlookApi
{
	...
	public class Links : COMObject
	{
		...
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.Link Item(object index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.OutlookApi.Link newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.OutlookApi.Link;
			return newObject;
		}
		...
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.Link Add(object item)
		{
