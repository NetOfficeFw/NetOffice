...
namespace LateBindingApi.OutlookApi
{
	...
	public class _TimeZones : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi._TimeZone CurrentTimeZone
		{
			get
			{
				object[] paramsArray = null;
		...
		[SupportByLibrary("OL12","OL14")]
		public LateBindingApi.OutlookApi._TimeZone Item(object index)
		{
		...
		/// <param name="SourceTimeZone">LateBindingApi.OutlookApi._TimeZone SourceTimeZone</param>
		/// <param name="DestinationTimeZone">LateBindingApi.OutlookApi._TimeZone DestinationTimeZone</param>
		[SupportByLibrary("OL12","OL14")]
		public DateTime ConvertTime(DateTime sourceDateTime, LateBindingApi.OutlookApi._TimeZone sourceTimeZone, LateBindingApi.OutlookApi._TimeZone destinationTimeZone)
		{
