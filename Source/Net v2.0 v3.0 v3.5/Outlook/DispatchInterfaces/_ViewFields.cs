...
{
	///<summary>
	/// DispatchInterface _ViewFields SupportByLibrary Outlook, 12,14
	///</summary>
	...
	public class _ViewFields : COMObject
	{
		...
		public NetOffice.OutlookApi._ViewField this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi._ViewField newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi._ViewField.LateBindingApiWrapperType) as NetOffice.OutlookApi._ViewField;
				return newObject;
			}
		}
