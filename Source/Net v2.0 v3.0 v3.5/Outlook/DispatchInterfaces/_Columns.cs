...
{
	///<summary>
	/// DispatchInterface _Columns SupportByLibrary Outlook, 12,14
	///</summary>
	...
	public class _Columns : COMObject
	{
		...
		public NetOffice.OutlookApi._Column this[object index]
		{
			get
			{
				...
				NetOffice.OutlookApi._Column newObject = LateBindingApi.Core.Factory.CreateKnownObjectFromComProxy(this, returnItem,NetOffice.OutlookApi._Column.LateBindingApiWrapperType) as NetOffice.OutlookApi._Column;
				return newObject;
			}
		}
