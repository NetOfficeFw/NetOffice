...
namespace LateBindingApi.OutlookApi
{
	...
	public class _OutlookBarShortcuts : COMObject
	{
		...
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.OutlookBarShortcut Item(object index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.OutlookApi.OutlookBarShortcut newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.OutlookApi.OutlookBarShortcut;
			return newObject;
		}
		...
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.OutlookBarShortcut Add(object target, string name, object index)
		{
		...
		/// <param name="Name">string Name</param>
		[SupportByLibrary("OL09","OL10","OL11","OL12","OL14")]
		public LateBindingApi.OutlookApi.OutlookBarShortcut Add(object target, string name)
		{
