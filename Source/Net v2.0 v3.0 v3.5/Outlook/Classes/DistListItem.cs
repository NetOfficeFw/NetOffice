...
namespace LateBindingApi.OutlookApi
{
	...
	public delegate void DistListItem_AttachmentAddEventHandler(LateBindingApi.OutlookApi.Attachment Attachment);
	public delegate void DistListItem_AttachmentReadEventHandler(LateBindingApi.OutlookApi.Attachment Attachment);
	public delegate void DistListItem_BeforeAttachmentSaveEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void DistListItem_BeforeDeleteEventHandler(COMObject Item, ref bool Cancel);
	public delegate void DistListItem_AttachmentRemoveEventHandler(LateBindingApi.OutlookApi.Attachment Attachment);
	public delegate void DistListItem_BeforeAttachmentAddEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void DistListItem_BeforeAttachmentPreviewEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void DistListItem_BeforeAttachmentReadEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
	public delegate void DistListItem_BeforeAttachmentWriteToTempFileEventHandler(LateBindingApi.OutlookApi.Attachment Attachment, ref bool Cancel);
