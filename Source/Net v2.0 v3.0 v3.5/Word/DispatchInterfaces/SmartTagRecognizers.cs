...
namespace NetOffice.WordApi
{
	...
	public class SmartTagRecognizers : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("WD11","WD12","WD14")]
		public NetOffice.WordApi.SmartTagRecognizer Item(ref object index)
		{
			ParameterModifier[] modifiers = Invoker.CreateParamModifiers(true);
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray, modifiers);
			NetOffice.WordApi.SmartTagRecognizer newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as NetOffice.WordApi.SmartTagRecognizer;
