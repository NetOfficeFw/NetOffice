...
{
	///<summary>
	/// DispatchInterface PageNumber SupportByLibrary WD09 WD10 WD11 WD12 WD14 
	///</summary>
	...
	public class PageNumber : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdPageNumberAlignment Alignment
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Alignment", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdPageNumberAlignment)returnItem;
			}
			set
			{
