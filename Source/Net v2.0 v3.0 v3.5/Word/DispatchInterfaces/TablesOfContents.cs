...
namespace LateBindingApi.WordApi
{
	...
	public class TablesOfContents : COMObject ,IEnumerable
	{
		...
		/// </summary>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdTocFormat Format
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Format", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdTocFormat)returnItem;
			}
			set
			{
		...
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.TableOfContents Item(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.WordApi.TableOfContents newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.WordApi.TableOfContents;
			return newObject;
		}
		...
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.TableOfContents AddOld(LateBindingApi.WordApi.Range range, ref object useHeadingStyles, ref object upperHeadingLevel, ref object lowerHeadingLevel, ref object useFields, ref object tableID, ref object rightAlignPageNumbers, ref object includePageNumbers, ref object addedStyles)
		{
		...
		/// <param name="Range">LateBindingApi.WordApi.Range Range</param>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.TableOfContents AddOld(LateBindingApi.WordApi.Range range)
		{
		...
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Field MarkEntry(LateBindingApi.WordApi.Range range, ref object entry, ref object entryAutoText, ref object tableID, ref object level)
		{
		...
		/// <param name="Range">LateBindingApi.WordApi.Range Range</param>
		[SupportByLibrary("WD09","WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.TableOfContents Add(LateBindingApi.WordApi.Range range)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(range);
		...
		/// <param name="HidePageNumbersInWeb">ref optional object HidePageNumbersInWeb</param>
		[SupportByLibrary("WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.TableOfContents Add2000(LateBindingApi.WordApi.Range range, ref object useHeadingStyles, ref object upperHeadingLevel, ref object lowerHeadingLevel, ref object useFields, ref object tableID, ref object rightAlignPageNumbers, ref object includePageNumbers, ref object addedStyles, ref object useHyperlinks, ref object hidePageNumbersInWeb)
		{
			ParameterModifier[] modifiers = Invoker.CreateParamModifiers(false,true,true,true,true,true,true,true,true,true,true);
			object[] paramsArray = Invoker.ValidateParamsArray(range, useHeadingStyles, upperHeadingLevel, lowerHeadingLevel, useFields, tableID, rightAlignPageNumbers, includePageNumbers, addedStyles, useHyperlinks, hidePageNumbersInWeb);
		...
		/// <param name="Range">LateBindingApi.WordApi.Range Range</param>
		[SupportByLibrary("WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.TableOfContents Add2000(LateBindingApi.WordApi.Range range)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(range);
