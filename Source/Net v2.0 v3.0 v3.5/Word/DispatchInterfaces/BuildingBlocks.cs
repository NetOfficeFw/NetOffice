...
namespace LateBindingApi.WordApi
{
	...
	public class BuildingBlocks : COMObject
	{
		...
		[SupportByLibrary("WD12","WD14")]
		public LateBindingApi.WordApi.BuildingBlock Add(string name, LateBindingApi.WordApi.Range range, ref object description, LateBindingApi.WordApi.Enums.WdDocPartInsertOptions insertOptions)
		{
