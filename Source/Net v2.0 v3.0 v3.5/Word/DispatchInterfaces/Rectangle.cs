...
namespace LateBindingApi.WordApi
{
	...
	public class Rectangle : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Enums.WdRectangleType RectangleType
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "RectangleType", paramsArray);
				return (LateBindingApi.WordApi.Enums.WdRectangleType)returnItem;
			}
		}
		...
		/// </summary>
		[SupportByLibrary("WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Lines Lines
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Lines", paramsArray);
				LateBindingApi.WordApi.Lines newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.WordApi.Lines;
				return newObject;
			}
		}
