...
namespace NetOffice.WordApi
{
	...
	public class Lines : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("WD11","WD12","WD14")]
		public NetOffice.WordApi.Line Item(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			NetOffice.WordApi.Line newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as NetOffice.WordApi.Line;
			return newObject;
		}
