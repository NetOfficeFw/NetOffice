...
namespace LateBindingApi.WordApi
{
	...
	public class Lines : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("WD11","WD12","WD14")]
		public LateBindingApi.WordApi.Line Item(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.WordApi.Line newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.WordApi.Line;
			return newObject;
		}
