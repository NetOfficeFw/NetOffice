	...
	public class EmailSignature : COMObject
	{
		...
		public NetOffice.WordApi.EmailSignatureEntries EmailSignatureEntries
		{
			get
			{
				...
				NetOffice.WordApi.EmailSignatureEntries newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as NetOffice.WordApi.EmailSignatureEntries;
				return newObject;
			}
		}
