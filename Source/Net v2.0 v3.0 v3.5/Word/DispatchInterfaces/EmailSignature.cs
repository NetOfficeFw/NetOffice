...
{
	///<summary>
	/// DispatchInterface EmailSignature SupportByLibrary WD09 WD10 WD11 WD12 WD14 
	///</summary>
	...
	public class EmailSignature : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("WD10","WD11","WD12","WD14")]
		public LateBindingApi.WordApi.EmailSignatureEntries EmailSignatureEntries
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "EmailSignatureEntries", paramsArray);
				LateBindingApi.WordApi.EmailSignatureEntries newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.WordApi.EmailSignatureEntries;
				return newObject;
			}
		}
