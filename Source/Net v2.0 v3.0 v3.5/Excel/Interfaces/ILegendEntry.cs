...
{
	///<summary>
	/// Interface ILegendEntry SupportByLibrary XL09 XL10 XL11 XL12 XL14 
	///</summary>
	...
	public class ILegendEntry : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.LegendKey LegendKey
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "LegendKey", paramsArray);
				LateBindingApi.ExcelApi.LegendKey newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.ExcelApi.LegendKey;
				return newObject;
			}
		}
