...
{
	///<summary>
	/// Interface ISparkVerticalAxis SupportByLibrary XL14 
	///</summary>
	...
	public class ISparkVerticalAxis : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XL14")]
		public LateBindingApi.ExcelApi.Enums.XlSparkScale MinScaleType
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MinScaleType", paramsArray);
				return (LateBindingApi.ExcelApi.Enums.XlSparkScale)returnItem;
			}
			set
			{
		...
		/// </summary>
		[SupportByLibrary("XL14")]
		public LateBindingApi.ExcelApi.Enums.XlSparkScale MaxScaleType
		{
			get
			{
				object[] paramsArray = null;
