...
{
	///<summary>
	/// Interface IXmlNamespaces SupportByLibrary XL11 XL12 XL14 
	///</summary>
	...
	public class IXmlNamespaces : COMObject ,IEnumerable
	{
		...
		public LateBindingApi.ExcelApi.XmlNamespace this[object index]
		{
			get
{			
		...
		/// <param name="Index">object Index</param>
		[SupportByLibrary("XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.XmlNamespace get_Item(object index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
