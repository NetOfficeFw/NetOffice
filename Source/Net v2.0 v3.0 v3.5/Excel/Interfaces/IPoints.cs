...
{
	///<summary>
	/// Interface IPoints SupportByLibrary XL09 XL10 XL11 XL12 XL14 
	///</summary>
	...
	public class IPoints : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Point Item(Int32 index)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(index);
			object returnItem = Invoker.MethodReturn(this, "Item", paramsArray);
			LateBindingApi.ExcelApi.Point newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.ExcelApi.Point;
			return newObject;
		}
		...
		public LateBindingApi.ExcelApi.Point this[Int32 index]
		{
			get
			{
				object[] paramsArray = Invoker.ValidateParamsArray(index);
