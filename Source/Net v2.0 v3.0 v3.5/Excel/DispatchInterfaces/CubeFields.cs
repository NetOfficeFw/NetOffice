...
{
	///<summary>
	/// DispatchInterface CubeFields SupportByLibrary XL09 XL10 XL11 XL12 XL14 
	///</summary>
	[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
	public class CubeFields : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.CubeField get_Item(object index)
		{
		...
		public LateBindingApi.ExcelApi.CubeField this[object index]
		{
			get
{			
			object[] paramsArray = Invoker.ValidateParamsArray(index);
		...
		[SupportByLibrary("XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.CubeField AddSet(string name, string caption)
		{
