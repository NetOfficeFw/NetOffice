...
namespace LateBindingApi.ExcelApi
{
	...
	public class CheckBoxes : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.CheckBox Add(Double left, Double top, Double width, Double height)
		{
			object[] paramsArray = Invoker.ValidateParamsArray(left, top, width, height);
			object returnItem = Invoker.MethodReturn(this, "Add", paramsArray);
			LateBindingApi.ExcelApi.CheckBox newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this, returnItem) as LateBindingApi.ExcelApi.CheckBox;
			return newObject;
		}
