...
{
	///<summary>
	/// DispatchInterface SmartTagOptions SupportByLibrary XL10 XL11 XL12 XL14 
	///</summary>
	...
	public class SmartTagOptions : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Enums.XlSmartTagDisplayMode DisplaySmartTags
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "DisplaySmartTags", paramsArray);
				return (LateBindingApi.ExcelApi.Enums.XlSmartTagDisplayMode)returnItem;
			}
			set
			{
