...
{
	///<summary>
	/// DispatchInterface PublishObject SupportByLibrary XL09 XL10 XL11 XL12 XL14 
	///</summary>
	...
	public class PublishObject : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Enums.XlSourceType SourceType
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "SourceType", paramsArray);
				return (LateBindingApi.ExcelApi.Enums.XlSourceType)returnItem;
			}
		}
		...
		/// </summary>
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Enums.XlHtmlType HtmlType
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "HtmlType", paramsArray);
				return (LateBindingApi.ExcelApi.Enums.XlHtmlType)returnItem;
			}
			set
			{
