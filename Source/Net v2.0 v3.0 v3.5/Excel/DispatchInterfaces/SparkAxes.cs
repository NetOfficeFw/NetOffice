...
namespace LateBindingApi.ExcelApi
{
	...
	public class SparkAxes : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XL14")]
		public LateBindingApi.ExcelApi.SparkVerticalAxis Vertical
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Vertical", paramsArray);
				LateBindingApi.ExcelApi.SparkVerticalAxis newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.ExcelApi.SparkVerticalAxis;
				return newObject;
			}
		}
		...
		/// </summary>
		[SupportByLibrary("XL14")]
		public LateBindingApi.ExcelApi.SparkHorizontalAxis Horizontal
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Horizontal", paramsArray);
				LateBindingApi.ExcelApi.SparkHorizontalAxis newObject = LateBindingApi.Core.Factory.CreateObjectFromComProxy(this,returnItem) as LateBindingApi.ExcelApi.SparkHorizontalAxis;
				return newObject;
			}
		}
