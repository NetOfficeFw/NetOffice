...
{
	///<summary>
	/// DispatchInterface Legend SupportByLibrary XL09 XL10 XL11 XL12 XL14 
	///</summary>
	...
	public class Legend : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Enums.XlLegendPosition Position
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "Position", paramsArray);
				return (LateBindingApi.ExcelApi.Enums.XlLegendPosition)returnItem;
			}
			set
			{
