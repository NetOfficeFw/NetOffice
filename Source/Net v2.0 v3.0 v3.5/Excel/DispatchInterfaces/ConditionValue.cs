...
{
	///<summary>
	/// DispatchInterface ConditionValue SupportByLibrary XL12 XL14 
	///</summary>
	...
	public class ConditionValue : COMObject
	{
		...
		[SupportByLibrary("XL12","XL14")]
		public void Modify(LateBindingApi.ExcelApi.Enums.XlConditionValueTypes newtype, object newvalue)
		{
		...
		/// <param name="newtype">LateBindingApi.ExcelApi.Enums.XlConditionValueTypes newtype</param>
		[SupportByLibrary("XL12","XL14")]
		public void Modify(LateBindingApi.ExcelApi.Enums.XlConditionValueTypes newtype)
		{
