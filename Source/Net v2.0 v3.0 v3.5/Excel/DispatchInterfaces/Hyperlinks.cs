...
{
	///<summary>
	/// DispatchInterface Hyperlinks SupportByLibrary XL09 XL10 XL11 XL12 XL14 
	///</summary>
	...
	public class Hyperlinks : COMObject ,IEnumerable
	{
		...
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Hyperlink get_Item(object index)
		{
		...
		public LateBindingApi.ExcelApi.Hyperlink this[object index]
		{
			get
{			
			object[] paramsArray = Invoker.ValidateParamsArray(index);
