...
namespace LateBindingApi.ExcelApi
{
	...
	public class Outline : COMObject
	{
		...
		/// </summary>
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Enums.XlSummaryColumn SummaryColumn
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "SummaryColumn", paramsArray);
				return (LateBindingApi.ExcelApi.Enums.XlSummaryColumn)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		/// </summary>
		[SupportByLibrary("XL09","XL10","XL11","XL12","XL14")]
		public LateBindingApi.ExcelApi.Enums.XlSummaryRow SummaryRow
		{
			get
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "SummaryRow", paramsArray);
				return (LateBindingApi.ExcelApi.Enums.XlSummaryRow)returnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
