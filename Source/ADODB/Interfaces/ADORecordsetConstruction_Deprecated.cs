...
namespace NetOffice.ADODBApi
{
	...
	public class ADORecordsetConstruction_Deprecated : COMObject
	{
		...
		public ADORecordsetConstruction_Deprecated(Core factory, COMObject parentObject, object comProxy) : base(factory, parentObject, comProxy)
		{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Browsable(false)]
		public ADORecordsetConstruction_Deprecated(Core factory, COMObject parentObject, object comProxy, NetRuntimeSystem.Type comProxyType) : base(factory, parentObject, comProxy, comProxyType)
		{
