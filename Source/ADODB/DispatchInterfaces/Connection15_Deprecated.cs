...
namespace NetOffice.ADODBApi
{
	...
	public interface Connection15_Deprecated : _ADO
	{
		#region Properties
		...
		[SupportByVersion("ADODB", 2.5)]
		NetOffice.ADODBApi._Recordset_Deprecated Execute(string commandText, object recordsAffected, object options);
		...
		[CustomMethod]
		[SupportByVersion("ADODB", 2.5)]
		NetOffice.ADODBApi._Recordset_Deprecated Execute(string commandText, object recordsAffected);
		...
		[SupportByVersion("ADODB", 2.5)]
		NetOffice.ADODBApi._Recordset_Deprecated OpenSchema(NetOffice.ADODBApi.Enums.SchemaEnum schema, object restrictions, object schemaID);
		...
		[CustomMethod]
		[SupportByVersion("ADODB", 2.5)]
		NetOffice.ADODBApi._Recordset_Deprecated OpenSchema(NetOffice.ADODBApi.Enums.SchemaEnum schema);
		...
		[CustomMethod]
		[SupportByVersion("ADODB", 2.5)]
		NetOffice.ADODBApi._Recordset_Deprecated OpenSchema(NetOffice.ADODBApi.Enums.SchemaEnum schema, object restrictions);
