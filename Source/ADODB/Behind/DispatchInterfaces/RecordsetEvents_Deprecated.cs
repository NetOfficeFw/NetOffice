...
namespace NetOffice.ADODBApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class RecordsetEvents_Deprecated : COMObject, NetOffice.ADODBApi.RecordsetEvents_Deprecated
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ADODBApi.RecordsetEvents_Deprecated);
