...
namespace NetOffice.ADODBApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface), BaseType]
 	public class _Stream : COMObject, NetOffice.ADODBApi._Stream
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ADODBApi._Stream);
		...
		[SupportByVersion("ADODB", 2.5)]
		public virtual void CopyTo(NetOffice.ADODBApi._Stream destStream, object charNumber)
		{
		...
		[CustomMethod]
		[SupportByVersion("ADODB", 2.5)]
		public virtual void CopyTo(NetOffice.ADODBApi._Stream destStream)
		{
