...
namespace NetOffice.ADODBApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class ADORecordsetConstruction : COMObject, NetOffice.ADODBApi.ADORecordsetConstruction
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ADODBApi.ADORecordsetConstruction);
