...
namespace NetOffice.ADODBApi.Behind
{
	...
	[EntityType(EntityType.IsInterface)]
 	public class ConnectionEventsVt_Deprecated : COMObject, NetOffice.ADODBApi.ConnectionEventsVt_Deprecated
	{
        ...
        public override Type ContractType
        {
            get
            {
                if(null == _contractType)
                    _contractType = typeof(NetOffice.ADODBApi.ConnectionEventsVt_Deprecated);
