...
namespace NetOffice.PublisherApi
{
	...
	public class Columns : COMObject , IEnumerable<NetOffice.PublisherApi.Column>
	{
		...
		public NetOffice.PublisherApi.Column this[Int32 index]
		{
			get
			{
				return Factory.ExecuteKnownReferenceMethodGet<NetOffice.PublisherApi.Column>(this, "Item", NetOffice.PublisherApi.Column.LateBindingApiWrapperType, index);
			}
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.PublisherApi.Column>(this, "Add", NetOffice.PublisherApi.Column.LateBindingApiWrapperType, beforeColumn);
		}
		...
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.PublisherApi.Column>(this, "Add", NetOffice.PublisherApi.Column.LateBindingApiWrapperType);
		}
