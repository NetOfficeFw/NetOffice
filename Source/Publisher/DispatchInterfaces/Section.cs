...
namespace NetOffice.PublisherApi
{
 	...
 	public class Section : COMObject
	{
		...
		public Int32 StartPageIndex
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "StartPageIndex");
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public Int32 PageNumberStart
		{
			get
			{
				return Factory.ExecuteInt32PropertyGet(this, "PageNumberStart");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "PageNumberStart", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.Enums.PbPageNumberFormat PageNumberFormat
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.PublisherApi.Enums.PbPageNumberFormat>(this, "PageNumberFormat");
			}
			set
			{
				Factory.ExecuteEnumPropertySet(this, "PageNumberFormat", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public bool ShowHeaderFooterOnFirstPage
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "ShowHeaderFooterOnFirstPage");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ShowHeaderFooterOnFirstPage", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public bool ContinueNumbersFromPreviousSection
		{
			get
			{
				return Factory.ExecuteBoolPropertyGet(this, "ContinueNumbersFromPreviousSection");
			}
			set
			{
				Factory.ExecuteValuePropertySet(this, "ContinueNumbersFromPreviousSection", value);
			}
		}
