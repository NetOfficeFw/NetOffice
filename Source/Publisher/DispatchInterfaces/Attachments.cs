...
namespace NetOffice.PublisherApi
{
	...
	public class Attachments : COMObject , IEnumerable<NetOffice.PublisherApi.Attachment>
	{
		...
		public NetOffice.PublisherApi.Attachment this[Int32 item]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.Attachment>(this, "Item", NetOffice.PublisherApi.Attachment.LateBindingApiWrapperType, item);
			}
		}
		...
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.Attachment Add(string filename)
		{
			return Factory.ExecuteKnownReferenceMethodGet<NetOffice.PublisherApi.Attachment>(this, "Add", NetOffice.PublisherApi.Attachment.LateBindingApiWrapperType, filename);
		}
       ...
       #region IEnumerable<NetOffice.PublisherApi.Attachment> Member
        
        /// <summary>
		/// SupportByVersion Publisher, 14,15,16
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
       public IEnumerator<NetOffice.PublisherApi.Attachment> GetEnumerator()  
       {
