...
{			
			...
			NetOffice.PublisherApi.Attachment newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PublisherApi.Attachment.LateBindingApiWrapperType) as NetOffice.PublisherApi.Attachment;
			return newObject;
			}
		}
