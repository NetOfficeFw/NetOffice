	...
	public class Field : COMObject
	{
		...
		public NetOffice.PublisherApi.Enums.PbFieldType Type
		{
			get
			{
				...
				return (NetOffice.PublisherApi.Enums.PbFieldType)intReturnItem;
			}
		}
		...
		public NetOffice.PublisherApi.PhoneticGuide PhoneticGuide
		{
			...
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "PhoneticGuide", paramsArray);
				NetOffice.PublisherApi.PhoneticGuide newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PublisherApi.PhoneticGuide.LateBindingApiWrapperType) as NetOffice.PublisherApi.PhoneticGuide;
				return newObject;
			}
		}
