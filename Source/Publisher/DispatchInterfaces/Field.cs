...
namespace NetOffice.PublisherApi
{
 	...
 	public class Field : COMObject
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.Enums.PbFieldType Type
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.PublisherApi.Enums.PbFieldType>(this, "Type");
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.Field Next
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.Field>(this, "Next", NetOffice.PublisherApi.Field.LateBindingApiWrapperType);
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.PhoneticGuide PhoneticGuide
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.PhoneticGuide>(this, "PhoneticGuide", NetOffice.PublisherApi.PhoneticGuide.LateBindingApiWrapperType);
			}
		}
