	...
	public class View : COMObject
	{
		...
		public NetOffice.PublisherApi.Page ActivePage
		{
			...
			set
			{
				...
				Invoker.PropertySet(this, "ActivePage", paramsArray);
			}
		}
		...
		public NetOffice.PublisherApi.Enums.PbZoom Zoom
		{
			get
			{
				...
				return (NetOffice.PublisherApi.Enums.PbZoom)intReturnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
		...
		public void ScrollShapeIntoView(NetOffice.PublisherApi.Shape shape)
		{
			...
			Invoker.Method(this, "ScrollShapeIntoView", paramsArray);
		}
		...
		{
			object[] paramsArray = null;
			Invoker.Method(this, "ZoomIn", paramsArray);
		}
		...
		{
			object[] paramsArray = null;
			Invoker.Method(this, "ZoomOut", paramsArray);
		}
