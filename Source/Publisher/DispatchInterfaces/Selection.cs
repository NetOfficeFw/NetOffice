...
namespace NetOffice.PublisherApi
{
 	...
 	public class Selection : COMObject
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.Enums.PbSelectionType Type
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.PublisherApi.Enums.PbSelectionType>(this, "Type");
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.ShapeRange ShapeRange
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.ShapeRange>(this, "ShapeRange", NetOffice.PublisherApi.ShapeRange.LateBindingApiWrapperType);
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.ShapeRange ChildShapeRange
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.ShapeRange>(this, "ChildShapeRange", NetOffice.PublisherApi.ShapeRange.LateBindingApiWrapperType);
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public NetOffice.PublisherApi.CellRange TableCellRange
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.CellRange>(this, "TableCellRange", NetOffice.PublisherApi.CellRange.LateBindingApiWrapperType);
			}
		}
