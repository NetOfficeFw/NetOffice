	...
	public class PageSetup : COMObject
	{
		...
		public object HorizontalGap
		{
			...
			set
			{
				...
				Invoker.PropertySet(this, "HorizontalGap", paramsArray);
			}
		}
		...
		public bool MultiplePagesPerSheet
		{
			...
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "MultiplePagesPerSheet", paramsArray);
				return NetRuntimeSystem.Convert.ToBoolean(returnItem);
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
				Invoker.PropertySet(this, "MultiplePagesPerSheet", paramsArray);
			}
		}
		...
		public object VerticalGap
		{
			...
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
				Invoker.PropertySet(this, "VerticalGap", paramsArray);
			}
		}
		...
		public NetOffice.PublisherApi.Enums.PbPublicationLayout PublicationLayout
		{
			...
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "PublicationLayout", paramsArray);
				int intReturnItem = NetRuntimeSystem.Convert.ToInt32(returnItem);
				return (NetOffice.PublisherApi.Enums.PbPublicationLayout)intReturnItem;
			}
			set
			{
				object[] paramsArray = Invoker.ValidateParamsArray(value);
				Invoker.PropertySet(this, "PublicationLayout", paramsArray);
			}
		}
		...
		public NetOffice.PublisherApi.Labels AvailableLabels
		{
			...
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "AvailableLabels", paramsArray);
				NetOffice.PublisherApi.Labels newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PublisherApi.Labels.LateBindingApiWrapperType) as NetOffice.PublisherApi.Labels;
				return newObject;
			}
		}
		...
		public NetOffice.PublisherApi.PageSizes AvailablePageSizes
		{
			...
			{
				object[] paramsArray = null;
				object returnItem = Invoker.PropertyGet(this, "AvailablePageSizes", paramsArray);
				NetOffice.PublisherApi.PageSizes newObject = Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.PublisherApi.PageSizes.LateBindingApiWrapperType) as NetOffice.PublisherApi.PageSizes;
				return newObject;
			}
		}
