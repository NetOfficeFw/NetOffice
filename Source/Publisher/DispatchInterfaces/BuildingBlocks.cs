...
namespace NetOffice.PublisherApi
{
	...
	public class BuildingBlocks : COMObject, NetOffice.CollectionsGeneric.IEnumerableProvider<NetOffice.PublisherApi.BuildingBlock>
	{
		...
		public NetOffice.PublisherApi.BuildingBlock this[Int32 item]
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.BuildingBlock>(this, "Item", NetOffice.PublisherApi.BuildingBlock.LateBindingApiWrapperType, item);
			}
		}
