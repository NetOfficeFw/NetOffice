...
namespace NetOffice.PublisherApi
{
 	...
 	public class WebListBox : COMObject
	{
		...
		public WebListBox(Core factory, ICOMObject parentObject, COMProxyShare proxyShare) : base(factory, parentObject, proxyShare)
		{
		}
		...
		public NetOffice.PublisherApi.WebListBoxItems ListBoxItems
		{
			get
			{
				return Factory.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.WebListBoxItems>(this, "ListBoxItems", NetOffice.PublisherApi.WebListBoxItems.LateBindingApiWrapperType);
			}
		}
		...
		public NetOffice.OfficeApi.Enums.MsoTriState MultiSelect
		{
			get
			{
				return Factory.ExecuteEnumPropertyGet<NetOffice.OfficeApi.Enums.MsoTriState>(this, "MultiSelect");
			}
			set
			{
