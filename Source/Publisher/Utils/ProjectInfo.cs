...
namespace PublisherApi.Utils
{
    ...
    public class ProjectInfo : IFactoryInfo
    {
        ...
        private string   _namespace     = "NetOffice.PublisherApi";
        private Guid[]    _componentGuid = new Guid[]{new Guid("0002123C-0000-0000-C000-000000000046")};
