...
namespace NetOffice.PublisherApi.Tools
{
    ...
    public abstract class COMAddin : COMAddinBase, IOfficeCOMAddin
    {
        ...
        /// </summary>
        private static readonly string _addinOfficeRegistryKey = "Software\\Microsoft\\Office\\Publisher\\Addins\\";
        ...
        /// </summary>
        public Office.Tools.Contribution.CommonUtils Utils { get; private set; }

        /// <summary>
        /// Host Application Instance
        /// </summary>
        protected internal Publisher.Application Application { get; private set; }
        ...
        public virtual void CTPFactoryAvailable(object CTPFactoryInst)
        {
            try
            {
                ...
                TaskPaneFactory = paneHandler.CreateCustomPanes<ITaskPane, Publisher.Application>(Factory, CTPFactoryInst, TaskPanes, TaskPaneInstances, OnError, Application);
            }
            catch (NetRuntimeSystem.Exception exception)
            {
                Factory.Console.WriteException(exception);
        ...
        private bool? IsLoadedFromSystem()
        {
            ...
            OfficeApi.Tools.Contribution.RegistryLocationResult result = 
                                    OfficeApi.Tools.Contribution.CommonUtils.TryFindAddinLoadLocation(Type,
                                                        ApplicationIdentifiers.ApplicationType.Publisher);
            switch (result)
            {
