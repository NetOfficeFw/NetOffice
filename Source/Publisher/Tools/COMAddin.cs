...
namespace NetOffice.PublisherApi.Tools
{
    ...
    public abstract class COMAddin : OfficeCOMAddin, IOfficeCOMAddin
    {
        ...
        /// </summary>
        public new Publisher.Application Application
        {
            get
            {
                return base.Application as Publisher.Application;
            }
        }
        ...
        protected override void HandleOnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
        {
            ...
            base.Application = Factory.CreateKnownObjectFromComProxy<Publisher.Application>(null, application, typeof(Publisher.Application));
            Utils = OnCreateUtils();
