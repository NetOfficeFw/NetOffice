...
namespace NetOffice.PublisherApi.Behind
{
	...
	/// </summary>
	public class RulerGuides : COMObject, NetOffice.PublisherApi.RulerGuides
	{
		...
		public virtual NetOffice.PublisherApi.RulerGuide this[Int32 item]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.RulerGuide>(this, "Item", typeof(NetOffice.PublisherApi.RulerGuide), item);
			}
		}
        ...
        /// </summary>
        [SupportByVersion("Publisher", 14, 15, 16)]
        public virtual IEnumerator<NetOffice.PublisherApi.RulerGuide> GetEnumerator()
        {
