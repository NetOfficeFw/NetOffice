...
namespace NetOffice.PublisherApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class TextStyle : COMObject, NetOffice.PublisherApi.TextStyle
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual string BaseStyle
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "BaseStyle");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "BaseStyle", value);
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual string NextParagraphStyle
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteStringPropertyGet(this, "NextParagraphStyle");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "NextParagraphStyle", value);
			}
		}
