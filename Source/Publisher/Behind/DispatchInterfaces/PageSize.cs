...
namespace NetOffice.PublisherApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class PageSize : COMObject, NetOffice.PublisherApi.PageSize
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual bool HasBackgroundImage
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "HasBackgroundImage");
			}
		}
