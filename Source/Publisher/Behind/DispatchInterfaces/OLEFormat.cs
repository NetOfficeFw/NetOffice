...
namespace NetOffice.PublisherApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class OLEFormat : COMObject, NetOffice.PublisherApi.OLEFormat
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual NetOffice.PublisherApi.ObjectVerbs ObjectVerbs
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferencePropertyGet<NetOffice.PublisherApi.ObjectVerbs>(this, "ObjectVerbs", typeof(NetOffice.PublisherApi.ObjectVerbs));
			}
		}
		...
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual void DoVerb(Int32 iVerb)
		{
			 InvokerService.InvokeInternal.ExecuteMethod(this, "DoVerb", iVerb);
		}
