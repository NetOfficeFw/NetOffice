...
namespace NetOffice.PublisherApi.Behind
{
	...
	public class CatalogMergeShapes : COMObject, NetOffice.PublisherApi.CatalogMergeShapes
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual Int32 HorizontalRepeat
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "HorizontalRepeat");
			}
		}
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual Int32 VerticalRepeat
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteInt32PropertyGet(this, "VerticalRepeat");
			}
		}
