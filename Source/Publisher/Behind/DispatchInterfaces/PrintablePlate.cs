...
namespace NetOffice.PublisherApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class PrintablePlate : COMObject, NetOffice.PublisherApi.PrintablePlate
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual bool PrintPlate
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteBoolPropertyGet(this, "PrintPlate");
			}
			set
			{
				InvokerService.InvokeInternal.ExecuteValuePropertySet(this, "PrintPlate", value);
			}
		}
