...
namespace NetOffice.PublisherApi.Behind
{
	...
	public class MailMergeDataFields : NetOffice.OfficeApi.Behind._IMsoDispObj, NetOffice.PublisherApi.MailMergeDataFields
	{
		...
		public virtual NetOffice.PublisherApi.MailMergeDataField this[object varIndex]
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteKnownReferenceMethodGet<NetOffice.PublisherApi.MailMergeDataField>(this, "Item", typeof(NetOffice.PublisherApi.MailMergeDataField), varIndex);
			}
		}
        ...
        [SupportByVersion("Publisher", 14, 15, 16)]
        [CustomEnumerator]
        public virtual IEnumerator<NetOffice.PublisherApi.MailMergeDataField> GetEnumerator()
        {
            NetRuntimeSystem.Collections.IEnumerable innerEnumerator = (this as NetRuntimeSystem.Collections.IEnumerable);
            foreach (NetOffice.PublisherApi.MailMergeDataField item in innerEnumerator)
                yield return item;
