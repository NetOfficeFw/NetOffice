...
namespace NetOffice.PublisherApi.Behind
{
	...
	[EntityType(EntityType.IsDispatchInterface)]
 	public class Story : COMObject, NetOffice.PublisherApi.Story
	{
		...
		/// </summary>
		[SupportByVersion("Publisher", 14,15,16)]
		public virtual NetOffice.PublisherApi.Enums.PbStoryType Type
		{
			get
			{
				return InvokerService.InvokeInternal.ExecuteEnumPropertyGet<NetOffice.PublisherApi.Enums.PbStoryType>(this, "Type");
			}
		}
